import{_ as t,n as e,b as s,e as i,B as a,c as o,I as r,a as n,i as l,f as d,p as c,x as p,t as u,g as _}from"./backend-ai-webui-4e657d63.js";import"./lablup-progress-bar-ac2aec86.js";import"./mwc-switch-c4435080.js";import"./vaadin-grid-c5d53900.js";import"./vaadin-grid-sort-column-4bca542b.js";import"./backend-ai-list-status-a705f355.js";import"./lablup-activity-panel-522fe303.js";import"./mwc-tab-bar-41e085c1.js";import"./dir-utils-bf4e22d3.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,n,l`
        vaadin-grid {
          border: 0;
          font-size: 14px;
