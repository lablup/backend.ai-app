import{_ as t,e,c as s,a,B as i,d as o,I as r,b as n,i as l,h as d,A as c,y as p,t as u,g}from"./backend-ai-webui-8aa0c11e.js";import"./mwc-tab-bar-0925db43.js";import"./lablup-activity-panel-686ae39b.js";import"./backend-ai-list-status-904e1a62.js";import"./vaadin-grid-2a76ea8a.js";import"./vaadin-grid-sort-column-a26239dd.js";import"./lablup-progress-bar-74ec7ef2.js";import"./mwc-switch-825da182.js";
/**
 @license
Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
*/let _=class extends i{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,n,l`
    ...
    `]}firstUpdated(){var t;this.notification=globalThis.lablupNotification,this.agentDetailDialog=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#agent-detail")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(t){await this.updateComplete,!1!==t&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._enableAgentSchedulable=globalThis.backendaiclient.supports("schedulable"),this._loadAgentList()}),!0):(this._enableAgentSchedulable=globalThis.backendaiclient.supports("schedulable"),this._loadAgentList()))}_loadAgentList(){var t;if(!0!==this.active)return;this.listCondition="loading",null===(t=this._listStatus)||void 0===t||t.show();const e=["id","status","available_slots","occupied_slots","architecture"];globalThis.backendaiclient.supports("schedulable")&&e.push("schedulable");const s="running"===this.condition?"ALIVE":"TERMINATED";globalThis.backendaiclient.agentSummary.list(s,e,20,0,1e4).then((t=>{var e,s,a;const i=null===(e=t.agent_summary_list)||void 0===e?void 0:e.items;if(void 0!==i&&0!=i.length){let t;""!==this.filter&&(t=this.filter.split(":")),Object.keys(i).map(((e,s)=>{var a,o,r,n,l,d;const c=i[e];if(""===this.filter||t[0]in c&&c[t[0]]===t[1]){const t=JSON.parse(c.occupied_slots),s=JSON.parse(c.available_slots);["cpu","mem"].forEach((e=>{e in t==!1&&(t[e]="0")})),i[e].cpu_slots=parseInt(s.cpu),i[e].used_cpu_slots=parseInt(t.cpu),null!==c.cpu_cur_pct?(i[e].cpu_total_usage_ratio=i[e].used_cpu_slots/i[e].cpu_slots,i[e].total_cpu_percent=null===(a=100*i[e].cpu_total_usage_ratio)||void 0===a?void 0:a.toFixed(2)):(i[e].cpu_total_usage_ratio=0,i[e].total_cpu_percent=null===(o=100*i[e].cpu_total_usage_ratio)||void 0===o?void 0:o.toFixed(2)),i[e].mem_slots=parseInt(globalThis.backendaiclient.utils.changeBinaryUnit(s.mem,"g")),i[e].used_mem_slots=parseInt(globalThis.backendaiclient.utils.changeBinaryUnit(t.mem,"g")),i[e].mem_total_usage_ratio=i[e].used_mem_slots/i[e].mem_slots,i[e].total_mem_percent=null===(r=100*i[e].mem_total_usage_ratio)||void 0===r?void 0:r.toFixed(2),"cuda.device"in s&&(i[e].cuda_gpu_slots=parseInt(s["cuda.device"]),i[e].used_cuda_gpu_slots="cuda.device"in t?parseInt(t["cuda.device"]):0,i[e].used_cuda_gpu_slots_ratio=i[e].used_cuda_gpu_slots/i[e].cuda_gpu_slots,i[e].total_cuda_gpu_percent=null===(n=100*i[e].used_cuda_gpu_slots_ratio)||void 0===n?void 0:n.toFixed(2)),"cuda.shares"in s&&(i[e].cuda_fgpu_slots=parseInt(s["cuda.shares"]),i[e].used_cuda_fgpu_slots="cuda.shares"in t?parseInt(t["cuda.shares"]):0,i[e].used_cuda_fgpu_slots_ratio=i[e].used_cuda_fgpu_slots/i[e].cuda_fgpu_slots,i[e].total_cuda_fgpu_percent=null===(l=100*i[e].used_cuda_fgpu_slots_ratio)||void 0===l?void 0:l.toFixed(2)),"rocm.device"in s&&(i[e].rocm_gpu_slots=parseInt(s["rocm.device"]),i[e].used_rocm_gpu_slots="rocm.device"in t?parseInt(t["rocm.device"]):0,i[e].used_rocm_gpu_slots_ratio=i[e].used_rocm_gpu_slots/i[e].rocm_gpu_slots,i[e].total_rocm_gpu_percent=null===(d=100*i[e].used_rocm_gpu_slots_ratio)||void 0===d?void 0:d.toFixed(2)),"schedulable"in c&&(i[e].schedulable=c.schedulable),this.agentsObject[i[e].id]=i[e]}}))}this.agents=i,this._agentGrid.recalculateColumnWidths(),0===(null===(s=this.agents)||void 0===s?void 0:s.length)?this.listCondition="no-data":null===(a=this._listStatus)||void 0===a||a.hide(),!0===this.active&&setTimeout((()=>{this._loadAgentList()}),15e3)})).catch((t=>{var e;null===(e=this._listStatus)||void 0===e||e.hide(),t&&t.message&&(console.log(t),this.notification.text=d.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}_isRunning(){return"running"===this.condition}_indexRenderer(t,e,s){const a=s.index+1;c(p`
        <div>${a}</div>
      ...
      `,t)}resourceRenderer(t,e,s){c(p`
        <div class="layout flex">
          ...
          `:p``}
        </div>`,t)}schedulableRenderer(t,e,s){var a;c(p`
        <div class="layout horizontal center center-justified wrap">
          ${(null===(a=s.item)||void 0===a?void 0:a.schedulable)?p`
...
let b=class extends i{constructor(){super(),this._status="inactive",this._tab="running-lists",this.hideAgents=!0}static get styles(){return[o,l`
      ...
      `]}async _viewStateChanged(t){var e,s,a,i;if(await this.updateComplete,!t)return(null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#running-agents")).active=!1,(null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector("#terminated-agents")).active=!1,void(this._status="inactive");(null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("#running-agents")).active=!0,(null===(i=this.shadowRoot)||void 0===i?void 0:i.querySelector("#terminated-agents")).active=!0,this._status="active"}_showTab(t){var e,s;const a=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelectorAll(".tab-content");for(let t=0;t<a.length;t++)a[t].style.display="none";(null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector("#"+t.title)).style.display="block",this._tab=t.title}render(){return p`
    ...
    `}};t([e({type:String})],b.prototype,"_status",void 0),t([e({type:String})],b.prototype,"_tab",void 0),t([e({type:Boolean})],b.prototype,"hideAgents",void 0),b=t([a("backend-ai-agent-summary-view")],b);var m=b;export{m as default};
