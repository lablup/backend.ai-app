import{_ as e,e as t,n as i,B as a,b as s,I as o,a as r,r as n,d as l,x as d,$ as c,t as u,g as p}from"./backend-ai-webui-06490572.js";import"./mwc-tab-bar-97685284.js";import"./lablup-activity-panel-744a4492.js";import"./vaadin-grid-7fc2c91c.js";import"./vaadin-grid-sort-column-d646877d.js";import"./mwc-linear-progress-29164e31.js";import"./mwc-switch-def7ca75.js";import"./lablup-progress-bar-5880b482.js";import"./label-1b536839.js";import"./select-63560cc0.js";import"./switch-373b0432.js";import"./textarea-17192ef9.js";import"./textfield-d47463ef.js";import"./mwc-textarea-7bcfd4ae.js";import"./input-behavior-ba836c70.js";
/**
 @license
      ...
      <backend-ai-dialog id="agent-detail" fixed backdrop blockscrolling persistent scrollable>
        ...
        <div slot="content">
          <div class="horizontal start start-justified layout">
            ...
            ${(null===(s=this.agentDetail)||void 0===s?void 0:s.rocm_util_live)?c`
                <div style="margin-left:10px;">
                  <h3>ROCm Devices</h3>
                  <h4>Utilization</h4>
...
let h=class extends a{constructor(){super(),this.condition="running",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this.storageProxyDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[s,o,r,n`
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}resourceRenderer(e,t,i){const a=JSON.parse(i.item.usage),s=a.capacity_bytes>0?a.used_bytes/a.capacity_bytes:0,o=(100*s).toFixed(3);d(c`
        <div class="layout flex">
          <div class="layout horizontal center flex">
            <div class="layout horizontal start resource-indicator">
