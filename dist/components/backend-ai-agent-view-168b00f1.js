import{_ as e,p as t,c as i,k as a,l as n,I as s,j as o,a as r,n as l,as as d,h as c}from"./backend-ai-console-ab7f3e11.js";import"./iron-resizable-behavior-688f52d4.js";import"./vaadin-progress-bar-af5576eb.js";import"./paper-progress-280ac00d.js";import"./radio-behavior-1cbd0f8e.js";import"./paper-icon-button-32abd987.js";import"./index-104ed7f5.js";import"./av-icons-97d47f39.js";import"./vaadin-grid-d044369a.js";import"./index-41c821eb.js";import"./index-a503f1e5.js";import"./index-01ab3157.js";import"./index-b244d61a.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let p=class extends a{constructor(){super(),this.condition="running",this.agents=Array(),this.notification=Object(),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[n,s,o,r`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `]}firstUpdated(){this.notification=window.lablupNotification}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){if(await this.updateComplete,!1!==e)if(void 0===window.backendaiclient||null===window.backendaiclient||!1===window.backendaiclient.ready)document.addEventListener("backend-ai-connected",()=>{this._loadAgentList("ALIVE")},!0);else{let e="ALIVE";this._loadAgentList(e)}}_loadAgentList(e="running"){if(!0!==this.active)return;switch(this.condition){case"running":e="ALIVE";break;case"terminated":e="TERMINATED";break;case"archived":default:e="ALIVE"}window.backendaiclient.agent.list(e,["id","status","addr","region","first_contact","cpu_cur_pct","mem_cur_bytes","available_slots","occupied_slots"]).then(t=>{let i=t.agents;void 0!==i&&0!=i.length&&Object.keys(i).map((e,t)=>{var a=i[e],n=JSON.parse(a.occupied_slots),s=JSON.parse(a.available_slots);i[e].cpu_slots=parseInt(s.cpu),i[e].used_cpu_slots=parseInt(n.cpu),null!==a.cpu_cur_pct?(i[e].current_cpu_percent=a.cpu_cur_pct,i[e].cpu_total_usage_ratio=i[e].used_cpu_slots/i[e].cpu_slots*100,i[e].cpu_current_usage_ratio=i[e].current_cpu_percent/i[e].cpu_slots,i[e].current_cpu_percent=i[e].current_cpu_percent.toFixed(2)):(i[e].current_cpu_percent=0,i[e].cpu_total_usage_ratio=0,i[e].cpu_current_usage_ratio=0),null!==a.mem_cur_bytes?i[e].current_mem_bytes=a.mem_cur_bytes:i[e].current_mem_bytes=0,i[e].current_mem=window.backendaiclient.utils.changeBinaryUnit(a.current_mem_bytes,"g"),i[e].mem_slots=parseInt(window.backendaiclient.utils.changeBinaryUnit(s.mem,"g")),i[e].used_mem_slots=parseInt(window.backendaiclient.utils.changeBinaryUnit(n.mem,"g")),i[e].mem_total_usage_ratio=i[e].used_mem_slots/i[e].mem_slots*100,i[e].mem_current_usage_ratio=i[e].current_mem/i[e].mem_slots*100,i[e].current_mem=i[e].current_mem.toFixed(2),"cuda.device"in s&&(i[e].gpu_slots=parseInt(s["cuda.device"])),"cuda.shares"in s&&(i[e].vgpu_slots=parseInt(s["cuda.shares"])),"cuda.device"in n&&(i[e].used_gpu_slots=parseInt(n["cuda.device"])),"cuda.shares"in n&&(i[e].used_vgpu_slots=parseInt(n["cuda.shares"]))}),this.agents=i,!0===this.active&&setTimeout(()=>{this._loadAgentList(e)},15e3)}).catch(e=>{e&&e.message&&(this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})}_isRunning(){return"running"===this.condition}_byteToMB(e){return Math.floor(e/1e6)}_MBtoGB(e){return Math.floor(e/1024)}_elapsed(e,t){var i=new Date(e);if("running"===this.condition)var a=new Date;else a=new Date(t);var n=Math.floor((a.getTime()-i.getTime())/1e3);return"running"===this.condition?"Running "+n+"sec.":"Reserved for "+n+"sec."}_humanReadableDate(e){return new Date(e).toLocaleString("ko-KR")}_indexFrom1(e){return e+1}_heartbeatStatus(e){return e}_heartbeatColor(e){switch(e){case"ALIVE":return"green";case"TERMINATED":return"red";default:return"blue"}}_indexRenderer(e,t,i){let a=i.index+1;d(c`
        <div>${a}</div>
      `,e)}regionRenderer(e,t,i){let a,n,s,o,r=i.item.region.split("/");switch(r.length>1?(a=r[0],n=r[1]):(a=r[0],n=""),a){case"aws":s="orange",o="aws";break;case"azure":s="blue",o="azure";break;case"gcp":s="lightblue",o="gcp";break;case"nbp":s="green",o="nbp";break;case"openstack":s="red",o="openstack";break;case"local":s="yellow",o="local";break;default:s="yellow",o="local"}d(c`
        <div class="horizontal start-justified center layout">
          <img src="/resources/icons/${o}.png" style="width:32px;height:32px;"/>
          <lablup-shields app="${n}" color="${s}"
