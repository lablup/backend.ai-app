import{_ as e,p as t,c as i,B as a,d as s,I as o,a as r,b as n,f as l,a7 as d,h as c,t as u,g as p}from"./backend-ai-webui-25876be0.js";import"./mwc-tab-bar-625caf6d.js";import"./lablup-activity-panel-dbf1a475.js";import"./vaadin-grid-62d1a164.js";import"./vaadin-grid-sorter-3eb0b81c.js";import"./vaadin-grid-sort-column-e99b0ae1.js";import"./mwc-linear-progress-e82a4237.js";import"./lablup-progress-bar-afedae3a.js";import"./label-6cbe012a.js";import"./select-b220ebc1.js";import"./switch-26eed8a7.js";import"./textarea-a8305bd4.js";import"./textfield-4541350c.js";import"./mwc-switch-245c1f13.js";import"./mwc-textarea-4d3d280d.js";import"./input-behavior-8b6b6242.js";
/**
 @license
...
/**
 ...
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */
let h=class extends a{constructor(){super(),this.condition="running",this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.agents=[]}static get styles(){return[s,o,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
          height: var(--list-height, calc(100vh - 200px));
      ...
      `]}firstUpdated(){this.notification=globalThis.lablupNotification,this.agentDetailDialog=this.shadowRoot.querySelector("#agent-detail")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._loadAgentList()}),!0):this._loadAgentList())}_loadAgentList(){!0===this.active&&globalThis.backendaiclient.storageproxy.list(["id","backend","capabilities","path","fsprefix","performance_metric","usage"]).then((e=>{const t=e.storage_volume_list.items,i=[];void 0!==t&&0!=t.length&&Object.keys(t).map(((e,a)=>{const s=t[e];if(""!==this.filter){const e=this.filter.split(":");e[0]in s&&s[e[0]]===e[1]&&i.push(s)}else i.push(s)})),this.agents=i;const a=new CustomEvent("backend-ai-storage-proxy-updated",{});this.dispatchEvent(a),!0===this.active&&setTimeout((()=>{this._loadAgentList()}),15e3)})).catch((e=>{e&&e.message&&(this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}_byteToMB(e){return Math.floor(e/1e6)}_MBtoGB(e){return Math.floor(e/1024)}_humanReadableDate(e){return new Date(e).toLocaleString()}_indexFrom1(e){return e+1}_heartbeatStatus(e){return e}_indexRenderer(e,t,i){const a=i.index+1;d(c`
        <div>${a}</div>
      `,e)}endpointRenderer(e,t,i){d(c`
        <div>${i.item.id}</div>
      ...
      `,e)}capabilitiesRenderer(e,t,i){d(c`
        <div class="layout vertical start justified wrap">
          ...
          `)):c``}
        </div>`,e)}showStorageProxyDetailDialog(e){const t=new CustomEvent("backend-ai-selected-storage-proxy",{detail:e});document.dispatchEvent(t)}controlRenderer(e,t,i){d(c`
