import{_ as e,p as t,c as i,B as a,d as s,I as o,a as r,b as n,f as l,v as d,h as c,t as u,g as p}from"./backend-ai-webui-b56c9d72.js";import"./mwc-tab-bar-5e35aaba.js";import"./lablup-activity-panel-ff25b4dd.js";import"./vaadin-grid-69a293c4.js";import"./vaadin-grid-sorter-d6b9e3db.js";import"./vaadin-grid-sort-column-7b54e7e6.js";import"./mwc-linear-progress-62221883.js";import"./lablup-progress-bar-8c0c3f16.js";import"./vaadin-template-renderer-70daef03.js";import"./label-3b666883.js";import"./select-e63c676c.js";import"./switch-88d435a5.js";import"./textarea-d865f2d6.js";import"./textfield-50f5c976.js";import"./mwc-switch-f232cf4c.js";import"./mwc-textarea-b31b3077.js";import"./templatize-8b3cf88e.js";import"./input-behavior-dde5586e.js";
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */let g=class extends a{constructor(){super(),this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter=""}static get styles(){return[s,o,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}contactDateRenderer(e,t,i){let a;"TERMINATED"===i.item.status&&"lost_at"in i.item?(a=this._elapsed2(i.item.lost_at,Date.now()),d(c`
        ...
        <div id="controls" class="layout horizontal flex center" agent-id="${i.item.addr}">
          ...
          `:c``}
        </div>`,e)}_bytesToMB(e){return Number(e/1048576).toFixed(1)}render(){var e,t,i,a,s,o;return c`
...
let b=class extends a{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.selectedIndex=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.scalingGroups=[],this.domains=[]}static get styles(){return[s,o,r,n`
    ...
    `,e)}_indexRenderer(e,t,i){const a=i.index+1;d(c`
      ...
      <vaadin-grid theme="row-stripes column-borders compact" aria-label="Job list" .items="${this.scalingGroups}">
        ...
        <vaadin-grid-column flex-grow="1" header="${u("resourceGroup.WsproxyAddress")}">
          <template>
