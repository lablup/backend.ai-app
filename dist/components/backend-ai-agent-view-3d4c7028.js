import{_ as e,p as t,c as i,B as a,d as s,I as o,a as n,b as r,f as l,Z as c,h as d,t as u}from"./backend-ai-console-52b9eb55.js";import"./mwc-linear-progress-f21fdedb.js";import"./iron-resizable-behavior-60d31af0.js";import"./vaadin-grid-sorter-4d8e13ce.js";import"./radio-behavior-3164ce17.js";import"./vaadin-grid-sort-column-c8394169.js";import"./tab-group-81ed713d.js";import"./select-8282ab89.js";import"./switch-25ec0469.js";import"./textarea-690bae24.js";
/**
 @license
...
let h=class extends a{constructor(){super(),this._status="inactive"}static get styles(){return[s]}firstUpdated(){}async _viewStateChanged(e){if(await this.updateComplete,!1===e)return this.shadowRoot.querySelector("#running-agents").active=!1,this.shadowRoot.querySelector("#terminated-agents").active=!1,this.shadowRoot.querySelector("#scaling-groups").active=!1,void(this._status="inactive");this.shadowRoot.querySelector("#running-agents").active=!0,this.shadowRoot.querySelector("#terminated-agents").active=!0,this.shadowRoot.querySelector("#scaling-groups").active=!1,this._status="active"}_showTab(e){let t=this.shadowRoot.querySelectorAll(".tab-content");for(let e=0;e<t.length;e++)t[e].style.display="none";this.shadowRoot.querySelector("#"+e.value).style.display="block"}render(){return d`
    ...
    `}};e([t({type:String})],h.prototype,"_status",void 0),h=e([i("backend-ai-agent-view")],h);var m=h;export default m;
