import{_ as e,p as t,c as i,B as a,d as s,I as r,a as o,b as n,f as l,a3 as d,h as c,t as u,g as p}from"./backend-ai-console-3e306fa6.js";import"./lablup-progress-bar-5be2a0b9.js";import"./lablup-activity-panel-2f2f5cfd.js";import"./mwc-switch-abe4a1f9.js";import"./input-behavior-fdf6248c.js";import"./textfield-c88f7c86.js";import"./vaadin-grid-sorter-3c5cee99.js";import"./vaadin-grid-sort-column-73a43168.js";import"./mwc-tab-bar-d706c26f.js";import"./select-df7b8eaf.js";import"./switch-4d66fcbb.js";import"./mwc-textarea-ece9cbc9.js";import"./textarea-de577d85.js";
/**
 @license
...
\            </div>
        ...
        `:c``}
          ...
          <lablup-shields app="CUDA" color="green"
                          description="${i.item.cuda_plugin.cuda_version}" ui="round"></lablup-shields>`:c`          <lablup-shields app="CUDA Disabled" color="green"
      ...
      <backend-ai-dialog id="agent-detail" fixed backdrop blockscrolling persistent scrollable>
        ...
        <div slot="content">
          ...
          ${"cpu_util_live"in this.agentDetail?c`<div>
              <h3>CPU</h3>
          ...
          ${"cuda_util_live"in this.agentDetail?c`<div style="margin-left:10px;">
              <h3>CUDA Devices</h3>
              <h4>Utilization</h4>
          ...
          ${"rocm_util_live"in this.agentDetail?c`<div style="margin-left:10px;">
              <h3>ROCm Devices</h3>
              <h4>Utilization</h4>
          ...
          ${"tpu_util_live"in this.agentDetail?c`<div style="margin-left:10px;">
              <h3>TPU Devices</h3>
              <h4>Utilization</h4>
...
let h=class extends a{constructor(){super(),this.condition="running",this.agents=Array(),this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter=""}static get styles(){return[s,r,o,n`
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}resourceRenderer(e,t,i){d(c`
        <div class="layout flex">
          <div class="layout horizontal center flex">
            <div class="layout horizontal start resource-indicator">
              <mwc-icon class="fg green">developer_board</mwc-icon>
        ...
        </div>`,e)}capabilitiesRenderer(e,t,i){d(c`
        <div class="layout vertical start justified wrap">
