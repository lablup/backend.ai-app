import{_ as e,e as t,n as i,B as s,b as a,I as o,a as r,r as n,d as l,y as d,$ as c,t as u,g as p}from"./backend-ai-webui-ac946d0d.js";import"./mwc-tab-bar-f5180fe5.js";import"./lablup-activity-panel-bfe30f45.js";import"./vaadin-grid-8b758932.js";import"./vaadin-grid-sort-column-6ba9fc72.js";import"./mwc-linear-progress-635a730b.js";import"./mwc-switch-58b198dd.js";import"./backend-ai-list-status-10cd8f8b.js";import"./lablup-progress-bar-dcc76d9f.js";import"./vaadin-item-styles-c8b74e0b.js";import"./vaadin-item-dad3fa47.js";import"./label-1fae8d8f.js";import"./select-eec89b38.js";import"./switch-6ea5d115.js";import"./textarea-b980fa97.js";import"./textfield-673c2471.js";import"./expansion-09b11571.js";import"./mwc-textarea-8f6f9a88.js";import"./input-behavior-e48ce742.js";import"./radio-behavior-a8529ed3.js";
/**
 @license
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */let h=class extends s{constructor(){super(),this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.list_status=Object(),this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this.enableAgentSchedulable=!1,this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.list_condition="loading"}static get styles(){return[a,o,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
        }
    ...
    `]}firstUpdated(){this.list_status=this.shadowRoot.querySelector("#list-status"),this.notification=globalThis.lablupNotification,this.agentDetailDialog=this.shadowRoot.querySelector("#agent-detail"),this.agentSettingDialog=this.shadowRoot.querySelector("#agent-setting")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){if(await this.updateComplete,!1!==e)if(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready)document.addEventListener("backend-ai-connected",(()=>{this.enableAgentSchedulable=globalThis.backendaiclient.supports("schedulable");this._loadAgentList("ALIVE")}),!0);else{this.enableAgentSchedulable=globalThis.backendaiclient.supports("schedulable");const e="ALIVE";this._loadAgentList(e)}}_loadAgentList(e="running"){if(!0!==this.active)return;let t;switch(this.list_condition="loading",this.list_status.show(),this.condition){case"running":e="ALIVE",t=["id","status","version","addr","architecture","region","compute_plugins","first_contact","lost_at","status_changed","live_stat","cpu_cur_pct","mem_cur_bytes","available_slots","occupied_slots","scaling_group"];break;case"terminated":e="TERMINATED",t=["id","status","version","addr","architecture","region","compute_plugins","first_contact","lost_at","status_changed","cpu_cur_pct","mem_cur_bytes","available_slots","occupied_slots","scaling_group"];break;default:e="ALIVE",t=["id","status","version","addr","architecture","region","compute_plugins","first_contact","lost_at","status_changed","cpu_cur_pct","mem_cur_bytes","available_slots","occupied_slots","scaling_group"]}this.useHardwareMetadata&&globalThis.backendaiclient.supports("hardware-metadata")&&t.push("hardware_metadata"),globalThis.backendaiclient.supports("schedulable")&&t.push("schedulable"),globalThis.backendaiclient.agent.list(e,t,1e4).then((t=>{const i=t.agents;if(void 0!==i&&0!=i.length){let e;""!==this.filter&&(e=this.filter.split(":")),Object.keys(i).map(((t,s)=>{var a,o,r,n,l,d,c,u,p,h,g,b,v,m;const _=i[t];if(""===this.filter||e[0]in _&&_[e[0]]===e[1]){const e=JSON.parse(_.occupied_slots),s=JSON.parse(_.available_slots),y=JSON.parse(_.compute_plugins);if(["cpu","mem"].forEach((t=>{t in e==!1&&(e[t]="0")})),"live_stat"in _&&(i[t].live_stat=JSON.parse(_.live_stat)),i[t].cpu_slots=parseInt(s.cpu),i[t].used_cpu_slots=parseInt(e.cpu),null!==_.cpu_cur_pct?(i[t].current_cpu_percent=_.cpu_cur_pct,i[t].cpu_total_usage_ratio=i[t].used_cpu_slots/i[t].cpu_slots,i[t].cpu_current_usage_ratio=i[t].current_cpu_percent/i[t].cpu_slots/100,i[t].current_cpu_percent=i[t].current_cpu_percent.toFixed(2)):(i[t].current_cpu_percent=0,i[t].cpu_total_usage_ratio=0,i[t].cpu_current_usage_ratio=0),null!==_.mem_cur_bytes?i[t].current_mem_bytes=_.mem_cur_bytes:i[t].current_mem_bytes=0,i[t].current_mem=globalThis.backendaiclient.utils.changeBinaryUnit(_.current_mem_bytes,"g"),i[t].mem_slots=parseInt(globalThis.backendaiclient.utils.changeBinaryUnit(s.mem,"g")),i[t].used_mem_slots=parseInt(globalThis.backendaiclient.utils.changeBinaryUnit(e.mem,"g")),i[t].mem_total_usage_ratio=i[t].used_mem_slots/i[t].mem_slots,i[t].mem_current_usage_ratio=i[t].current_mem/i[t].mem_slots,i[t].current_mem=i[t].current_mem.toFixed(2),"cuda.device"in s&&(i[t].cuda_gpu_slots=parseInt(s["cuda.device"]),i[t].used_cuda_gpu_slots="cuda.device"in e?parseInt(e["cuda.device"]):0,i[t].used_cuda_gpu_slots_ratio=i[t].used_cuda_gpu_slots/i[t].cuda_gpu_slots),"cuda.shares"in s&&(i[t].cuda_fgpu_slots=parseInt(s["cuda.shares"]),i[t].used_cuda_fgpu_slots="cuda.shares"in e?parseInt(e["cuda.shares"]):0,i[t].used_cuda_fgpu_slots_ratio=i[t].used_cuda_fgpu_slots/i[t].cuda_fgpu_slots),"rocm.device"in s&&(i[t].rocm_gpu_slots=parseInt(s["rocm.device"]),i[t].used_rocm_gpu_slots="rocm.device"in e?parseInt(e["rocm.device"]):0,i[t].used_rocm_gpu_slots_ratio=i[t].used_rocm_gpu_slots/i[t].rocm_gpu_slots),"cuda"in y){const e=y.cuda;i[t].cuda_plugin=e}if(null===(o=null===(a=i[t].live_stat)||void 0===a?void 0:a.devices)||void 0===o?void 0:o.cpu_util){const e=[];Object.entries(i[t].live_stat.devices.cpu_util).forEach((([t,i])=>{const s=Object.assign({},i,{num:t});e.push(s)})),i[t].cpu_util_live=e}if(null===(n=null===(r=i[t].live_stat)||void 0===r?void 0:r.devices)||void 0===n?void 0:n.cuda_util){const e=[];let s=1;Object.entries(i[t].live_stat.devices.cuda_util).forEach((([t,i])=>{const a=Object.assign({},i,{num:t,idx:s});s+=1,e.push(a)})),i[t].cuda_util_live=e}if(null===(d=null===(l=i[t].live_stat)||void 0===l?void 0:l.devices)||void 0===d?void 0:d.cuda_mem){const e=[];let s=1;Object.entries(i[t].live_stat.devices.cuda_mem).forEach((([t,i])=>{const a=Object.assign({},i,{num:t,idx:s});s+=1,e.push(a)})),i[t].cuda_mem_live=e}if(null===(u=null===(c=i[t].live_stat)||void 0===c?void 0:c.devices)||void 0===u?void 0:u.rocm_util){const e=[];let s=1;Object.entries(i[t].live_stat.devices.rocm_util).forEach((([t,i])=>{const a=Object.assign({},i,{num:t,idx:s});s+=1,e.push(a)})),i[t].rocm_util_live=e}if(null===(h=null===(p=i[t].live_stat)||void 0===p?void 0:p.devices)||void 0===h?void 0:h.rocm_mem){const e=[];let s=1;Object.entries(i[t].live_stat.devices.rocm_mem).forEach((([t,i])=>{const a=Object.assign({},i,{num:t,idx:s});s+=1,e.push(a)})),i[t].rocm_mem_live=e}if(null===(b=null===(g=i[t].live_stat)||void 0===g?void 0:g.devices)||void 0===b?void 0:b.tpu_util){const e=[];let s=1;Object.entries(i[t].live_stat.devices.tpu_util).forEach((([t,i])=>{const a=Object.assign({},i,{num:t,idx:s});s+=1,e.push(a)})),i[t].tpu_util_live=e}if(null===(m=null===(v=i[t].live_stat)||void 0===v?void 0:v.devices)||void 0===m?void 0:m.tpu_mem){const e=[];let s=1;Object.entries(i[t].live_stat.devices.tpu_mem).forEach((([t,i])=>{const a=Object.assign({},i,{num:t,idx:s});s+=1,e.push(a)})),i[t].tpu_mem_live=e}"hardware_metadata"in _&&(i[t].hardware_metadata=JSON.parse(_.hardware_metadata)),"schedulable"in _&&(i[t].schedulable=_.schedulable),this.agentsObject[i[t].id]=i[t]}}))}this.agents=i,0==this.agents.length?this.list_condition="no-data":this.list_status.hide(),this.agentDetailDialog.open&&(this.agentDetail=this.agentsObject[this.agentDetail.id],this.agentDetailDialog.updateComplete),!0===this.active&&setTimeout((()=>{this._loadAgentList(e)}),15e3)})).catch((e=>{this.list_status.hide(),e&&e.message&&(this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}_isRunning(){return"running"===this.condition}_byteToMB(e){return Math.floor(e/1e6)}_MBtoGB(e){return Math.floor(e/1024)}_elapsed(e,t){const i=new Date(e);let s;s="running"===this.condition?new Date:new Date(t);const a=Math.floor((s.getTime()-i.getTime())/1e3);return"running"===this.condition?"Running "+a+"sec.":"Reserved for "+a+"sec."}_humanReadableDate(e){return new Date(e).toLocaleString()}_indexFrom1(e){return e+1}_heartbeatStatus(e){return e}_heartbeatColor(e){switch(e){case"ALIVE":return"green";case"TERMINATED":return"red";default:return"blue"}}_indexRenderer(e,t,i){const s=i.index+1;d(c`
        <div>${s}</div>
      `,e)}endpointRenderer(e,t,i){d(c`
        <div>${i.item.id}</div>
        <div class="indicator monospace">${i.item.addr}</div>
      `,e)}regionRenderer(e,t,i){let s,a,o,r;const n=i.item.region.split("/");switch(n.length>1?(s=n[0],a=n[1]):(s=n[0],a=""),s){case"aws":case"amazon":o="orange",r="aws";break;case"azure":o="blue",r="azure";break;case"gcp":case"google":o="lightblue",r="gcp";break;case"nbp":case"naver":o="green",r="nbp";break;case"openstack":o="red",r="openstack";break;case"dgx":o="green",r="local";break;default:o="yellow",r="local"}d(c`
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}contactDateRenderer(e,t,i){let s;"TERMINATED"===i.item.status&&"lost_at"in i.item?(s=this._elapsed2(i.item.lost_at,Date.now()),d(c`
          <div class="layout vertical">
            <span>${this._humanReadableDate(i.item.first_contact)}</span>
            <lablup-shields app="${u("agent.Terminated")}" color="yellow"
                            description="${s}" ui="round"></lablup-shields>
          </div>`,e)):(s=this._elapsed2(i.item.first_contact,Date.now()),d(c`
          <div class="layout vertical">
            <span>${this._humanReadableDate(i.item.first_contact)}</span>
        ...
        <div class="layout vertical start justified wrap">
          ...
          ${i.item.cuda_plugin?c`
            ...
            `:c``}
            ${(null===(s=i.item.cuda_plugin)||void 0===s?void 0:s.cuda_version)?c`
        ...
        <div id="controls" class="layout horizontal flex center" agent-id="${i.item.addr}">
          ...
          `:c``}
        </div>`,e)}_showConfigDialog(e){var t,i;this.agentDetail=this.agentsObject[e];this.shadowRoot.querySelector("#schedulable-switch").selected=null!==(i=null===(t=this.agentDetail)||void 0===t?void 0:t.schedulable)&&void 0!==i&&i,this.agentSettingDialog.show()}_bytesToMB(e){return Number(e/1048576).toFixed(1)}_modifyAgentSetting(){var e;const t=this.shadowRoot.querySelector("#schedulable-switch").selected;(null===(e=this.agentDetail)||void 0===e?void 0:e.schedulable)!==t?globalThis.backendaiclient.agent.update(this.agentDetail.id,{schedulable:t}).then((e=>{this.notification.text=p("agent.AgentSettingUpdated"),this.notification.show(),this.agentSettingDialog.hide(),this._loadAgentList()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)})):(this.notification.text=p("agent.NoChanges"),this.notification.show(),this.agentSettingDialog.hide())}render(){var e,t,i,s,a,o,r;return c`
      <div class="list-wrapper">
        ...
        <backend-ai-list-status id="list-status" status_condition="${this.list_condition}" message="${p("agent.NoAgentToDisplay")}"></backend-ai-list-status>
      </div>
        ...
        <div slot="content">
          <div class="horizontal start around-justified layout flex">
            ${(null===(e=this.agentDetail)||void 0===e?void 0:e.cpu_util_live)?c`
              ...
              ${(null===(s=this.agentDetail)||void 0===s?void 0:s.cuda_util_live)?c`
                <div class="vertical layout start-justified flex">
                  <h3>CUDA Devices</h3>
                  <h4>Utilization</h4>
              ...
              ${(null===(a=this.agentDetail)||void 0===a?void 0:a.rocm_util_live)?c`
                <div class="vertical layout start-justified flex">
                  <h3>ROCm Devices</h3>
                  <h4>Utilization</h4>
              ...
              ${(null===(o=this.agentDetail)||void 0===o?void 0:o.tpu_util_live)?c`
                <div class="vertical layout start-justified flex">
                  <h3>TPU Devices</h3>
                  <h4>Utilization</h4>
    ...
    `}};e([t({type:String})],h.prototype,"condition",void 0),e([t({type:Boolean})],h.prototype,"useHardwareMetadata",void 0),e([t({type:Array})],h.prototype,"agents",void 0),e([t({type:Object})],h.prototype,"list_status",void 0),e([t({type:Object})],h.prototype,"agentsObject",void 0),e([t({type:Object})],h.prototype,"agentDetail",void 0),e([t({type:Object})],h.prototype,"notification",void 0),e([t({type:Object})],h.prototype,"agentDetailDialog",void 0),e([t({type:Object})],h.prototype,"agentSettingDialog",void 0),e([t({type:Boolean})],h.prototype,"enableAgentSchedulable",void 0),e([t({type:Object})],h.prototype,"_boundEndpointRenderer",void 0),e([t({type:Object})],h.prototype,"_boundRegionRenderer",void 0),e([t({type:Object})],h.prototype,"_boundContactDateRenderer",void 0),e([t({type:Object})],h.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],h.prototype,"_boundStatusRenderer",void 0),e([t({type:Object})],h.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],h.prototype,"_boundSchedulableRenderer",void 0),e([t({type:String})],h.prototype,"filter",void 0),e([t({type:String})],h.prototype,"list_condition",void 0),h=e([i("backend-ai-agent-list")],h);let g=class extends s{constructor(){super(),this.condition="running",this.list_status=Object(),this.list_condition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this.storageProxyDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[a,o,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `]}firstUpdated(){this.list_status=this.shadowRoot.querySelector("#list-status"),this.notification=globalThis.lablupNotification,this.storageProxyDetailDialog=this.shadowRoot.querySelector("#storage-proxy-detail")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._loadStorageProxyList()}),!0):this._loadStorageProxyList())}_loadStorageProxyList(){!0===this.active&&(this.list_condition="loading",this.list_status.show(),globalThis.backendaiclient.storageproxy.list(["id","backend","capabilities","path","fsprefix","performance_metric","usage"]).then((e=>{const t=e.storage_volume_list.items,i=[];void 0!==t&&0!=t.length&&Object.keys(t).map(((e,s)=>{const a=t[e];if(""!==this.filter){const e=this.filter.split(":");e[0]in a&&a[e[0]]===e[1]&&i.push(a)}else i.push(a)})),this.storages=i,0==this.storages.length?this.list_condition="no-data":this.list_status.hide();const s=new CustomEvent("backend-ai-storage-proxy-updated",{});this.dispatchEvent(s),!0===this.active&&setTimeout((()=>{this._loadStorageProxyList()}),15e3)})).catch((e=>{this.list_status.hide(),e&&e.message&&(this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})))}_byteToMB(e){return Math.floor(e/1e6)}_MBtoGB(e){return Math.floor(e/1024)}_humanReadableDate(e){return new Date(e).toLocaleString()}_indexFrom1(e){return e+1}_heartbeatStatus(e){return e}_indexRenderer(e,t,i){const s=i.index+1;d(c`
        <div>${s}</div>
      `,e)}endpointRenderer(e,t,i){d(c`
        <div>${i.item.id}</div>
        <div class="indicator monospace">${i.item.path}</div>
      `,e)}typeRenderer(e,t,i){let s,a;switch(i.item.backend){case"xfs":s="blue",a="local";break;case"ceph":case"cephfs":s="lightblue",a="ceph";break;case"vfs":case"nfs":case"dgx":s="green",a="local";break;case"purestorage":s="red",a="purestorage";break;default:s="yellow",a="local"}d(c`
        <div class="horizontal start-justified center layout">
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}resourceRenderer(e,t,i){const s=JSON.parse(i.item.usage),a=s.capacity_bytes>0?s.used_bytes/s.capacity_bytes:0,o=(100*a).toFixed(3);d(c`
        <div class="layout flex">
          <div class="layout horizontal center flex">
            <div class="layout horizontal start resource-indicator">
      ...
      `,e)}capabilitiesRenderer(e,t,i){d(c`
        <div class="layout vertical start justified wrap">
          ...
          `)):c``}
        </div>`,e)}showStorageProxyDetailDialog(e){const t=new CustomEvent("backend-ai-selected-storage-proxy",{detail:e});document.dispatchEvent(t)}controlRenderer(e,t,i){let s;try{const e=JSON.parse(i.item.performance_metric);s=!(Object.keys(e).length>0)}catch(e){s=!0}d(c`
    ...
    `}};e([t({type:String})],g.prototype,"condition",void 0),e([t({type:Array})],g.prototype,"storages",void 0),e([t({type:Object})],g.prototype,"list_status",void 0),e([t({type:String})],g.prototype,"list_condition",void 0),e([t({type:Object})],g.prototype,"storagesObject",void 0),e([t({type:Object})],g.prototype,"storageProxyDetail",void 0),e([t({type:Object})],g.prototype,"notification",void 0),e([t({type:Object})],g.prototype,"storageProxyDetailDialog",void 0),e([t({type:Object})],g.prototype,"_boundEndpointRenderer",void 0),e([t({type:Object})],g.prototype,"_boundTypeRenderer",void 0),e([t({type:Object})],g.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],g.prototype,"_boundCapabilitiesRenderer",void 0),e([t({type:Object})],g.prototype,"_boundControlRenderer",void 0),e([t({type:String})],g.prototype,"filter",void 0),g=e([i("backend-ai-storage-proxy-list")],g);
/**
 @license
 Copyright (c) 2015-2018 Lablup Inc. All rights reserved.
 */
let b=class extends s{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypesObjects={interactive:"interactive",batch:"batch",both:"both (interactive, batch)"},this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[a,o,r,n`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
      ...
      `]}firstUpdated(){this.notification=globalThis.lablupNotification}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this.enableSchedulerOpts=globalThis.backendaiclient.supports("scheduler-opts"),this.enableWSProxyAddr=globalThis.backendaiclient.supports("wsproxy-addr"),globalThis.backendaiclient.scalingGroup.list_available().then((e=>{this.resourceGroups=e.scaling_groups})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)})),globalThis.backendaiclient.domain.list().then((({domains:e})=>{this.domains=e,this.requestUpdate()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)}))}),!0):(this.enableSchedulerOpts=globalThis.backendaiclient.supports("scheduler-opts"),this.enableWSProxyAddr=globalThis.backendaiclient.supports("wsproxy-addr"),globalThis.backendaiclient.scalingGroup.list_available().then((e=>{this.resourceGroups=e.scaling_groups})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)})),globalThis.backendaiclient.domain.list().then((({domains:e})=>{this.domains=e,this.requestUpdate()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)}))))}_activeStatusRenderer(e,t,i){d(c`
        <lablup-shields
          ...
          ui="flat"
        ></lablup-shields>
    `,e)}_indexRenderer(e,t,i){const s=i.index+1;d(c`
        <div>${s}</div>
      ...
      `,e)}_validateResourceGroupName(){const e=this.resourceGroups.map((e=>e.name)),t=this.shadowRoot.querySelector("#resource-group-name");t.validityTransform=(i,s)=>{if(s.valid){const s=!e.includes(i);return s||(t.validationMessage=p("resourceGroup.ResourceGroupAlreadyExist")),{valid:s,customError:!s}}return s.valueMissing?(t.validationMessage=p("resourceGroup.ResourceGroupNameRequired"),{valid:s.valid,valueMissing:!s.valid}):(t.validationMessage=p("resourceGroup.EnterValidResourceGroupName"),{valid:s.valid,customError:!s.valid})}}_createResourceGroup(){const e=this.shadowRoot.querySelector("#resource-group-name");if(e.checkValidity()&&this._verifyCreateSchedulerOpts()){this._saveSchedulerOpts();const t=e.value,i=this.shadowRoot.querySelector("#resource-group-description").value,s=this.shadowRoot.querySelector("#resource-group-domain").value,a={description:i,is_active:!0,driver:"static",driver_opts:"{}",scheduler:"fifo"};if(this.enableSchedulerOpts&&(a.scheduler_opts=JSON.stringify(this.schedulerOpts)),this.enableWSProxyAddr){const e=this.shadowRoot.querySelector("#resource-group-wsproxy-address").value;a.wsproxy_addr=e}globalThis.backendaiclient.scalingGroup.create(t,a).then((({create_scaling_group:e})=>e.ok?globalThis.backendaiclient.scalingGroup.associate_domain(s,t):Promise.reject(e.msg))).then((({associate_scaling_group_with_domain:e})=>{e.ok?(this.notification.text=p("resourceGroup.ResourceGroupCreated"),this._refreshList(),this.shadowRoot.querySelector("#resource-group-name").value="",this.shadowRoot.querySelector("#resource-group-description").value=""):(this.notification.text=l.relieve(e.title),this.notification.detail=e.msg),this._hideDialogById("#resource-group-dialog"),this.notification.show()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e,this._hideDialogById("#resource-group-dialog"),this.notification.show(!0,e)}))}}_modifyResourceGroup(){if(!1===this._verifyModifySchedulerOpts())return;this._saveSchedulerOpts();const e=this.shadowRoot.querySelector("#resource-group-description").value,t=this.shadowRoot.querySelector("#resource-group-scheduler").value,i=this.shadowRoot.querySelector("#resource-group-active").checked,s=this.schedulerOpts,a=this.resourceGroupInfo.name,o={};if(e!==this.resourceGroupInfo.description&&(o.description=e),t!==this.resourceGroupInfo.scheduler&&(o.scheduler=t),i!==this.resourceGroupInfo.is_active&&(o.is_active=i),this.enableWSProxyAddr){let e=this.shadowRoot.querySelector("#resource-group-wsproxy-address").value;e.endsWith("/")&&(e=e.slice(0,e.length-1)),e!==this.resourceGroupInfo.wsproxy_addr&&(o.wsproxy_addr=e)}if(this.enableSchedulerOpts&&s!==this.resourceGroupInfo.scheduler_opts&&(o.scheduler_opts=JSON.stringify(s)),0===Object.keys(o).length)return this.notification.text=p("resourceGroup.NochangesMade"),void this.notification.show();globalThis.backendaiclient.scalingGroup.update(a,o).then((({modify_scaling_group:e})=>{e.ok?(this.notification.text=p("resourceGroup.ResourceGroupModified"),this._refreshList()):(this.notification.text=l.relieve(e.msg),this.notification.detail=e.msg),this._hideDialogById("#resource-group-dialog"),this.notification.show()}))}_deleteResourceGroup(){const e=this.resourceGroupInfo.name;if(this.shadowRoot.querySelector("#delete-resource-group").value!==e)return this.notification.text=p("resourceGroup.ResourceGroupNameNotMatch"),this._hideDialogById("#delete-resource-group-dialog"),void this.notification.show();globalThis.backendaiclient.scalingGroup.delete(e).then((({delete_scaling_group:e})=>{e.ok?(this.notification.text=p("resourceGroup.ResourceGroupDeleted"),this._refreshList(),this.shadowRoot.querySelector("#delete-resource-group").value=""):(this.notification.text=l.relieve(e.msg),this.notification.detail=e.msg),this._hideDialogById("#delete-resource-group-dialog"),this.notification.show()}))}_refreshList(){globalThis.backendaiclient.scalingGroup.list_available().then((({scaling_groups:e})=>{this.resourceGroups=e,this.requestUpdate()}))}_initializeCreateSchedulerOpts(){const e=this.shadowRoot.querySelector("#allowed-session-types"),t=this.shadowRoot.querySelector("#pending-timeout"),i=this.shadowRoot.querySelector("#num-retries-to-skip"),s=this.shadowRoot.querySelector("#scheduler-options-input-form");e.value="both",s.checked=!1,(null==t?void 0:t.value)&&(t.value=""),(null==i?void 0:i.value)&&(i.value="")}_initializeModifySchedulerOpts(e="",t){var i;const s=this.shadowRoot.querySelector("#allowed-session-types"),a=this.shadowRoot.querySelector("#pending-timeout"),o=this.shadowRoot.querySelector("#num-retries-to-skip");"allowed_session_types"===e?t.includes("interactive")&&t.includes("batch")?s.value="both":s.value=t[0]:"pending_timeout"===e?a.value=t:"config"===e&&(o.value=null!==(i=t.num_retries_to_skip)&&void 0!==i?i:"")}_verifyCreateSchedulerOpts(){return!([this.shadowRoot.querySelector("#allowed-session-types"),this.shadowRoot.querySelector("#pending-timeout"),this.shadowRoot.querySelector("#num-retries-to-skip")].filter((e=>!e.checkValidity())).length>0)}_verifyModifySchedulerOpts(){return!([this.shadowRoot.querySelector("#allowed-session-types"),this.shadowRoot.querySelector("#pending-timeout"),this.shadowRoot.querySelector("#num-retries-to-skip")].filter((e=>!e.checkValidity())).length>0)}_saveSchedulerOpts(){this.schedulerOpts={};const e=this.shadowRoot.querySelector("#allowed-session-types"),t=this.shadowRoot.querySelector("#pending-timeout"),i=this.shadowRoot.querySelector("#num-retries-to-skip");"both"===e.value?this.schedulerOpts.allowed_session_types=["interactive","batch"]:this.schedulerOpts.allowed_session_types=[e.value],""!==t.value&&(this.schedulerOpts.pending_timeout=t.value),""!==i.value&&Object.assign(this.schedulerOpts,{config:{num_retries_to_skip:i.value}})}_launchCreateDialog(){this.enableSchedulerOpts&&this._initializeCreateSchedulerOpts(),this.resourceGroupInfo={},this._launchDialogById("#resource-group-dialog")}_launchDeleteDialog(e){this.resourceGroupInfo=e,this._launchDialogById("#delete-resource-group-dialog")}_launchDetailDialog(e){this.resourceGroupInfo=e,this._launchDialogById("#resource-group-detail-dialog")}_launchModifyDialog(e){if(this.resourceGroupInfo=e,this.enableSchedulerOpts){const e=JSON.parse(this.resourceGroupInfo.scheduler_opts);Object.entries(e).forEach((([e,t])=>{this._initializeModifySchedulerOpts(e,t)}))}this._launchDialogById("#resource-group-dialog")}render(){var e,t,i,s,a,o,r,n,l,d,h,g,b,v,m,_,y,f,x,w;return c`
          ...
          ${this.enableSchedulerOpts?c`
            <wl-expansion id="scheduler-options-input-form">
              ...
              <mwc-textfield
                ...
                autoValidate
                min="0"
                value="${null!==(n=null===(r=null===(o=this.resourceGroupInfo)||void 0===o?void 0:o.scheduler_opts)||void 0===r?void 0:r.pending_timeout)&&void 0!==n?n:""}"
              ></mwc-textfield>
              <mwc-textfield
                  type="number"
                  value="0"
...
/**
 ...
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */
let v=class extends s{constructor(){super(),this._status="inactive",this._tab="running-lists",this.enableStorageProxy=!1}static get styles(){return[a,n`
        h3.tab {
