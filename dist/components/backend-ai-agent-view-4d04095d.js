import{_ as e,e as t,n as i,B as a,b as o,I as s,a as r,r as n,d as l,y as d,$ as c,t as u,g as p}from"./backend-ai-webui-1eec9a06.js";import"./mwc-tab-bar-31d9ee1e.js";import"./lablup-activity-panel-e36e139c.js";import"./vaadin-grid-eb720a1f.js";import"./vaadin-grid-sort-column-adbcd7b7.js";import"./mwc-linear-progress-6d1f9a9e.js";import"./mwc-switch-53c1bae4.js";import"./lablup-progress-bar-dd7168cb.js";import"./vaadin-item-styles-b266be2e.js";import"./vaadin-item-e502bee6.js";import"./label-7e012461.js";import"./select-35570c3d.js";import"./switch-f41ef405.js";import"./textarea-f5506009.js";import"./textfield-a44880ce.js";import"./expansion-d27cb585.js";import"./mwc-textarea-11080d35.js";import"./input-behavior-791d83b3.js";import"./radio-behavior-32d164f6.js";
/**
 @license
...
let g=class extends a{constructor(){super(),this.condition="running",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this.storageProxyDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,s,r,n`
      ...
      `,e)}typeRenderer(e,t,i){let a,o;switch(i.item.backend){case"xfs":a="blue",o="local";break;case"ceph":case"cephfs":a="lightblue",o="ceph";break;case"vfs":case"nfs":a="green",o="local";break;case"purestorage":a="red",o="purestorage";break;case"dgx":a="green",o="local";break;default:a="yellow",o="local"}d(c`
        <div class="horizontal start-justified center layout">
