import{_ as e,p as t,c as i,B as a,d as s,I as o,a as r,b as n,f as l,a3 as d,h as c,t as u,g as p}from"./backend-ai-webui-5c3ff6fd.js";import"./mwc-tab-bar-ed11ffac.js";import"./lablup-activity-panel-244152fb.js";import"./vaadin-grid-sorter-1af01316.js";import"./vaadin-grid-sort-column-8692d586.js";import"./lablup-progress-bar-902d4700.js";import"./input-behavior-7f01818e.js";import"./select-7255886e.js";import"./switch-c06ed7a9.js";import"./textarea-c46304c0.js";import"./textfield-b792aa14.js";import"./mwc-switch-13be5612.js";import"./mwc-textarea-6e0aa5a2.js";
/**
 @license
...
let h=class extends a{constructor(){super(),this.condition="running",this.agents=Array(),this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter=""}static get styles(){return[s,o,r,n`
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}resourceRenderer(e,t,i){let a=JSON.parse(i.item.usage),s=a.capacity_bytes>0?a.used_bytes/a.capacity_bytes:0,o=(100*s).toFixed(3);d(c`
        <div class="layout flex">
          <div class="layout horizontal center flex">
            <div class="layout horizontal start resource-indicator">
 ...
 */
let b=class extends a{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.selectedIndex=0,this.domains=Array(),this.scalingGroups=Array(),this.schedulerTypes=Array(),this.active=!1,this.schedulerTypes=["fifo","lifo","drf"]}static get styles(){return[s,o,r,n`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
