import{_ as e,p as t,c as i,B as a,d as s,I as r,a as o,b as n,f as l,a3 as c,h as d,t as u,g as p}from"./backend-ai-console-b3bc0c77.js";import"./lablup-progress-bar-9db47297.js";import"./lablup-activity-panel-87f56c48.js";import"./mwc-switch-8f4c4df0.js";import"./input-behavior-73324317.js";import"./textfield-33f30c44.js";import"./vaadin-grid-sorter-3c5cee99.js";import"./vaadin-grid-sort-column-73a43168.js";import"./mwc-tab-bar-d9177ce1.js";import"./select-219ec85f.js";import"./switch-fbcf36b1.js";import"./mwc-textarea-757689ea.js";import"./textarea-92a5f49c.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let g=class extends a{constructor(){super(),this.condition="running",this.agents=Array(),this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter=""}static get styles(){return[s,r,o,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
...
\            </div>
        ...
        `:d``}
          ...
          <lablup-shields app="CUDA" color="green"
                          description="${i.item.cuda_plugin.cuda_version}" ui="round"></lablup-shields>`:d`          <lablup-shields app="CUDA Disabled" color="green"
...
let h=class extends a{constructor(){super(),this.condition="running",this.agents=Array(),this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter=""}static get styles(){return[s,r,o,n`
      ...
      `]}firstUpdated(){this.notification=globalThis.lablupNotification,this.agentDetailDialog=this.shadowRoot.querySelector("#agent-detail")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._loadAgentList()}),!0):this._loadAgentList())}_loadAgentList(){!0===this.active&&globalThis.backendaiclient.storageproxy.list(["id","backend","capabilities","path","fsprefix","performance_metric"]).then((e=>{let t=e.storage_volume_list.items,i=[];void 0!==t&&0!=t.length&&Object.keys(t).map(((e,a)=>{let s=t[e];if(""!==this.filter){let e=this.filter.split(":");e[0]in s&&s[e[0]]===e[1]&&i.push(s)}else i.push(s)})),this.agents=i;let a=new CustomEvent("backend-ai-storage-proxy-updated",{});this.dispatchEvent(a),!0===this.active&&setTimeout((()=>{this._loadAgentList()}),15e3)})).catch((e=>{e&&e.message&&(this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}_byteToMB(e){return Math.floor(e/1e6)}_MBtoGB(e){return Math.floor(e/1024)}_humanReadableDate(e){return new Date(e).toLocaleString()}_indexFrom1(e){return e+1}_heartbeatStatus(e){return e}_indexRenderer(e,t,i){let a=i.index+1;c(d`
        <div>${a}</div>
      `,e)}endpointRenderer(e,t,i){c(d`
        <div>${i.item.id}</div>
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}resourceRenderer(e,t,i){c(d`
        <div class="layout flex">
          <div class="layout horizontal center flex">
            <div class="layout horizontal start resource-indicator">
              <mwc-icon class="fg green">developer_board</mwc-icon>
        ...
        </div>`,e)}capabilitiesRenderer(e,t,i){c(d`
        <div class="layout vertical start justified wrap">
        ...
        </div>`,e)}showStorageProxyDetailDialog(e){let t=new CustomEvent("backend-ai-selected-storage-proxy",{detail:e});document.dispatchEvent(t)}controlRenderer(e,t,i){c(d`
      ...
      <backend-ai-dialog id="agent-detail" fixed backdrop blockscrolling persistent scrollable>
        ...
        <div slot="content">
          <div class="horizontal start start-justified layout">
            ${"cpu_util_live"in this.agentDetail?d`
                <div>
                  <h3>CPU</h3>
                  <div class="horizontal wrap layout" style="max-width:600px;">
                    ${this.agentDetail.cpu_util_live.map((e=>d`
...
/**
 ...
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let m=class extends a{constructor(){super(),this._status="inactive",this._tab="running-lists"}static get styles(){return[s,n`
        h3.tab {
    ...
    `}};e([t({type:String})],m.prototype,"_status",void 0),e([t({type:String})],m.prototype,"_tab",void 0),m=e([i("backend-ai-agent-view")],m);var v=m;export default v;
