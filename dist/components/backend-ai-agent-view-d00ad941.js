import{_ as e,e as t,n as i,B as a,b as s,I as o,a as r,r as n,d as l,w as c,p as d,t as u,g as p}from"./backend-ai-webui-ad308e0c.js";import"./mwc-tab-bar-ba2faa01.js";import"./lablup-activity-panel-387ccaab.js";import"./vaadin-grid-3d51fc23.js";import"./vaadin-grid-sort-column-f6c5c367.js";import"./mwc-linear-progress-d09f8c1f.js";import"./mwc-switch-0b390378.js";import"./lablup-progress-bar-b915fc73.js";import"./label-f0a9dca2.js";import"./select-5d4df5e7.js";import"./switch-308e5433.js";import"./textarea-ba4ba3c6.js";import"./textfield-71eb2c95.js";import"./mwc-textarea-8ca78699.js";import"./input-behavior-cbb7ec82.js";
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */let g=class extends a{constructor(){super(),this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this.enableAgentSchedulable=!1,this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter=""}static get styles(){return[s,o,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}contactDateRenderer(e,t,i){let a;"TERMINATED"===i.item.status&&"lost_at"in i.item?(a=this._elapsed2(i.item.lost_at,Date.now()),c(d`
        ...
        <div class="layout vertical start justified wrap">
          ...
          ${i.item.cuda_plugin?d`
            ...
            `:d``}
            ${(null===(a=i.item.cuda_plugin)||void 0===a?void 0:a.cuda_version)?d`
                <lablup-shields app="CUDA" color="green"
                                description="${i.item.cuda_plugin.cuda_version}" ui="round"></lablup-shields>`:d`
        ...
        <div id="controls" class="layout horizontal flex center" agent-id="${i.item.addr}">
          ...
          `:d``}
        </div>`,e)}_showConfigDialog(e){var t,i;this.agentDetail=this.agentsObject[e];this.shadowRoot.querySelector("#schedulable-switch").selected=null!==(i=null===(t=this.agentDetail)||void 0===t?void 0:t.schedulable)&&void 0!==i&&i,this.agentSettingDialog.show()}_bytesToMB(e){return Number(e/1048576).toFixed(1)}_modifyAgentSetting(){var e;const t=this.shadowRoot.querySelector("#schedulable-switch").selected;(null===(e=this.agentDetail)||void 0===e?void 0:e.schedulable)!==t?globalThis.backendaiclient.agent.update(this.agentDetail.id,{schedulable:t}).then((e=>{this.notification.text=p("agent.AgentSettingUpdated"),this.notification.show(),this.agentSettingDialog.hide(),this._loadAgentList()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)})):(this.notification.text=p("agent.NoChanges"),this.notification.show(),this.agentSettingDialog.hide())}render(){var e,t,i,a,s,o,r;return d`
      ...
      <backend-ai-dialog id="agent-detail" fixed backdrop blockscrolling persistent scrollable>
        ...
        <div slot="content">
          <div class="horizontal start start-justified layout">
            ${(null===(e=this.agentDetail)||void 0===e?void 0:e.cpu_util_live)?d`
                <div>
                  <h3>CPU</h3>
            ...
            <div>
              ...
              <h3>Network</h3>
              ${(null===(i=null===(t=this.agentDetail)||void 0===t?void 0:t.live_stat)||void 0===i?void 0:i.node)?d`
            ...
            ${(null===(a=this.agentDetail)||void 0===a?void 0:a.cuda_util_live)?d`
            ...
            ${(null===(s=this.agentDetail)||void 0===s?void 0:s.rocm_util_live)?d`
                <div style="margin-left:10px;">
                  <h3>ROCm Devices</h3>
                  <h4>Utilization</h4>
            ...
            ${(null===(o=this.agentDetail)||void 0===o?void 0:o.tpu_util_live)?d`
                <div style="margin-left:10px;">
                  <h3>TPU Devices</h3>
                  <h4>Utilization</h4>
    ...
    `}};e([t({type:String})],g.prototype,"condition",void 0),e([t({type:Boolean})],g.prototype,"useHardwareMetadata",void 0),e([t({type:Array})],g.prototype,"agents",void 0),e([t({type:Object})],g.prototype,"agentsObject",void 0),e([t({type:Object})],g.prototype,"agentDetail",void 0),e([t({type:Object})],g.prototype,"notification",void 0),e([t({type:Object})],g.prototype,"agentDetailDialog",void 0),e([t({type:Object})],g.prototype,"agentSettingDialog",void 0),e([t({type:Boolean})],g.prototype,"enableAgentSchedulable",void 0),e([t({type:Object})],g.prototype,"_boundEndpointRenderer",void 0),e([t({type:Object})],g.prototype,"_boundRegionRenderer",void 0),e([t({type:Object})],g.prototype,"_boundContactDateRenderer",void 0),e([t({type:Object})],g.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],g.prototype,"_boundStatusRenderer",void 0),e([t({type:Object})],g.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],g.prototype,"_boundSchedulableRenderer",void 0),e([t({type:String})],g.prototype,"filter",void 0),g=e([i("backend-ai-agent-list")],g);
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */
let h=class extends a{constructor(){super(),this.condition="running",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this.storageProxyDetailDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[s,o,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
          height: var(--list-height, calc(100vh - 200px));
      ...
      `]}firstUpdated(){this.notification=globalThis.lablupNotification,this.storageProxyDetailDialog=this.shadowRoot.querySelector("#storage-proxy-detail")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._loadStorageProxyList()}),!0):this._loadStorageProxyList())}_loadStorageProxyList(){!0===this.active&&globalThis.backendaiclient.storageproxy.list(["id","backend","capabilities","path","fsprefix","performance_metric","usage"]).then((e=>{const t=e.storage_volume_list.items,i=[];void 0!==t&&0!=t.length&&Object.keys(t).map(((e,a)=>{const s=t[e];if(""!==this.filter){const e=this.filter.split(":");e[0]in s&&s[e[0]]===e[1]&&i.push(s)}else i.push(s)})),this.storages=i;const a=new CustomEvent("backend-ai-storage-proxy-updated",{});this.dispatchEvent(a),!0===this.active&&setTimeout((()=>{this._loadStorageProxyList()}),15e3)})).catch((e=>{e&&e.message&&(this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}_byteToMB(e){return Math.floor(e/1e6)}_MBtoGB(e){return Math.floor(e/1024)}_humanReadableDate(e){return new Date(e).toLocaleString()}_indexFrom1(e){return e+1}_heartbeatStatus(e){return e}_indexRenderer(e,t,i){const a=i.index+1;c(d`
        <div>${a}</div>
      `,e)}endpointRenderer(e,t,i){c(d`
        <div>${i.item.id}</div>
        <div class="indicator monospace">${i.item.path}</div>
      `,e)}typeRenderer(e,t,i){let a,s;switch(i.item.backend){case"xfs":a="blue",s="local";break;case"ceph":case"cephfs":a="lightblue",s="ceph";break;case"vfs":case"nfs":a="green",s="local";break;case"purestorage":a="red",s="purestorage";break;case"dgx":a="green",s="local";break;default:a="yellow",s="local"}c(d`
        <div class="horizontal start-justified center layout">
      ...
      `,e)}_elapsed2(e,t){return globalThis.backendaiclient.utils.elapsedTime(e,t)}resourceRenderer(e,t,i){const a=JSON.parse(i.item.usage),s=a.capacity_bytes>0?a.used_bytes/a.capacity_bytes:0,o=(100*s).toFixed(3);c(d`
        <div class="layout flex">
          <div class="layout horizontal center flex">
            <div class="layout horizontal start resource-indicator">
      ...
      `,e)}capabilitiesRenderer(e,t,i){c(d`
        <div class="layout vertical start justified wrap">
          ${i.item.capabilities?i.item.capabilities.map((e=>d`
            <lablup-shields app="" color="blue"
                            description="${e}" ui="round"></lablup-shields>
          `)):d``}
        </div>`,e)}showStorageProxyDetailDialog(e){const t=new CustomEvent("backend-ai-selected-storage-proxy",{detail:e});document.dispatchEvent(t)}controlRenderer(e,t,i){let a;try{const e=JSON.parse(i.item.performance_metric);a=!(Object.keys(e).length>0)}catch(e){a=!0}c(d`
      ...
      <backend-ai-dialog id="storage-proxy-detail" fixed backdrop blockscrolling persistent scrollable>
        ...
        <div slot="content">
          <div class="horizontal start start-justified layout">
            ${"cpu_util_live"in this.storageProxyDetail?d`
                <div>
                  <h3>CPU</h3>
                  <div class="horizontal wrap layout" style="max-width:600px;">
                    ${this.storageProxyDetail.cpu_util_live.map((e=>d`
                      <div class="horizontal start-justified center layout" style="padding:0 5px;">
                        <div style="font-size:8px;width:35px;">CPU${e.num}</div>
                        <lablup-progress-bar class="cpu"
                                             progress="${e.pct/100}"
            ...
            <div style="margin-left:10px;">
              ...
              <h3>Network</h3>
              ${"live_stat"in this.storageProxyDetail&&"node"in this.storageProxyDetail.live_stat?d`
    ...
    `}};e([t({type:String})],h.prototype,"condition",void 0),e([t({type:Array})],h.prototype,"storages",void 0),e([t({type:Object})],h.prototype,"storagesObject",void 0),e([t({type:Object})],h.prototype,"storageProxyDetail",void 0),e([t({type:Object})],h.prototype,"notification",void 0),e([t({type:Object})],h.prototype,"storageProxyDetailDialog",void 0),e([t({type:Object})],h.prototype,"_boundEndpointRenderer",void 0),e([t({type:Object})],h.prototype,"_boundTypeRenderer",void 0),e([t({type:Object})],h.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],h.prototype,"_boundCapabilitiesRenderer",void 0),e([t({type:Object})],h.prototype,"_boundControlRenderer",void 0),e([t({type:String})],h.prototype,"filter",void 0),h=e([i("backend-ai-storage-proxy-list")],h);
/**
 @license
 Copyright (c) 2015-2018 Lablup Inc. All rights reserved.
 */
let b=class extends a{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.selectedIndex=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.scalingGroups=[],this.domains=[]}static get styles(){return[s,o,r,n`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
      ...
      `]}firstUpdated(){this.notification=globalThis.lablupNotification}connectedCallback(){super.connectedCallback()}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{globalThis.backendaiclient.scalingGroup.list_available().then((e=>{this.scalingGroups=e.scaling_groups})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)})),globalThis.backendaiclient.domain.list().then((({domains:e})=>{this.domains=e,this.requestUpdate()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)}))}),!0):(globalThis.backendaiclient.scalingGroup.list_available().then((e=>{this.scalingGroups=e.scaling_groups})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)})),globalThis.backendaiclient.domain.list().then((({domains:e})=>{this.domains=e,this.requestUpdate()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)}))))}_activeStatusRenderer(e,t,i){c(d`
        <lablup-shields
          app=""
          ...
          ui="flat"
        ></lablup-shields>
    `,e)}_indexRenderer(e,t,i){const a=i.index+1;c(d`
        <div>${a}</div>
      `,e)}_launchDialogById(e){this.shadowRoot.querySelector(e).show()}_hideDialogById(e){this.shadowRoot.querySelector(e).hide()}_controlRenderer(e,t,i){c(d`
        ...
        >
          <wl-button fab flat inverted
            icon="settings"
            class="fg blue"
            @click=${()=>{this.selectedIndex=i.index,this.shadowRoot.querySelector("#modify-scaling-group-active").selected=this.scalingGroups[i.index].is_active,this._launchDialogById("#modify-scaling-group-dialog")}}
      ...
      `,e)}_validateResourceGroupName(){const e=this.scalingGroups.map((e=>e.name)),t=this.shadowRoot.querySelector("#scaling-group-name");t.validityTransform=(i,a)=>{if(a.valid){const a=!e.includes(i);return a||(t.validationMessage=p("resourceGroup.ResourceGroupAlreadyExist")),{valid:a,customError:!a}}return a.valueMissing?(t.validationMessage=p("resourceGroup.ResourceGroupNameRequired"),{valid:a.valid,valueMissing:!a.valid}):(t.validationMessage=p("resourceGroup.EnterValidResourceGroupName"),{valid:a.valid,customError:!a.valid})}}_createScalingGroup(){const e=this.shadowRoot.querySelector("#scaling-group-name");if(e.checkValidity()){const e=this.shadowRoot.querySelector("#scaling-group-name").value,t=this.shadowRoot.querySelector("#scaling-group-description").value,i=this.shadowRoot.querySelector("#scaling-group-domain").value,a=this.shadowRoot.querySelector("#scaling-group-wsproxy-address").value;globalThis.backendaiclient.scalingGroup.create(e,t,a).then((({create_scaling_group:t})=>t.ok?globalThis.backendaiclient.scalingGroup.associate_domain(i,e):Promise.reject(t.msg))).then((({associate_scaling_group_with_domain:e})=>{e.ok?(this.notification.text=p("resourceGroup.ResourceGroupCreated"),this._refreshList(),this.shadowRoot.querySelector("#scaling-group-name").value="",this.shadowRoot.querySelector("#scaling-group-description").value=""):(this.notification.text=l.relieve(e.title),this.notification.detail=e.msg),this._hideDialogById("#create-scaling-group-dialog"),this.notification.show()})).catch((e=>{this.notification.text=l.relieve(e.title),this.notification.detail=e,this._hideDialogById("#create-scaling-group-dialog"),this.notification.show(!0,e)}))}else e.reportValidity()}_modifyScalingGroup(){const e=this.shadowRoot.querySelector("#modify-scaling-group-description").value,t=this.shadowRoot.querySelector("#modify-scaling-group-scheduler").value,i=this.shadowRoot.querySelector("#modify-scaling-group-active").checked;let a=this.shadowRoot.querySelector("#modify-scaling-group-wsproxy-address").value;a.endsWith("/")&&(a=a.slice(0,a.length-1));const s=this.scalingGroups[this.selectedIndex].name,o={};if(e!==this.scalingGroups[this.selectedIndex].description&&(o.description=e),t!==this.scalingGroups[this.selectedIndex].scheduler&&(o.scheduler=t),i!==this.scalingGroups[this.selectedIndex].is_active&&(o.is_active=i),a!==this.scalingGroups[this.selectedIndex].wsproxy_addr&&(o.wsproxy_addr=a),0===Object.keys(o).length)return this.notification.text=p("resourceGroup.NochangesMade"),void this.notification.show();globalThis.backendaiclient.scalingGroup.update(s,o).then((({modify_scaling_group:e})=>{e.ok?(this.notification.text=p("resourceGroup.ResourceGroupCreated"),this._refreshList()):(this.notification.text=l.relieve(e.msg),this.notification.detail=e.msg),this._hideDialogById("#modify-scaling-group-dialog"),this.notification.show()}))}_deleteScalingGroup(){const e=this.scalingGroups[this.selectedIndex].name;if(this.shadowRoot.querySelector("#delete-scaling-group").value!==e)return this.notification.text=p("resourceGroup.ResourceGroupNameNotMatch"),this._hideDialogById("#delete-scaling-group-dialog"),void this.notification.show();globalThis.backendaiclient.scalingGroup.delete(e).then((({delete_scaling_group:e})=>{e.ok?(this.notification.text=p("resourceGroup.ResourceGroupDeleted"),this._refreshList(),this.shadowRoot.querySelector("#delete-scaling-group").value=""):(this.notification.text=l.relieve(e.msg),this.notification.detail=e.msg),this._hideDialogById("#delete-scaling-group-dialog"),this.notification.show()})),this.selectedIndex=0}_refreshList(){globalThis.backendaiclient.scalingGroup.list_available().then((({scaling_groups:e})=>{this.scalingGroups=e,this.requestUpdate()}))}render(){var e,t;return d`
      ...
      <vaadin-grid theme="row-stripes column-borders compact" aria-label="Job list" .items="${this.scalingGroups}">
        ...
        <vaadin-grid-column flex-grow="1" header="${u("resourceGroup.DriverOptions")}" path="driver_opts">
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${u("resourceGroup.Scheduler")}" path="scheduler">
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${u("resourceGroup.SchedulerOptions")}" path="scheduler_opts">
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${u("resourceGroup.WsproxyAddress")}" path="wsproxy_addr">
        </vaadin-grid-column>
      ...
      <backend-ai-dialog id="modify-scaling-group-dialog" fixed backdrop blockscrolling>
        ...
        <div slot="content" class="vertical layout wrap">
          ...
          <mwc-textarea
            ...
            type="text"
            label="${u("resourceGroup.Description")}"
            value=${0===this.scalingGroups.length?"":null!==(e=this.scalingGroups[this.selectedIndex].description)&&void 0!==e?e:""}
          ></mwc-textarea>
          <mwc-textfield
            id="modify-scaling-group-wsproxy-address"
            type="url"
            label="${u("resourceGroup.WsproxyAddress")}"
            value=${0===this.scalingGroups.length?"":null!==(t=this.scalingGroups[this.selectedIndex].wsproxy_addr)&&void 0!==t?t:""}
          ></mwc-textfield>
        </div>
        <div slot="footer" class="horizontal center-justified flex layout">
          <mwc-button
...
let m=class extends a{constructor(){super(),this._status="inactive",this._tab="running-lists",this.enableStorageProxy=!1}static get styles(){return[s,n`
          ...
          <h3 class="tab horizontal center layout">
            <mwc-tab-bar>
              ...
              <mwc-tab title="storage-proxy-lists" label="${u("general.StorageProxies")}"
                  @click="${e=>this._showTab(e.target)}"></mwc-tab>`:d``}
    ...
    `}};e([t({type:String})],m.prototype,"_status",void 0),e([t({type:String})],m.prototype,"_tab",void 0),e([t({type:Boolean})],m.prototype,"enableStorageProxy",void 0),m=e([i("backend-ai-agent-view")],m);var v=m;export{v as default};
