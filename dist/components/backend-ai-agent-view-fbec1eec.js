import{b as e,p as t,d as i,B as a,I as s,e as o,c as n,V as r,h as l}from"./iron-flex-layout-classes-ee69fac0.js";import"./switch-behavior-4e1a81fd.js";import"./iron-icon-ca5712db.js";import"./lablup-shields-e4175548.js";import"./iron-icons-acbf3762.js";import"./hardware-icons-4e0c12ba.js";import"./input-behavior-872d13be.js";import"./index-cb0c7803.js";import"./resize-ace60eb2.js";import{B as c}from"./backend-ai-painkiller-681ec8f5.js";import"./index-747c3387.js";import"./index-5a6bbe37.js";import{B as d}from"./backend-ai-page-3369cbe3.js";import"./iron-resizable-behavior-a95821af.js";import"./vaadin-progress-bar-a8a99e7f.js";import"./paper-progress-68663377.js";import"./radio-behavior-b3f61f51.js";import"./index-3ca3eda0.js";import"./av-icons-c0c79095.js";import"./vaadin-grid-2601235c.js";import"./index-2d31afdb.js";import"./index-158cfd80.js";import"./index-ae7a7b9a.js";import"./index-53aa4530.js";let p=class extends d{constructor(){super(),this.condition="running",this.agents=Array(),this.notification=Object(),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[a,s,o,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
    ...
    `}};e([t({type:String})],p.prototype,"condition",void 0),e([t({type:Array})],p.prototype,"agents",void 0),e([t({type:Object})],p.prototype,"notification",void 0),e([t({type:Object})],p.prototype,"_boundRegionRenderer",void 0),e([t({type:Object})],p.prototype,"_boundContactDateRenderer",void 0),e([t({type:Object})],p.prototype,"_boundStatusRenderer",void 0),e([t({type:Object})],p.prototype,"_boundControlRenderer",void 0),p=e([i("backend-ai-agent-list")],p);let u=class extends d{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.selectedIndex=0,this.domains=Array(),this.scalingGroups=Array(),this.schedulerTypes=Array(),this.active=!1,this.schedulerTypes=["fifo","lifo","drf"]}static get properties(){return{active:{type:Boolean},scalingGroups:{type:Array},schedulerTypes:{type:Array},notification:{type:Object},domain:{type:Array},selectedIndex:{type:Number}}}static get styles(){return[a,s,o,n`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
    ...
    `,e)}_indexRenderer(e,t,i){let a=i.index+1;r(l`
      ...
      `,e)}_hideDialog(e){e.target.closest("wl-dialog").hide()}_createScalingGroup(){const e=this.shadowRoot.querySelector("#scaling-group-name").value,t=this.shadowRoot.querySelector("#scaling-group-description").value,i=this.shadowRoot.querySelector("#scaling-group-domain").value;if(""===e)return this.notification.text="Enter valid Resource group name",this.notification.show(),void this._hideDialogById("#create-scaling-group-dialog");window.backendaiclient.scalingGroup.create(e,t).then(({create_scaling_group:t})=>t.ok?window.backendaiclient.scalingGroup.associateWithDomain(i,e):(this.notification.text=c.relieve(t.title),this.notification.detail=t.msg,this.notification.show(),Promise.reject(t.msg))).then(({associate_scaling_group_with_domain:e})=>{e.ok?(this.notification.text="Resource group succesfully created",this._refreshList(),this.shadowRoot.querySelector("#scaling-group-name").value="",this.shadowRoot.querySelector("#scaling-group-description").value=""):(this.notification.text=c.relieve(e.title),this.notification.detail=e.msg),this._hideDialogById("#create-scaling-group-dialog"),this.notification.show()}).catch(e=>{this.notification.text=c.relieve(e.title),this.notification.detail=e,this._hideDialogById("#create-scaling-group-dialog"),this.notification.show(!0)})}_modifyScalingGroup(){const e=this.shadowRoot.querySelector("#modify-scaling-group-description").value,t=this.shadowRoot.querySelector("#modify-scaling-group-scheduler").value,i=this.shadowRoot.querySelector("#modify-scaling-group-active").checked,a=this.scalingGroups[this.selectedIndex].name;let s={};if(e!==this.scalingGroups[this.selectedIndex].description&&(s.description=e),t!==this.scalingGroups[this.selectedIndex].scheduler&&(s.scheduler=t),i!==this.scalingGroups[this.selectedIndex].is_active&&(s.is_active=i),0===Object.keys(s).length)return this.notification.text="No changes made",void this.notification.show();window.backendaiclient.scalingGroup.modify(a,s).then(({modify_scaling_group:e})=>{e.ok?(this.notification.text="Resource group successfully modified",this._refreshList()):(this.notification.text=c.relieve(e.msg),this.notification.detail=e.msg),this._hideDialogById("#modify-scaling-group-dialog"),this.notification.show()})}_deleteScalingGroup(){const e=this.scalingGroups[this.selectedIndex].name;if(this.shadowRoot.querySelector("#delete-scaling-group").value!==e)return this.notification.text="Resource group name does not match!",this._hideDialogById("#delete-scaling-group-dialog"),void this.notification.show();window.backendaiclient.scalingGroup.delete(e).then(({delete_scaling_group:e})=>{e.ok?(this.notification.text="Resource group successfully deleted",this._refreshList(),this.shadowRoot.querySelector("#delete-scaling-group").value=""):(this.notification.text=c.relieve(e.msg),this.notification.detail=e.msg),this._hideDialogById("#delete-scaling-group-dialog"),this.notification.show()})}_refreshList(){window.backendaiclient.scalingGroup.list_all().then(({scaling_groups:e})=>{this.scalingGroups=e,this.requestUpdate()})}render(){return l`
