import{B as t,d as e,I as i,a as o,C as a,e as s,b as l,g as n,h as d,t as c,_ as r,p as h,c as p}from"./backend-ai-console-c1b729c1.js";let g=class extends t{constructor(){super(...arguments),this.consoleShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.passwordChangeDialog=Object(),this.failDialog=Object(),this.token=""}static get styles(){return[e,i,o,a,s,l`
        mwc-textfield {
          width: 100%;
        }
      ...
      <wl-dialog id="update-password-dialog" fixed backdrop blockscrolling persistent style="padding:0;">
        <wl-card class="login-panel intro centered" style="margin: 0;">
          <h3 class="horizontal center layout">
            <span>${c("console.menu.ChangePassword")}</span>
          </h3>
