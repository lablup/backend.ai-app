import{B as e,b as t,I as i,a,m as o,c as s,r as n,g as l,p as d,t as r,_ as c,e as h,n as g}from"./backend-ai-webui-ad308e0c.js";let p=class extends e{constructor(){super(...arguments),this.webUIShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.passwordChangeDialog=Object(),this.failDialog=Object(),this.token=""}static get styles(){return[t,i,a,o,s,n`
        mwc-textfield {
          width: 100%;
        }
    ...
    `}};c([h({type:Object})],p.prototype,"webUIShell",void 0),c([h({type:Object})],p.prototype,"clientConfig",void 0),c([h({type:Object})],p.prototype,"client",void 0),c([h({type:Object})],p.prototype,"notification",void 0),c([h({type:Object})],p.prototype,"passwordChangeDialog",void 0),c([h({type:Object})],p.prototype,"failDialog",void 0),c([h({type:String})],p.prototype,"token",void 0),p=c([g("backend-ai-change-forgot-password-view")],p);var w=p;export{w as default};
