import{_ as e,e as t,c as i,a as s,B as o,d as a,I as l,b as r,x as n,f as c,i as d,h as u,A as h,y as p,t as m,g as v,s as g,au as b,r as y,av as f}from"./backend-ai-webui-f03dfdc8.js";import"./mwc-tab-bar-0e6b2296.js";import"./tab-group-067fd976.js";import"./expansion-ac6ecf8b.js";import"./label-c8beeb7f.js";import"./lablup-activity-panel-e8ef0f24.js";import"./vaadin-grid-141c4edd.js";import"./vaadin-grid-filter-column-be47eee1.js";import"./vaadin-grid-sort-column-750208d9.js";import"./vaadin-icons-d2d796e1.js";import"./vaadin-item-styles-b7552ccb.js";import"./vaadin-item-cf6a20fa.js";import"./backend-ai-list-status-88352f5a.js";import"./lablup-grid-sort-filter-column-53bad97e.js";import"./mwc-check-list-item-e1197543.js";import"./switch-b89cd102.js";import"./textarea-12face8e.js";import"./textfield-f14b8705.js";import"./mwc-switch-7988c9d0.js";import{J as _}from"./json_to_csv-6fce0343.js";import"./radio-behavior-3fc41a70.js";import"./dom-repeat-734ce150.js";import"./input-behavior-50b6d347.js";
/**
 @license
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */class w extends Error{constructor(e){super(e),Object.setPrototypeOf(this,w.prototype),this.title="Unable to delete keypair"}}let x=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1}static get styles(){return[a,l,r,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
...
`:p``}
      ...
      `,e)}concurrencyRenderer(e,t,i){h(p`
        <div>${[0,I.getValue()].includes(i.item.max_concurrent_sessions)?"∞":i.item.max_concurrent_sessions}</div>
    `,e)}controlRenderer(e,t,i){h(p`
      ...
      <div>${[0,I.getValue()].includes(i.item.max_containers_per_session)?"∞":i.item.max_containers_per_session}</div>
      `,e)}storageNodesRenderer(e,t,i){let s=JSON.parse(i.item.allowed_vfolder_hosts);this.enableParsingStoragePermissions&&(s=Object.keys(s)),h(p`
      <div class="layout horizontal center flex">
      ...
      `,e)}totpActivatedRenderer(e,t,i){var s;h(p`
        <div class="layout horizontal center center-justified wrap">
          ${(null===(s=i.item)||void 0===s?void 0:s.totp_activated)?p`
    ...
    `}};e([t({type:Boolean})],S.prototype,"isAdmin",void 0),e([t({type:Boolean})],S.prototype,"editMode",void 0),e([t({type:Array})],S.prototype,"users",void 0),e([t({type:Object})],S.prototype,"userInfo",void 0),e([t({type:Array})],S.prototype,"userInfoGroups",void 0),e([t({type:String})],S.prototype,"condition",void 0),e([t({type:Object})],S.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],S.prototype,"_userIdRenderer",void 0),e([t({type:Object})],S.prototype,"_userNameRenderer",void 0),e([t({type:Object})],S.prototype,"_userStatusRenderer",void 0),e([t({type:Object})],S.prototype,"_totpActivatedRenderer",void 0),e([t({type:Object})],S.prototype,"keypairs",void 0),e([t({type:String})],S.prototype,"signoutUserName",void 0),e([t({type:Object})],S.prototype,"notification",void 0),e([t({type:String})],S.prototype,"listCondition",void 0),e([t({type:Number})],S.prototype,"_totalUserCount",void 0),e([t({type:Boolean})],S.prototype,"isUserInfoMaskEnabled",void 0),e([t({type:Boolean})],S.prototype,"totpSupported",void 0),e([t({type:Boolean})],S.prototype,"totpActivated",void 0),e([t({type:String})],S.prototype,"totpKey",void 0),e([t({type:String})],S.prototype,"totpUri",void 0),e([t({type:Object})],S.prototype,"userStatus",void 0),e([i("#user-grid")],S.prototype,"userGrid",void 0),e([i("#loading-spinner")],S.prototype,"spinner",void 0),e([i("#list-status")],S.prototype,"_listStatus",void 0),e([i("#password")],S.prototype,"passwordInput",void 0),e([i("#confirm")],S.prototype,"confirmInput",void 0),e([i("#username")],S.prototype,"usernameInput",void 0),e([i("#full_name")],S.prototype,"fullNameInput",void 0),e([i("#description")],S.prototype,"descriptionInput",void 0),e([i("#need_password_change")],S.prototype,"needPasswordChangeSwitch",void 0),e([i("#status")],S.prototype,"statusSelect",void 0),e([i("#signout-user-dialog")],S.prototype,"signoutUserDialog",void 0),e([i("#user-info-dialog")],S.prototype,"userInfoDialog",void 0),e([i("#totp-setup-dialog")],S.prototype,"totpSetupDialog",void 0),e([i("#totp-confirm-otp")],S.prototype,"confirmOtpTextfield",void 0),e([i("#totp-uri-qrcode")],S.prototype,"totpUriQrImage",void 0),S=e([s("backend-ai-user-list")],S);let R=class extends o{constructor(){super(),this.concurrency_limit={},this.idle_timeout={},this.session_lifetime={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.rate_metric=[1e3,2e3,3e3,4e3,5e3,1e4,5e4],this.resource_policies=Object(),this.isAdmin=!1,this.isSuperAdmin=!1,this._status="inactive",this.new_access_key="",this.new_secret_key="",this._activeTab="users",this.notification=Object(),this._defaultFileName="",this.enableSessionLifetime=!1,this.enableParsingStoragePermissions=!1,this.default_vfolder_host="",this.all_vfolder_hosts=[],this.resource_policy_names=[]}static get styles(){return[a,l,r,n,c,d`
        #new-keypair-dialog {
          min-width: 350px;
          height: 100%;
        }
