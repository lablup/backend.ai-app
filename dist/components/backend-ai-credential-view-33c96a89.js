import{_ as e,e as t,n as i,B as o,b as a,I as s,a as l,m as r,c,r as n,d,w as u,p as h,t as p,g as m}from"./backend-ai-webui-ad308e0c.js";import"./mwc-tab-bar-ba2faa01.js";import"./tab-group-c74d0864.js";import"./expansion-658b1888.js";import"./label-f0a9dca2.js";import"./lablup-activity-panel-387ccaab.js";import"./vaadin-grid-3d51fc23.js";import"./vaadin-grid-filter-column-d69b130c.js";import"./vaadin-grid-sort-column-f6c5c367.js";import"./iconset-77efb306.js";import"./vaadin-item-styles-79c27717.js";import"./vaadin-item-d8c735cb.js";import"./switch-308e5433.js";import"./textarea-ba4ba3c6.js";import"./textfield-71eb2c95.js";import"./mwc-textarea-8ca78699.js";import"./mwc-switch-0b390378.js";import{J as _}from"./json_to_csv-440e3b00.js";import"./radio-behavior-fe220c8d.js";import"./polymer-legacy-f5f630a0.js";import"./input-behavior-cbb7ec82.js";
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */class y extends Error{constructor(e){super(e),Object.setPrototypeOf(this,y.prototype),this.title="Unable to delete keypair"}}let v=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this.keypairGrid=Object(),this._totalCredentialCount=0}static get styles(){return[a,s,l,r,c,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      <vaadin-grid theme="row-stripes column-borders compact" aria-label="Credential list"
        ...
        <vaadin-grid-filter-column path="access_key" header="${p("general.AccessKey")}" resizable .renderer="${this._boundAccessKeyRenderer}"></vaadin-grid-filter-column>
    ...
    `}};e([t({type:Object})],v.prototype,"notification",void 0),e([t({type:Object})],v.prototype,"keypairInfo",void 0),e([t({type:Boolean})],v.prototype,"isAdmin",void 0),e([t({type:String})],v.prototype,"condition",void 0),e([t({type:Array})],v.prototype,"keypairs",void 0),e([t({type:Object})],v.prototype,"resourcePolicy",void 0),e([t({type:Object})],v.prototype,"indicator",void 0),e([t({type:Object})],v.prototype,"_boundKeyageRenderer",void 0),e([t({type:Object})],v.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],v.prototype,"_boundAccessKeyRenderer",void 0),e([t({type:Object})],v.prototype,"_boundPermissionRenderer",void 0),e([t({type:Object})],v.prototype,"_boundResourcePolicyRenderer",void 0),e([t({type:Object})],v.prototype,"_boundAllocationRenderer",void 0),e([t({type:Object})],v.prototype,"keypairGrid",void 0),e([t({type:Number})],v.prototype,"_totalCredentialCount",void 0),v=e([i("backend-ai-credential-list")],v);
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */
let g=class extends o{constructor(){super(),this.visible=!1,this.keypairs={},this.resourcePolicy=[],this.keypairInfo={},this.is_admin=!1,this.active=!1,this.condition="active",this.cpu_resource={},this.ram_resource={},this.gpu_resource={},this.fgpu_resource={},this.concurrency_limit={},this.idle_timeout={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.default_vfolder_host="",this.current_policy_name="",this._boundResourceRenderer=Object(),this._boundConcurrencyRenderer=this.concurrencyRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundPolicyNameRenderer=this.policyNameRenderer.bind(this),this._boundClusterSizeRenderer=this.clusterSizeRenderer.bind(this),this._boundStorageNodesRenderer=this.storageNodesRenderer.bind(this),this.allowed_vfolder_hosts=[],this.resource_policy_names=[],this._boundResourceRenderer=this.resourceRenderer.bind(this)}static get styles(){return[a,s,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
...
`:h``}
    ...
    `,e)}policyNameRenderer(e,t,i){u(h`
      ...
      <div>${i.item.max_containers_per_session}</div>
      `,e)}storageNodesRenderer(e,t,i){u(h`
      <div class="layout horizontal center flex">
        <div class="vertical start layout">
          ${i.item.allowed_vfolder_hosts}
        </div>
      </div>
      `,e)}firstUpdated(){this.notification=globalThis.lablupNotification,this.selectAreaHeight=this.shadowRoot.querySelector("#dropdown-area").offsetHeight?this.shadowRoot.querySelector("#dropdown-area").offsetHeight:"123px"}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._refreshPolicyData(),this._getResourceInfo(),this.is_admin=globalThis.backendaiclient.is_admin,this._getResourceInfo()}),!0):(this._refreshPolicyData(),this._getResourceInfo(),this.is_admin=globalThis.backendaiclient.is_admin,this._getResourceInfo()))}_launchResourcePolicyDialog(e){this.updateCurrentPolicyToDialog(e),this.shadowRoot.querySelector("#modify-policy-dialog").show()}_openDeleteResourcePolicyListDialog(e){this.updateCurrentPolicyToDialog(e),this.shadowRoot.querySelector("#delete-policy-dialog").show()}updateCurrentPolicyToDialog(e){const t=e.target.closest("#controls")["policy-name"],i=globalThis.backendaiclient.utils.gqlToObject(this.resourcePolicy,"name");this.resource_policy_names=Object.keys(i);const o=i[t];this.shadowRoot.querySelector("#id_new_policy_name").value=t,this.current_policy_name=t,this.cpu_resource.value=this._updateUnlimitedValue(o.total_resource_slots.cpu),this.ram_resource.value=this._updateUnlimitedValue(o.total_resource_slots.mem),this.gpu_resource.value=this._updateUnlimitedValue(o.total_resource_slots.cuda_device),this.fgpu_resource.value=this._updateUnlimitedValue(o.total_resource_slots.cuda_shares),this.concurrency_limit.value=this._updateUnlimitedValue(o.max_concurrent_sessions),this.idle_timeout.value=this._updateUnlimitedValue(o.idle_timeout),this.container_per_session_limit.value=this._updateUnlimitedValue(o.max_containers_per_session),this.vfolder_capacity.value=this._updateUnlimitedValue(o.max_vfolder_size),this.allowed_vfolder_hosts=o.allowed_vfolder_hosts,this._updateInputStatus(this.cpu_resource),this._updateInputStatus(this.ram_resource),this._updateInputStatus(this.gpu_resource),this._updateInputStatus(this.fgpu_resource),this._updateInputStatus(this.concurrency_limit),this._updateInputStatus(this.idle_timeout),this._updateInputStatus(this.container_per_session_limit),this._updateInputStatus(this.vfolder_capacity),this.shadowRoot.querySelector("#vfolder-count-limit").value=o.max_vfolder_count,this.shadowRoot.querySelector("#vfolder-capacity-limit").value=this._byteToGB(o.max_vfolder_size,1),this.shadowRoot.querySelector("#allowed_vfolder-hosts").layout(!0).then((()=>{this.shadowRoot.querySelector("#allowed_vfolder-hosts").select(0),this.shadowRoot.querySelector("#allowed_vfolder-hosts").value=o.allowed_vfolder_hosts[0]}))}_refreshPolicyData(){return globalThis.backendaiclient.resourcePolicy.get().then((e=>e.keypair_resource_policies)).then((e=>{const t=e;Object.keys(t).map(((e,i)=>{const o=t[e];o.total_resource_slots=JSON.parse(o.total_resource_slots),"cpu"in o.total_resource_slots||"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.cpu="Unlimited"),"mem"in o.total_resource_slots?o.total_resource_slots.mem=parseFloat(globalThis.backendaiclient.utils.changeBinaryUnit(o.total_resource_slots.mem,"g")):"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.mem="Unlimited"),"cuda.device"in o.total_resource_slots?0===o.total_resource_slots["cuda.device"]&&"UNLIMITED"===o.default_for_unspecified?o.total_resource_slots.cuda_device="Unlimited":o.total_resource_slots.cuda_device=o.total_resource_slots["cuda.device"]:"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.cuda_device="Unlimited"),"cuda.shares"in o.total_resource_slots?0===o.total_resource_slots["cuda.shares"]&&"UNLIMITED"===o.default_for_unspecified?o.total_resource_slots.cuda_shares="Unlimited":o.total_resource_slots.cuda_shares=o.total_resource_slots["cuda.shares"]:"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.cuda_shares="Unlimited")})),this.resourcePolicy=t})).catch((e=>{console.log(e),e&&e.message&&(this.notification.text=d.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}refresh(){this._refreshPolicyData()}_isActive(){return"active"===this.condition}_byteToGB(e,t=0){const i=Math.pow(2,30),o=Math.pow(10,t);return(Math.round(e/i*o)/o).toFixed(t)}_gBToByte(e=0){const t=Math.pow(2,30);return Math.round(t*e)}_readResourcePolicyInput(){const e={},t=[];t.push(this.shadowRoot.querySelector("#allowed_vfolder-hosts").value),this._validateUserInput(this.cpu_resource),this._validateUserInput(this.ram_resource),this._validateUserInput(this.gpu_resource),this._validateUserInput(this.fgpu_resource),this._validateUserInput(this.concurrency_limit),this._validateUserInput(this.idle_timeout),this._validateUserInput(this.container_per_session_limit),this._validateUserInput(this.vfolder_capacity),this._validateUserInput(this.vfolder_max_limit),e.cpu=this.cpu_resource.value,e.mem=this.ram_resource.value+"g",e["cuda.device"]=parseInt(this.gpu_resource.value),e["cuda.shares"]=parseFloat(this.fgpu_resource.value),this.concurrency_limit.value=""===this.concurrency_limit.value?1e6:parseInt(this.concurrency_limit.value),this.idle_timeout.value=""===this.idle_timeout.value?0:parseInt(this.idle_timeout.value),this.container_per_session_limit.value=""===this.container_per_session_limit.value?0:parseInt(this.container_per_session_limit.value),this.vfolder_capacity.value=""===this.vfolder_capacity.value?0:parseFloat(this.vfolder_capacity.value),this.vfolder_max_limit.value=""===this.vfolder_max_limit.value?0:parseInt(this.vfolder_max_limit.value),Object.keys(e).map((t=>{isNaN(parseFloat(e[t]))&&delete e[t]}));return{default_for_unspecified:"UNLIMITED",total_resource_slots:JSON.stringify(e),max_concurrent_sessions:this.concurrency_limit.value,max_containers_per_session:this.container_per_session_limit.value,idle_timeout:this.idle_timeout.value,max_vfolder_count:this.vfolder_max_limit.value,max_vfolder_size:this._gBToByte(this.vfolder_capacity.value),allowed_vfolder_hosts:t}}_modifyResourcePolicy(){try{const e=this._readResourcePolicyInput();globalThis.backendaiclient.resourcePolicy.mutate(this.current_policy_name,e).then((({modify_keypair_resource_policy:e})=>{e.ok?(this.shadowRoot.querySelector("#modify-policy-dialog").hide(),this.notification.text=m("resourcePolicy.SuccessfullyUpdated"),this.notification.show(),this.refresh()):e.msg&&(this.shadowRoot.querySelector("#modify-policy-dialog").hide(),this.notification.text=d.relieve(e.msg),this.notification.show(),this.refresh())})).catch((e=>{console.log(e),e&&e.message&&(this.shadowRoot.querySelector("#modify-policy-dialog").hide(),this.notification.text=d.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}catch(e){this.notification.text=e.message,this.notification.show()}}_deleteResourcePolicy(){const e=this.current_policy_name;globalThis.backendaiclient.resourcePolicy.delete(e).then((({delete_keypair_resource_policy:e})=>{e.ok?(this.shadowRoot.querySelector("#delete-policy-dialog").hide(),this.notification.text=m("resourcePolicy.SuccessfullyDeleted"),this.notification.show(),this.refresh()):e.msg&&(this.shadowRoot.querySelector("#delete-policy-dialog").hide(),this.notification.text=d.relieve(e.msg),this.notification.show(),this.refresh())})).catch((e=>{console.log(e),e&&e.message&&(this.notification.text=d.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))}))}_toggleCheckbox(e){const t=e.target,i=t.checked,o=t.closest("div").querySelector("mwc-textfield");o.disabled=i,o.disabled||""===o.value&&(o.value=0)}_validateResourceInput(e){const t=e.target.closest("mwc-textfield"),i=t.closest("div").querySelector("wl-label.unlimited"),o=i?i.querySelector("wl-checkbox"):null;if(t.classList.contains("discrete")&&(t.value=Math.round(t.value)),t.value<=0&&(t.value="concurrency-limit"===t.id||"container-per-session-limit"===t.id?1:0),!t.valid){const e=t.step?(a=t.step)%1?a.toString().split(".")[1].length:0:0;t.value=e>0?parseFloat(t.value).toFixed(e):Math.min(Math.round(t.value),t.value<0?t.min:t.max)}var a;o&&(t.disabled=o.checked=t.value==parseFloat(t.min))}_updateUnlimitedValue(e){return["-",0,"0","Unlimited",1/0,"Infinity"].includes(e)?"":e}_validateUserInput(e){if(e.disabled)e.value="";else if(""===e.value)throw new Error(m("resourcePolicy.CannotCreateResourcePolicy"))}_updateInputStatus(e){const t=e,i=t.closest("div").querySelector("wl-checkbox");""===t.value||"0"===t.value||"concurrency-limit"===t.id&&"1000000"===t.value?(t.disabled=!0,i.checked=!0):(t.disabled=!1,i.checked=!1)}_markIfUnlimited(e,t=!1){return["-",0,"0","Unlimited",1/0,"Infinity"].includes(e)?"∞":["NaN",NaN].includes(e)?"-":t?this._byteToGB(e,1):e}_getResourceInfo(){this.cpu_resource=this.shadowRoot.querySelector("#cpu-resource"),this.ram_resource=this.shadowRoot.querySelector("#ram-resource"),this.gpu_resource=this.shadowRoot.querySelector("#gpu-resource"),this.fgpu_resource=this.shadowRoot.querySelector("#fgpu-resource"),this.concurrency_limit=this.shadowRoot.querySelector("#concurrency-limit"),this.idle_timeout=this.shadowRoot.querySelector("#idle-timeout"),this.container_per_session_limit=this.shadowRoot.querySelector("#container-per-session-limit"),this.vfolder_capacity=this.shadowRoot.querySelector("#vfolder-capacity-limit"),this.vfolder_max_limit=this.shadowRoot.querySelector("#vfolder-count-limit")}_controlHeightByVfolderHostCount(e=!1){if(!e)return void(this.shadowRoot.querySelector("#dropdown-area").style.height=this.selectAreaHeight);const t=this.shadowRoot.querySelector("#allowed_vfolder-hosts").items.length,i=this.shadowRoot.querySelector("#dropdown-area").offsetHeight;t>0&&(this.shadowRoot.querySelector("#dropdown-area").style.height=i+14*t+"px")}};e([t({type:Boolean})],g.prototype,"visible",void 0),e([t({type:Object})],g.prototype,"keypairs",void 0),e([t({type:Array})],g.prototype,"resourcePolicy",void 0),e([t({type:Object})],g.prototype,"keypairInfo",void 0),e([t({type:Boolean})],g.prototype,"is_admin",void 0),e([t({type:Boolean})],g.prototype,"active",void 0),e([t({type:String})],g.prototype,"condition",void 0),e([t({type:Object})],g.prototype,"cpu_resource",void 0),e([t({type:Object})],g.prototype,"ram_resource",void 0),e([t({type:Object})],g.prototype,"gpu_resource",void 0),e([t({type:Object})],g.prototype,"fgpu_resource",void 0),e([t({type:Object})],g.prototype,"concurrency_limit",void 0),e([t({type:Object})],g.prototype,"idle_timeout",void 0),e([t({type:Object})],g.prototype,"vfolder_capacity",void 0),e([t({type:Object})],g.prototype,"vfolder_max_limit",void 0),e([t({type:Object})],g.prototype,"container_per_session_limit",void 0),e([t({type:Array})],g.prototype,"allowed_vfolder_hosts",void 0),e([t({type:String})],g.prototype,"default_vfolder_host",void 0),e([t({type:Array})],g.prototype,"resource_policy_names",void 0),e([t({type:String})],g.prototype,"current_policy_name",void 0),e([t({type:Number})],g.prototype,"selectAreaHeight",void 0),e([t({type:Object})],g.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],g.prototype,"_boundConcurrencyRenderer",void 0),e([t({type:Object})],g.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],g.prototype,"_boundPolicyNameRenderer",void 0),e([t({type:Object})],g.prototype,"_boundClusterSizeRenderer",void 0),e([t({type:Object})],g.prototype,"_boundStorageNodesRenderer",void 0),g=e([i("backend-ai-resource-policy-list")],g);let b=class extends o{constructor(){super(),this.isAdmin=!1,this.editMode=!1,this.users=[],this.userInfo=Object(),this.userInfoGroups=[],this.condition="active",this._boundControlRenderer=this.controlRenderer.bind(this),this.signoutUserDialog=Object(),this.signoutUserName="",this.notification=Object(),this.userGrid=Object(),this._totalUserCount=0}static get styles(){return[a,s,l,r,c,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
          height: calc(100vh - 235px);
      ...
      `,e)}_togglePasswordVisibility(e){const t=e.__on,i=e.closest("div").querySelector("mwc-textfield");t?i.setAttribute("type","text"):i.setAttribute("type","password")}_togglePasswordInputRequired(){const e=this.shadowRoot.querySelector("#password"),t=e.value,i=this.shadowRoot.querySelector("#confirm"),o=i.value;e.required=""===t&&""!==o,i.required=""!==t&&""===o,e.reportValidity(),i.reportValidity()}_saveChanges(e){const t=this.shadowRoot.querySelector("#username").value,i=this.shadowRoot.querySelector("#full_name").value,o=this.shadowRoot.querySelector("#password"),a=o.value,s=this.shadowRoot.querySelector("#confirm"),l=s.value,r=this.shadowRoot.querySelector("#description").value,c=this.shadowRoot.querySelector("#is_active").selected,n=this.shadowRoot.querySelector("#need_password_change").selected;if(this._togglePasswordInputRequired(),!o.checkValidity()||!s.checkValidity())return;if(a!==l)return this.notification.text=m("environment.PasswordsDoNotMatch"),void this.notification.show();const u=Object();if(""!==a&&(u.password=a),t!==this.userInfo.username&&(u.username=t),i!==this.userInfo.full_name&&(u.full_name=i),r!==this.userInfo.description&&(u.description=r),n!==this.userInfo.need_password_change&&(u.need_password_change=n),c!==this.userInfo.is_active&&(u.is_active=c),this.refresh(),0===Object.entries(u).length)return this._hideDialog(e),this.notification.text=m("environment.NoChangeMade"),void this.notification.show();if(globalThis.backendaiclient.user.update(this.userInfo.email,u).then((e=>{e.modify_user.ok?(this.shadowRoot.querySelector("#user-info-dialog").hide(),this.notification.text=m("environment.SuccessfullyModified"),this.userInfo={...this.userInfo,...u,password:null},this._refreshUserData(),this.shadowRoot.querySelector("#password").value="",this.shadowRoot.querySelector("#confirm").value=""):(this.notification.text=d.relieve(e.modify_user.msg),this.shadowRoot.querySelector("#username").value=this.userInfo.username,this.shadowRoot.querySelector("#description").value=this.userInfo.description),this.notification.show()})),this.userInfo.email===globalThis.backendaiclient.email){const e=new CustomEvent("current-user-info-changed",{detail:u});document.dispatchEvent(e)}}render(){return h`
    ...
    `}};e([t({type:Boolean})],b.prototype,"isAdmin",void 0),e([t({type:Boolean})],b.prototype,"editMode",void 0),e([t({type:Array})],b.prototype,"users",void 0),e([t({type:Object})],b.prototype,"userInfo",void 0),e([t({type:Array})],b.prototype,"userInfoGroups",void 0),e([t({type:String})],b.prototype,"condition",void 0),e([t({type:Object})],b.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],b.prototype,"spinner",void 0),e([t({type:Object})],b.prototype,"keypairs",void 0),e([t({type:Object})],b.prototype,"signoutUserDialog",void 0),e([t({type:String})],b.prototype,"signoutUserName",void 0),e([t({type:Object})],b.prototype,"notification",void 0),e([t({type:Object})],b.prototype,"userGrid",void 0),e([t({type:Number})],b.prototype,"_totalUserCount",void 0),b=e([i("backend-ai-user-list")],b);let f=class extends o{constructor(){super(),this.cpu_resource={},this.ram_resource={},this.gpu_resource={},this.fgpu_resource={},this.concurrency_limit={},this.idle_timeout={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.rate_metric=[1e3,2e3,3e3,4e3,5e3,1e4,5e4],this.resource_policies=Object(),this.isAdmin=!1,this.isSuperAdmin=!1,this._status="inactive",this.allowed_vfolder_hosts=[],this.default_vfolder_host="",this.new_access_key="",this.new_secret_key="",this._activeTab="users",this.notification=Object(),this.exportToCsvDialog=Object(),this._defaultFileName="",this.resource_policy_names=[]}static get styles(){return[a,s,l,r,c,n`
        #new-keypair-dialog {
          min-width: 350px;
          height: 100%;
        }
