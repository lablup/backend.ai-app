import{_ as e,e as t,c as i,a as s,B as o,d as a,I as l,b as r,x as n,f as c,i as d,h as u,A as h,y as p,t as m,g as v,s as y,aw as g,r as _}from"./backend-ai-webui-43f3504d.js";import"./mwc-tab-bar-be651071.js";import"./tab-group-a4043930.js";import"./expansion-84e40fc3.js";import"./label-72dd372f.js";import"./lablup-activity-panel-507ecea3.js";import"./vaadin-grid-f840c455.js";import"./vaadin-grid-filter-column-30309305.js";import"./vaadin-grid-sort-column-42023335.js";import"./iconset-175c6221.js";import"./vaadin-item-styles-3f497690.js";import"./vaadin-item-d20ee659.js";import"./backend-ai-list-status-c409a664.js";import"./mwc-check-list-item-2ee94c8a.js";import"./switch-c71c912e.js";import"./textarea-e39847f0.js";import"./textfield-69d71789.js";import"./mwc-switch-151936f0.js";import{J as b}from"./json_to_csv-6fce0343.js";import"./radio-behavior-797743f9.js";import"./dom-repeat-69730814.js";import"./input-behavior-83617c90.js";
/**
 @license
 ...
 */class f extends Error{constructor(e){super(e),Object.setPrototypeOf(this,f.prototype),this.title="Unable to delete keypair"}}let w=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1}static get styles(){return[a,l,r,n,c,d`
      ...
      `,e)}_saveKeypairModification(e){const t=this.policyListSelect.value,i=Number(this.rateLimit.value);if(!this.rateLimit.checkValidity())return;let s={};t!==this.keypairInfo.resource_policy&&(s={...s,resource_policy:t}),i!==this.keypairInfo.rate_limit&&(s={...s,rate_limit:i}),0===Object.entries(s).length?(this.notification.text=v("credential.NoChanges"),this.notification.show()):globalThis.backendaiclient.keypair.mutate(this.keypairInfo.access_key,s).then((e=>{e.modify_keypair.ok?(this.keypairInfo.resource_policy===t&&this.keypairInfo.rate_limit===i?this.notification.text=v("credential.NoChanges"):this.notification.text=v("environment.SuccessfullyModified"),this.refresh()):this.notification.text=v("dialog.ErrorOccurred"),this.notification.show()})),this._hideDialog(e)}_adjustRateLimit(){const e=Number(this.rateLimit.value);e>5e4&&(this.rateLimit.value=5e4.toString()),e<=0&&(this.rateLimit.value="1")}_getUserId(e=""){if(this.isUserInfoMaskEnabled){const t=2,i=e.split("@")[0].length-t;e=globalThis.backendaiutils._maskString(e,"*",t,i)}return e}_getAccessKey(e=""){if(this.isUserInfoMaskEnabled){const t=4,i=e.length-t;e=globalThis.backendaiutils._maskString(e,"*",t,i)}return e}render(){return p`
...
class ${static getValue(){return 1e6}}let I=class extends o{constructor(){super(),this.visible=!1,this.listCondition="loading",this.keypairs={},this.resourcePolicy=[],this.keypairInfo={},this.active=!1,this.condition="active",this.current_policy_name="",this.enableSessionLifetime=!1,this._boundResourceRenderer=Object(),this._boundConcurrencyRenderer=this.concurrencyRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundPolicyNameRenderer=this.policyNameRenderer.bind(this),this._boundClusterSizeRenderer=this.clusterSizeRenderer.bind(this),this._boundStorageNodesRenderer=this.storageNodesRenderer.bind(this),this.is_super_admin=!1,this.all_vfolder_hosts=[],this.allowed_vfolder_hosts=[],this.resource_policy_names=[],this._boundResourceRenderer=this.resourceRenderer.bind(this)}static get styles(){return[a,l,r,d`
    ...
    `}_indexRenderer(e,t,i){const s=i.index+1;h(p`
        <div>${s}</div>
...
`:p``}
    ...
    `,e)}controlRenderer(e,t,i){h(p`
      ...
      `,e)}userStatusRenderer(e,t,i){const s="active"===i.item.status?"green":"lightgrey";h(p`
    ...
    `}};e([t({type:Boolean})],P.prototype,"isAdmin",void 0),e([t({type:Boolean})],P.prototype,"editMode",void 0),e([t({type:Array})],P.prototype,"users",void 0),e([t({type:Object})],P.prototype,"userInfo",void 0),e([t({type:Array})],P.prototype,"userInfoGroups",void 0),e([t({type:String})],P.prototype,"condition",void 0),e([t({type:Object})],P.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],P.prototype,"_userIdRenderer",void 0),e([t({type:Object})],P.prototype,"_userNameRenderer",void 0),e([t({type:Object})],P.prototype,"_userStatusRenderer",void 0),e([t({type:Object})],P.prototype,"keypairs",void 0),e([t({type:String})],P.prototype,"signoutUserName",void 0),e([t({type:Object})],P.prototype,"notification",void 0),e([t({type:String})],P.prototype,"listCondition",void 0),e([t({type:Number})],P.prototype,"_totalUserCount",void 0),e([t({type:Boolean})],P.prototype,"isUserInfoMaskEnabled",void 0),e([t({type:Object})],P.prototype,"userStatus",void 0),e([i("#user-grid")],P.prototype,"userGrid",void 0),e([i("#loading-spinner")],P.prototype,"spinner",void 0),e([i("#list-status")],P.prototype,"_listStatus",void 0),e([i("#password")],P.prototype,"passwordInput",void 0),e([i("#confirm")],P.prototype,"confirmInput",void 0),e([i("#username")],P.prototype,"usernameInput",void 0),e([i("#full_name")],P.prototype,"fullNameInput",void 0),e([i("#description")],P.prototype,"descriptionInput",void 0),e([i("#need_password_change")],P.prototype,"needPasswordChangeSwitch",void 0),e([i("#status")],P.prototype,"statusSelect",void 0),e([i("#signout-user-dialog")],P.prototype,"signoutUserDialog",void 0),e([i("#user-info-dialog")],P.prototype,"userInfoDialog",void 0),P=e([s("backend-ai-user-list")],P);let R=class extends o{constructor(){super(),this.concurrency_limit={},this.idle_timeout={},this.session_lifetime={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.rate_metric=[1e3,2e3,3e3,4e3,5e3,1e4,5e4],this.resource_policies=Object(),this.isAdmin=!1,this.isSuperAdmin=!1,this._status="inactive",this.new_access_key="",this.new_secret_key="",this._activeTab="users",this.notification=Object(),this._defaultFileName="",this.enableSessionLifetime=!1,this.default_vfolder_host="",this.all_vfolder_hosts=[],this.resource_policy_names=[]}static get styles(){return[a,l,r,n,c,d`
        #new-keypair-dialog {
          min-width: 350px;
          height: 100%;
        }
