import{_ as e,n as i,b as t,e as s,B as o,c as a,I as r,a as l,q as n,d as c,i as d,f as u,g as p,p as h,x as m,t as v,w as _,Q as y}from"./backend-ai-webui-ecaf99ee.js";import{J as g}from"./json_to_csv-35c9e191.js";import"./backend-ai-list-status-813286bf.js";import"./lablup-grid-sort-filter-column-7f6dc2bb.js";import"./vaadin-grid-798320e5.js";import"./vaadin-grid-filter-column-c9fe72e2.js";import"./vaadin-grid-sort-column-c154b80d.js";import"./vaadin-iconset-73b6a7a7.js";import"./vaadin-item-19b96319.js";import"./backend-ai-multi-select-ab1b6af0.js";import"./mwc-switch-4eed1e1c.js";import"./lablup-activity-panel-e283a3a7.js";import"./mwc-formfield-6c406dcc.js";import"./mwc-tab-bar-c3cea253.js";import"./dir-utils-fbe312c1.js";import"./vaadin-item-mixin-3e44fae1.js";import"./mwc-check-list-item-aff3ba37.js";var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey=""}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
        ...
        <div slot="content">
          ...
          <div class="vertical center layout distancing" id="dropdown-area">
            ...
            <div
              ...
              style=${globalThis.backendaiclient.supports("max-vfolder-count-in-user-resource-policy")?"display:none;":"width:100%;"}
            >
              <mwc-textfield
    ...
    `}_indexRenderer(e,i,t){const s=t.index+1;h(m`
      ...
      `,e)}_displayResourcesByResourceUnit(e=0,i=!1,t=""){let s=0;const o=this._markIfUnlimited(e,i);switch(t=t.toLowerCase()){case"cpu":case"cuda_device":case"max_vfolder_count":s=0;break;case"mem":case"cuda_shares":s=1}return["∞","-"].includes(o)?o:Number(o).toFixed(s)}resourceRenderer(e,i,t){h(m`
        ...
        ${globalThis.backendaiclient.supports("max-vfolder-count-in-user-resource-policy")?m``:m`
              <div class="layout horizontal wrap center">
                <div class="layout horizontal configuration">
