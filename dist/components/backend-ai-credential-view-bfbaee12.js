import{_ as e,p as t,c as i,k as o,I as a,j as s,ad as l,l as r,a as n,m as c,ae as d,h as u}from"./backend-ai-console-82521713.js";import{B as p}from"./backend-ai-page-ef800f72.js";import"./lablup-loading-indicator-c2458808.js";import"./iron-resizable-behavior-96b94882.js";import"./radio-behavior-9735b631.js";import"./paper-dropdown-menu-d721ec1c.js";import"./index-6f89f224.js";import"./index-1ac6b2a8.js";import"./av-icons-412a9e3c.js";import"./paper-dialog-5ef6f083.js";import"./vaadin-grid-79cd4138.js";import"./vaadin-grid-sorter-bf08a6c9.js";import"./vaadin-grid-sort-column-6aaeab8d.js";import"./index-bf273402.js";import"./index-da26517d.js";import"./vaadin-item-d35828ff.js";import"./index-95e830a8.js";import"./index-f7e8d026.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let h=class extends p{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=Object(),this.resourcePolicy=Object(),this.indicator=Object(),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[o,a,s,l,r,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `]}firstUpdated(){this.indicator=this.shadowRoot.querySelector("#loading-indicator"),this.notification=window.lablupNotification}async _viewStateChanged(e){await this.updateComplete,!1!==e&&(void 0===window.backendaiclient||null===window.backendaiclient||!1===window.backendaiclient.ready?document.addEventListener("backend-ai-connected",()=>{this._refreshKeyData(),this.isAdmin=window.backendaiclient.is_admin},!0):(this._refreshKeyData(),this.isAdmin=window.backendaiclient.is_admin))}_refreshKeyData(e){let t=!0;switch(this.condition){case"active":t=!0;break;default:t=!1}return window.backendaiclient.resourcePolicy.get().then(e=>{this.indicator.hide();let t=e.keypair_resource_policies;this.resourcePolicy=window.backendaiclient.utils.gqlToObject(t,"name")}).then(()=>window.backendaiclient.keypair.list(e,["access_key","is_active","is_admin","user_id","created_at","last_used","concurrency_limit","concurrency_used","rate_limit","num_queries","resource_policy"],t)).then(e=>{let t=e.keypairs;Object.keys(t).map((e,i)=>{var o=t[e];if(o.resource_policy in this.resourcePolicy){for(var a in this.resourcePolicy[o.resource_policy])"created_at"!==a&&(o[a]=this.resourcePolicy[o.resource_policy][a],"total_resource_slots"===a&&(o.total_resource_slots=JSON.parse(this.resourcePolicy[o.resource_policy][a])));o.created_at_formatted=this._humanReadableTime(o.created_at),o.elapsed=this._elapsed(o.created_at),"cpu"in o.total_resource_slots||"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.cpu="-"),"mem"in o.total_resource_slots?o.total_resource_slots.mem=parseFloat(window.backendaiclient.utils.changeBinaryUnit(o.total_resource_slots.mem,"g")):"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.mem="-"),"cuda.device"in o.total_resource_slots&&(o.total_resource_slots.cuda_device=o.total_resource_slots["cuda.device"]),"cuda.shares"in o.total_resource_slots&&(o.total_resource_slots.cuda_shares=o.total_resource_slots["cuda.shares"]),"cuda_device"in o.total_resource_slots==!1&&"cuda_shares"in o.total_resource_slots==!1&&"UNLIMITED"===o.default_for_unspecified&&(o.total_resource_slots.cuda_shares="-",o.total_resource_slots.cuda_device="-"),["cpu","mem","cuda_shares","cuda_device"].forEach(e=>{o.total_resource_slots[e]=this._markIfUnlimited(o.total_resource_slots[e])})}}),this.keypairs=t}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}async _showKeypairDetail(e){const t=e.target.closest("#controls")["access-key"];try{const e=await this._getKeyData(t);this.keypairInfo=e.keypair,this.shadowRoot.querySelector("#keypair-info-dialog").show()}catch(e){e&&e.message&&(this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))}}async _modifyResourcePolicy(e){const t=e.target.closest("#controls")["access-key"];try{const e=await this._getKeyData(t);this.keypairInfo=e.keypair,this.shadowRoot.querySelector("#policy-list").value=this.keypairInfo.resource_policy,this.shadowRoot.querySelector("#keypair-modify-dialog").show()}catch(e){e&&e.message&&(this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))}}async _getKeyData(e){return window.backendaiclient.keypair.info(e,["access_key","secret_key","is_active","is_admin","user_id","created_at","last_used","concurrency_limit","concurrency_used","rate_limit","num_queries","resource_policy"])}refresh(){this._refreshKeyData()}_isActive(){return"active"===this.condition}_deleteKey(e){const t=e.target.closest("#controls")["access-key"];window.backendaiclient.keypair.delete(t).then(e=>{this.refresh()}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}_revokeKey(e){this._mutateKey(e,!1)}_reuseKey(e){this._mutateKey(e,!0)}_mutateKey(e,t){const i=e.target.closest("#controls")["access-key"];let o=this.keypairs.find(this._findKeyItem,i),a={is_active:t,is_admin:o.is_admin,resource_policy:o.resource_policy,rate_limit:o.rate_limit,concurrency_limit:o.concurrency_limit};window.backendaiclient.keypair.mutate(i,a).then(e=>{let t=new CustomEvent("backend-ai-credential-refresh",{detail:this});document.dispatchEvent(t)}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}_findKeyItem(e){return e.access_key=this}_elapsed(e,t){var i=new Date(e);if("active"==this.condition)var o=new Date;else o=new Date;var a=Math.floor((o.getTime()-i.getTime())/1e3);return Math.floor(a/86400)}_humanReadableTime(e){return new Date(e).toUTCString()}_indexRenderer(e,t,i){let o=i.index+1;d(u`
        <div>${o}</div>
      `,e)}_markIfUnlimited(e){return["-",0,"Unlimited",1/0,"Infinity"].includes(e)?"∞":e}controlRenderer(e,t,i){d(u`
    ...
    `}};e([t({type:Object})],h.prototype,"notification",void 0),e([t({type:Object})],h.prototype,"keypairInfo",void 0),e([t({type:Boolean})],h.prototype,"isAdmin",void 0),e([t({type:String})],h.prototype,"condition",void 0),e([t({type:Object})],h.prototype,"keypairs",void 0),e([t({type:Object})],h.prototype,"resourcePolicy",void 0),e([t({type:Object})],h.prototype,"indicator",void 0),e([t({type:Object})],h.prototype,"_boundControlRenderer",void 0),h=e([i("backend-ai-credential-list")],h);
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let _=class extends p{constructor(){super(),this.visible=!1,this.keypairs={},this.resourcePolicy={},this.keypairInfo={},this.is_admin=!1,this.active=!1,this.condition="active",this.cpu_resource={},this.ram_resource={},this.gpu_resource={},this.fgpu_resource={},this.concurrency_limit={},this.idle_timeout={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.allowed_vfolder_hosts=[],this.default_vfolder_host="",this.resource_policy_names=Array(),this.current_policy_name="",this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[o,a,s,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
...
let v=class extends p{constructor(){super(),this.isAdmin=!1,this.editMode=!1,this.users=Object(),this.userInfo=Object(),this.userInfoGroups=Array(),this.condition="active",this._boundControlRenderer=this.controlRenderer.bind(this),this.signoutUserDialog=Object(),this.signoutUserName="",this.notification=Object()}static get styles(){return[o,a,s,l,r,n`
    ...
    `}};e([t({type:Boolean})],v.prototype,"isAdmin",void 0),e([t({type:Boolean})],v.prototype,"editMode",void 0),e([t({type:Object})],v.prototype,"users",void 0),e([t({type:Object})],v.prototype,"userInfo",void 0),e([t({type:Array})],v.prototype,"userInfoGroups",void 0),e([t({type:String})],v.prototype,"condition",void 0),e([t({type:Object})],v.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],v.prototype,"indicator",void 0),e([t({type:Object})],v.prototype,"keypairs",void 0),e([t({type:Object})],v.prototype,"signoutUserDialog",void 0),e([t({type:String})],v.prototype,"signoutUserName",void 0),e([t({type:Object})],v.prototype,"notification",void 0),v=e([i("backend-ai-user-list")],v);let m=class extends p{constructor(){super(),this.cpu_resource={},this.ram_resource={},this.gpu_resource={},this.fgpu_resource={},this.concurrency_limit={},this.idle_timeout={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.rate_metric=[1e3,2e3,3e3,4e3,5e3,1e4,5e4],this.resource_policies=Object(),this.resource_policy_names=Array(),this.is_admin=!1,this._status="inactive",this.allowed_vfolder_hosts=Array(),this.default_vfolder_host="",this.use_user_list=!1,this.new_access_key="",this.new_secret_key="",this._activeTab="credential-lists",this.notification=Object()}static get styles(){return[o,a,s,l,r,n`
        wl-button.create-button {
          width: 335px;
        }
      ...
      `]}firstUpdated(){this.notification=window.lablupNotification,document.addEventListener("backend-ai-credential-refresh",()=>{this.shadowRoot.querySelector("#active-credential-list").refresh(),this.shadowRoot.querySelector("#inactive-credential-list").refresh()},!0),this.shadowRoot.querySelectorAll("wl-expansion").forEach(e=>{e.addEventListener("keydown",e=>{e.stopPropagation()},!0)}),void 0===window.backendaiclient||null===window.backendaiclient||!1===window.backendaiclient.ready?document.addEventListener("backend-ai-connected",()=>{!0!==window.backendaiclient.is_admin&&this.disablePage(),!0===window.backendaiclient.isAPIVersionCompatibleWith("v4.20190601")&&(this.use_user_list=!0,this._activeTab="user-lists")}):(!0!==window.backendaiclient.is_admin&&this.disablePage(),!0===window.backendaiclient.isAPIVersionCompatibleWith("v4.20190601")?(this.use_user_list=!0,this._activeTab="user-lists"):this.use_user_list=!1),this._getResourceInfo(),this._getResourcePolicies(),this._updateInputStatus(this.cpu_resource),this._updateInputStatus(this.ram_resource),this._updateInputStatus(this.gpu_resource),this._updateInputStatus(this.fgpu_resource),this._updateInputStatus(this.concurrency_limit),this._updateInputStatus(this.idle_timeout),this._updateInputStatus(this.container_per_session_limit),this._updateInputStatus(this.vfolder_capacity),this.vfolder_max_limit.value=10}async _viewStateChanged(e){if(await this.updateComplete,!1===e)return this.shadowRoot.querySelector("#resource-policy-list").active=!1,this.shadowRoot.querySelector("#user-list").active=!1,void(this._status="inactive");this.shadowRoot.querySelector("#resource-policy-list").active=!0,this.shadowRoot.querySelector("#user-list").active=!0,this._status="active"}async _launchKeyPairDialog(){await this._getResourcePolicies(),this.shadowRoot.querySelector("#new-keypair-dialog").show()}_readVFolderHostInfo(){window.backendaiclient.vfolder.list_hosts().then(e=>{this.allowed_vfolder_hosts=e.allowed,this.default_vfolder_host=e.default}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}_launchResourcePolicyDialog(){this._readVFolderHostInfo(),this.shadowRoot.querySelector("#new-policy-dialog").show()}_launchModifyResourcePolicyDialog(){this._readVFolderHostInfo(),this.shadowRoot.querySelector("#new-policy-dialog").show()}_launchUserAddDialog(){this.shadowRoot.querySelector("#new-user-dialog").show()}async _getResourcePolicies(){return window.backendaiclient.resourcePolicy.get(null,["name","default_for_unspecified","total_resource_slots","max_concurrent_sessions","max_containers_per_session"]).then(e=>{let t=window.backendaiclient.utils.gqlToObject(e.keypair_resource_policies,"name"),i=window.backendaiclient.utils.gqlToList(e.keypair_resource_policies,"name");this.resource_policies=t,this.resource_policy_names=i})}_addKeyPair(){let e;if(""!=this.shadowRoot.querySelector("#id_new_user_id").value){if(1==this.shadowRoot.querySelector("#id_new_user_id").invalid)return;e=this.shadowRoot.querySelector("#id_new_user_id").value}else e=window.backendaiclient.email;let t=this.shadowRoot.querySelector("#resource-policy").value,i=this.shadowRoot.querySelector("#rate-limit").value,o=this.shadowRoot.querySelector("#id_new_access_key").value,a=this.shadowRoot.querySelector("#id_new_secret_key").value;window.backendaiclient.keypair.add(e,!0,!1,t,i,o,a).then(e=>{this.shadowRoot.querySelector("#new-keypair-dialog").hide(),this.notification.text="Keypair successfully created.",this.notification.show(),this.shadowRoot.querySelector("#active-credential-list").refresh()}).catch(e=>{console.log(e),e&&e.message&&(this.shadowRoot.querySelector("#new-keypair-dialog").hide(),this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}_readResourcePolicyInput(){let e={},t=[];t.push(this.shadowRoot.querySelector("#allowed_vfolder-hosts").value);try{this._validateUserInput(this.cpu_resource),this._validateUserInput(this.ram_resource),this._validateUserInput(this.gpu_resource),this._validateUserInput(this.fgpu_resource),this._validateUserInput(this.concurrency_limit),this._validateUserInput(this.idle_timeout),this._validateUserInput(this.container_per_session_limit),this._validateUserInput(this.vfolder_capacity),this._validateUserInput(this.vfolder_max_limit)}catch(e){throw e}return e.cpu=this.cpu_resource.value,e.mem=this.ram_resource.value+"g",e["cuda.device"]=parseInt(this.gpu_resource.value),e["cuda.shares"]=parseFloat(this.fgpu_resource.value),this.concurrency_limit.value=""===this.concurrency_limit.value?0:parseInt(this.concurrency_limit.value),this.idle_timeout.value=""===this.idle_timeout.value?0:parseInt(this.idle_timeout.value),this.container_per_session_limit.value=""===this.container_per_session_limit.value?0:parseInt(this.container_per_session_limit.value),this.vfolder_capacity.value=""===this.vfolder_capacity.value?0:parseInt(this.vfolder_capacity.value),this.vfolder_max_limit.value=""===this.vfolder_max_limit.value?0:parseInt(this.vfolder_max_limit.value),Object.keys(e).map(t=>{isNaN(parseFloat(e[t]))&&delete e[t]}),{default_for_unspecified:"UNLIMITED",total_resource_slots:JSON.stringify(e),max_concurrent_sessions:this.concurrency_limit.value,max_containers_per_session:this.container_per_session_limit.value,idle_timeout:this.idle_timeout.value,max_vfolder_count:this.vfolder_max_limit.value,max_vfolder_size:this.vfolder_capacity.value,allowed_vfolder_hosts:t}}_addResourcePolicy(){let e=this.shadowRoot.querySelector("#id_new_policy_name");if(""==e.value)return e.invalid=!0,void(e.errorMessage="Please input policy name.");if(1!=e.invalid){if(this.resource_policy_names.includes(e.value))return e.invalid=!0,void(e.errorMessage="Policy name already exists!");try{let e=this._readResourcePolicyInput();window.backendaiclient.resourcePolicy.add(name,e).then(e=>{this.shadowRoot.querySelector("#new-policy-dialog").hide(),this.notification.text="Resource policy successfully created.",this.notification.show(),this.shadowRoot.querySelector("#resource-policy-list").refresh()}).catch(e=>{console.log(e),e&&e.message&&(this.shadowRoot.querySelector("#new-policy-dialog").hide(),this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}catch(e){this.notification.text=e.message,this.notification.show()}}}_addUser(){const e=this.shadowRoot.querySelector("#id_user_email").value,t=this.shadowRoot.querySelector("#id_user_name").value,i=this.shadowRoot.querySelector("#id_user_password").value,o=this.shadowRoot.querySelector("#id_user_confirm").value;if(""===e)return this.notification.text="Please Input User Id(Email)!",void this.notification.show();if(this.shadowRoot.querySelector("#id_user_email").hasAttribute("invalid"))return this.notification.text="Email Is Invalid!",void this.notification.show();if(""===t)return this.notification.text="Username Is Empty!",void this.notification.show();if(null!==this.shadowRoot.querySelector("#id_user_password").getAttribute("invalid"))return this.notification.text="Password must contain at least one alphabet, one digit, and one special character",void this.notification.show();if(""===i)return this.notification.text="Password Is Empty!",void this.notification.show();if(i!==o)return this.notification.text="Confirmation Does Not Match With Original Password!",void this.notification.show();const a={username:t,password:i,need_password_change:!1,full_name:t,description:`${t}'s Account`,is_active:!0,domain_name:"default",role:"user"};window.backendaiclient.group.list().then(t=>{const i=t.groups.find(e=>"default"===e.name).id;return Promise.resolve(window.backendaiclient.user.add(e,Object.assign(Object.assign({},a),{group_ids:[i]})))}).then(e=>{this.shadowRoot.querySelector("#new-user-dialog").hide(),e.create_user.ok?(this.notification.text="User successfully created",this.shadowRoot.querySelector("#user-list").refresh()):(console.error(e.create_user.msg),this.notification.text="Error on user creation"),this.notification.show(),this.shadowRoot.querySelector("#id_user_email").value="",this.shadowRoot.querySelector("#id_user_name").value="",this.shadowRoot.querySelector("#id_user_password").value="",this.shadowRoot.querySelector("#id_user_confirm").value=""})}_modifyResourcePolicy(){let e=this.shadowRoot.querySelector("#id_new_policy_name").value;try{let t=this._readResourcePolicyInput();window.backendaiclient.resourcePolicy.mutate(e,t).then(e=>{this.shadowRoot.querySelector("#new-policy-dialog").close(),this.notification.text="Resource policy successfully updated.",this.notification.show(),this.shadowRoot.querySelector("#resource-policy-list").refresh()}).catch(e=>{console.log(e),e&&e.message&&(this.shadowRoot.querySelector("#new-policy-dialog").close(),this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}catch(e){this.notification.text=e.message,this.notification.show()}}disablePage(){for(var e=this.shadowRoot.querySelectorAll(".admin"),t=0;t<e.length;t++)e[t].style.display="none"}_hideDialog(e){e.target.closest("wl-dialog").hide()}_showTab(e){for(var t=this.shadowRoot.querySelectorAll(".tab-content"),i=0;i<t.length;i++)t[i].style.display="none";this._activeTab=e.value,this.shadowRoot.querySelector("#"+e.value).style.display="block"}_toggleCheckbox(e){const t=e.target,i=t.checked,o=t.closest("div").querySelector("wl-textfield");o.disabled=i,o.disabled||""===o.value&&(o.value=0)}_validateResourceInput(e){const t=e.target.closest("wl-textfield"),i=t.closest("div").querySelector(".unlimited");let o;if(o=i?i.querySelector("wl-checkbox"):null,t.value<0&&(t.value=0),""===t.value)try{if(!o||!o.checked)throw t.required=!0,t.focus(),{message:"Please input value or check unlimited."};t.required=!1,t.value=""}catch(e){this.notification.text=e.message,this.notification.show()}}_validateUserInput(e){if(e.disabled)e.value="";else if(""===e.value)throw{message:"Cannot create Resource Policy. Please check input values."}}_validatePolicyName(e){let t=e.target,i=e.target.value;this.resource_policy_names.includes(i)?(t.errorMessage="Policy name already exists!",t.invalid=!0):t.invalid=!1}_updateInputStatus(e){let t=e,i=t.closest("div").querySelector("wl-checkbox");""===t.value||"0"===t.value?(t.disabled=!0,i.checked=!0):(t.disabled=!1,i.checked=!1)}_getResourceInfo(){this.cpu_resource=this.shadowRoot.querySelector("#cpu-resource"),this.ram_resource=this.shadowRoot.querySelector("#ram-resource"),this.gpu_resource=this.shadowRoot.querySelector("#gpu-resource"),this.fgpu_resource=this.shadowRoot.querySelector("#fgpu-resource"),this.concurrency_limit=this.shadowRoot.querySelector("#concurrency-limit"),this.idle_timeout=this.shadowRoot.querySelector("#idle-timeout"),this.container_per_session_limit=this.shadowRoot.querySelector("#container-per-session-limit"),this.vfolder_capacity=this.shadowRoot.querySelector("#vfolder-capacity-limit"),this.vfolder_max_limit=this.shadowRoot.querySelector("#vfolder-count-limit")}render(){return u`
      <wl-card class="admin item" elevation="1">
        <h3 class="tab horizontal wrap layout">
          <wl-tab-group>
            ${"active"===this._status&&!0===this.use_user_list?u`
            <wl-tab value="user-lists" checked @click="${e=>this._showTab(e.target)}">Users</wl-tab>`:u``}
    ...
    `}};e([t({type:Object})],m.prototype,"cpu_resource",void 0),e([t({type:Object})],m.prototype,"ram_resource",void 0),e([t({type:Object})],m.prototype,"gpu_resource",void 0),e([t({type:Object})],m.prototype,"fgpu_resource",void 0),e([t({type:Object})],m.prototype,"concurrency_limit",void 0),e([t({type:Object})],m.prototype,"idle_timeout",void 0),e([t({type:Object})],m.prototype,"vfolder_capacity",void 0),e([t({type:Object})],m.prototype,"vfolder_max_limit",void 0),e([t({type:Object})],m.prototype,"container_per_session_limit",void 0),e([t({type:Array})],m.prototype,"rate_metric",void 0),e([t({type:Object})],m.prototype,"resource_policies",void 0),e([t({type:Array})],m.prototype,"resource_policy_names",void 0),e([t({type:Boolean})],m.prototype,"is_admin",void 0),e([t({type:String})],m.prototype,"_status",void 0),e([t({type:Array})],m.prototype,"allowed_vfolder_hosts",void 0),e([t({type:String})],m.prototype,"default_vfolder_host",void 0),e([t({type:Boolean})],m.prototype,"use_user_list",void 0),e([t({type:String})],m.prototype,"new_access_key",void 0),e([t({type:String})],m.prototype,"new_secret_key",void 0),e([t({type:String})],m.prototype,"_activeTab",void 0),e([t({type:Object})],m.prototype,"notification",void 0),m=e([i("backend-ai-credential-view")],m);var w=m;export default w;
