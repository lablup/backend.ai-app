import{_ as e,n as i,b as t,e as s,B as o,c as a,I as r,a as l,q as n,d as c,i as d,f as u,g as p,p as h,x as m,t as v,w as _,Q as y}from"./backend-ai-webui-4e657d63.js";import{J as g}from"./json_to_csv-35c9e191.js";import"./backend-ai-list-status-a705f355.js";import"./lablup-grid-sort-filter-column-65d12b22.js";import"./vaadin-grid-c5d53900.js";import"./vaadin-grid-filter-column-a072489e.js";import"./vaadin-grid-sort-column-4bca542b.js";import"./vaadin-iconset-0c80a8d3.js";import"./vaadin-item-5790154d.js";import"./backend-ai-multi-select-e733648f.js";import"./mwc-switch-c4435080.js";import"./lablup-activity-panel-522fe303.js";import"./mwc-formfield-3a3027ce.js";import"./mwc-tab-bar-41e085c1.js";import"./dir-utils-bf4e22d3.js";import"./vaadin-item-mixin-4ef64737.js";import"./mwc-check-list-item-da3a559a.js";var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey=""}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
