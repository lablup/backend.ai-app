import{_ as e,p as t,c as i,d as o,e as a,I as s,a as l,z as r,f as n,b as c,g as d,X as u,h as p}from"./backend-ai-console-14d10124.js";import"./lablup-loading-indicator-d581dc83.js";import"./polymer-legacy-4d33d7bd.js";import"./iron-resizable-behavior-33a9d7fa.js";import"./radio-behavior-583b4374.js";import"./paper-icon-button-2254421d.js";import"./iron-iconset-svg-7f9b79bb.js";import"./iron-icons-5b385824.js";import"./paper-dropdown-menu-571001d5.js";import"./shadow-dc0e6b19.js";import"./paper-item-93d362db.js";import"./expansion-9ebb0313.js";import"./label-e1bc0c8e.js";import"./av-icons-5ae8754c.js";import"./vaadin-grid-253f5dab.js";import"./vaadin-grid-sorter-8aff2bf9.js";import"./vaadin-grid-sort-column-98e5fcc3.js";import"./iconset-92ff2bc9.js";import"./divider-33c1d747.js";import{J as h}from"./json_to_csv-95c4522d.js";import"./tab-group-c1fbd113.js";import"./vaadin-item-7d466ec1.js";import"./switch-62f68fad.js";import"./textarea-6ca6ffdc.js";
/**
 @license
...
let v=class extends o{constructor(){super(),this.visible=!1,this.keypairs={},this.resourcePolicy={},this.keypairInfo={},this.is_admin=!1,this.active=!1,this.condition="active",this.cpu_resource={},this.ram_resource={},this.gpu_resource={},this.fgpu_resource={},this.concurrency_limit={},this.idle_timeout={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.allowed_vfolder_hosts=[],this.default_vfolder_host="",this.resource_policy_names=Array(),this.current_policy_name="",this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[a,s,l,c`
    ...
    `}_indexRenderer(e,t,i){let o=i.index+1;u(p`
        <div>${o}</div>
      `,e)}_hideDialog(e){e.target.closest("wl-dialog").hide()}resourceRenderer(e,t,i){u(p`
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
...
let m=class extends o{constructor(){super(),this.isAdmin=!1,this.editMode=!1,this.users=Object(),this.userView=Object(),this.userInfo=Object(),this.userInfoGroups=Array(),this.condition="active",this._boundControlRenderer=this.controlRenderer.bind(this),this.signoutUserDialog=Object(),this.signoutUserName="",this.notification=Object(),this._pageSize=20,this.userGrid=Object(),this._currentPage=1,this._totalUserCount=0}static get styles(){return[a,s,l,r,n,c`
      ...
      `,e)}_markIfUnlimited(e){return["-",0,"Unlimited",1/0,"Infinity"].includes(e)?"∞":e}_updateItemsFromPage(e){if("number"!=typeof e){let t=e.target;"button"!==t.role&&(t=e.target.closest("wl-button")),"previous-page"===t.id?this._currentPage-=1:this._currentPage+=1}let t=(this._currentPage-1)*this.userGrid.pageSize,i=this._currentPage*this.userGrid.pageSize;this.userView=this.users.slice(t,i)}controlRenderer(e,t,i){u(p`
            ...
            >
              ...
              ${window.backendaiclient.is_superadmin&&this._isActive()?p`
            ...
            <div style="width:335px;">
              ...
              <div role="listbox" style="margin: 0;">
                ...
                ${this.editMode?p`
                            ...
                            <wl-textfield type="password" label="Confirm" id="confirm"></wl-textfield>`:p``}
