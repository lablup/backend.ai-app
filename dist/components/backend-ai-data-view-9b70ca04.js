import{f as e,af as t,P as i,al as o,av as r,k as a,I as l,j as n,l as s,a as d,h as c,ae as h,m as p,_ as A,c as m}from"./backend-ai-console-82521713.js";import{B as u}from"./backend-ai-page-ef800f72.js";import"./lablup-loading-indicator-c2458808.js";import{E as v,T as g}from"./iron-resizable-behavior-96b94882.js";import"./vaadin-progress-bar-42df7141.js";import"./radio-behavior-9735b631.js";import"./paper-dropdown-menu-d721ec1c.js";import"./index-1ac6b2a8.js";import{C as f}from"./vaadin-grid-79cd4138.js";import"./vaadin-grid-selection-column-3d3cf852.js";import"./vaadin-grid-sorter-bf08a6c9.js";import"./vaadin-grid-sort-column-6aaeab8d.js";import"./index-bf273402.js";import"./index-da26517d.js";import"./vaadin-item-d35828ff.js";
/**
@license
...
*/const b=e`<iron-iconset-svg name="social" size="24">
<svg><defs>
...
*/
class x extends(v(f(g(t(i))))){static get template(){return e`
    <style>
      :host {
        display: inline-block;
        position: relative;
...
`}static get is(){return"vaadin-button"}static get version(){return"2.2.1"}ready(){super.ready(),this.setAttribute("role","button"),this.$.button.setAttribute("role","presentation"),this._addActiveListeners()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("active")&&this.removeAttribute("active")}_addActiveListeners(){o(this,"down",()=>!this.disabled&&this.setAttribute("active","")),o(this,"up",()=>this.removeAttribute("active")),this.addEventListener("keydown",e=>!this.disabled&&[13,32].indexOf(e.keyCode)>=0&&this.setAttribute("active","")),this.addEventListener("keyup",()=>this.removeAttribute("active")),this.addEventListener("blur",()=>this.removeAttribute("active"))}get focusElement(){return this.$.button}}customElements.define(x.is,x);const _=e`<dom-module id="lumo-upload" theme-for="vaadin-upload">
  <template>
    <style>
      :host {
...
let E=class extends u{constructor(){super(),this.folders={},this.folderInfo={},this.is_admin=!1,this.authenticated=!1,this.deleteFolderId="",this.active=!1,this.explorer={},this.explorerFiles=[],this.invitees=[],this.selectedFolder="",this.uploadFiles=[],this.vhost="",this.vhosts=[],this.allowedGroups=[],this.uploadFilesExist=!1,this.allowed_folder_type=[],this._boundIndexRenderer=this.indexRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundControlFolderListRenderer=this.controlFolderListRenderer.bind(this),this._boundControlFileListRenderer=this.controlFileListRenderer.bind(this),this._boundPermissionViewRenderer=this.permissionViewRenderer.bind(this),this._boundFileNameRenderer=this.fileNameRenderer.bind(this),this._boundCreatedTimeRenderer=this.createdTimeRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this)}static get properties(){return{folders:{type:Object},folderInfo:{type:Object},fileListGrid:{type:Object},is_admin:{type:Boolean},authenticated:{type:Boolean},deleteFolderId:{type:String},active:{type:Boolean},explorer:{type:Object},explorerFiles:{type:Array},uploadFiles:{type:Array},uploadFilesExist:{type:Boolean},vhost:{type:String},vhosts:{type:Array},allowedGroups:{type:Array},invitees:{type:Array},deleteFileDialog:{type:Object},notification:{type:Object},indicator:{type:Object}}}static get styles(){return[a,l,n,s,d`
      ...
      `]}_toggleCheckbox(){let e=this.shadowRoot.querySelectorAll(".multiple-action-buttons");this.fileListGrid.selectedItems.length>0?[].forEach.call(e,e=>{e.style.display="block"}):[].forEach.call(e,e=>{e.style.display="none"})}render(){return c`
          ...
          <section>
            ...
            <div class="horizontal layout">
              ...
              <paper-dropdown-menu id="add-folder-type" label="Type">
                <paper-listbox slot="dropdown-content" selected="0">
                ${this.allowed_folder_type.includes("user")?c`
                  <paper-item label="user">User</paper-item>
                `:c``}
                ${this.is_admin&&this.allowed_folder_type.includes("group")?c`
      ...
      <wl-dialog id="folder-explorer-dialog">
        <wl-card>
          ...
          ${this.explorer.breadcrumb?c`
              ${this.explorer.breadcrumb.map(e=>c`
    ...
    `}_modifySharedFolderPermissions(){const e=this.shadowRoot.querySelectorAll("#modify-permission-dialog wl-select"),t=Array.prototype.filter.call(e,(e,t)=>e.value!==this.invitees[t].perm).map((e,t)=>({perm:e.value,user:this.invitees[t].shared_to.uuid,vfolder:this.invitees[t].vfolder_id})).map(e=>window.backendaiclient.vfolder.modify_invitee_permission(e));Promise.all(t).then(e=>{0===e.length?this.notification.text="No changes made.":this.notification.text="Permission successfully modified.",this.notification.show(),this.shadowRoot.querySelector("#modify-permission-dialog").hide()})}permissionRenderer(e,t,i){h(c`
      ...
      `,e)}_addTextField(e){let t=document.createElement("wl-textfield");t.label="Enter e-mail address",t.type="email",this.shadowRoot.querySelector("#textfields").appendChild(t)}_removeTextField(e){const t=this.shadowRoot.querySelector("#textfields");t.removeChild(t.lastChild)}indexRenderer(e,t,i){h(c`${this._indexFrom1(i.index)}`,e)}controlFolderListRenderer(e,t,i){h(c`
        <div
          id="controls"
        ...
        >
          ...
          ${this._hasPermission(i.item,"r")?c`
              <paper-icon-button
          ...
          ${this._hasPermission(i.item,"w"),c``}

          ${i.item.is_owner&&"user"==i.item.type?c`
              <paper-icon-button
                class="fg blue controls-running"
                icon="social:share"
          ...
          ${this._hasPermission(i.item,"d")?c`
              <paper-icon-button
       ...
       `,e)}controlFileListRenderer(e,t,i){h(c`
        ${!this._isDir(i.item)&&this._isDownloadable(i.item)?c`
            ...
            <paper-icon-button id="delete-btn" class="tiny fg red" icon="vaadin:trash"
                               ...
                               `:c``}
       `,e)}fileNameRenderer(e,t,i){h(c`
        ${this._isDir(i.item)?c`
       ...
       `}
      `,e)}permissionViewRenderer(e,t,i){h(c`
        <div class="horizontal center-justified wrap layout">
        ${this._hasPermission(i.item,"r")?c`
            <lablup-shields app="" color="green"
                            description="R" ui="flat"></lablup-shields>`:c``}
        ${this._hasPermission(i.item,"w")?c`
            <lablup-shields app="" color="blue"
                            description="W" ui="flat"></lablup-shields>`:c``}
        ${this._hasPermission(i.item,"d")?c`
            <lablup-shields app="" color="red"
                            description="D" ui="flat"></lablup-shields>`:c``}
        </div>`,e)}createdTimeRenderer(e,t,i){h(c`
        <div class="layout vertical">
            <span>${this._humanReadableTime(i.item.ctime)}</span>
        </div>`,e)}typeRenderer(e,t,i){h(c`
