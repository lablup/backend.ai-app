import{_ as __decorate,p as property,c as customElement,d as BackendAIPage,e as BackendAiStyles,I as IronFlex,a as IronFlexAlignment,f as IronPositioning,b as css,h as html$1,t as translate,a5 as render,i as BackendAIPainKiller}from"./backend-ai-console-969654a6.js";import"./lablup-loading-indicator-e032c91f.js";import{h as html,G as GestureEventListeners,b as PolymerElement,l as addListener,r as resetMouseCanceller}from"./iron-resizable-behavior-1c6a25ef.js";import{E as ElementMixin,C as ControlStateMixin,T as ThemableMixin}from"./vaadin-grid-54115755.js";import"./paper-dropdown-menu-2c0c71b5.js";import"./iron-iconset-svg-83c12504.js";import"./paper-item-97b726d6.js";import"./radio-behavior-b4045b4d.js";import"./label-54919d09.js";import"./input-behavior-31a4f7aa.js";import"./select-d9b0247d.js";import"./textfield-4e6b96d6.js";import"./vaadin-grid-selection-column-d1751c1f.js";import"./vaadin-grid-sorter-8611ddda.js";import"./vaadin-grid-sort-column-05614ab9.js";import"./vaadin-progress-bar-9c925cf1.js";import"./divider-3cdf13c7.js";import"./tab-group-59cd9f85.js";import"./vaadin-item-3e1596cf.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML='<dom-module id="lumo-field-button">\n  <template>\n    <style>\n      [part$="button"] {\n        flex: none;\n        width: 1em;\n        height: 1em;\n        line-height: 1;\n        font-size: var(--lumo-icon-size-m);\n        text-align: center;\n        color: var(--lumo-contrast-60pct);\n        transition: 0.2s color;\n        cursor: var(--lumo-clickable-cursor);\n      }\n\n      :host(:not([readonly])) [part$="button"]:hover {\n        color: var(--lumo-contrast-90pct);\n      }\n\n      :host([disabled]) [part$="button"],\n      :host([readonly]) [part$="button"] {\n        color: var(--lumo-contrast-20pct);\n      }\n\n      [part$="button"]::before {\n        font-family: "lumo-icons";\n        display: block;\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild($_documentContainer.content);const $_documentContainer$1=html`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
        ...
        <wl-card elevation="1" class="login-panel intro centered">
          ...
          <section>
            ...
            <div class="horizontal layout">
              <mwc-select id="add-folder-host" label="${translate("data.Host")}">
            ...
            ${this._vfolderInnatePermissionSupport?html$1`
              <div class="horizontal layout">
                <mwc-select id="add-folder-usage-mode" label="${translate("data.UsageMode")}">
                  ${this.usageModes.map((e,t)=>html$1`
                    <mwc-list-item value="${e}" ?selected="${0===t}">${e}</mwc-list-item>
                  `)}
                </mwc-select>
                <mwc-select id="add-folder-permission" label="${translate("data.Type")}">
            ...
            ${this.is_admin&&this.allowed_folder_type.includes("group")?html$1`
              <div class="horizontal layout">
                <mwc-select id="add-folder-group" label="${translate("data.Group")}">
