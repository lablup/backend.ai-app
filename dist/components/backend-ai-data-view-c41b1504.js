import{_ as __decorate,p as property,c as customElement,d as BackendAIPage,e as BackendAiStyles,I as IronFlex,a as IronFlexAlignment,f as IronPositioning,b as css,h as html$1,t as translate,a1 as render,i as BackendAIPainKiller,g as get}from"./backend-ai-console-258bce16.js";import{u as unsafeHTML}from"./unsafe-html-ed81f2e2.js";import"./lablup-loading-spinner-ce8c59c1.js";import{h as html,G as GestureEventListeners,b as PolymerElement,l as addListener,r as resetMouseCanceller}from"./iron-resizable-behavior-c7edc396.js";import{E as ElementMixin,C as ControlStateMixin,T as ThemableMixin}from"./vaadin-grid-db23b19c.js";import"./paper-dropdown-menu-53ae0330.js";import"./iron-iconset-svg-19993a4c.js";import"./paper-item-9eb3436d.js";import"./radio-behavior-cc1ecd41.js";import"./label-39dd0fee.js";import"./input-behavior-54325f99.js";import"./select-4a89b11d.js";import"./textfield-a301f777.js";import"./vaadin-grid-selection-column-14023a4b.js";import"./vaadin-grid-sorter-f16f385c.js";import"./vaadin-grid-sort-column-0ee0e80a.js";import"./vaadin-progress-bar-0ee7fbba.js";import"./tab-group-490f625c.js";import"./vaadin-item-fa3fd0a1.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML='<dom-module id="lumo-field-button">\n  <template>\n    <style>\n      [part$="button"] {\n        flex: none;\n        width: 1em;\n        height: 1em;\n        line-height: 1;\n        font-size: var(--lumo-icon-size-m);\n        text-align: center;\n        color: var(--lumo-contrast-60pct);\n        transition: 0.2s color;\n        cursor: var(--lumo-clickable-cursor);\n      }\n\n      :host(:not([readonly])) [part$="button"]:hover {\n        color: var(--lumo-contrast-90pct);\n      }\n\n      :host([disabled]) [part$="button"],\n      :host([readonly]) [part$="button"] {\n        color: var(--lumo-contrast-20pct);\n      }\n\n      [part$="button"]::before {\n        font-family: "lumo-icons";\n        display: block;\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild($_documentContainer.content);const $_documentContainer$1=html`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
 ...
 */let BackendAiStorageList=(()=>{let e=class extends BackendAIPage{constructor(){super(),this.storageType="general",this.folders=Object(),this.folderInfo=Object(),this.is_admin=!1,this.authenticated=!1,this.renameFolderId="",this.deleteFolderId="",this.explorer=Object(),this.explorerFiles=[],this.invitees=[],this.selectedFolder="",this.downloadURL="",this.uploadFiles=[],this.fileUploadQueue=[],this.fileUploadCount=0,this.concurrentFileUploadLimit=2,this.vhost="",this.vhosts=[],this.allowedGroups=[],this.fileListGrid=Object(),this.notification=Object(),this.renameFileDialog=Object(),this.deleteFileDialog=Object(),this.downloadFileDialog=Object(),this.spinner=Object(),this.allowed_folder_type=[],this.uploadFilesExist=!1,this._boundIndexRenderer=Object(),this._boundTypeRenderer=Object(),this._boundControlFolderListRenderer=Object(),this._boundControlFileListRenderer=Object(),this._boundPermissionViewRenderer=Object(),this._boundFileNameRenderer=Object(),this._boundCreatedTimeRenderer=Object(),this._boundPermissionRenderer=Object(),this._uploadFlag=!0,this._boundIndexRenderer=this.indexRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundControlFolderListRenderer=this.controlFolderListRenderer.bind(this),this._boundControlFileListRenderer=this.controlFileListRenderer.bind(this),this._boundPermissionViewRenderer=this.permissionViewRenderer.bind(this),this._boundFileNameRenderer=this.fileNameRenderer.bind(this),this._boundCreatedTimeRenderer=this.createdTimeRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this)}static get styles(){return[BackendAiStyles,IronFlex,IronFlexAlignment,IronPositioning,css`
      ...
      <wl-dialog id="rename-folder-dialog" class="dialog-ask" fixed backdrop blockscrolling>
        <wl-card class="login-panel intro centered">
          <h3 class="horizontal center layout">
            <span>${translate("data.folders.RenameAFolder")}</span>
            <div class="flex"></div>
      ...
      <wl-dialog id="rename-file-dialog" class="dialog-ask" fixed backdrop blockscrolling>
        <wl-card class="login-panel intro centered">
          <h3 class="horizontal center layout">
            <span>${translate("data.explorer.RenameAFile")}</span>
            <div class="flex"></div>
            <wl-button fab flat inverted @click="${e=>this._hideDialog(e)}">
              <wl-icon>close</wl-icon>
            </wl-button>
      ...
      <wl-dialog id="delete-file-dialog" fixed backdrop blockscrolling>
         <wl-title level="3" slot="header">${translate("dialog.title.LetsDouble-Check")}</wl-title>
         <div slot="content">
