 ...
 * Copyright (c) 2021 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;class R extends(y(x(C(b)))){static get template(){return _`
      <style>
        :host {
          display: block;
        ...
        <div slot="content">
          ...
          ${this._vfolderInnatePermissionSupport?d`
            <div class="horizontal layout">
              ...
              <mwc-select class="fixed-position" id="add-folder-permission" label="${c("data.Type")}" fixedMenuPosition>
                ${this.permissions.map(((e,t)=>d`
                  <mwc-list-item value="${e}" ?selected="${0===t}">${e}</mwc-list-item>
                `))}
              </mwc-select>
        ...
        <div slot="content" style="width:100%;">
          ...
          ${this._vfolderInnatePermissionSupport?d`
            <div class="horizontal layout">
              ...
              <mwc-select class="fixed-position" id="clone-folder-permission" label="${c("data.Type")}" FixedMenuPosition>
                ${this.permissions.map(((e,t)=>d`
                  <mwc-list-item value="${e}" ?selected="${0===t}">${e}</mwc-list-item>
                `))}
              </mwc-select>
