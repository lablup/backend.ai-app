import{r as e,_ as t,e as i,n as o,B as a,b as l,I as r,a as s,c as n,$ as d,t as c,g as h,z as p,d as u,o as m}from"./backend-ai-webui-140927b6.js";import"./mwc-switch-8541520c.js";import"./mwc-tab-bar-66321218.js";import"./label-7d023796.js";import"./select-b9739a0f.js";import"./tab-group-db16df71.js";import"./textfield-283ec9bf.js";import"./chart-js-c55d36b0.js";import{a2 as g,P as f,a3 as b,b as v,a4 as w,r as y,E as x,a as _,h as F}from"./vaadin-grid-379661de.js";import"./vaadin-grid-sort-column-49bc77af.js";import"./vaadin-grid-filter-column-751aac32.js";import"./vaadin-grid-selection-column-2a66fad7.js";import"./vaadin-item-styles-91dd9c72.js";import"./vaadin-item-fa1986a0.js";import{t as k}from"./tus-4013acdb.js";import"./lablup-activity-panel-54453d62.js";import"./input-behavior-5f3ea587.js";import"./radio-behavior-cf06ee83.js";
/**
 * @license
 * Copyright (c) 2016 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class $ extends(g(f)){static get is(){return"vaadin-grid-column-group"}static get properties(){return{_childColumns:{value:function(){return this._getChildColumns(this)}},flexGrow:{type:Number,readOnly:!0},width:{type:String,readOnly:!0},_visibleChildColumns:Array,_colSpan:Number,_rootColumns:Array}}static get observers(){return["_updateVisibleChildColumns(_childColumns)","_childColumnsChanged(_childColumns)","_groupFrozenChanged(frozen, _rootColumns)","_groupHiddenChanged(hidden, _rootColumns)","_visibleChildColumnsChanged(_visibleChildColumns)","_colSpanChanged(_colSpan, _headerCell, _footerCell)","_groupOrderChanged(_order, _rootColumns)","_groupReorderStatusChanged(_reorderStatus, _rootColumns)","_groupResizableChanged(resizable, _rootColumns)"]}connectedCallback(){super.connectedCallback(),this._addNodeObserver(),this._updateFlexAndWidth()}disconnectedCallback(){super.disconnectedCallback(),this._observer&&this._observer.disconnect()}_columnPropChanged(e,t){"hidden"===e&&(this._preventHiddenCascade=!0,this._updateVisibleChildColumns(this._childColumns),this._preventHiddenCascade=!1),/flexGrow|width|hidden|_childColumns/.test(e)&&this._updateFlexAndWidth(),"frozen"===e&&(this.frozen=this.frozen||t),"lastFrozen"===e&&(this._lastFrozen=this._lastFrozen||t)}_groupOrderChanged(e,t){if(t){const i=t.slice(0);if(!e)return void i.forEach((e=>e._order=0));const o=10**(/(0+)$/.exec(e).pop().length-(1+~~(Math.log(t.length)/Math.LN10)));i[0]&&i[0]._order&&i.sort(((e,t)=>e._order-t._order)),b(i,o,e)}}_groupReorderStatusChanged(e,t){void 0!==e&&void 0!==t&&t.forEach((t=>t._reorderStatus=e))}_groupResizableChanged(e,t){void 0!==e&&void 0!==t&&t.forEach((t=>t.resizable=e))}_updateVisibleChildColumns(e){this._visibleChildColumns=Array.prototype.filter.call(e,(e=>!e.hidden))}_childColumnsChanged(e){!this._autoHidden&&this.hidden&&(Array.prototype.forEach.call(e,(e=>e.hidden=!0)),this._updateVisibleChildColumns(e))}_updateFlexAndWidth(){this._visibleChildColumns&&(this._visibleChildColumns.length?this._setWidth("calc("+Array.prototype.reduce.call(this._visibleChildColumns,((e,t)=>e+" + "+(t.width||"0px").replace("calc","")),"").substring(3)+")"):this._setWidth("0px"),this._setFlexGrow(Array.prototype.reduce.call(this._visibleChildColumns,((e,t)=>e+t.flexGrow),0)))}_groupFrozenChanged(e,t){void 0!==t&&void 0!==e&&!1!==e&&Array.from(t).forEach((t=>t.frozen=e))}_groupHiddenChanged(e,t){t&&!this._preventHiddenCascade&&(this._ignoreVisibleChildColumns=!0,t.forEach((t=>t.hidden=e)),this._ignoreVisibleChildColumns=!1),this._columnPropChanged("hidden")}_visibleChildColumnsChanged(e){this._colSpan=e.length,this._ignoreVisibleChildColumns||(0===e.length?this._autoHidden=this.hidden=!0:this.hidden&&this._autoHidden&&(this._autoHidden=this.hidden=!1))}_colSpanChanged(e,t,i){t&&(t.setAttribute("colspan",e),this._grid&&this._grid._a11yUpdateCellColspan(t,e)),i&&(i.setAttribute("colspan",e),this._grid&&this._grid._a11yUpdateCellColspan(i,e))}_getChildColumns(e){return v.getFlattenedNodes(e).filter(this._isColumnElement)}_addNodeObserver(){this._observer=new v(this,(e=>{(e.addedNodes.filter(this._isColumnElement).length>0||e.removedNodes.filter(this._isColumnElement).length>0)&&(this._preventHiddenCascade=!0,this._rootColumns=this._getChildColumns(this),this._childColumns=this._rootColumns,this._preventHiddenCascade=!1,w.run((()=>{this._grid&&this._grid._updateColumnTree&&this._grid._updateColumnTree()})))})),this._observer.flush()}_isColumnElement(e){return e.nodeType===Node.ELEMENT_NODE&&/\bcolumn\b/.test(e.localName)}}customElements.define($.is,$),y("vaadin-progress-bar",e`
    :host {
 ...
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;class C extends(x(_(R(f)))){static get template(){return F`
      <style>
        :host {
          display: block;
...
let T=class extends a{constructor(){super(),this._APIMajorVersion=5,this.storageType="general",this.folders=[],this.folderInfo=Object(),this.is_admin=!1,this.enableStorageProxy=!1,this.authenticated=!1,this.renameFolderName="",this.deleteFolderName="",this.leaveFolderName="",this.explorer=Object(),this.explorerFiles=[],this.existingFile="",this.invitees=[],this.selectedFolder="",this.selectedFolderType="",this.downloadURL="",this.uploadFiles=[],this.fileUploadQueue=[],this.fileUploadCount=0,this.concurrentFileUploadLimit=2,this.vhost="",this.vhosts=[],this.allowedGroups=[],this.fileListGrid=Object(),this.indicator=Object(),this.notification=Object(),this.renameFileDialog=Object(),this.deleteFileDialog=Object(),this.downloadFileDialog=Object(),this.sessionLauncher=Object(),this.spinner=Object(),this.allowed_folder_type=[],this.uploadFilesExist=!1,this._boundIndexRenderer=Object(),this._boundTypeRenderer=Object(),this._boundFolderListRenderer=Object(),this._boundControlFolderListRenderer=Object(),this._boundControlFileListRenderer=Object(),this._boundPermissionViewRenderer=Object(),this._boundOwnerRenderer=Object(),this._boundFileNameRenderer=Object(),this._boundCreatedTimeRenderer=Object(),this._boundPermissionRenderer=Object(),this._boundCloneableRenderer=Object(),this._boundQuotaRenderer=Object(),this._boundUploadListRenderer=Object(),this._boundUploadProgressRenderer=Object(),this._boundInviteeInfoRenderer=Object(),this._boundIDRenderer=Object(),this._uploadFlag=!0,this._folderRefreshing=!1,this.lastQueryTime=0,this.isWritable=!1,this.permissions={rw:"Read-Write",ro:"Read-Only",wd:"Delete"},this._maxFileUploadSize=-1,this.oldFileExtension="",this.newFileExtension="",this.is_dir=!1,this.minimumResource={cpu:1,mem:.5},this.filebrowserSupportedImages=[],this.storageProxyInfo=Object(),this.quotaSupportStorageBackends=["xfs"],this.quotaUnit={MiB:Math.pow(2,20),GiB:Math.pow(2,30),TiB:Math.pow(2,40),PiB:Math.pow(2,50)},this.maxSize={value:0,unit:"MiB"},this.quota={value:0,unit:"MiB"},this._boundIndexRenderer=this.indexRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundControlFolderListRenderer=this.controlFolderListRenderer.bind(this),this._boundControlFileListRenderer=this.controlFileListRenderer.bind(this),this._boundPermissionViewRenderer=this.permissionViewRenderer.bind(this),this._boundCloneableRenderer=this.CloneableRenderer.bind(this),this._boundOwnerRenderer=this.OwnerRenderer.bind(this),this._boundFileNameRenderer=this.fileNameRenderer.bind(this),this._boundCreatedTimeRenderer=this.createdTimeRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundFolderListRenderer=this.folderListRenderer.bind(this),this._boundQuotaRenderer=this.quotaRenderer.bind(this),this._boundUploadListRenderer=this.uploadListRenderer.bind(this),this._boundUploadProgressRenderer=this.uploadProgressRenderer.bind(this),this._boundInviteeInfoRenderer=this.inviteeInfoRenderer.bind(this),this._boundIDRenderer=this.iDRenderer.bind(this)}static get styles(){return[l,r,s,n,e`
      ...
      `]}_toggleFileListCheckbox(){const e=this.shadowRoot.querySelectorAll(".multiple-action-buttons");this.fileListGrid.selectedItems.length>0?[].forEach.call(e,(e=>{e.style.display="block"})):[].forEach.call(e,(e=>{e.style.display="none"}))}_updateQuotaInputHumanReadableValue(){const e=this.shadowRoot.querySelector("#modify-folder-quota"),t=this.shadowRoot.querySelector("#modify-folder-quota-unit");let i="MiB";const o=e.value*this.quotaUnit[t.value],a=this.maxSize.value*this.quotaUnit[this.maxSize.unit];[e.value,i]=globalThis.backendaiutils._humanReadableFileSize(o).split(" "),["Bytes","KiB","MiB"].includes(i)?(e.value="MiB"===i?e.value<1?1:Math.round(e.value):1,i="MiB"):(e.value=parseFloat(e.value).toFixed(1),a<o&&(e.value=this.maxSize.value,i=this.maxSize.unit)),e.step="MiB"===t.value?0:.1;const l=t.items.findIndex((e=>e.value===i));t.select(l)}render(){return d`
      ...
      <vaadin-grid class="folderlist" theme="row-stripes column-borders wrap-cell-content compact" column-reordering-allowed aria-label="Folder list" .items="${this.folders}">
        ...
        <vaadin-grid-filter-column path="name" width="80px" resizable .renderer="${this._boundFolderListRenderer}"
            header="${c("data.folders.Name")}"></vaadin-grid-filter-column>
        ...
        <vaadin-grid-filter-column path="host" width="105px" flex-grow="0" resizable
            header="${c("data.folders.Location")}"></vaadin-grid-filter-column>
        <vaadin-grid-column auto-width flex-grow="0" resizable header="${c("data.folders.FolderQuota")}" .renderer="${this._boundQuotaRenderer}"></vaadin-grid-column>
        <vaadin-grid-column width="55px" flex-grow="0" resizable header="${c("data.folders.Type")}" .renderer="${this._boundTypeRenderer}"></vaadin-grid-column>
        <vaadin-grid-column width="95px" flex-grow="0" resizable header="${c("data.folders.Permission")}" .renderer="${this._boundPermissionViewRenderer}"></vaadin-grid-column>
        ...
        <div slot="content" class="vertical layout flex">
          <div class="vertical layout" id="modify-quota-controls"
            ...
            <div class="horizontal layout center justified">
                <mwc-textfield id="modify-folder-quota" label="${c("data.folders.FolderQuota")}" value="${this.maxSize.value}"
                ...
                ${Object.keys(this.quotaUnit).map(((e,t)=>d`
                      <mwc-list-item value="${e}" ?selected="${e===this.maxSize.unit}">${e}</mwc-list-item>
                    `))}
                </mwc-select>
            </div>
            <span class="helper-text">${c("data.folders.MaxFolderQuota")} : ${this.maxSize.value+" "+this.maxSize.unit}</span>
          </div>
          <mwc-select class="full-width fixed-position" id="update-folder-permission" style="width:100%;" label="${c("data.Permission")}"
                  fixedMenuPosition>
                  ${Object.keys(this.permissions).map((e=>d`
      ...
      <backend-ai-dialog id="modify-folder-name-dialog" fixed backdrop>
        <span slot="title">${c("data.folders.RenameAFolder")}</span>
        <div slot="content" class="vertical layout flex">
          <mwc-textfield
              id="clone-folder-src" label="${c("data.ExistingFolderName")}" value="${this.renameFolderName}"
      ...
      <backend-ai-dialog id="info-folder-dialog" fixed backdrop>
        ...
        <div slot="content" role="listbox" style="margin: 0;width:100%;">
          ...
          <mwc-list>
            ...
            `:d``}
            ${this._checkFolderSupportSizeQuota(this.folderInfo.host)?d`
              <mwc-list-item twoline>
                <span><strong>${c("data.folders.FolderUsage")}</strong></span>
                <span class="monospace" slot="secondary">
                  ${c("data.folders.FolderUsing")}: ${this.folderInfo.used_bytes>=0?globalThis.backendaiutils._humanReadableFileSize(this.folderInfo.used_bytes):"Undefined"} /
                  ${c("data.folders.FolderQuota")}: ${this.folderInfo.max_size>=0?globalThis.backendaiutils._humanReadableFileSize(this.folderInfo.max_size*this.quotaUnit.MiB):"Undefined"}
                  ${this.folderInfo.used_bytes>=0&&this.folderInfo.max_size>=0?d`
      ...
      <backend-ai-dialog id="folder-explorer-dialog" class="folder-explorer" narrowLayout>
        ...
        <div slot="content">
          ...
          <vaadin-grid id="fileList-grid" class="explorer" theme="row-stripes compact" aria-label="Explorer" .items="${this.explorerFiles}">
            ...
            <vaadin-grid-sort-column path="size" auto-width resizable header="${c("data.explorer.Size")}">
            </vaadin-grid-sort-column>
            <vaadin-grid-column resizable auto-width header="${c("data.explorer.Actions")}" .renderer="${this._boundControlFileListRenderer}">
            </vaadin-grid-column>
          </vaadin-grid>
        </div>
      </backend-ai-dialog>
      ...
      <backend-ai-dialog id="modify-permission-dialog" fixed backdrop>
        ...
        <div slot="content" role="listbox" style="margin: 0; padding: 10px;">
          <vaadin-grid theme="row-stripes column-borders compact" .items="${this.invitees}">
            ...
            ></vaadin-grid-column>
            <vaadin-grid-column header="${c("data.explorer.InviteeEmail")}" .renderer="${this._boundInviteeInfoRenderer}">
            </vaadin-grid-column>
      ...
      <backend-ai-dialog id="filebrowser-notification-dialog" fixed backdrop narrowLayout>
        <span slot="title">${c("dialog.title.Notice")}</span>
        <div slot="content" style="margin: 15px;">
          <span>${c("data.explorer.ReadOnlyFolderOnFileBrowser")}</span>
        </div>
        <div slot="footer" class="flex horizontal layout center justified" style="margin: 15px 15px 15px 0px;">
          <div class="horizontal layout start-justified center">
            ...
            <span style="font-size:0.8rem;">${h("dialog.hide.DonotShowThisAgain")}</span>
          </div>
          <mwc-button unelevated @click="${e=>this._hideDialog(e)}">${c("button.Confirm")}</mwc-button>
        </div>
      </backend-ai-dialog>
    `}firstUpdated(){this._addEventListenerDropZone(),this._mkdir=this._mkdir.bind(this),this.renameFileDialog=this.shadowRoot.querySelector("#rename-file-dialog"),this.deleteFileDialog=this.shadowRoot.querySelector("#delete-file-dialog"),this.downloadFileDialog=this.shadowRoot.querySelector("#download-file-dialog"),this.sessionLauncher=this.shadowRoot.querySelector("#session-launcher"),this.fileListGrid=this.shadowRoot.querySelector("#fileList-grid"),this.fileListGrid.addEventListener("selected-items-changed",(()=>{this._toggleFileListCheckbox()})),this.spinner=this.shadowRoot.querySelector("#loading-spinner"),this.indicator=globalThis.lablupIndicator,this.notification=globalThis.lablupNotification;const e=this.shadowRoot.querySelectorAll("mwc-textfield");for(const t of e)this._addInputValidator(t);"automount"===this.storageType?this.shadowRoot.querySelector("vaadin-grid.folderlist").style.height="calc(100vh - 230px)":this.shadowRoot.querySelector("vaadin-grid.folderlist").style.height="calc(100vh - 185px)",document.addEventListener("backend-ai-group-changed",(e=>this._refreshFolderList(!0,"group-changed"))),document.addEventListener("backend-ai-ui-changed",(e=>this._refreshFolderUI(e))),this._refreshFolderUI({detail:{"mini-ui":globalThis.mini_ui}}),void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._getStorageProxyBackendInformation(),this._triggerFolderListChanged()}),!0):(this._getStorageProxyBackendInformation(),this._triggerFolderListChanged())}_modifySharedFolderPermissions(){const e=this.shadowRoot.querySelectorAll("#modify-permission-dialog wl-select"),t=Array.prototype.filter.call(e,((e,t)=>e.value!==this.invitees[t].perm)).map(((e,t)=>({perm:"kickout"===e.value?null:e.value,user:this.invitees[t].shared_to.uuid,vfolder:this.invitees[t].vfolder_id}))).map((e=>globalThis.backendaiclient.vfolder.modify_invitee_permission(e)));Promise.all(t).then((e=>{0===e.length?this.notification.text=h("data.permission.NoChanges"):this.notification.text=h("data.permission.PermissionModified"),this.notification.show(),this.shadowRoot.querySelector("#modify-permission-dialog").hide()}))}permissionRenderer(e,t,i){p(d`
      ...
      `,e)}quotaRenderer(e,t,i){let o="-";this._checkFolderSupportSizeQuota(i.item.host)&&i.item.max_size&&(o=globalThis.backendaiutils._humanReadableFileSize(i.item.max_size*this.quotaUnit.MiB)),p(d`
        <div class="horizontal layout center center-justified">${o}</div>
      `,e)}uploadListRenderer(e,t,i){p(d`
      ...
      `,e)}uploadProgressRenderer(e,t,i){p(d`
      <vaadin-item>
      ...
      `,e)}inviteeInfoRenderer(e,t,i){p(d`
        <div>${i.item.shared_to.email}</div>
      `,e)}iDRenderer(e,t,i){p(d`
