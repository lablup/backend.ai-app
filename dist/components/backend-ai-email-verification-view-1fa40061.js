import{B as i,d as e,I as t,a,n as o,e as s,b as l,g as n,h as c,t as d,_ as r,p as h,c as f}from"./backend-ai-webui-3ec8f434.js";let g=class extends i{constructor(){super(...arguments),this.webUIShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.successDialog=Object(),this.failDialog=Object()}static get styles(){return[e,t,a,o,s,l`
        mwc-textfield {
          width: 100%;
    ...
    `}};r([h({type:Object})],g.prototype,"webUIShell",void 0),r([h({type:Object})],g.prototype,"clientConfig",void 0),r([h({type:Object})],g.prototype,"client",void 0),r([h({type:Object})],g.prototype,"notification",void 0),r([h({type:Object})],g.prototype,"successDialog",void 0),r([h({type:Object})],g.prototype,"failDialog",void 0),g=r([f("backend-ai-email-verification-view")],g);var p=g;export default p;
