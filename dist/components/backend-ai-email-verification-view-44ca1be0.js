import{B as i,d as e,I as t,a as o,n as a,e as s,b as l,g as n,h as c,t as d,_ as r,p as h,c as g}from"./backend-ai-console-228ea035.js";let f=class extends i{constructor(){super(...arguments),this.consoleShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.successDialog=Object(),this.failDialog=Object()}static get styles(){return[e,t,o,a,s,l`
        mwc-textfield {
          width: 100%;
    ...
    `}};r([h({type:Object})],f.prototype,"consoleShell",void 0),r([h({type:Object})],f.prototype,"clientConfig",void 0),r([h({type:Object})],f.prototype,"client",void 0),r([h({type:Object})],f.prototype,"notification",void 0),r([h({type:Object})],f.prototype,"successDialog",void 0),r([h({type:Object})],f.prototype,"failDialog",void 0),f=r([g("backend-ai-email-verification-view")],f);var p=f;export default p;
