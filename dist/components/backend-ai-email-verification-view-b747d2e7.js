import{B as i,d as e,I as t,b as o,x as a,f as l,i as s,av as n,aw as c,g as d,y as r,t as h,_ as f,e as g,a as v}from"./backend-ai-webui-c668737f.js";let p=class extends i{constructor(){super(...arguments),this.webUIShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.successDialog=Object(),this.failDialog=Object()}static get styles(){return[e,t,o,a,l,s`
        mwc-textfield {
          width: 100%;
    ...
    `}};f([g({type:Object})],p.prototype,"webUIShell",void 0),f([g({type:Object})],p.prototype,"clientConfig",void 0),f([g({type:Object})],p.prototype,"client",void 0),f([g({type:Object})],p.prototype,"notification",void 0),f([g({type:Object})],p.prototype,"successDialog",void 0),f([g({type:Object})],p.prototype,"failDialog",void 0),p=f([v("backend-ai-email-verification-view")],p);var u=p;export{u as default};
