import{_ as e,p as t,c as i,B as a,d as o,I as s,a as l,x as r,e as n,b as d,g as c,f as u,t as h,Z as p,h as m}from"./backend-ai-console-52b9eb55.js";import"./iron-resizable-behavior-60d31af0.js";import"./vaadin-grid-sorter-4d8e13ce.js";import"./paper-dropdown-menu-a208b033.js";import"./iron-iconset-svg-04ff383c.js";import"./radio-behavior-3164ce17.js";import"./vaadin-grid-selection-column-182b798b.js";import"./iconset-b6786ef5.js";import"./tab-group-81ed713d.js";import"./select-8282ab89.js";import"./field-button-2772ae34.js";import"./switch-25ec0469.js";import"./vaadin-grid-filter-column-57d33852.js";let g=class extends a{constructor(){super(),this.images=Array(),this.allowed_registries=Array(),this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this.servicePorts=Array(),this.selectedIndex=0,this.selectedImages=Array(),this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.spinner=Object(),this.indicator=Object(),this.installImageDialog=Object(),this.deleteImageDialog=Object(),this.installImageNameList=Array(),this.deleteImageNameList=Array(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object()}static get styles(){return[o,s,l,r,n,d`
        vaadin-grid {
          font-size: 14px;
      ...
      `]}_markIfUnlimited(e){return["-",0,"Unlimited",1/0,"Infinity"].includes(e)?"∞":e}_hideDialog(e){e.target.closest("backend-ai-dialog").hide()}_hideDialogById(e){return this.shadowRoot.querySelector(e).hide()}_launchDialogById(e){return this.shadowRoot.querySelector(e).show()}modifyImage(){const e=this.shadowRoot.querySelector("#modify-image-cpu").value,t=this.shadowRoot.querySelector("#modify-image-mem").value,i=this.shadowRoot.querySelector("#modify-image-cuda-gpu").value,a=this.shadowRoot.querySelector("#modify-image-cuda-fgpu").value,o=this.shadowRoot.querySelector("#modify-image-rocm-gpu").value,s=this.shadowRoot.querySelector("#modify-image-tpu").value,{resource_limits:l}=this.images[this.selectedIndex];let r={};const n=this._cuda_gpu_disabled?this._cuda_fgpu_disabled?1:2:this._cuda_fgpu_disabled?2:3;e!==l[0].min&&(r.cpu={min:e});let d=this._symbolicUnit(t);d!==l[n].min&&(r.mem={min:d}),this._cuda_gpu_disabled||i===l[1].min||(r["cuda.device"]={min:i}),this._cuda_fgpu_disabled||a===l[2].min||(r["cuda.shares"]={min:a}),this._rocm_gpu_disabled||o===l[3].min||(r["rocm.device"]={min:o}),this._tpu_disabled||s===l[4].min||(r["tpu.device"]={min:s});const c=this.images[this.selectedIndex];if(0===Object.keys(r).length)return this.notification.text="No changes made",this.notification.show(),void this._hideDialogById("#modify-image-dialog");globalThis.backendaiclient.image.modifyResource(c.registry,c.name,c.tag,r).then(e=>{e.reduce((e,t)=>e&&"ok"===t.result,!0)?(this._getImages(),this.requestUpdate(),this.notification.text="Successfully modified"):this.notification.text="Problem occurred",this.notification.show(),this._hideDialogById("#modify-image-dialog")})}openInstallImageDialog(){this.selectedImages=this._grid.selectedItems.filter(e=>!e.installed),this.installImageNameList=this.selectedImages.map(e=>e.registry+"/"+e.name+":"+e.tag),this.selectedImages.length>0?this.installImageDialog.show():(this.notification.text=c("environment.SelectedImagesAlreadyInstalled"),this.notification.show())}_installImage(){this.installImageDialog.hide(),this.selectedImages.forEach(async e=>{let t="#"+e.registry.replace(/\./gi,"-")+"-"+e.name.replace("/","-")+"-"+e.tag.replace(/\./gi,"-");this._grid.querySelector(t).setAttribute("style","display:block;");let i=e.registry+"/"+e.name+":"+e.tag,a=Object();e.resource_limits.forEach(e=>{a[e.key.replace("_",".")]=e.min}),"cuda.device"in a&&"cuda.shares"in a?(a.gpu=0,a.fgpu=a["cuda.shares"]):"cuda.device"in a&&(a.gpu=a["cuda.device"]),a.mem.endsWith("g")?a.mem=a.mem.replace("g",".5g"):a.mem.endsWith("m")&&(a.mem=Number(a.mem.slice(0,-1))+256+"m"),a.domain=globalThis.backendaiclient._config.domainName,a.group_name=globalThis.backendaiclient.current_group,this.notification.text="Installing "+i+". It takes time so have a cup of coffee!",this.notification.show();let o=await this.indicator.start("indeterminate");o.set(10,"Downloading..."),globalThis.backendaiclient.get_resource_slots().then(e=>{let t=e;return"cuda.device"in t&&"cuda.shares"in t?"fgpu"in a&&"gpu"in a&&(delete a.gpu,delete a["cuda.device"]):"cuda.device"in t?(delete a.fgpu,delete a["cuda.shares"]):"cuda.shares"in t&&(delete a.gpu,delete a["cuda.device"]),globalThis.backendaiclient.image.install(i,a)}).then(e=>{o.set(100,"Install finished."),o.end(1e3),this._grid.querySelector(t).className="installed",this._grid.querySelector(t).innerHTML=c("environment.Installed")}).catch(e=>{this._grid.querySelector(t).className=c("environment.Installing"),this._grid.querySelector(t).setAttribute("style","display:none;"),this._uncheckSelectedRow(),this.notification.text=u.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e),o.set(100,h("environment.DescProblemOccurred")),o.end(1e3)})})}openDeleteImageDialog(){this.selectedImages=this._grid.selectedItems.filter(e=>e.installed),this.deleteImageNameList=this.selectedImages.map(e=>e.registry+"/"+e.name+":"+e.tag),this.selectedImages.length>0?this.deleteImageDialog.show():(this.notification.text=c("environment.SelectedImagesNotInstalled"),this.notification.show())}_deleteImage(){}requirementsRenderer(e,t,i){p(m`
      ...
      <backend-ai-dialog id="install-image-dialog" fixed backdrop persistent>
        ...
        <div slot="content">
          ...
          ${this.installImageNameList.map(e=>m`${e}<br />`)}
          </span></p>
        ...
        <div slot="footer" class="horizontal flex layout">
          <div class="flex"></div>
          <wl-button class="cancel" inverted flat @click="${e=>{this._hideDialog(e),this._uncheckSelectedRow()}}">
            ${h("button.Cancel")}
          </wl-button>
      ...
      <backend-ai-dialog id="delete-image-dialog" fixed backdrop persistent>
        ...
        <div slot="content">
          ...
          <p style="margin:auto; "><span style="color:blue;">
          ${this.deleteImageNameList.map(e=>m`${e}<br />`)}
          </span></p>
...
let y=class extends a{constructor(){super(),this.resourcePolicy={},this.is_admin=!1,this.active=!1,this.gpu_allocatable=!1,this.gpuAllocationMode="device",this.condition="",this.presetName="",this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[o,s,l,d`
      ...
      `,e)}_indexRenderer(e,t,i){let a=i.index+1;p(m`
        <div>${a}</div>
