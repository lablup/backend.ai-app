import{_ as e,e as t,c as i,a,B as s,d as o,I as r,b as l,x as n,f as d,i as c,g as u,h as p,t as m,A as h,y as g}from"./backend-ai-webui-67004191.js";import"./tab-group-57707824.js";import"./mwc-tab-bar-4c0c0798.js";import"./lablup-activity-panel-3f701007.js";import"./lablup-grid-sort-filter-column-aebb7281.js";import"./lablup-loading-spinner-542223c5.js";import"./vaadin-grid-b307120d.js";import"./vaadin-grid-selection-column-7bcbc3b9.js";import"./vaadin-grid-filter-column-56016096.js";import"./vaadin-grid-sort-column-9f8cecc6.js";import"./select-c9b75e15.js";import"./textfield-cc1679e6.js";import"./label-15e54aa7.js";import"./slider-49796585.js";import"./vaadin-icons-f0d9d23d.js";import"./vaadin-item-styles-1fc30bdc.js";import"./vaadin-item-f42fc8a2.js";import"./backend-ai-list-status-f6f485b3.js";import"./mwc-switch-8fe28f19.js";import"./radio-behavior-85423886.js";import"./progress-spinner-8fcece3e.js";import"./input-behavior-78fab2b6.js";import"./dom-repeat-0177808f.js";let v=class extends s{constructor(){super(),this.selectedIndex=0,this.selectedImages=[],this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this._range={cpu:["1","2","3","4","5","6","7","8"],mem:["64MB","128MB","256MB","512MB","1GB","2GB","4GB","8GB","16GB","32GB","256GB","512GB"],"cuda-gpu":["0","1","2","3","4","5","6","7"],"cuda-fgpu":["0","0.1","0.2","0.5","1.0","2.0"],"rocm-gpu":["0","1","2","3","4","5","6","7"],tpu:["0","1","2"]},this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[]}static get styles(){return[o,r,l,n,d,c`
         vaadin-grid {
           border: 0;
           font-size: 14px;
