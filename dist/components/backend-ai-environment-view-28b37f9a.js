import{_ as e,e as t,c as i,a,B as s,d as o,I as r,b as l,x as n,f as d,i as c,g as u,h as p,t as m,A as h,y as g}from"./backend-ai-webui-c668737f.js";import"./tab-group-ecc4c906.js";import"./mwc-tab-bar-7b200658.js";import"./lablup-activity-panel-0c26142f.js";import"./lablup-grid-sort-filter-column-0af01ea6.js";import"./lablup-loading-spinner-89cb77e0.js";import"./vaadin-grid-9de58569.js";import"./vaadin-grid-selection-column-be36a6f6.js";import"./vaadin-grid-filter-column-faa0319d.js";import"./vaadin-grid-sort-column-2e404eaf.js";import"./select-773d3b38.js";import"./textfield-ea14368e.js";import"./label-cfef56e5.js";import"./slider-d44d2f3a.js";import"./vaadin-icons-ffcb4869.js";import"./vaadin-item-styles-f813b6fd.js";import"./vaadin-item-2cb95179.js";import"./backend-ai-list-status-8799d9f0.js";import"./mwc-switch-bfd737f3.js";import"./radio-behavior-3e23fb76.js";import"./progress-spinner-98e0f7a4.js";import"./input-behavior-62f0810a.js";import"./dom-repeat-e3923569.js";let v=class extends s{constructor(){super(),this.selectedIndex=0,this.selectedImages=[],this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this._range={cpu:["1","2","3","4","5","6","7","8"],mem:["64MB","128MB","256MB","512MB","1GB","2GB","4GB","8GB","16GB","32GB","256GB","512GB"],"cuda-gpu":["0","1","2","3","4","5","6","7"],"cuda-fgpu":["0","0.1","0.2","0.5","1.0","2.0"],"rocm-gpu":["0","1","2","3","4","5","6","7"],tpu:["0","1","2"]},this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[]}static get styles(){return[o,r,l,n,d,c`
         vaadin-grid {
           border: 0;
           font-size: 14px;
      ...
      <div class="list-wrapper">
        <vaadin-grid theme="row-stripes column-borders compact" aria-label="Environments" id="testgrid" .items="${this.images}">
          ...
          <vaadin-grid-sort-filter-column path="baseimage" resizable width="110px" header="${m("environment.Base")}" .renderer="${this._boundBaseImageRenderer}">
