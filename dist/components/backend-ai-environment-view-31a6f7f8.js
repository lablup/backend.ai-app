      ...
      <div class="list-wrapper">
        <vaadin-grid theme="row-stripes column-borders compact" aria-label="Environments" id="testgrid" .items="${this.images}">
          ...
          <vaadin-grid-filter-column path="architecture" width="80px" resizable
              header="${m("environment.Architecture")}"></vaadin-grid-filter-column>
          ...
          <vaadin-grid-column resizable width="110px" header="${m("environment.Base")}" .renderer="${this._boundBaseImageRenderer}">
          </vaadin-grid-column>
          <vaadin-grid-column width="50px" resizable header="${m("environment.Constraint")}" .renderer="${this._boundConstraintRenderer}">
          </vaadin-grid-column>
          <vaadin-grid-filter-column path="digest" resizable header="${m("environment.Digest")}" .renderer="${this._boundDigestRenderer}">
...
/**
 ...
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */
let _=class extends s{constructor(){super(...arguments),this.images=Object(),this.is_superadmin=!1,this._activeTab="image-lists"}static get styles(){return[o,r,n,c`
          wl-tab-group {
