import{_ as e,p as t,c as i,d as a,e as o,I as l,a as s,b as r,Y as n,h as d,g as c,C as h,f as u}from"./backend-ai-console-ac2839c6.js";import"./lablup-loading-indicator-5b28ed66.js";import"./iron-resizable-behavior-5743f649.js";import"./vaadin-progress-bar-c86f5342.js";import"./vaadin-grid-369d5b12.js";import"./paper-dropdown-menu-ae71b683.js";import"./iron-iconset-svg-c8634dd5.js";import"./mwc-select-d0aee009.js";import"./radio-behavior-9563ef20.js";import"./label-e4aee937.js";import"./vaadin-grid-sorter-250e386d.js";import"./iconset-2993a19c.js";import"./divider-eafbf648.js";import"./backend-ai-indicator-e4527a9c.js";import"./tab-group-31bc77b5.js";import"./vaadin-item-03518044.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let p=class extends a{constructor(){super(),this.resourcePolicy={},this.is_admin=!1,this.active=!1,this.gpu_allocatable=!1,this.gpuAllocationMode="device",this.condition="",this.presetName="",this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[o,l,s,r`
        vaadin-grid {
          border: 0;
          font-size: 14px;
...
let g=class extends a{constructor(){super(),this.images=Array(),this.allowed_registries=Array(),this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this.servicePorts=Array(),this.selectedIndex=0,this._gpu_disabled=!1,this._fgpu_disabled=!1,this.alias=Object(),this.loadingIndicator=Object(),this.indicator=Object(),this.installImageDialog=Object(),this.installImageName="",this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object()}static get styles(){return[o,l,s,h,u,r`
              ...
              <div style="display: flex; flex-direction: column;">
                <div style="display: flex;">
                  ...
                  <wl-select
                    ...
                    style="flex: 1"
                  >
                    ${["64m","128m","256m","512m","1g","2g","4g","8g","16g"].map(e=>d`
                      <option
                        value=${e}
                      >${e}</option>
                    `)}
    ...
    `}_removeRow(e){const t=e.composedPath();let i=0;for(;"div"!==t[i].localName;)i++;t[i].remove()}_addRow(){const e=this.shadowRoot.querySelector("#modify-app-container"),t=e.children[e.children.length-1],i=this._createRow();e.insertBefore(i,t)}_createRow(){const e=document.createElement("div");e.setAttribute("class","row extra");const t=document.createElement("wl-textfield");t.setAttribute("type","text");const i=document.createElement("wl-textfield");t.setAttribute("type","text");const a=document.createElement("wl-textfield");t.setAttribute("type","number");const o=document.createElement("wl-button");o.setAttribute("class","fg pink"),o.setAttribute("fab",""),o.setAttribute("flat",""),o.addEventListener("click",e=>this._removeRow(e));const l=document.createElement("wl-icon");return l.innerHTML="remove",o.appendChild(l),e.appendChild(a),e.appendChild(i),e.appendChild(t),e.appendChild(o),e}_clearRows(){const e=this.shadowRoot.querySelector("#modify-app-container"),t=e.querySelectorAll(".row");t[t.length-1].querySelectorAll("wl-textfield").forEach(e=>{e.value=""}),e.querySelectorAll(".row.extra").forEach(e=>{e.remove()})}_uncheckSelectedRow(){this.selectedCheckbox.checked=!1}firstUpdated(){this.loadingIndicator=this.shadowRoot.querySelector("#loading-indicator"),this.indicator=this.shadowRoot.querySelector("#indicator"),this.notification=globalThis.lablupNotification,this.installImageDialog=this.shadowRoot.querySelector("#install-image-dialog"),void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",()=>{this._getImages()},!0):this._getImages(),this._grid=this.shadowRoot.querySelector("#testgrid"),this._grid.addEventListener("sorter-changed",e=>{this._refreshSorter(e)})}_refreshSorter(e){let t=e.target,i=t.path.toString();t.direction&&("asc"===t.direction?this._grid.items.sort((e,t)=>e[i]<t[i]?-1:e[i]>t[i]?1:0):this._grid.items.sort((e,t)=>e[i]>t[i]?-1:e[i]<t[i]?1:0))}async _viewStateChanged(e){await this.updateComplete}_getImages(){this.loadingIndicator.show(),globalThis.backendaiclient.domain.get(globalThis.backendaiclient._config.domainName,["allowed_docker_registries"]).then(e=>(this.allowed_registries=e.domain.allowed_docker_registries,globalThis.backendaiclient.image.list(["name","tag","registry","digest","installed","labels { key value }","resource_limits { key min max }"],!1,!0))).then(e=>{let t=e.images,i=[];t.forEach(e=>{if(this.allowed_registries.includes(e.registry)){let t=e.tag.split("-");void 0!==t[1]?(e.baseversion=t[0],e.baseimage=t[1],void 0!==t[2]&&(e.additional_req=t[2].toUpperCase())):e.baseversion=e.tag;let a=e.name.split("/");void 0!==a[1]?(e.namespace=a[0],e.lang=a.slice(1).join("")):(e.namespace="",e.lang=a[0]);let o=e.lang.split("-"),l=[this._humanizeName(e.baseimage)];void 0!==o[1]&&(e.lang=o[1],l.push(this._humanizeName(o[0]))),e.baseimage=l,e.lang=this._humanizeName(e.lang),e.resource_limits.forEach(t=>{0==t.max&&(t.max="∞"),"cuda.device"==t.key&&(t.key="cuda_device"),"cuda.shares"==t.key&&(t.key="cuda_shares"),e[t.key+"_limit_min"]=this._addUnit(t.min),e[t.key+"_limit_max"]=this._addUnit(t.max)}),e.labels=e.labels.reduce((e,t)=>Object.assign(Object.assign({},e),{[t.key]:t.value}),{}),i.push(e)}}),this.images=i,this.loadingIndicator.hide()}).catch(e=>{console.log(e),void 0!==e.message?(this.notification.text=c.relieve(e.title),this.notification.detail=e.message):this.notification.text=c.relieve("Problem occurred during image metadata loading."),this.notification.show(!0,e),this.loadingIndicator.hide()})}_addUnit(e){let t=e.substr(-1);return"m"==t?e.slice(0,-1)+"MB":"g"==t?e.slice(0,-1)+"GB":"t"==t?e.slice(0,-1)+"TB":e}_humanizeName(e){return this.alias={python:"Python",tensorflow:"TensorFlow",pytorch:"PyTorch",lua:"Lua",r:"R","r-base":"R",julia:"Julia",rust:"Rust",cpp:"C++",gcc:"GCC",go:"Go",tester:"Tester",haskell:"Haskell",matlab:"MATLAB",sagemath:"Sage",java:"Java",php:"PHP",octave:"Octave",nodejs:"Node",caffe:"Caffe",scheme:"Scheme",scala:"Scala",base:"Base",cntk:"CNTK",h2o:"H2O.AI",digits:"DIGITS",py3:"Python 3",py2:"Python 2",py27:"Python 2.7",py35:"Python 3.5",py36:"Python 3.6",py37:"Python 3.7",py38:"Python 3.8",py39:"Python 3.9","ubuntu16.04":"Ubuntu 16.04","ubuntu18.04":"Ubuntu 18.04","ubuntu20.04":"Ubuntu 20.04",intel:"Intel MKL",rocm:"ROCm",cuda9:"CUDA9",cuda10:"CUDA10","cuda10.1":"CUDA10.1",miniconda:"Miniconda","anaconda2018.12":"Anaconda 2018.12","anaconda2019.12":"Anaconda 2019.12","alpine3.8":"Alpine Linux 3.8",ngc:"NVidia GPU Cloud",ff:"Research Env."},e in this.alias?this.alias[e]:e}};e([t({type:Array})],g.prototype,"images",void 0),e([t({type:Array})],g.prototype,"allowed_registries",void 0),e([t({type:Object})],g.prototype,"_boundRequirementsRenderer",void 0),e([t({type:Object})],g.prototype,"_boundControlsRenderer",void 0),e([t({type:Object})],g.prototype,"_boundInstallRenderer",void 0),e([t({type:Array})],g.prototype,"servicePorts",void 0),e([t({type:Number})],g.prototype,"selectedIndex",void 0),e([t({type:Boolean})],g.prototype,"_gpu_disabled",void 0),e([t({type:Boolean})],g.prototype,"_fgpu_disabled",void 0),e([t({type:Object})],g.prototype,"alias",void 0),e([t({type:Object})],g.prototype,"loadingIndicator",void 0),e([t({type:Object})],g.prototype,"indicator",void 0),e([t({type:Object})],g.prototype,"installImageDialog",void 0),e([t({type:String})],g.prototype,"installImageName",void 0),e([t({type:Object})],g.prototype,"installImageResource",void 0),e([t({type:Object})],g.prototype,"selectedCheckbox",void 0),e([t({type:Object})],g.prototype,"_grid",void 0),g=e([i("backend-ai-environment-list")],g);
/**
 @license
 Copyright (c) 2015-2018 Lablup Inc. All rights reserved.
 */
let m=class extends a{constructor(){super(),this.indicator=Object(),this.selectedIndex=0,this.boundControlsRenderer=this._controlsRenderer.bind(this),this._registryType=Array(),this.registryList=[]}static get styles(){return[o,l,s,r`
        vaadin-grid {
          border: 0;
          font-size: 14px;
          height: calc(100vh - 265px);
    ...
    `}};e([t({type:Object})],m.prototype,"indicator",void 0),e([t({type:Number})],m.prototype,"selectedIndex",void 0),e([t({type:String})],m.prototype,"boundControlsRenderer",void 0),e([t({type:Array})],m.prototype,"_registryType",void 0),m=e([i("backend-ai-registry-list")],m);
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let b=class extends a{constructor(){super(),this.images=Object(),this.is_superadmin=!1,this._activeTab="image-lists"}static get styles(){return[o,l,s,r`
          wl-tab-group {
        ...
        <h3 class="tab horizontal center layout">
          <wl-tab-group>
            ...
            ${this.is_superadmin?d`
              <wl-tab value="registry-lists" @click="${e=>this._showTab(e.target)}">Registries</wl-tab>`:d``}
          </wl-tab-group>
          <div class="flex"></div>
        </h3>
    ...
    `}firstUpdated(){}disconnectedCallback(){super.disconnectedCallback()}};e([t({type:String})],b.prototype,"images",void 0),e([t({type:Boolean})],b.prototype,"is_superadmin",void 0),e([t({type:String})],b.prototype,"_activeTab",void 0),b=e([i("backend-ai-environment-view")],b);var y=b;export default y;
