import{_ as e,e as t,c as i,a,B as s,d as o,I as r,b as l,x as n,f as d,i as c,g as u,h as p,t as m,A as h,y as g}from"./backend-ai-webui-f03dfdc8.js";import"./tab-group-067fd976.js";import"./mwc-tab-bar-0e6b2296.js";import"./lablup-activity-panel-e8ef0f24.js";import"./lablup-grid-sort-filter-column-53bad97e.js";import"./lablup-loading-spinner-6b540b3e.js";import"./vaadin-grid-141c4edd.js";import"./vaadin-grid-selection-column-9cfe1fdf.js";import"./vaadin-grid-filter-column-be47eee1.js";import"./vaadin-grid-sort-column-750208d9.js";import"./select-e554ca83.js";import"./textfield-f14b8705.js";import"./label-c8beeb7f.js";import"./slider-25ccdae3.js";import"./vaadin-icons-d2d796e1.js";import"./vaadin-item-styles-b7552ccb.js";import"./vaadin-item-cf6a20fa.js";import"./backend-ai-list-status-88352f5a.js";import"./mwc-switch-7988c9d0.js";import"./radio-behavior-3fc41a70.js";import"./progress-spinner-ed0cc662.js";import"./input-behavior-50b6d347.js";import"./dom-repeat-734ce150.js";let v=class extends s{constructor(){super(),this.selectedIndex=0,this.selectedImages=[],this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this._range={cpu:["1","2","3","4","5","6","7","8"],mem:["64MB","128MB","256MB","512MB","1GB","2GB","4GB","8GB","16GB","32GB","256GB","512GB"],"cuda-gpu":["0","1","2","3","4","5","6","7"],"cuda-fgpu":["0","0.1","0.2","0.5","1.0","2.0"],"rocm-gpu":["0","1","2","3","4","5","6","7"],tpu:["0","1","2"]},this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[]}static get styles(){return[o,r,l,n,d,c`
         vaadin-grid {
           border: 0;
           font-size: 14px;
