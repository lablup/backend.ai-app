import{_ as e,p as t,c as i,B as a,d as o,I as s,a as r,x as l,e as n,b as d,f as c,t as h,Z as u,h as m,g as p}from"./backend-ai-console-e6c7b7b2.js";import"./iron-resizable-behavior-60d31af0.js";import"./vaadin-grid-sorter-427927f5.js";import"./paper-dropdown-menu-a208b033.js";import"./iron-iconset-svg-04ff383c.js";import"./radio-behavior-ced3ce22.js";import"./iconset-b6786ef5.js";import"./tab-group-fc8346fa.js";import"./select-94b1b041.js";import"./field-button-23738262.js";import"./switch-b7bf4f25.js";import"./vaadin-grid-filter-column-d59d5c45.js";let g=class extends a{constructor(){super(),this.images=Array(),this.allowed_registries=Array(),this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this.servicePorts=Array(),this.selectedIndex=0,this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.spinner=Object(),this.indicator=Object(),this.installImageDialog=Object(),this.installImageName="",this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object()}static get styles(){return[o,s,r,l,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `,e)}installRenderer(e,t,i){u(m`
        <div class="layout horizontal center center-justified" style="margin:0; padding:0;">
          <wl-checkbox id="${i.item.name}" style="--checkbox-size:12px;"
              ...
              @click="${e=>{this.openInstallImageDialog(i.item.digest),this.selectedCheckbox=e.target}}">
          </wl-checkbox>
        </div>
      `,e)}render(){return m`
