import{_ as e,p as t,c as i,B as a,d as o,I as s,a as r,n as l,e as n,b as d,g as c,f as u,t as m,W as h,h as g}from"./backend-ai-console-22d31a8d.js";import"./lablup-activity-panel-7944657c.js";import"./mwc-slider-9da234df.js";import"./radio-behavior-ddc0148e.js";import"./vaadin-grid-sorter-f0db9e83.js";import"./vaadin-grid-selection-column-056a9949.js";import"./iconset-a5679453.js";import"./mwc-tab-bar-ef87d5ea.js";import"./tab-group-9d0f9222.js";import"./select-b521709e.js";import"./field-button-01c017ac.js";import"./switch-6a2b55ad.js";import"./mwc-switch-8b84e37a.js";import"./vaadin-grid-filter-column-63af0a5a.js";let p=class extends a{constructor(){super(),this.images=Array(),this.allowed_registries=Array(),this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this.servicePorts=Array(),this.selectedIndex=0,this.selectedImages=Array(),this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.spinner=Object(),this.indicator=Object(),this.installImageDialog=Object(),this.deleteImageDialog=Object(),this.installImageNameList=Array(),this.deleteImageNameList=Array(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this._range={cpu:["1","2","3","4","5","6","7","8"],mem:["64MB","128MB","256MB","512MB","1GB","2GB","4GB","8GB","16GB","32GB","256GB","512GB"],"cuda-gpu":["0","1","2","3","4","5","6","7"],"cuda-fgpu":["0","0.1","0.2","0.5","1.0","2.0"],"rocm-gpu":["0","1","2","3","4","5","6","7"],tpu:["0","1","2"]},this.cpuValue=0}static get styles(){return[o,s,r,l,n,d`
        vaadin-grid {
          font-size: 14px;
      ...
      `]}_markIfUnlimited(e){return["-",0,"Unlimited",1/0,"Infinity"].includes(e)?"∞":e}_hideDialog(e){e.target.closest("backend-ai-dialog").hide()}_hideDialogById(e){return this.shadowRoot.querySelector(e).hide()}_launchDialogById(e){return this.shadowRoot.querySelector(e).show()}modifyImage(){const e=this.shadowRoot.querySelector("#modify-image-cpu").label,t=this.shadowRoot.querySelector("#modify-image-mem").label,i=this.shadowRoot.querySelector("#modify-image-cuda-gpu").label,a=this.shadowRoot.querySelector("#modify-image-cuda-fgpu").label,o=this.shadowRoot.querySelector("#modify-image-rocm-gpu").label,s=this.shadowRoot.querySelector("#modify-image-tpu").value,{resource_limits:r}=this.images[this.selectedIndex];let l={};const n=this._cuda_gpu_disabled?this._cuda_fgpu_disabled?1:2:this._cuda_fgpu_disabled?2:3;e!==r[0].min&&(l.cpu={min:e});let d=this._symbolicUnit(t);d!==r[n].min&&(l.mem={min:d}),this._cuda_gpu_disabled||i===r[1].min||(l["cuda.device"]={min:i}),this._cuda_fgpu_disabled||a===r[2].min||(l["cuda.shares"]={min:a}),this._rocm_gpu_disabled||o===r[3].min||(l["rocm.device"]={min:o}),this._tpu_disabled||s===r[4].min||(l["tpu.device"]={min:s});const c=this.images[this.selectedIndex];if(0===Object.keys(l).length)return this.notification.text="No changes made",this.notification.show(),void this._hideDialogById("#modify-image-dialog");globalThis.backendaiclient.image.modifyResource(c.registry,c.name,c.tag,l).then((e=>{e.reduce(((e,t)=>e&&"ok"===t.result),!0)?(this._getImages(),this.requestUpdate(),this.notification.text="Successfully modified"):this.notification.text="Problem occurred",this.notification.show(),this._hideDialogById("#modify-image-dialog")}))}openInstallImageDialog(){this.selectedImages=this._grid.selectedItems.filter((e=>!e.installed)),this.installImageNameList=this.selectedImages.map((e=>e.registry+"/"+e.name+":"+e.tag)),this.selectedImages.length>0?this.installImageDialog.show():(this.notification.text=c("environment.SelectedImagesAlreadyInstalled"),this.notification.show())}_installImage(){this.installImageDialog.hide(),this.selectedImages.forEach((async e=>{let t="#"+e.registry.replace(/\./gi,"-")+"-"+e.name.replace("/","-")+"-"+e.tag.replace(/\./gi,"-");this._grid.querySelector(t).setAttribute("style","display:block;");let i=e.registry+"/"+e.name+":"+e.tag,a=!1,o=Object();e.resource_limits.forEach((e=>{o[e.key.replace("_",".")]=e.min})),"cuda.device"in o&&"cuda.shares"in o?(a=!0,o.gpu=0,o.fgpu=o["cuda.shares"]):"cuda.device"in o?(o.gpu=o["cuda.device"],a=!0):a=!1,o.mem.endsWith("g")?o.mem=o.mem.replace("g",".5g"):o.mem.endsWith("m")&&(o.mem=Number(o.mem.slice(0,-1))+256+"m"),o.domain=globalThis.backendaiclient._config.domainName,o.group_name=globalThis.backendaiclient.current_group;const s=await globalThis.backendaiclient.get_resource_slots();if(a&&!("cuda.device"in s)&&!("cuda.shares"in s))return this.notification.text=c("environment.NoResourcesForImage")+i,this.notification.show(),void this._grid.querySelector(t).setAttribute("style","display:none;");"cuda.device"in s&&"cuda.shares"in s?"fgpu"in o&&"gpu"in o&&(delete o.gpu,delete o["cuda.device"]):"cuda.device"in s?(delete o.fgpu,delete o["cuda.shares"]):"cuda.shares"in s&&(delete o.gpu,delete o["cuda.device"]),this.notification.text=c("environment.InstallingImage")+i+c("environment.TakesTime"),this.notification.show();let r=await this.indicator.start("indeterminate");r.set(10,"Downloading..."),globalThis.backendaiclient.image.install(i,o).then((e=>{r.set(100,"Install finished."),r.end(1e3),this._grid.querySelector(t).className="installed",this._grid.querySelector(t).innerHTML=c("environment.Installed")})).catch((e=>{this._grid.querySelector(t).className=c("environment.Installing"),this._grid.querySelector(t).setAttribute("style","display:none;"),this._uncheckSelectedRow(),this.notification.text=u.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e),r.set(100,m("environment.DescProblemOccurred")),r.end(1e3)}))}))}openDeleteImageDialog(){this.selectedImages=this._grid.selectedItems.filter((e=>e.installed)),this.deleteImageNameList=this.selectedImages.map((e=>e.registry+"/"+e.name+":"+e.tag)),this.selectedImages.length>0?this.deleteImageDialog.show():(this.notification.text=c("environment.SelectedImagesNotInstalled"),this.notification.show())}_deleteImage(){}requirementsRenderer(e,t,i){h(g`
...
let y=class extends a{constructor(){super(),this.resourcePolicy={},this.is_admin=!1,this.active=!1,this.gpu_allocatable=!1,this.gpuAllocationMode="device",this.condition="",this.presetName="",this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[o,s,r,d`
      ...
      `,e)}_indexRenderer(e,t,i){let a=i.index+1;h(g`
        <div>${a}</div>
    ...
    `}};e([t({type:Object})],b.prototype,"indicator",void 0),e([t({type:Number})],b.prototype,"selectedIndex",void 0),e([t({type:String})],b.prototype,"boundIsEnabledRenderer",void 0),e([t({type:String})],b.prototype,"boundControlsRenderer",void 0),e([t({type:Array})],b.prototype,"_registryType",void 0),e([t({type:Array})],b.prototype,"allowed_registries",void 0),e([t({type:Array})],b.prototype,"hostnames",void 0),b=e([i("backend-ai-registry-list")],b);
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
