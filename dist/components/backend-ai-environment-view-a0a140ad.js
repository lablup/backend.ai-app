import{_ as e,p as t,c as i,d as a,e as o,I as s,a as l,b as r,X as n,h as d,g as c,z as h,f as p}from"./backend-ai-console-14d10124.js";import"./lablup-loading-indicator-d581dc83.js";import"./polymer-legacy-4d33d7bd.js";import"./iron-resizable-behavior-33a9d7fa.js";import"./vaadin-progress-bar-432ef8ee.js";import"./radio-behavior-583b4374.js";import"./paper-progress-31fb9b80.js";import"./paper-icon-button-2254421d.js";import"./iron-iconset-svg-7f9b79bb.js";import"./iron-icons-5b385824.js";import"./paper-dropdown-menu-571001d5.js";import"./shadow-dc0e6b19.js";import"./mwc-select-26829684.js";import"./label-e1bc0c8e.js";import"./av-icons-5ae8754c.js";import"./vaadin-grid-253f5dab.js";import"./vaadin-grid-sorter-8aff2bf9.js";import"./iconset-92ff2bc9.js";import"./divider-33c1d747.js";import"./backend-ai-indicator-a5fe5e8a.js";import"./tab-group-c1fbd113.js";import"./vaadin-item-7d466ec1.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let u=class extends a{constructor(){super(),this.resourcePolicy={},this.is_admin=!1,this.active=!1,this.gpu_allocatable=!1,this.gpuAllocationMode="device",this.condition="",this.presetName="",this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this)}static get styles(){return[o,s,l,r`
        vaadin-grid {
          border: 0;
          font-size: 14px;
...
let m=class extends a{constructor(){super(),this.images=Array(),this.allowed_registries=Array(),this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this.servicePorts=Array(),this.selectedIndex=0,this._gpu_disabled=!1,this._fgpu_disabled=!1,this.alias=Object(),this.loadingIndicator=Object(),this.indicator=Object(),this.installImageDialog=Object(),this.installImageName="",this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object()}static get styles(){return[o,s,l,h,p,r`
      ...
      `]}_markIfUnlimited(e){return["-",0,"Unlimited",1/0,"Infinity"].includes(e)?"∞":e}_hideDialog(e){e.target.closest("wl-dialog").hide()}_hideDialogById(e){return this.shadowRoot.querySelector(e).hide()}_launchDialogById(e){return this.shadowRoot.querySelector(e).show()}modifyImage(){const e=this.shadowRoot.querySelector("#modify-image-cpu").value,t=this.shadowRoot.querySelector("#modify-image-mem").value,i=this.shadowRoot.querySelector("#modify-image-gpu").value,a=this.shadowRoot.querySelector("#modify-image-fgpu").value,{resource_limits:o}=this.images[this.selectedIndex];let s={};const l=this._gpu_disabled?this._fgpu_disabled?1:2:this._fgpu_disabled?2:3;e!==o[0].min&&(s.cpu={min:e}),t!==o[l].min&&(s.mem={min:t}),this._gpu_disabled||i===o[1].min||(s["cuda.device"]={min:i}),this._fgpu_disabled||a===o[2].min||(s["cuda.shares"]={min:a});const r=this.images[this.selectedIndex];if(0===Object.keys(s).length)return this.notification.text="No changes made",this.notification.show(),void this._hideDialogById("#modify-image-dialog");window.backendaiclient.image.modifyResource(r.registry,r.name,r.tag,s).then(e=>{e.reduce((e,t)=>e&&"ok"===t.result,!0)?(this._getImages(),this.requestUpdate(),this.notification.text="Successfully modified"):this.notification.text="Problem occurred",this.notification.show(),this._hideDialogById("#modify-image-dialog")})}openInstallImageDialog(e){this.selectedIndex=e;let t=this.images[this.selectedIndex];this.installImageName=t.registry+"/"+t.name+":"+t.tag,this.installImageResource={},t.resource_limits.forEach(e=>{this.installImageResource[e.key.replace("_",".")]=e.min}),this.installImageDialog.show()}_installImage(){this.installImageDialog.hide(),"cuda.device"in this.installImageResource&&"cuda.shares"in this.installImageResource?(this.installImageResource.gpu=0,this.installImageResource.fgpu=this.installImageResource["cuda.shares"]):"cuda.device"in this.installImageResource&&(this.installImageResource.gpu=this.installImageResource["cuda.device"]),this.installImageResource.mem.endsWith("g")?this.installImageResource.mem=this.installImageResource.mem.replace("g",".5g"):this.installImageResource.mem.endsWith("m")&&(this.installImageResource.mem=Number(this.installImageResource.mem.slice(0,-1))+256+"m"),this.installImageResource.domain=window.backendaiclient._config.domainName,this.installImageResource.group_name=window.backendaiclient.current_group,this.notification.text="Installing "+this.installImageName+". It takes time so have a cup of coffee!",this.notification.show(),this.indicator.start("indeterminate"),this.indicator.set(10,"Downloading..."),window.backendaiclient.image.install(this.installImageName,this.installImageResource).then(e=>{this.indicator.set(100,"Install finished."),this.indicator.end(1e3),this._getImages()}).catch(e=>{this._uncheckSelectedRow(),this.notification.text=c.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e),this.indicator.set(100,"Problem occurred during installation."),this.indicator.end(1e3)})}requirementsRenderer(e,t,i){n(d`
          <div class="layout horizontal center flex">
            <div class="layout horizontal configuration">
...
let g=class extends a{constructor(){super(),this.indicator=Object(),this.selectedIndex=0,this.boundControlsRenderer=this._controlsRenderer.bind(this),this._registryType=Array(),this.registryList=[]}static get styles(){return[o,s,l,r`
    ...
    `}};e([t({type:Object})],g.prototype,"indicator",void 0),e([t({type:Number})],g.prototype,"selectedIndex",void 0),e([t({type:String})],g.prototype,"boundControlsRenderer",void 0),e([t({type:Array})],g.prototype,"_registryType",void 0),g=e([i("backend-ai-registry-list")],g);
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let w=class extends a{constructor(){super(),this.images=Object(),this.is_superadmin=!1,this._activeTab="image-lists"}static get styles(){return[o,s,l,r`
          wl-tab-group {
    ...
    `}firstUpdated(){}disconnectedCallback(){super.disconnectedCallback()}};e([t({type:String})],w.prototype,"images",void 0),e([t({type:Boolean})],w.prototype,"is_superadmin",void 0),e([t({type:String})],w.prototype,"_activeTab",void 0),w=e([i("backend-ai-environment-view")],w);var y=w;export default y;
