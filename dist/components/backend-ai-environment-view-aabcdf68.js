          ...
          <form id="login-form">
            <fieldset>
              ...
              <div class="horizontal center layout">
                ...
                <mwc-textfield id="ram-resource" class="modify" type="number" label="${m("resourcePreset.RAM(GB)")}"
              ...
              <div class="horizontal center layout">
                <mwc-textfield id="shmem-resource" class="modify" type="number"
                    label="${m("resourcePreset.SharedMemory(GB)")}" min="0" step="0.01"
