import{_ as t,p as e,c as a,d as i,e as r,I as o,a as s,b as l,h as d,t as n}from"./backend-ai-console-f3f55dfb.js";import"./lablup-loading-indicator-f881de2e.js";import"./iron-resizable-behavior-de55f964.js";import"./vaadin-progress-bar-1df69f2a.js";import"./vaadin-grid-4911f4dc.js";import"./iron-iconset-svg-9534ec82.js";import"./expansion-9cb7b1da.js";import"./label-580b3f1c.js";import"./vaadin-grid-selection-column-674d4aac.js";import"./vaadin-grid-sorter-a00e6fad.js";import"./vaadin-grid-sort-column-7c57152f.js";import"./iconset-2efda350.js";import"./backend-ai-indicator-06adad47.js";
/**
 @license
 ...
 */let g=class extends i{constructor(){super(),this.timestamp="",this.errorType="",this.requestUrl="",this.statusCode="",this.statusText="",this.title="",this.message="",this.logs=Array(),this._selected_items=Array(),this.loadingIndicator=Object(),this._grid=Object(),this.logView=Object(),this._pageSize=25,this._currentPage=1,this._totalLogCount=0}static get styles(){return[r,o,s,l`
      ...
      <vaadin-grid id="list-grid" page-size="${this._pageSize}"
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.TimeStamp")}">
          <template>
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.Status")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.ErrorTitle")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.ErrorMessage")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.Method")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.RequestUrl")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.Parameters")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
        ...
        <vaadin-grid-column resizable flex-grow="0" text-align="start" auto-width header="${n("logs.ErrorType")}">
          <template>
              <div class="layout vertical" error-cell$="[[item.isError]]">
                <span>[[item.type]]</span>
              </div>
