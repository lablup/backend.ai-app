import{i as e,G as t,J as i,K as o,P as a,E as n,at as s,au as r,av as l,r as d,_ as p,p as c,t as h,q as u,c as m,h as v,Y as b,d as y,e as g,I as f,a as _,D as w,f as x,b as k,aw as E}from"./backend-ai-console-284685c7.js";import{T as C,a as T,c as z,E as O}from"./iron-resizable-behavior-eeda571e.js";import"./lablup-loading-indicator-3faeff25.js";import"./vaadin-progress-bar-01e0851c.js";import"./paper-progress-855f10af.js";import{r as L}from"./radio-behavior-2b43bd0c.js";import{a as N}from"./paper-icon-button-d968ca7f.js";import"./paper-dropdown-menu-7bb56615.js";import"./paper-slider-7886e1f4.js";import"./shadow-d8679dfa.js";import"./expansion-3cac6714.js";import"./av-icons-0dade827.js";import"./paper-dialog-scrollable-0c739eaa.js";import"./vaadin-grid-ed9f4151.js";import"./vaadin-grid-selection-column-5ba54f2f.js";import"./vaadin-grid-sorter-1cdb77de.js";import"./vaadin-grid-sort-column-b087df5d.js";import"./backend-ai-session-list-bacb718b.js";import"./divider-0454c933.js";import"./backend-ai-indicator-8a817de1.js";import"./json_to_csv-95c4522d.js";import"./tab-group-6c4d9db8.js";
/**
@license
...
*/
let D=0;const M={},U=e=>{D++;const t=`vaadin-overlay-content-${D}`,i=document.createElement("template"),o=document.createElement("style");o.textContent=":host { display: block; }"+e,i.content.appendChild(o),window.ShadyCSS&&window.ShadyCSS.prepareTemplate(i,t);const a=class extends HTMLElement{static get is(){return t}constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(document.importNode(i.content,!0)))}connectedCallback(){window.ShadyCSS&&window.ShadyCSS.styleElement(this)}};return customElements.define(a.is,a),M[e]=t,t};class G extends(C(n)){static get template(){return e`
    <style>
      :host {
        z-index: 200;
        position: fixed;
...
let Y=class extends y{constructor(){super(),E(!0),this.active=!1,this.supports={},this.resourceLimits={},this.userResourceLimit={},this.aliases={TensorFlow:"python-tensorflow","Lablup ResearchEnv.":"python-ff",Python:"python",PyTorch:"python-pytorch",Chainer:"chainer",R:"r",Julia:"julia",Lua:"lua"},this.versions=["3.6"],this.languages=[],this.gpu_mode="no",this.gpu_step=.05,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.gpu_metric={min:"0",max:"0"},this.tpu_metric={min:"1",max:"1"},this.images={},this.defaultResourcePolicy="UNLIMITED",this.total_slot={},this.used_slot={},this.available_slot={},this.resource_info={},this.used_slot_percent={},this.resource_templates=[],this.vfolders=[],this.default_language="",this.launch_ready=!1,this.concurrency_used=0,this.concurrency_max=0,this._status="inactive"}static get is(){return"backend-ai-experiment-view"}static get properties(){return{active:{type:Boolean},supports:{type:Object},resourceLimits:{type:Object},userResourceLimit:{type:Object},aliases:{type:Object},versions:{type:Array},languages:{type:Array},gpu_mode:{type:String},gpu_step:{type:Number},cpu_metric:{type:Object},mem_metric:{type:Object},gpu_metric:{type:Object},tpu_metric:{type:Object},images:{type:Object},defaultResourcePolicy:{type:String},total_slot:{type:Object},used_slot:{type:Object},available_slot:{type:Object},concurrency_used:{type:Number},concurrency_max:{type:Number},vfolders:{type:Array},resource_info:{type:Object},used_slot_percent:{type:Object},resource_templates:{type:Array},default_language:{type:String},launch_ready:{type:Boolean},_status:{type:Boolean},notification:{type:Object}}}static get styles(){return[g,f,_,w,x,k`
      ...
      `]}firstUpdated(){this.notification=window.lablupNotification}_showTab(e){for(var t=this.shadowRoot.querySelectorAll(".tab-content"),i=0;i<t.length;i++)t[i].style.display="none";this.shadowRoot.querySelector("#"+e.value).style.display="block"}_hideDialog(e){e.target.closest("wl-dialog").hide()}render(){return v`
...
`}};Y=p([m("backend-ai-experiment-view")],Y);var J=Y;export default J;
