import{a8 as e,x as t,_ as i,p as n,y as o,q as s,c as a,h as r,R as l,d,e as c,I as h,a as p,G as u,f as v,b as m}from"./backend-ai-console-04ff2fbe.js";import"./lablup-loading-spinner-bef8aa5b.js";import{h as g,b,F as y,n as w,o as f,I as _,s as x}from"./iron-resizable-behavior-1c6a25ef.js";import{T as z,a as E,b as C,E as L}from"./vaadin-grid-54115755.js";import"./paper-dropdown-menu-2c0c71b5.js";import"./iron-iconset-svg-83c12504.js";import{r as k}from"./radio-behavior-ff239169.js";import"./expansion-0316d6fc.js";import"./input-behavior-0076553c.js";import"./textfield-2f8050ba.js";import"./vaadin-grid-selection-column-d1751c1f.js";import"./vaadin-grid-sorter-8611ddda.js";import"./vaadin-grid-sort-column-05614ab9.js";import"./iconset-6e7d381f.js";import"./vaadin-progress-bar-9c925cf1.js";import"./backend-ai-session-list-ccf5d5ff.js";import"./json_to_csv-0a6876b9.js";import"./tab-group-24c52ec5.js";const T=document.createElement("template");T.innerHTML='<dom-module id="lumo-overlay">\n  <template>\n    <style>\n      :host {\n        top: var(--lumo-space-m);\n        right: var(--lumo-space-m);\n        bottom: var(--lumo-space-m);\n        left: var(--lumo-space-m);\n        /* Workaround for Edge issue (only on Surface), where an overflowing vaadin-list-box inside vaadin-select-overlay makes the overlay transparent */\n        /* stylelint-disable-next-line */\n        outline: 0px solid transparent;\n      }\n\n      [part="overlay"] {\n        background-color: var(--lumo-base-color);\n        background-image: linear-gradient(var(--lumo-tint-5pct), var(--lumo-tint-5pct));\n        border-radius: var(--lumo-border-radius-m);\n        box-shadow: 0 0 0 1px var(--lumo-shade-5pct), var(--lumo-box-shadow-m);\n        color: var(--lumo-body-text-color);\n        font-family: var(--lumo-font-family);\n        font-size: var(--lumo-font-size-m);\n        font-weight: 400;\n        line-height: var(--lumo-line-height-m);\n        letter-spacing: 0;\n        text-transform: none;\n        -webkit-text-size-adjust: 100%;\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n      }\n\n      [part="content"] {\n        padding: var(--lumo-space-xs);\n      }\n\n      [part="backdrop"] {\n        background-color: var(--lumo-shade-20pct);\n        animation: 0.2s lumo-overlay-backdrop-enter both;\n        will-change: opacity;\n      }\n\n      @keyframes lumo-overlay-backdrop-enter {\n        0% {\n          opacity: 0;\n        }\n      }\n\n      :host([closing]) [part="backdrop"] {\n        animation: 0.2s lumo-overlay-backdrop-exit both;\n      }\n\n      @keyframes lumo-overlay-backdrop-exit {\n        100% {\n          opacity: 0;\n        }\n      }\n\n      @keyframes lumo-overlay-dummy-animation {\n        0% { opacity: 1; }\n        100% { opacity: 1; }\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild(T.content);const O=g`<dom-module id="lumo-dialog" theme-for="vaadin-dialog-overlay">
  <template>
...
*/
let N=0;const R={},I=e=>{N++;const t=`vaadin-overlay-content-${N}`,i=document.createElement("template"),n=document.createElement("style");n.textContent=":host { display: block; }"+e,i.content.appendChild(n),window.ShadyCSS&&window.ShadyCSS.prepareTemplate(i,t);const o=class extends HTMLElement{static get is(){return t}constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(document.importNode(i.content,!0)))}connectedCallback(){window.ShadyCSS&&window.ShadyCSS.styleElement(this)}};return customElements.define(o.is,o),R[e]=t,t};class F extends(z(b)){static get template(){return g`
    <style>
      :host {
        z-index: 200;
        position: fixed;
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/,D=document.createElement("template");let G;D.innerHTML='<dom-module id="vaadin-dialog-overlay-styles" theme-for="vaadin-dialog-overlay">\n  <template>\n    <style>\n      /*\n        NOTE(platosha): Make some min-width to prevent collapsing of the content\n        taking the parent width, e. g., <vaadin-grid> and such.\n      */\n      [part="content"] {\n        min-width: 12em; /* matches the default <vaadin-text-field> width */\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild(D.content);class U extends(f(_,F)){static get is(){return"vaadin-dialog-overlay"}static get template(){if(!G){G=super.template.cloneNode(!0);const e=G.content.querySelector('[part="content"]'),t=G.content.querySelector('[part="overlay"]'),i=document.createElement("div");i.id="resizerContainer",i.classList.add("resizer-container"),i.appendChild(e),t.appendChild(i)}return G}static get properties(){return{modeless:Boolean,withBackdrop:Boolean}}}customElements.define(U.is,U);class q extends(C(L(M(j(b))))){static get template(){return g`
    <style>
      :host {
        display: none;
      }
