import{f as e,o as t,q as i,r as o,g as a,P as n,am as s,G as r,an as l,au as d,x as p,_ as c,p as h,y as u,Q as m,c as v,h as b,W as y,k as g,I as f,j as w,ad as _,l as x,a as k,J as E}from"./backend-ai-console-f442a6b8.js";import{B as C}from"./backend-ai-page-98b8ad16.js";import"./lablup-loading-indicator-fe6978c9.js";import{T,a as z,E as O}from"./iron-resizable-behavior-1552c11e.js";import"./vaadin-progress-bar-0ea54e72.js";import"./paper-progress-2c71e8dd.js";import{a as L,r as N}from"./radio-behavior-0dc5181d.js";import"./backend-ai-dropdown-menu-53aa635a.js";import"./shadow-a7d1713f.js";import"./paper-dropdown-menu-6c03947c.js";import"./index-bb02ee2d.js";import"./av-icons-4bfc1b50.js";import"./paper-dialog-dab367c8.js";import"./paper-dialog-scrollable-21a187c8.js";import"./vaadin-grid-d72d8ff2.js";import"./vaadin-grid-selection-column-8deeb859.js";import"./vaadin-grid-sorter-d8dd722c.js";import"./vaadin-grid-sort-column-f7aa6beb.js";import"./backend-ai-session-list-85b48cc9.js";import"./index-eb0bd4f9.js";import"./backend-ai-indicator-c5b0b1ab.js";import"./index-2ca25cb7.js";
/**
@license
...
</dom-module>`;S.setAttribute("style","display: none;"),document.head.appendChild(S.content);
/**
@license
...
found at http://polymer.github.io/PATENTS.txt
*/
const j={properties:{elevation:{type:Number,reflectToAttribute:!0,readOnly:!0}},observers:["_calculateElevation(focused, disabled, active, pressed, receivedFocusFromKeyboard)","_computeKeyboardClass(receivedFocusFromKeyboard)"],hostAttributes:{role:"button",tabindex:"0",animated:!0},_calculateElevation:function(){var e=1;this.disabled?e=0:this.active||this.pressed?e=4:this.receivedFocusFromKeyboard&&(e=3),this._setElevation(e)},_computeKeyboardClass:function(e){this.toggleClass("keyboard-focus",e)},_spaceKeyDownHandler:function(e){t._spaceKeyDownHandler.call(this,e),this.hasRipple()&&this.getRipple().ripples.length<1&&this._ripple.uiDownAction()},_spaceKeyUpHandler:function(e){t._spaceKeyUpHandler.call(this,e),this.hasRipple()&&this._ripple.uiUpAction()}},A=[i,o,L,j],R=e`
  ...
  <slot></slot>`;R.setAttribute("strip-whitespace",""),a({_template:R,is:"paper-button",behaviors:[A],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?j._calculateElevation.apply(this):this._setElevation(0)}});const P=document.createElement("template");P.innerHTML='<dom-module id="lumo-overlay">\n  <template>\n    <style>\n      :host {\n        top: var(--lumo-space-m);\n        right: var(--lumo-space-m);\n        bottom: var(--lumo-space-m);\n        left: var(--lumo-space-m);\n        /* Workaround for Edge issue (only on Surface), where an overflowing vaadin-list-box inside vaadin-select-overlay makes the overlay transparent */\n        /* stylelint-disable-next-line */\n        outline: 0px solid transparent;\n      }\n\n      [part="overlay"] {\n        background-color: var(--lumo-base-color);\n        background-image: linear-gradient(var(--lumo-tint-5pct), var(--lumo-tint-5pct));\n        border-radius: var(--lumo-border-radius-m);\n        box-shadow: 0 0 0 1px var(--lumo-shade-5pct), var(--lumo-box-shadow-m);\n        color: var(--lumo-body-text-color);\n        font-family: var(--lumo-font-family);\n        font-size: var(--lumo-font-size-m);\n        font-weight: 400;\n        line-height: var(--lumo-line-height-m);\n        letter-spacing: 0;\n        text-transform: none;\n        -webkit-text-size-adjust: 100%;\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n      }\n\n      [part="content"] {\n        padding: var(--lumo-space-xs);\n      }\n\n      [part="backdrop"] {\n        background-color: var(--lumo-shade-20pct);\n        animation: 0.2s lumo-overlay-backdrop-enter both;\n        will-change: opacity;\n      }\n\n      @keyframes lumo-overlay-backdrop-enter {\n        0% {\n          opacity: 0;\n        }\n      }\n\n      :host([closing]) [part="backdrop"] {\n        animation: 0.2s lumo-overlay-backdrop-exit both;\n      }\n\n      @keyframes lumo-overlay-backdrop-exit {\n        100% {\n          opacity: 0;\n        }\n      }\n\n      @keyframes lumo-overlay-dummy-animation {\n        0% { opacity: 1; }\n        100% { opacity: 1; }\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild(P.content);const I=e`<dom-module id="lumo-dialog" theme-for="vaadin-dialog-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(I.content);const F=Element.prototype,B=F.matches||F.matchesSelector||F.mozMatchesSelector||F.msMatchesSelector||F.oMatchesSelector||F.webkitMatchesSelector,$={getTabbableNodes:function(e){const t=[];return this._collectTabbableNodes(e,t)?this._sortByTabIndex(t):t},isFocusable:function(e){return B.call(e,"input, select, textarea, button, object")?B.call(e,":not([disabled])"):B.call(e,"a[href], area[href], iframe, [tabindex], [contentEditable]")},isTabbable:function(e){return this.isFocusable(e)&&B.call(e,':not([tabindex="-1"])')&&this._isVisible(e)},_normalizedTabIndex:function(e){if(this.isFocusable(e)){const t=e.getAttribute("tabindex")||0;return Number(t)}return-1},_collectTabbableNodes:function(e,t){if(e.nodeType!==Node.ELEMENT_NODE||!this._isVisible(e))return!1;const i=e,o=this._normalizedTabIndex(i);let a,n=o>0;if(o>=0&&t.push(i),a="slot"===i.localName?i.assignedNodes({flatten:!0}):(i.shadowRoot||i).children,a)for(let e=0;e<a.length;e++)n=this._collectTabbableNodes(a[e],t)||n;return n},_isVisible:function(e){let t=e.style;return"hidden"!==t.visibility&&"none"!==t.display&&(t=window.getComputedStyle(e),"hidden"!==t.visibility&&"none"!==t.display)},_sortByTabIndex:function(e){const t=e.length;if(t<2)return e;const i=Math.ceil(t/2),o=this._sortByTabIndex(e.slice(0,i)),a=this._sortByTabIndex(e.slice(i));return this._mergeSortByTabIndex(o,a)},_mergeSortByTabIndex:function(e,t){const i=[];for(;e.length>0&&t.length>0;)this._hasLowerTabOrder(e[0],t[0])?i.push(t.shift()):i.push(e.shift());return i.concat(e,t)},_hasLowerTabOrder:function(e,t){const i=Math.max(e.tabIndex,0),o=Math.max(t.tabIndex,0);return 0===i||0===o?o>i:i>o}};
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
let D=0;const M={},U=e=>{D++;const t=`vaadin-overlay-content-${D}`,i=document.createElement("template"),o=document.createElement("style");o.textContent=":host { display: block; }"+e,i.content.appendChild(o),window.ShadyCSS&&window.ShadyCSS.prepareTemplate(i,t);const a=class extends HTMLElement{static get is(){return t}constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(document.importNode(i.content,!0)))}connectedCallback(){window.ShadyCSS&&window.ShadyCSS.styleElement(this)}};return customElements.define(a.is,a),M[e]=t,t};class G extends(T(n)){static get template(){return e`
    <style>
      :host {
        z-index: 200;
        position: fixed;
...
let W=class extends C{constructor(){super(),E(!0),this.active=!1,this.supports={},this.resourceLimits={},this.userResourceLimit={},this.aliases={TensorFlow:"python-tensorflow","Lablup ResearchEnv.":"python-ff",Python:"python",PyTorch:"python-pytorch",Chainer:"chainer",R:"r",Julia:"julia",Lua:"lua"},this.versions=["3.6"],this.languages=[],this.gpu_mode="no",this.gpu_step=.05,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.gpu_metric={min:"0",max:"0"},this.tpu_metric={min:"1",max:"1"},this.images={},this.defaultResourcePolicy="UNLIMITED",this.total_slot={},this.used_slot={},this.available_slot={},this.resource_info={},this.used_slot_percent={},this.resource_templates=[],this.vfolders=[],this.default_language="",this.launch_ready=!1,this.concurrency_used=0,this.concurrency_max=0,this._status="inactive"}static get is(){return"backend-ai-experiment-view"}static get properties(){return{active:{type:Boolean},supports:{type:Object},resourceLimits:{type:Object},userResourceLimit:{type:Object},aliases:{type:Object},versions:{type:Array},languages:{type:Array},gpu_mode:{type:String},gpu_step:{type:Number},cpu_metric:{type:Object},mem_metric:{type:Object},gpu_metric:{type:Object},tpu_metric:{type:Object},images:{type:Object},defaultResourcePolicy:{type:String},total_slot:{type:Object},used_slot:{type:Object},available_slot:{type:Object},concurrency_used:{type:Number},concurrency_max:{type:Number},vfolders:{type:Array},resource_info:{type:Object},used_slot_percent:{type:Object},resource_templates:{type:Array},default_language:{type:String},launch_ready:{type:Boolean},_status:{type:Boolean},notification:{type:Object}}}static get styles(){return[g,f,w,_,x,k`
      ...
      `]}firstUpdated(){this.notification=window.lablupNotification}_showTab(e){for(var t=this.shadowRoot.querySelectorAll(".tab-content"),i=0;i<t.length;i++)t[i].style.display="none";this.shadowRoot.querySelector("#"+e.value).style.display="block"}_hideDialog(e){e.target.closest("wl-dialog").hide()}render(){return b`
...
`}};W=c([v("backend-ai-experiment-view")],W);var J=W;export default J;
