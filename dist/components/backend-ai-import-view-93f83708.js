import{B as t,d as e,I as i,a as o,e as a,b as n,g as s,f as r,h as l,t as c,_ as d,p as h,c as p}from"./backend-ai-console-22d31a8d.js";import"./unsafe-html-06722fb8.js";import"./mwc-linear-progress-bf85309b.js";import"./lablup-activity-panel-7944657c.js";import"./mwc-slider-9da234df.js";import"./backend-ai-session-launcher-2d4db0b1.js";import"./radio-behavior-ddc0148e.js";import"./expansion-bdffdc99.js";import"./mwc-textarea-066f859e.js";import"./backend-ai-chart-fe5b5b7c.js";
/**
 @license
 ...
 */let u=class extends t{constructor(){super(),this.condition="running",this.authenticated=!1,this.spinner=Object(),this.indicator=Object(),this.notification=Object(),this.sessionLauncher=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importMessage=""}static get styles(){return[e,i,o,a,n`
      ...
      <lablup-activity-panel title="${c("import.ImportNotebook")}" elevation="1" horizontalsize="2x">
        <div slot="message">
          <div class="horizontal wrap layout center">
            <mwc-textfield outlined style="width:75%;" id="notebook-url" label="${c("import.NotebookURL")}"></mwc-textfield>
      ...
      <div class="horizontal wrap layout">
        <lablup-activity-panel title="${c("summary.ResourceStatistics")}" elevation="1" width="350" narrow>
          <div slot="message">
        ...
        <lablup-activity-panel title="${c("import.CreateNotebookButton")}" elevation="1">
          <div slot="message">
            <div class="vertical wrap layout center description">
              ...
              <mwc-textfield outlined id="notebook-badge-url" label="${c("import.NotebookBadgeURL")}"></mwc-textfield>
              <mwc-button style="width:100%;" @click="${()=>this.createNotebookBadge()}" icon="code">${c("import.CreateButtonCode")}</mwc-button>
              <mwc-textarea outlined id="notebook-badge-code" label="${c("import.NotebookBadgeCodeHTML")}">></mwc-textarea>
              <mwc-textarea outlined id="notebook-badge-code-markdown" label="${c("import.NotebookBadgeCodeMarkdown")}">></mwc-textarea>
            </div>
          </div>
        </lablup-activity-panel>
      </div>
      <div class="horizontal wrap layout">
        <lablup-activity-panel title="${c("import.ImportGithubRepo")}" elevation="1" horizontalsize="2x">
          <div slot="message">
            ...
            <div class="horizontal wrap layout center">
              <mwc-textfield outlined style="width:75%;" id="github-repo-url" label="${c("import.GitHubURL")}"></mwc-textfield>
