import{B as t,b as e,I as i,a as o,c as a,r,g as n,d as s,$ as c,t as l,_ as d,e as h,n as p}from"./backend-ai-webui-06490572.js";import"./mwc-textarea-7bcfd4ae.js";import"./lablup-activity-panel-744a4492.js";import"./backend-ai-chart-5ff2b35c.js";import"./backend-ai-session-launcher-4cc6ce88.js";import"./chart-js-fd79f6c7.js";import"./mwc-linear-progress-29164e31.js";import"./mwc-switch-def7ca75.js";import"./label-1b536839.js";import"./lablup-progress-bar-5880b482.js";import"./vaadin-grid-7fc2c91c.js";import"./vaadin-grid-filter-column-296b9719.js";import"./vaadin-grid-selection-column-6225c81e.js";import"./polymer-legacy-d664b031.js";import"./vaadin-item-styles-ed0971bb.js";import"./expansion-a9428379.js";import"./radio-behavior-79c6cf84.js";import"./lablup-codemirror-57b42e7b.js";import"./slider-559289f4.js";
/**
 @license
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */let u=class extends t{constructor(){super(),this.condition="running",this.authenticated=!1,this.spinner=Object(),this.indicator=Object(),this.notification=Object(),this.sessionLauncher=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importMessage=""}static get styles(){return[e,i,o,a,r`
        div.description {
          font-size: 14px;
      ...
      `]}firstUpdated(){this.spinner=this.shadowRoot.querySelector("#loading-spinner"),this.sessionLauncher=this.shadowRoot.querySelector("#session-launcher"),this.indicator=globalThis.lablupIndicator,this.notification=globalThis.lablupNotification}async _viewStateChanged(t){if(await this.updateComplete,!1===t)return void this.shadowRoot.querySelector("#resource-monitor").removeAttribute("active");this.shadowRoot.querySelector("#resource-monitor").setAttribute("active","true"),void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this.authenticated=!0,this.activeConnected&&this.requestUpdate()}),!0):(this.authenticated=!0,this.requestUpdate()),this.requestURL=globalThis.currentPageParams.requestURL;let e=globalThis.currentPageParams.queryString;if(e=e.substring(e.indexOf("?")+1),this.queryString=e,this.importMessage=this.queryString,this.environment=this.guessEnvironment(this.queryString),""!==e){let t="https://raw.githubusercontent.com/"+this.queryString;t=t.replace("/blob/","/"),this.fetchNotebookURLResource(t)}}getNotebookFromURL(){const t=this.shadowRoot.querySelector("#notebook-url").value;""!==t&&(this.queryString=this.regularizeGithubURL(t),this.fetchNotebookURLResource(this.queryString))}regularizeGithubURL(t){return t=(t=t.replace("/blob/","/")).replace("github.com","raw.githubusercontent.com")}fetchNotebookURLResource(t){this.shadowRoot.querySelector("#notebook-url").value=t,void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._fetchNotebookURLResource(t)}),!0):this._fetchNotebookURLResource(t)}_fetchNotebookURLResource(t){fetch(t).then((e=>{this.notification.text=n("import.ReadyToImport"),this.importMessage=this.notification.text,this.notification.show(),this.sessionLauncher.selectDefaultLanguage(!0,this.environment),this.sessionLauncher.importScript="#!/bin/sh\ncurl -O "+t,this.sessionLauncher.importFilename=t.split("/").pop(),this.sessionLauncher._launchSessionDialog()})).catch((t=>{this.notification.text=n("import.NoSuitableResourceFoundOnGivenURL"),this.importMessage=this.notification.text,this.notification.show()}))}getGitHubRepoFromURL(){let t=this.shadowRoot.querySelector("#github-repo-url").value,e="master",i="";if(".git"===t.substring(t.length-4,t.length)&&(t=t.split(".git")[0]),t.includes("/tree")){const o=(/\/tree\/[.a-zA-Z.0-9_-]+/.exec(t)||[""])[0],a=(/\/[.a-zA-Z0-9_-]+\/tree\//.exec(t)||[""])[0];t=t.replace(o,""),e=o.replace("/tree/",""),i=a.replace("/tree/","").substring(1),t=t.replace("https://github.com","https://codeload.github.com"),t=t+"/zip/"+e;const r=(/^https?(?=:\/\/)/.exec(t)||[""])[0];return["http","https"].includes(r)?this.importRepoFromURL(t,i):(this.notification.text=n("import.WrongURLType"),this.importMessage=this.notification.text,this.notification.show(),!1)}i=t.split("/").slice(-1)[0];var o="https://api.github.com/repos"+new URL(t).pathname;return(async()=>{try{const t=await fetch(o);if(200===t.status){return(await t.json()).default_branch}if(404===t.status)throw"WrongURLType";if(403===t.status||429===t.status){const e=t.headers.get("x-ratelimit-limit"),i=t.headers.get("x-ratelimit-used"),o=t.headers.get("x-ratelimit-remaining");throw console.log(`used count: ${i}, remaining count: ${o}/total count: ${e}\nerror body: ${t.text}`),"0"===o?"GithubAPILimitError|"+i+"|"+o:"GithubAPIEtcError"}throw 500===t.status?"GithubInternalError":(console.log(`error statusCode: ${t.status}, body: ${t.text}`),"GithubAPIEtcError")}catch(t){throw t}})().then((o=>{e=o,t=t.replace("https://github.com","https://codeload.github.com"),t=t+"/zip/"+e;const a=(/^https?(?=:\/\/)/.exec(t)||[""])[0];return["http","https"].includes(a)?this.importRepoFromURL(t,i):(this.notification.text=n("import.WrongURLType"),this.importMessage=this.notification.text,this.notification.show(),!1)})).catch((t=>{switch(t){case"WrongURLType":this.notification.text=n("import.WrongURLType");break;case"GithubInternalError":this.notification.text=n("import.GithubInternalError");break;default:-1!==t.indexOf("|")?this.notification.text=n("import.GithubAPILimitError"):this.notification.text=n("import.GithubAPIEtcError")}return this.importMessage=this.notification.text,this.notification.show(),!1}))}async importRepoFromURL(t,e){const i={cpu:1,mem:"0.5g"};i.domain=globalThis.backendaiclient._config.domainName,i.group_name=globalThis.backendaiclient.current_group;const o=await this.indicator.start("indeterminate");return o.set(10,n("import.Preparing")),e=await this._checkFolderNameAlreadyExists(e),await this._addFolderWithName(e),o.set(20,n("import.FolderCreated")),i.mounts=[e],i.bootstrap_script="#!/bin/sh\ncurl -o repo.zip "+t+"\ncd /home/work/"+e+"\nunzip -u /home/work/repo.zip",globalThis.backendaiclient.get_resource_slots().then((t=>(o.set(50,n("import.Downloading")),globalThis.backendaiclient.createIfNotExists(globalThis.backendaiclient._config.default_import_environment,null,i,6e4)))).then((async t=>{o.set(80,n("import.CleanUpImportTask")),await globalThis.backendaiclient.destroy(t.sessionId),o.set(100,n("import.ImportFinished")),o.end(1e3)})).catch((t=>{this.notification.text=s.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t),o.end(1e3)}))}async _addFolderWithName(t){const e=(await globalThis.backendaiclient.vfolder.list_hosts()).default;return t=await this._checkFolderNameAlreadyExists(t),globalThis.backendaiclient.vfolder.create(t,e,"","general","rw").then((e=>{this.importMessage=n("import.FolderName")+t})).catch((t=>{console.log(t),t&&t.message&&(this.notification.text=s.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}async _checkFolderNameAlreadyExists(t){const e=(await globalThis.backendaiclient.vfolder.list()).map((function(t){return t.name}));if(e.includes(t)){this.notification.text=n("import.FolderAlreadyExists"),this.importMessage=this.notification.text,this.notification.show();let i=1,o=t;for(;e.includes(o);)o=t+"_"+i,i++;t=o}return t}guessEnvironment(t){return t.includes("tensorflow")||t.includes("keras")||t.includes("Keras")?"index.docker.io/lablup/python-tensorflow":t.includes("pytorch")?"index.docker.io/lablup/python-pytorch":t.includes("mxnet")?"index.docker.io/lablup/python-mxnet":"index.docker.io/lablup/python-ff"}createNotebookBadge(){const t=this.shadowRoot.querySelector("#notebook-badge-url").value,e=this.regularizeGithubURL(t).replace("https://raw.githubusercontent.com/","");let i="";if(""===t)this.notification.text=n("import.NoNotebookCode"),this.notification.show(),this.shadowRoot.querySelector("#notebook-badge-code").value="",this.shadowRoot.querySelector("#notebook-badge-code-markdown").value="";else{globalThis.isElectron?i="https://cloud.backend.ai/github?":(i=window.location.protocol+"//"+window.location.hostname,window.location.port&&(i=i+":"+window.location.port),i+="/github?");const t=`<a href="${i+e}"><img src="https://www.backend.ai/assets/badge.svg" /></a>`,o=`[![Run on Backend.AI](https://www.backend.ai/assets/badge.svg)](${i+e})`;this.shadowRoot.querySelector("#notebook-badge-code").value=t,this.shadowRoot.querySelector("#notebook-badge-code-markdown").value=o}}_copyTextArea(t){let e="";if("value"in t.target&&(e=t.target.value),""!==e)if(0===e.length)this.notification.text=n("import.NoNotebookCode"),this.notification.show();else if(void 0!==navigator.clipboard)navigator.clipboard.writeText(e).then((()=>{this.notification.text=n("import.NotebookBadgeCodeCopied"),this.notification.show()}),(t=>{console.error(n("import.CouldNotCopyText"),t)}));else{const t=document.createElement("input");t.type="text",t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),this.notification.text=n("import.NotebookBadgeCodeCopied"),this.notification.show()}}render(){return c`
