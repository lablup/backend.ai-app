import{d as i,e as t,I as e,a as s,G as o,f as a,b as n,h as r,t as d,g as l,_ as c,p as v,c as p}from"./backend-ai-console-04ff2fbe.js";import"./unsafe-html-e0d203fe.js";import{t as u}from"./translate-unsafe-html-6ea0c9ee.js";import"./lablup-loading-spinner-bef8aa5b.js";let f=class extends i{constructor(){super(),this.notification=Object(),this.manager_version="",this.manager_version_latest="",this.console_version="",this.api_version="",this.docker_version="",this.pgsql_version="",this.redis_version="",this.etcd_version="",this.account_changed=!0,this.use_ssl=!0}static get styles(){return[t,e,s,o,a,n`
        div.indicator,
        span.indicator {
          font-size: 9px;
          margin-right: 5px;
    ...
    `}firstUpdated(){this.notification=globalThis.lablupNotification,void 0===globalThis.backendaiclient||null===globalThis.backendaiclient?document.addEventListener("backend-ai-connected",()=>{this.updateInformation()},!0):this.updateInformation()}async _viewStateChanged(i){await this.updateComplete}updateInformation(){this.manager_version=globalThis.backendaiclient.managerVersion,this.console_version=globalThis.packageVersion,this.api_version=globalThis.backendaiclient.apiVersion,this.docker_version=l("information.Compatible"),this.pgsql_version=l("information.Compatible"),this.redis_version=l("information.Compatible"),this.etcd_version=l("information.Compatible")}};c([v({type:Object})],f.prototype,"notification",void 0),c([v({type:String})],f.prototype,"manager_version",void 0),c([v({type:String})],f.prototype,"manager_version_latest",void 0),c([v({type:String})],f.prototype,"console_version",void 0),c([v({type:String})],f.prototype,"api_version",void 0),c([v({type:String})],f.prototype,"docker_version",void 0),c([v({type:String})],f.prototype,"pgsql_version",void 0),c([v({type:String})],f.prototype,"redis_version",void 0),c([v({type:String})],f.prototype,"etcd_version",void 0),c([v({type:Boolean})],f.prototype,"account_changed",void 0),c([v({type:Boolean})],f.prototype,"use_ssl",void 0),f=c([p("backend-ai-information-view")],f);var g=f;export default g;
