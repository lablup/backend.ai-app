import{_ as i,p as t,c as e,B as s,d as o,I as a,a as n,z as r,e as d,b as l,h as c,t as v,g as p}from"./backend-ai-console-cb2f630c.js";import"./unsafe-html-1bfa332b.js";import{t as u}from"./translate-unsafe-html-e3359f74.js";import"./lablup-loading-spinner-90acdc8e.js";let h=(()=>{let h=class extends s{constructor(){super(),this.notification=Object(),this.manager_version="",this.manager_version_latest="",this.console_version="",this.api_version="",this.docker_version="",this.pgsql_version="",this.redis_version="",this.etcd_version="",this.account_changed=!0,this.use_ssl=!0}static get styles(){return[o,a,n,r,d,l`
        div.indicator,
        span.indicator {
          font-size: 9px;
          margin-right: 5px;
      ...
      <wl-card elevation="1">
        ...
        <div>
          ...
          <div class="horizontal flex layout wrap setting-item">
            ...
            <div class="vertical center-justified layout">
            ${this.use_ssl?c`<wl-icon>done</wl-icon>`:c`<wl-icon class="fg red">warning</wl-icon>`}
            </div>
          </div>
        </div>
      </wl-card>
    `}firstUpdated(){this.notification=globalThis.lablupNotification,void 0===globalThis.backendaiclient||null===globalThis.backendaiclient?document.addEventListener("backend-ai-connected",()=>{this.updateInformation()},!0):this.updateInformation()}async _viewStateChanged(i){await this.updateComplete}updateInformation(){this.manager_version=globalThis.backendaiclient.managerVersion,this.console_version=globalThis.packageVersion,this.api_version=globalThis.backendaiclient.apiVersion,this.docker_version=p("information.Compatible"),this.pgsql_version=p("information.Compatible"),this.redis_version=p("information.Compatible"),this.etcd_version=p("information.Compatible"),globalThis.backendaiclient._config.endpoint.startsWith("https:")?this.use_ssl=!0:this.use_ssl=!1}};return i([t({type:Object})],h.prototype,"notification",void 0),i([t({type:String})],h.prototype,"manager_version",void 0),i([t({type:String})],h.prototype,"manager_version_latest",void 0),i([t({type:String})],h.prototype,"console_version",void 0),i([t({type:String})],h.prototype,"api_version",void 0),i([t({type:String})],h.prototype,"docker_version",void 0),i([t({type:String})],h.prototype,"pgsql_version",void 0),i([t({type:String})],h.prototype,"redis_version",void 0),i([t({type:String})],h.prototype,"etcd_version",void 0),i([t({type:Boolean})],h.prototype,"account_changed",void 0),i([t({type:Boolean})],h.prototype,"use_ssl",void 0),h=i([e("backend-ai-information-view")],h),h})();export default h;
