import{_ as e,p as t,c as a,d as i,e as n,I as s,a as c,A as l,f as o,b as d,h as r,t as u,g,i as h}from"./backend-ai-console-258bce16.js";import"./unsafe-html-ed81f2e2.js";import{t as m}from"./translate-unsafe-html-1391f1ba.js";
/**
 @license
 ...
 */let p=(()=>{let p=class extends i{constructor(){super(),this.images=Object(),this.scanning=!1,this.recalculating=!1,this.notification=Object(),this.indicator=Object()}static get styles(){return[n,s,c,l,o,d`
    ...
    `}firstUpdated(){this.notification=globalThis.lablupNotification,this.indicator=globalThis.lablupIndicator,void 0!==globalThis.backendaiclient&&null!==globalThis.backendaiclient||document.addEventListener("backend-ai-connected",()=>{},!0)}async _viewStateChanged(e){await this.updateComplete}async rescan_images(){this.shadowRoot.querySelector("#rescan-image-button-desc").textContent=g("maintenance.RescanImageScanning"),this.scanning=!0;let e=await this.indicator.start("indeterminate");e.set(10,"Scanning..."),globalThis.tasker.add(globalThis.backendaiclient.maintenance.rescan_images().then(t=>{this.shadowRoot.querySelector("#rescan-image-button-desc").textContent=g("maintenance.RescanImages"),this.scanning=!1,e.set(100,"Rescan image finished.")}).catch(t=>{this.scanning=!1,this.shadowRoot.querySelector("#rescan-image-button-desc").textContent=g("maintenance.RescanImages"),console.log(t),e.set(50,"Rescan failed."),e.end(1e3),t&&t.message&&(this.notification.text=h.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}async recalculate_usage(){this.shadowRoot.querySelector("#recalculate_usage-button-desc").textContent=g("maintenance.Recalculating"),this.recalculating=!0;let e=await this.indicator.start("indeterminate");e.set(10,"Recalculating..."),this.tasker.add(globalThis.backendaiclient.maintenance.recalculate_usage().then(t=>{this.shadowRoot.querySelector("#recalculate_usage-button-desc").textContent=g("maintenance.RecalculateUsage"),this.recalculating=!1,e.set(100,"Recalculation finished.")}).catch(t=>{this.recalculating=!1,this.shadowRoot.querySelector("#recalculate_usage-button-desc").textContent=g("maintenance.RecalculateUsage"),console.log(t),e.set(50,"Recalculation failed."),e.end(1e3),t&&t.message&&(this.notification.text=h.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}};return e([t({type:Object})],p.prototype,"images",void 0),e([t({type:Boolean})],p.prototype,"scanning",void 0),e([t({type:Boolean})],p.prototype,"recalculating",void 0),e([t({type:Object})],p.prototype,"notification",void 0),e([t({type:Object})],p.prototype,"indicator",void 0),p=e([a("backend-ai-maintenance-view")],p),p})();export default p;
