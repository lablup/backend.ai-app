import{d as e,e as t,I as a,a as i,A as n,f as s,b as c,h as l,t as o,g as d,i as r,_ as u,p as g,c as h}from"./backend-ai-console-a8524ce7.js";import"./unsafe-html-efc67998.js";import{t as m}from"./translate-unsafe-html-89d05d93.js";
/**
 @license
 ...
 */let p=class extends e{constructor(){super(),this.images=Object(),this.scanning=!1,this.recalculating=!1,this.notification=Object(),this.indicator=Object()}static get styles(){return[t,a,i,n,s,c`
    ...
    `}firstUpdated(){this.notification=globalThis.lablupNotification,this.indicator=globalThis.lablupIndicator,void 0!==globalThis.backendaiclient&&null!==globalThis.backendaiclient||document.addEventListener("backend-ai-connected",()=>{},!0)}async _viewStateChanged(e){await this.updateComplete}async rescan_images(){this.shadowRoot.querySelector("#rescan-image-button-desc").textContent=d("maintenance.RescanImageScanning"),this.scanning=!0;let e=await this.indicator.start("indeterminate");e.set(10,"Scanning..."),globalThis.tasker.add(globalThis.backendaiclient.maintenance.rescan_images().then(t=>{this.shadowRoot.querySelector("#rescan-image-button-desc").textContent=d("maintenance.RescanImages"),this.scanning=!1,e.set(100,"Rescan image finished.")}).catch(t=>{this.scanning=!1,this.shadowRoot.querySelector("#rescan-image-button-desc").textContent=d("maintenance.RescanImages"),console.log(t),e.set(50,"Rescan failed."),e.end(1e3),t&&t.message&&(this.notification.text=r.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}async recalculate_usage(){this.shadowRoot.querySelector("#recalculate_usage-button-desc").textContent=d("maintenance.Recalculating"),this.recalculating=!0;let e=await this.indicator.start("indeterminate");e.set(10,"Recalculating..."),this.tasker.add(globalThis.backendaiclient.maintenance.recalculate_usage().then(t=>{this.shadowRoot.querySelector("#recalculate_usage-button-desc").textContent=d("maintenance.RecalculateUsage"),this.recalculating=!1,e.set(100,"Recalculation finished.")}).catch(t=>{this.recalculating=!1,this.shadowRoot.querySelector("#recalculate_usage-button-desc").textContent=d("maintenance.RecalculateUsage"),console.log(t),e.set(50,"Recalculation failed."),e.end(1e3),t&&t.message&&(this.notification.text=r.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}};u([g({type:Object})],p.prototype,"images",void 0),u([g({type:Boolean})],p.prototype,"scanning",void 0),u([g({type:Boolean})],p.prototype,"recalculating",void 0),u([g({type:Object})],p.prototype,"notification",void 0),u([g({type:Object})],p.prototype,"indicator",void 0),p=u([h("backend-ai-maintenance-view")],p);var v=p;export default v;
