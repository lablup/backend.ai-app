import{a3 as e,_ as t,a4 as i,a5 as a,a6 as s,a7 as o,c as r,e as l,K as d,a as n,s as c,d as h,I as m,a8 as p,b as u,x as v,f as g,i as b,y}from"./backend-ai-webui-fab7ac12.js";import{T as f,a as x}from"./textfield-93d9a450.js";import"./mwc-check-list-item-d257be7e.js";let w=class extends x{connectedCallback(){super.connectedCallback(),this.setAttribute("aria-multiline","true")}firstUpdated(e){super.firstUpdated(e),this.refreshHeight()}onInput(e){super.onInput(e),this.refreshHeight()}refreshHeight(){a(this)||requestAnimationFrame((()=>{this.setHeight(1);const e=this.$formElement.scrollHeight;this.setHeight(e)}))}setHeight(e){this.$formElement.style.setProperty("--_textarea-height",""+(null==e?"":`${e}px`))}renderFormElement(){return s` <textarea id="${this.formElementId}" .value="${this.value}" ?required="${this.required}" ?disabled="${this.disabled}" ?readonly="${this.readonly}" aria-label="${o(this.label)}" name="${o(this.name)}" pattern="${o(this.pattern)}" autocomplete="${o(this.autocomplete)}" minlength="${o(this.minLength)}" maxlength="${o(this.maxLength)}" rows="1" tabindex="${this.disabled?-1:0}">
