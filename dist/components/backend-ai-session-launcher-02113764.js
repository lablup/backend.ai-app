import{_ as e,e as t,l as i,n as s,s as o,b as r,I as a,a as n,x as l,c,r as d,$ as h,B as u,g as p,d as m,t as _,y as g,o as v}from"./backend-ai-webui-29a04808.js";import"./mwc-linear-progress-6cadac4a.js";import"./mwc-switch-e596012f.js";import"./label-f49b9d87.js";import"./lablup-progress-bar-bafce280.js";import"./mwc-check-list-item-4cc3468a.js";import"./slider-c0b339c3.js";import{r as b,T as y,D as f,C as w,P as x,h as k,F as S,i as D,a as C,A as $,b as I,c as T,E as P,d as E,e as O,f as R,t as A,s as M,g as q,I as z,K as j,j as L,L as B,V,k as N,p as F,l as U,m as G}from"./vaadin-grid-324151db.js";import{i as W,I as H,a as Y,P as K,r as X,h as Q,F as J}from"./vaadin-grid-filter-column-6c0e4354.js";import"./vaadin-grid-selection-column-ef5940fe.js";import{t as Z,D as ee}from"./dom-repeat-c48bf759.js";import{i as te}from"./vaadin-item-styles-461be75c.js";import"./expansion-a141e6f0.js";import"./lablup-codemirror-83e8eb38.js";
/**
 @license
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */let ie=class extends o{constructor(){super(),this.editable=!1,this.pin=!1,this.markers=!1,this.marker_limit=30,this.disabled=!1;new IntersectionObserver(((e,t)=>{e.forEach((e=>{e.intersectionRatio>0&&(this.value!==this.slider.value&&(this.slider.value=this.value),this.slider.layout())}))}),{}).observe(this)}static get styles(){return[r,a,n,l,c,d`
        mwc-textfield {
    ...
    `}firstUpdated(){this.editable&&(this.textfield.style.display="flex"),this.checkMarkerDisplay()}update(e){Array.from(e.keys()).some((e=>["value","min","max"].includes(e)))&&this.min==this.max&&(this.max=this.max+1,this.value=this.min,this.disabled=!0),super.update(e)}updated(e){e.forEach(((e,t)=>{["min","max","step"].includes(t)&&this.checkMarkerDisplay()}))}syncToText(){this.value=this.slider.value}syncToSlider(){this.textfield.step=this.step;const e=Math.round(this.textfield.value/this.step)*this.step;var t;this.textfield.value=e.toFixed((t=this.step,Math.floor(t)===t?0:t.toString().split(".")[1].length||0)),this.textfield.value>this.max&&(this.textfield.value=this.max),this.textfield.value<this.min&&(this.textfield.value=this.min),this.value=this.textfield.value;const i=new CustomEvent("change",{detail:{}});this.dispatchEvent(i)}checkMarkerDisplay(){this.markers&&(this.max-this.min)/this.step>this.marker_limit&&this.slider.removeAttribute("markers")}};e([t({type:Number})],ie.prototype,"step",void 0),e([t({type:Number})],ie.prototype,"value",void 0),e([t({type:Number})],ie.prototype,"max",void 0),e([t({type:Number})],ie.prototype,"min",void 0),e([t({type:String})],ie.prototype,"prefix",void 0),e([t({type:String})],ie.prototype,"suffix",void 0),e([t({type:Boolean})],ie.prototype,"editable",void 0),e([t({type:Boolean})],ie.prototype,"pin",void 0),e([t({type:Boolean})],ie.prototype,"markers",void 0),e([t({type:Number})],ie.prototype,"marker_limit",void 0),e([t({type:Boolean})],ie.prototype,"disabled",void 0),e([i("#slider",!0)],ie.prototype,"slider",void 0),e([i("#textfield",!0)],ie.prototype,"textfield",void 0),ie=e([s("lablup-slider")],ie);let se=class extends u{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[r,a,n,l,c,d`
      ...
      `:h``}
`}};e([t({type:Boolean})],se.prototype,"is_connected",void 0),e([t({type:String})],se.prototype,"direction",void 0),e([t({type:String})],se.prototype,"location",void 0),e([t({type:Object})],se.prototype,"aliases",void 0),e([t({type:Object})],se.prototype,"total_slot",void 0),e([t({type:Object})],se.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],se.prototype,"total_project_slot",void 0),e([t({type:Object})],se.prototype,"used_slot",void 0),e([t({type:Object})],se.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],se.prototype,"used_project_slot",void 0),e([t({type:Object})],se.prototype,"available_slot",void 0),e([t({type:Number})],se.prototype,"concurrency_used",void 0),e([t({type:Number})],se.prototype,"concurrency_max",void 0),e([t({type:Number})],se.prototype,"concurrency_limit",void 0),e([t({type:Object})],se.prototype,"used_slot_percent",void 0),e([t({type:Object})],se.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],se.prototype,"used_project_slot_percent",void 0),e([t({type:String})],se.prototype,"default_language",void 0),e([t({type:Boolean})],se.prototype,"_status",void 0),e([t({type:Number})],se.prototype,"num_sessions",void 0),e([t({type:String})],se.prototype,"scaling_group",void 0),e([t({type:Array})],se.prototype,"scaling_groups",void 0),e([t({type:Array})],se.prototype,"sessions_list",void 0),e([t({type:Boolean})],se.prototype,"metric_updating",void 0),e([t({type:Boolean})],se.prototype,"metadata_updating",void 0),e([t({type:Boolean})],se.prototype,"aggregate_updating",void 0),e([t({type:Object})],se.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],se.prototype,"resourceGauge",void 0),e([t({type:Boolean})],se.prototype,"project_resource_monitor",void 0),e([t({type:Object})],se.prototype,"resourceBroker",void 0),se=e([s("backend-ai-resource-monitor")],se);
/**
 * @license
...
`;b("",ue,{moduleId:"lumo-menu-overlay-core"});const pe=[oe,ue,d`
...
`];b("",pe,{moduleId:"lumo-menu-overlay"});b("vaadin-date-picker-overlay",[pe,d`
  [part='overlay'] {
    /*
  Width:
      date cell widths
...
`],{moduleId:"lumo-date-picker-overlay"});b("vaadin-button",d`
  :host {
    /* Sizing */
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const me=e=>class extends($(I(T(e)))){static get properties(){return{tabindex:{value:0}}}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button")}_onKeyDown(e){super._onKeyDown(e),this._activeKeys.includes(e.key)&&(e.preventDefault(),this.click())}}
/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;class _e extends(me(P(y(x)))){static get is(){return"vaadin-button"}static get template(){return k`
      <style>
        :host {
          display: inline-block;
          position: relative;
    ...
    `}}customElements.define(_e.is,_e),b("vaadin-date-picker-overlay-content",d`
    :host {
      position: relative;
      background-color: transparent;
  ...
  `,{moduleId:"lumo-date-picker-overlay-content"}),b("vaadin-month-calendar",d`
    :host {
      -moz-user-select: none;
      -webkit-user-select: none;
      -webkit-tap-highlight-color: transparent;
  ...
  `,{moduleId:"lumo-month-calendar"});const ge=document.createElement("template");ge.innerHTML="\n  <style>\n    @keyframes vaadin-date-picker-month-calendar-focus-date {\n      50% {\n        box-shadow: 0 0 0 2px transparent;\n      }\n    }\n  </style>\n",document.head.appendChild(ge.content);b("vaadin-date-picker",[W,d`
  :host {
    outline: none;
  }
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
b("vaadin-date-picker-overlay",d`
  [part='overlay'] {
    display: flex;
    flex: auto;
  }
...
`,{moduleId:"vaadin-date-picker-overlay-styles"});class xe extends(ee(ye(he))){static get is(){return"vaadin-date-picker-overlay"}static get template(){return we||(we=super.template.cloneNode(!0),we.content.querySelector('[part~="overlay"]').removeAttribute("tabindex")),we}}function ke(e,t){return e instanceof Date&&t instanceof Date&&e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function Se(e,t,i){return(!t||e>=t)&&(!i||e<=i)}function De(e,t){return t.filter((e=>void 0!==e)).reduce(((t,i)=>{if(!i)return t;if(!t)return i;return Math.abs(e.getTime()-i.getTime())<Math.abs(t.getTime()-e.getTime())?i:t}))}function Ce(e){return{day:e.getDate(),month:e.getMonth(),year:e.getFullYear()}}
/**
 * @license
 * Copyright (c) 2016 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */customElements.define(xe.is,xe);class $e extends(T(y(x))){static get template(){return k`
      <style>
        :host {
          display: block;
        }
...
`],{moduleId:"lumo-combo-box-overlay"});b("vaadin-combo-box-item",[te,d`
  :host {
...
`],{moduleId:"lumo-combo-box-item"});b("vaadin-time-picker",[W,d`
  [part~='toggle-button']::before {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class Ae extends(y(f(x))){static get template(){return k`
      <style>
        :host {
          display: block;
        }
 ...
 */;class Ge extends(Ue(y(x))){static get is(){return"vaadin-time-picker-combo-box"}static get template(){return k`
      ...
      <vaadin-time-picker-dropdown
        ...
        theme="[[_theme]]"
      ></vaadin-time-picker-dropdown>
    `}static get properties(){return{positionTarget:{type:Object}}}get clearElement(){return this.querySelector('[part="clear-button"]')}_getItemElements(){return Array.from(this.$.dropdown._scroller.querySelectorAll("vaadin-time-picker-item"))}ready(){super.ready(),this.allowCustomValue=!0,this._toggleElement=this.querySelector(".toggle-button"),this.setAttribute("dir","ltr")}}customElements.define(Ge.is,Ge),
/**
 * @license
 * Copyright (c) 2018 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
b("vaadin-time-picker",Y,{moduleId:"vaadin-time-picker-styles"});class We extends(K(H(y(P(x))))){static get is(){return"vaadin-time-picker"}static get template(){return k`
      <style>
...
`;b("vaadin-custom-field",[X,Q,He],{moduleId:"lumo-custom-field"}),b("vaadin-date-time-picker",[X,Q,He],{moduleId:"lumo-date-time-picker"}),b("vaadin-date-time-picker-date-picker",d`
    :host {
      margin-right: 2px;
    }
  ...
  `,{moduleId:"lumo-date-time-picker-date-picker"}),b("vaadin-date-time-picker-time-picker",d`
    [part~='input-field'] {
      border-top-left-radius: 0;
      border-bottom-left-radius: 0;
    }
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class Ye extends Re{static get is(){return"vaadin-date-time-picker-date-picker"}}customElements.define(Ye.is,Ye);
/**
 * @license
 * Copyright (c) 2019 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class Ke extends We{static get is(){return"vaadin-date-time-picker-time-picker"}}customElements.define(Ke.is,Ke);
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const Xe=G((e=>class extends e{get slots(){return{}}ready(){super.ready(),this._connectSlotMixin()}_connectSlotMixin(){Object.keys(this.slots).forEach((e=>{if(!(void 0!==this._getDirectSlotChild(e))){const t=(0,this.slots[e])();t instanceof Element&&(""!==e&&t.setAttribute("slot",e),this.appendChild(t))}}))}_getDirectSlotChild(e){return Array.from(this.childNodes).find((t=>t.nodeType===Node.ELEMENT_NODE&&t.slot===e||t.nodeType===Node.TEXT_NODE&&t.textContent.trim()&&""===e))}}));
/**
 * @license
 * Copyright (c) 2019 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function Qe(e,t){for(;e;){if(e.properties&&e.properties[t])return e.properties[t];e=Object.getPrototypeOf(e)}}b("vaadin-date-time-picker",Y,{moduleId:"vaadin-date-time-picker"});const Je=customElements.get("vaadin-date-time-picker-date-picker"),Ze=customElements.get("vaadin-date-time-picker-time-picker"),et=Qe(Je,"i18n").value(),tt=Qe(Ze,"i18n").value(),it=Object.keys(et),st=Object.keys(tt);class ot extends(J(Xe(N(T(y(P(x))))))){static get template(){return k`
      <style>
    ...
    `}};e([i("#image-name")],rt.prototype,"manualImageName",void 0),e([t({type:Boolean})],rt.prototype,"is_connected",void 0),e([t({type:Boolean})],rt.prototype,"enableLaunchButton",void 0),e([t({type:Boolean})],rt.prototype,"hideLaunchButton",void 0),e([t({type:String})],rt.prototype,"location",void 0),e([t({type:String})],rt.prototype,"mode",void 0),e([t({type:String})],rt.prototype,"newSessionDialogTitle",void 0),e([t({type:String})],rt.prototype,"importScript",void 0),e([t({type:String})],rt.prototype,"importFilename",void 0),e([t({type:Object})],rt.prototype,"imageRequirements",void 0),e([t({type:Object})],rt.prototype,"resourceLimits",void 0),e([t({type:Object})],rt.prototype,"userResourceLimit",void 0),e([t({type:Object})],rt.prototype,"aliases",void 0),e([t({type:Object})],rt.prototype,"tags",void 0),e([t({type:Object})],rt.prototype,"icons",void 0),e([t({type:Object})],rt.prototype,"imageInfo",void 0),e([t({type:String})],rt.prototype,"kernel",void 0),e([t({type:Array})],rt.prototype,"versions",void 0),e([t({type:Array})],rt.prototype,"languages",void 0),e([t({type:Number})],rt.prototype,"marker_limit",void 0),e([t({type:String})],rt.prototype,"gpu_mode",void 0),e([t({type:Array})],rt.prototype,"gpu_modes",void 0),e([t({type:Number})],rt.prototype,"gpu_step",void 0),e([t({type:Object})],rt.prototype,"cpu_metric",void 0),e([t({type:Object})],rt.prototype,"mem_metric",void 0),e([t({type:Object})],rt.prototype,"shmem_metric",void 0),e([t({type:Object})],rt.prototype,"cuda_device_metric",void 0),e([t({type:Object})],rt.prototype,"cuda_shares_metric",void 0),e([t({type:Object})],rt.prototype,"rocm_device_metric",void 0),e([t({type:Object})],rt.prototype,"tpu_device_metric",void 0),e([t({type:Object})],rt.prototype,"cluster_metric",void 0),e([t({type:Array})],rt.prototype,"cluster_mode_list",void 0),e([t({type:Boolean})],rt.prototype,"cluster_support",void 0),e([t({type:Object})],rt.prototype,"images",void 0),e([t({type:Object})],rt.prototype,"total_slot",void 0),e([t({type:Object})],rt.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],rt.prototype,"total_project_slot",void 0),e([t({type:Object})],rt.prototype,"used_slot",void 0),e([t({type:Object})],rt.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],rt.prototype,"used_project_slot",void 0),e([t({type:Object})],rt.prototype,"available_slot",void 0),e([t({type:Number})],rt.prototype,"concurrency_used",void 0),e([t({type:Number})],rt.prototype,"concurrency_max",void 0),e([t({type:Number})],rt.prototype,"concurrency_limit",void 0),e([t({type:Number})],rt.prototype,"max_containers_per_session",void 0),e([t({type:Array})],rt.prototype,"vfolders",void 0),e([t({type:Array})],rt.prototype,"selectedVfolders",void 0),e([t({type:Array})],rt.prototype,"autoMountedVfolders",void 0),e([t({type:Array})],rt.prototype,"nonAutoMountedVfolders",void 0),e([t({type:Object})],rt.prototype,"folderMapping",void 0),e([t({type:Object})],rt.prototype,"used_slot_percent",void 0),e([t({type:Object})],rt.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],rt.prototype,"used_project_slot_percent",void 0),e([t({type:Array})],rt.prototype,"resource_templates",void 0),e([t({type:Array})],rt.prototype,"resource_templates_filtered",void 0),e([t({type:String})],rt.prototype,"default_language",void 0),e([t({type:Number})],rt.prototype,"cpu_request",void 0),e([t({type:Number})],rt.prototype,"mem_request",void 0),e([t({type:Number})],rt.prototype,"shmem_request",void 0),e([t({type:Number})],rt.prototype,"gpu_request",void 0),e([t({type:String})],rt.prototype,"gpu_request_type",void 0),e([t({type:Number})],rt.prototype,"session_request",void 0),e([t({type:Boolean})],rt.prototype,"_status",void 0),e([t({type:Number})],rt.prototype,"num_sessions",void 0),e([t({type:String})],rt.prototype,"scaling_group",void 0),e([t({type:Array})],rt.prototype,"scaling_groups",void 0),e([t({type:Array})],rt.prototype,"sessions_list",void 0),e([t({type:Boolean})],rt.prototype,"metric_updating",void 0),e([t({type:Boolean})],rt.prototype,"metadata_updating",void 0),e([t({type:Boolean})],rt.prototype,"aggregate_updating",void 0),e([t({type:Object})],rt.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],rt.prototype,"resourceGauge",void 0),e([t({type:String})],rt.prototype,"sessionType",void 0),e([t({type:Boolean})],rt.prototype,"ownerFeatureInitialized",void 0),e([t({type:String})],rt.prototype,"ownerDomain",void 0),e([t({type:Array})],rt.prototype,"ownerKeypairs",void 0),e([t({type:Array})],rt.prototype,"ownerGroups",void 0),e([t({type:Array})],rt.prototype,"ownerScalingGroups",void 0),e([t({type:Boolean})],rt.prototype,"project_resource_monitor",void 0),e([t({type:Object})],rt.prototype,"version_selector",void 0),e([t({type:Boolean})],rt.prototype,"_default_language_updated",void 0),e([t({type:Boolean})],rt.prototype,"_default_version_updated",void 0),e([t({type:String})],rt.prototype,"_helpDescription",void 0),e([t({type:String})],rt.prototype,"_helpDescriptionTitle",void 0),e([t({type:String})],rt.prototype,"_helpDescriptionIcon",void 0),e([t({type:Number})],rt.prototype,"max_cpu_core_per_session",void 0),e([t({type:Number})],rt.prototype,"max_mem_per_container",void 0),e([t({type:Number})],rt.prototype,"max_cuda_device_per_container",void 0),e([t({type:Number})],rt.prototype,"max_cuda_shares_per_container",void 0),e([t({type:Number})],rt.prototype,"max_shm_per_container",void 0),e([t({type:Boolean})],rt.prototype,"allow_manual_image_name_for_session",void 0),e([t({type:Object})],rt.prototype,"resourceBroker",void 0),e([t({type:Number})],rt.prototype,"cluster_size",void 0),e([t({type:String})],rt.prototype,"cluster_mode",void 0),e([t({type:Object})],rt.prototype,"deleteEnvInfo",void 0),e([t({type:Object})],rt.prototype,"deleteEnvRow",void 0),e([t({type:Array})],rt.prototype,"environ",void 0),e([t({type:Object})],rt.prototype,"environ_values",void 0),e([t({type:Object})],rt.prototype,"vfolder_select_expansion",void 0),e([t({type:Number})],rt.prototype,"currentIndex",void 0),e([t({type:Number})],rt.prototype,"progressLength",void 0),e([t({type:Object})],rt.prototype,"_grid",void 0),e([t({type:Boolean})],rt.prototype,"_debug",void 0),e([t({type:Object})],rt.prototype,"_boundFolderToMountListRenderer",void 0),e([t({type:Object})],rt.prototype,"_boundFolderMapRenderer",void 0),e([t({type:Object})],rt.prototype,"_boundPathRenderer",void 0),e([t({type:Boolean})],rt.prototype,"useScheduledTime",void 0),e([t({type:Object})],rt.prototype,"schedulerTimer",void 0),e([t({type:Object})],rt.prototype,"sessionInfoObj",void 0),rt=e([s("backend-ai-session-launcher")],rt);
