import{_ as e,p as t,q as s,c as i,L as o,d as r,I as a,a as c,n,e as l,b as d,h as u,B as p,g as h,f as m,t as _,o as g,u as v,v as y,l as b,w as f,x as w,y as x}from"./backend-ai-webui-db9b3c72.js";import"./mwc-linear-progress-44aef550.js";import"./mwc-switch-e6fb85eb.js";import"./label-cd946b9b.js";import"./lablup-progress-bar-1dd2084d.js";import{u as k}from"./unsafe-html-4ea1b048.js";import"./expansion-a598630c.js";import"./mwc-slider-7fa0bf58.js";import"./textfield-6a78f688.js";
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */let $=class extends o{constructor(){super(...arguments),this.editable=null,this.pin=null,this.markers=null,this.marker_limit=30,this.disabled=null}static get styles(){return[r,a,c,n,l,d`
        .mdc-text-field {
          height: 25px;
        }
    ...
    `}firstUpdated(){this.editable&&(this.textfield=this.shadowRoot.querySelector("#textfield"),this.textfield.style.display="flex"),this.updateStep(),this.checkMarkerDisplay()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}update(e){this.min=this.min>this.max?this.max:this.min,super.update(e)}updated(e){e.forEach(((e,t)=>{if("value"===t){setTimeout((()=>{this.editable&&this.syncToSlider(),this.slider.layout()}),500);const e=new CustomEvent("value-changed",{detail:{}});this.dispatchEvent(e)}["min","max","step"].includes(t)&&this.checkMarkerDisplay()}));const t=new CustomEvent("changed",{detail:""});this.dispatchEvent(t)}syncToText(){this.value=this.slider.value}syncToSlider(){this.textfield.step=this.step;const e=Math.round(this.textfield.value/this.step)*this.step;var t;this.textfield.value=e.toFixed((t=this.step,Math.floor(t)===t?0:t.toString().split(".")[1].length||0)),this.textfield.value>this.max&&(this.textfield.value=this.max),this.textfield.value<this.min&&(this.textfield.value=this.min),this.value=this.textfield.value,this.slider.value=this.textfield.value,this.slider.step=this.step}checkMarkerDisplay(){this.markers&&(this.max-this.min)/this.step>this.marker_limit&&this.slider.removeAttribute("markers"),this.updateStep()}updateStep(){const e=this.shadowRoot.querySelectorAll("wl-textfield");setTimeout((()=>{e.forEach((e=>{const t=e.getAttribute("step");e.$formElement.step=t}))}),100),this.step||(this.step=1),this.slider.setAttribute("step",this.step),this.slider.step=this.step}};e([t({type:Number})],$.prototype,"step",void 0),e([t({type:Number})],$.prototype,"value",void 0),e([t({type:Number})],$.prototype,"max",void 0),e([t({type:Number})],$.prototype,"min",void 0),e([t({type:Boolean})],$.prototype,"editable",void 0),e([t({type:Boolean})],$.prototype,"pin",void 0),e([t({type:Boolean})],$.prototype,"markers",void 0),e([t({type:Number})],$.prototype,"marker_limit",void 0),e([t({type:Boolean})],$.prototype,"disabled",void 0),e([t({type:Object})],$.prototype,"textfield",void 0),e([s("#slider",!0)],$.prototype,"slider",void 0),$=e([i("lablup-slider")],$);let S=class extends p{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[r,a,c,n,l,d`
      ...
      `:u``}
`}};e([t({type:Boolean})],S.prototype,"is_connected",void 0),e([t({type:String})],S.prototype,"direction",void 0),e([t({type:String})],S.prototype,"location",void 0),e([t({type:Object})],S.prototype,"aliases",void 0),e([t({type:Object})],S.prototype,"total_slot",void 0),e([t({type:Object})],S.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],S.prototype,"total_project_slot",void 0),e([t({type:Object})],S.prototype,"used_slot",void 0),e([t({type:Object})],S.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],S.prototype,"used_project_slot",void 0),e([t({type:Object})],S.prototype,"available_slot",void 0),e([t({type:Number})],S.prototype,"concurrency_used",void 0),e([t({type:Number})],S.prototype,"concurrency_max",void 0),e([t({type:Number})],S.prototype,"concurrency_limit",void 0),e([t({type:Object})],S.prototype,"used_slot_percent",void 0),e([t({type:Object})],S.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],S.prototype,"used_project_slot_percent",void 0),e([t({type:String})],S.prototype,"default_language",void 0),e([t({type:Boolean})],S.prototype,"_status",void 0),e([t({type:Number})],S.prototype,"num_sessions",void 0),e([t({type:String})],S.prototype,"scaling_group",void 0),e([t({type:Array})],S.prototype,"scaling_groups",void 0),e([t({type:Array})],S.prototype,"sessions_list",void 0),e([t({type:Boolean})],S.prototype,"metric_updating",void 0),e([t({type:Boolean})],S.prototype,"metadata_updating",void 0),e([t({type:Boolean})],S.prototype,"aggregate_updating",void 0),e([t({type:Object})],S.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],S.prototype,"resourceGauge",void 0),e([t({type:Boolean})],S.prototype,"project_resource_monitor",void 0),e([t({type:Object})],S.prototype,"resourceBroker",void 0),S=e([i("backend-ai-resource-monitor")],S);
/**
 @license
 ...
 */
class R extends y{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-deprecated-list-item__graphic":this.left,"mdc-deprecated-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():u``,i=this.hasMeta&&this.left?this.renderMeta():u``,o=this.renderRipple();return u`
      ${o}
      ${s}
      ${this.left?"":t}
      <span class=${b(e)}>
      ...
      ${this.left?t:""}
      ${i}`}async onChange(e){const t=e.target;this.selected===t.checked||(this._skipPropRequest=!0,this.selected=t.checked,await this.updateComplete,this._skipPropRequest=!1)}}e([g("slot")],R.prototype,"slotElement",void 0),e([g("mwc-checkbox")],R.prototype,"checkboxElement",void 0),e([v({type:Boolean})],R.prototype,"left",void 0),e([v({type:String,reflect:!0})],R.prototype,"graphic",void 0);
/**
@license
...
limitations under the License.
*/
const q=f`:host(:not([twoline])){height:56px}:host(:not([left])) .mdc-deprecated-list-item__meta{height:40px;width:40px}`
/**
@license
Copyright 2020 Google Inc. All Rights Reserved.
...
*/;let j=class extends R{};j.styles=[w,q],j=e([x("mwc-check-list-item")],j);let P=class extends p{constructor(){super(),this.is_connected=!1,this.enableLaunchButton=!1,this.hideLaunchButton=!1,this.location="",this.mode="normal",this.newSessionDialogTitle="",this.importScript="",this.importFilename="",this.imageRequirements=Object(),this.resourceLimits=Object(),this.userResourceLimit=Object(),this.aliases=Object(),this.tags=Object(),this.icons=Object(),this.imageInfo=Object(),this.kernel="",this.marker_limit=25,this.gpu_modes=[],this.gpu_step=.1,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.shmem_metric={min:.0625,max:1,preferred:.0625},this.cuda_device_metric={min:0,max:0},this.rocm_device_metric={min:"0",max:"0"},this.tpu_device_metric={min:"1",max:"1"},this.cluster_metric={min:1,max:1},this.cluster_mode_list=["single-node","multi-node"],this.cluster_support=!1,this.aggregate_updating=!1,this.resourceGauge=Object(),this.ownerFeatureInitialized=!1,this.ownerDomain="",this.project_resource_monitor=!1,this.version_selector=Object(),this._default_language_updated=!1,this._default_version_updated=!1,this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.max_cpu_core_per_session=64,this.max_cuda_device_per_container=16,this.max_cuda_shares_per_container=16,this.max_shm_per_container=2,this.cluster_size=1,this.deleteEnvInfo=Object(),this.deleteEnvRow=Object(),this.environ_values=Object(),this.vfolder_select_expansion=Object(),this._debug=!1,this.active=!1,this.ownerKeypairs=[],this.ownerGroups=[],this.ownerScalingGroups=[],this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.environ=[],this.init_resource()}static get is(){return"backend-ai-session-launcher"}static get styles(){return[r,a,c,n,l,d`
      ...
      <backend-ai-dialog id="new-session-dialog" narrowLayout fixed backdrop persistent>
        <span
          slot="title">${this.newSessionDialogTitle?this.newSessionDialogTitle:_("session.launcher.StartNewSession")}</span>
        <form slot="content" id="launch-session-form" class="centered">
          <div class="vertical center layout" style="padding-top:15px;position:relative;z-index:12;">
            <mwc-select id="environment" icon="code" label="${_("session.launcher.Environments")}" fullwidth required
              ...
              ${this.languages.map((e=>u`
                ...
                `:u`
                  <mwc-list-item id="${e.name}" value="${e.name}" graphic="icon">
                    <img slot="graphic" src="resources/icons/${e.icon}" style="width:24px;height:24px;"/>
            ...
            <mwc-select id="version" icon="architecture" label="${_("session.launcher.Version")}" fullwidth required>
          ...
          <wl-expansion
            ...
            <span slot="title" class="launcher-item-title">${_("session.launcher.FolderToMount")}</span>
          ...
          <p class="title" style="font-weight:400;">${_("session.launcher.TotalAllocation")}</p>
              ...
              ${this.resource_templates_filtered.map((e=>u`
                ...
                <div class="horizontal layout end-justified">
                  ...
                  <div style="width:60px;text-align:right;">${e.shmem?u`
                        ${parseFloat(globalThis.backendaiclient.utils.changeBinaryUnit(e.shared_memory,"g")).toFixed(2)} GB`:u`
                        64MB
                        `}</div>
          ...
          <wl-expansion name="resource-group" style="--expansion-header-padding:16px;">
            <span slot="title" style="font-size:12px;color: rgb(64, 64, 64);font-weight:400;">${_("session.launcher.CustomAllocation")}</span>
        ...
        ${this.cluster_support?u`
          ...
          <div class="horizontal layout center" style="padding:0 24px 24px 24px;">
            ...
            ${"single-node"===this.cluster_mode?u`
              <span class="caption">${_("session.launcher.Container")}</span>
            `:u`
        ...
        `:u``}
          <wl-expansion name="ownership" style="--expansion-header-padding:16px;--expansion-content-padding:15px 0;">
            <span slot="title"
                  style="font-size:12px;font-weight:400;color:#404040;">${_("session.launcher.SetSessionOwner")}</span>
            ...
            <div class="vertical layout">
              ...
              <mwc-select id="owner-accesskey" label="${_("session.launcher.OwnerAccessKey")}" icon="vpn_key">
              ...
              <div class="horizontal center layout">
                <mwc-select id="owner-group" label="${_("session.launcher.OwnerGroup")}" icon="group_work">
    ...
    <backend-ai-dialog id="env-config-confirmation" warning fixed>
      ...
      <div slot="footer" class="horizontal end-justified flex layout">
        <mwc-button
          ...
          <span id="launch-button-msg">${_("button.DismissAndProceed")}</span>
        </mwc-button>
        <mwc-button
            outlined
          ...
          <span id="launch-button-msg">${_("button.Cancel")}</span>
        </mwc-button>
      </div>
    </backend-ai-dialog>
`}};e([s("#image-name")],P.prototype,"manualImageName",void 0),e([t({type:Boolean})],P.prototype,"is_connected",void 0),e([t({type:Boolean})],P.prototype,"enableLaunchButton",void 0),e([t({type:Boolean})],P.prototype,"hideLaunchButton",void 0),e([t({type:String})],P.prototype,"location",void 0),e([t({type:String})],P.prototype,"mode",void 0),e([t({type:String})],P.prototype,"newSessionDialogTitle",void 0),e([t({type:String})],P.prototype,"importScript",void 0),e([t({type:String})],P.prototype,"importFilename",void 0),e([t({type:Object})],P.prototype,"imageRequirements",void 0),e([t({type:Object})],P.prototype,"resourceLimits",void 0),e([t({type:Object})],P.prototype,"userResourceLimit",void 0),e([t({type:Object})],P.prototype,"aliases",void 0),e([t({type:Object})],P.prototype,"tags",void 0),e([t({type:Object})],P.prototype,"icons",void 0),e([t({type:Object})],P.prototype,"imageInfo",void 0),e([t({type:String})],P.prototype,"kernel",void 0),e([t({type:Array})],P.prototype,"versions",void 0),e([t({type:Array})],P.prototype,"languages",void 0),e([t({type:Number})],P.prototype,"marker_limit",void 0),e([t({type:String})],P.prototype,"gpu_mode",void 0),e([t({type:Array})],P.prototype,"gpu_modes",void 0),e([t({type:Number})],P.prototype,"gpu_step",void 0),e([t({type:Object})],P.prototype,"cpu_metric",void 0),e([t({type:Object})],P.prototype,"mem_metric",void 0),e([t({type:Object})],P.prototype,"shmem_metric",void 0),e([t({type:Object})],P.prototype,"cuda_device_metric",void 0),e([t({type:Object})],P.prototype,"cuda_shares_metric",void 0),e([t({type:Object})],P.prototype,"rocm_device_metric",void 0),e([t({type:Object})],P.prototype,"tpu_device_metric",void 0),e([t({type:Object})],P.prototype,"cluster_metric",void 0),e([t({type:Array})],P.prototype,"cluster_mode_list",void 0),e([t({type:Boolean})],P.prototype,"cluster_support",void 0),e([t({type:Object})],P.prototype,"images",void 0),e([t({type:Object})],P.prototype,"total_slot",void 0),e([t({type:Object})],P.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],P.prototype,"total_project_slot",void 0),e([t({type:Object})],P.prototype,"used_slot",void 0),e([t({type:Object})],P.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],P.prototype,"used_project_slot",void 0),e([t({type:Object})],P.prototype,"available_slot",void 0),e([t({type:Number})],P.prototype,"concurrency_used",void 0),e([t({type:Number})],P.prototype,"concurrency_max",void 0),e([t({type:Number})],P.prototype,"concurrency_limit",void 0),e([t({type:Number})],P.prototype,"max_containers_per_session",void 0),e([t({type:Array})],P.prototype,"vfolders",void 0),e([t({type:Array})],P.prototype,"selectedVfolders",void 0),e([t({type:Object})],P.prototype,"used_slot_percent",void 0),e([t({type:Object})],P.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],P.prototype,"used_project_slot_percent",void 0),e([t({type:Array})],P.prototype,"resource_templates",void 0),e([t({type:Array})],P.prototype,"resource_templates_filtered",void 0),e([t({type:String})],P.prototype,"default_language",void 0),e([t({type:Number})],P.prototype,"cpu_request",void 0),e([t({type:Number})],P.prototype,"mem_request",void 0),e([t({type:Number})],P.prototype,"shmem_request",void 0),e([t({type:Number})],P.prototype,"gpu_request",void 0),e([t({type:String})],P.prototype,"gpu_request_type",void 0),e([t({type:Number})],P.prototype,"session_request",void 0),e([t({type:Boolean})],P.prototype,"_status",void 0),e([t({type:Number})],P.prototype,"num_sessions",void 0),e([t({type:String})],P.prototype,"scaling_group",void 0),e([t({type:Array})],P.prototype,"scaling_groups",void 0),e([t({type:Array})],P.prototype,"sessions_list",void 0),e([t({type:Boolean})],P.prototype,"metric_updating",void 0),e([t({type:Boolean})],P.prototype,"metadata_updating",void 0),e([t({type:Boolean})],P.prototype,"aggregate_updating",void 0),e([t({type:Object})],P.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],P.prototype,"resourceGauge",void 0),e([t({type:Boolean})],P.prototype,"ownerFeatureInitialized",void 0),e([t({type:String})],P.prototype,"ownerDomain",void 0),e([t({type:Array})],P.prototype,"ownerKeypairs",void 0),e([t({type:Array})],P.prototype,"ownerGroups",void 0),e([t({type:Array})],P.prototype,"ownerScalingGroups",void 0),e([t({type:Boolean})],P.prototype,"project_resource_monitor",void 0),e([t({type:Object})],P.prototype,"version_selector",void 0),e([t({type:Boolean})],P.prototype,"_default_language_updated",void 0),e([t({type:Boolean})],P.prototype,"_default_version_updated",void 0),e([t({type:String})],P.prototype,"_helpDescription",void 0),e([t({type:String})],P.prototype,"_helpDescriptionTitle",void 0),e([t({type:String})],P.prototype,"_helpDescriptionIcon",void 0),e([t({type:Number})],P.prototype,"max_cpu_core_per_session",void 0),e([t({type:Number})],P.prototype,"max_cuda_device_per_container",void 0),e([t({type:Number})],P.prototype,"max_cuda_shares_per_container",void 0),e([t({type:Number})],P.prototype,"max_shm_per_container",void 0),e([t({type:Object})],P.prototype,"resourceBroker",void 0),e([t({type:Number})],P.prototype,"cluster_size",void 0),e([t({type:String})],P.prototype,"cluster_mode",void 0),e([t({type:Object})],P.prototype,"deleteEnvInfo",void 0),e([t({type:Object})],P.prototype,"deleteEnvRow",void 0),e([t({type:Array})],P.prototype,"environ",void 0),e([t({type:Object})],P.prototype,"environ_values",void 0),e([t({type:Object})],P.prototype,"vfolder_select_expansion",void 0),e([t({type:Boolean})],P.prototype,"_debug",void 0),P=e([i("backend-ai-session-launcher")],P);
