import{_ as e,p as t,q as s,c as i,L as o,d as r,I as a,a as c,n,e as l,b as d,h as u,B as p,g as h,f as m,t as g,o as _,l as y,r as v}from"./backend-ai-console-228ea035.js";import{u as b}from"./unsafe-html-a49d90c2.js";import"./lablup-progress-bar-5913ca82.js";import"./mwc-switch-fe76cc46.js";import"./input-behavior-9a33e26c.js";import"./mwc-slider-c51fa6c4.js";import"./textfield-6821a657.js";import"./expansion-8210fd0e.js";
/**
 @license
 ...
 */
class f extends _{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-list-item__graphic":this.left,"mdc-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():u``,i=this.hasMeta&&this.left?this.renderMeta():u``,o=this.renderRipple();return u`
      ${o}
      ${s}
      ${this.left?"":t}
      <span class=${y(e)}>
      ...
      ${this.left?t:""}
      ${i}`}async onChange(e){const t=e.target;this.selected===t.checked||(this._skipPropRequest=!0,this.selected=t.checked,await this.updateComplete,this._skipPropRequest=!1)}}e([s("slot")],f.prototype,"slotElement",void 0),e([s("mwc-checkbox")],f.prototype,"checkboxElement",void 0),e([t({type:Boolean})],f.prototype,"left",void 0),e([t({type:String,reflect:!0})],f.prototype,"graphic",void 0);
/**
@license
