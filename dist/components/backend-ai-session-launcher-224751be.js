import{_ as e,e as t,l as i,n as s,s as o,b as r,I as a,a as n,x as l,c,r as d,$ as h,B as u,g as p,d as m,t as _,y as g,o as v}from"./backend-ai-webui-1eec9a06.js";import"./mwc-linear-progress-6d1f9a9e.js";import"./mwc-switch-53c1bae4.js";import"./label-7e012461.js";import"./lablup-progress-bar-dd7168cb.js";import"./mwc-check-list-item-3760c05d.js";import"./slider-49abdd95.js";import{r as b,A as y,T as f,F as w,E as x,h as k,a as S,P as D,D as C,C as I,b as $,i as T,c as P,d as E,e as O,f as R,t as A,s as M,g as q,I as z,K as j,j as B,L as V,V as L,k as F,p as N,l as U,m as G}from"./vaadin-grid-eb720a1f.js";import{i as W,I as H,a as Y,P as K,r as X,h as Q,F as J}from"./vaadin-grid-filter-column-91b19917.js";import"./vaadin-grid-selection-column-4f3a5b1b.js";import{t as Z,D as ee}from"./dom-repeat-bf8a7dfc.js";import{i as te}from"./vaadin-item-styles-b266be2e.js";import"./expansion-d27cb585.js";import"./lablup-codemirror-7a02f52a.js";
/**
 @license
...
`;b("",re,{moduleId:"lumo-menu-overlay-core"});const ae=[oe,re,d`
...
`];b("",ae,{moduleId:"lumo-menu-overlay"});b("vaadin-date-picker-overlay",[ae,d`
  [part='overlay'] {
    /*
  Width:
      date cell widths
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class ne extends(y(f(w(x(S(D)))))){static get is(){return"vaadin-button"}static get properties(){return{tabindex:{value:0}}}static get template(){return k`
      <style>
        :host {
          display: inline-block;
          position: relative;
    ...
    `}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button")}_onKeyDown(e){super._onKeyDown(e),this._activeKeys.includes(e.key)&&(e.preventDefault(),this.click())}}customElements.define(ne.is,ne),b("vaadin-date-picker-overlay-content",d`
    :host {
      position: relative;
      background-color: transparent;
  ...
  `,{moduleId:"lumo-month-calendar"});const le=document.createElement("template");le.innerHTML="\n  <style>\n    @keyframes vaadin-date-picker-month-calendar-focus-date {\n      50% {\n        box-shadow: 0 0 0 2px transparent;\n      }\n    }\n  </style>\n",document.head.appendChild(le.content);function ce(e,t){const i=Math.max(e.tabIndex,0),s=Math.max(t.tabIndex,0);return 0===i||0===s?s>i:i>s}function de(e){const t=e.length;if(t<2)return e;const i=Math.ceil(t/2);return function(e,t){const i=[];for(;e.length>0&&t.length>0;)ce(e[0],t[0])?i.push(t.shift()):i.push(e.shift());return i.concat(e,t)}(de(e.slice(0,i)),de(e.slice(i)))}function he(e,t){if(e.nodeType!==Node.ELEMENT_NODE||
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
function(e){const t=e.style;if("hidden"===t.visibility||"none"===t.display)return!0;const i=window.getComputedStyle(e);return"hidden"===i.visibility||"none"===i.display}(e))return!1;const i=e,s=function(e){if(!function(e){return!e.matches('[tabindex="-1"]')&&(e.matches("input, select, textarea, button, object")?e.matches(":not([disabled])"):e.matches("a[href], area[href], iframe, [tabindex], [contentEditable]"))}(e))return-1;const t=e.getAttribute("tabindex")||0;return Number(t)}(i);let o=s>0;s>=0&&t.push(i);let r=[];return r="slot"===i.localName?i.assignedNodes({flatten:!0}):(i.shadowRoot||i).children,[...r].forEach((e=>{o=he(e,t)||o})),o}function ue(e){return e.getRootNode().activeElement===e}b("vaadin-date-picker",[W,d`
  :host {
    outline: none;
  }
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const pe=[];class me{constructor(e){this.host=e,this.__trapNode=null,this.__onKeyDown=this.__onKeyDown.bind(this)}hostConnected(){document.addEventListener("keydown",this.__onKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this.__onKeyDown)}trapFocus(e){if(this.__trapNode=e,0===this.__focusableElements.length)throw this.__trapNode=null,new Error("The trap node should have at least one focusable descendant or be focusable itself.");pe.push(this),-1===this.__focusedElementIndex&&this.__focusableElements[0].focus()}releaseFocus(){this.__trapNode=null,pe.pop()}__onKeyDown(e){if(this.__trapNode&&this===Array.from(pe).pop()&&"Tab"===e.key){e.preventDefault();const t=e.shiftKey;this.__focusNextElement(t)}}__focusNextElement(e=!1){const t=this.__focusableElements,i=e?-1:1,s=this.__focusedElementIndex;t[(t.length+s+i)%t.length].focus()}get __focusableElements(){return function(e){const t=[];return he(e,t)?de(t):t}(this.__trapNode)}get __focusedElementIndex(){const e=this.__focusableElements;return e.indexOf(e.filter(ue).pop())}}
/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class _e extends(S(C(I(D)))){static get template(){return k`
      <style>
        :host {
          z-index: 200;
          position: fixed;
...
`,{moduleId:"vaadin-date-picker-overlay-styles"});class we extends(ee(be(_e))){static get is(){return"vaadin-date-picker-overlay"}static get template(){return fe||(fe=super.template.cloneNode(!0),fe.content.querySelector('[part~="overlay"]').removeAttribute("tabindex")),fe}}function xe(e,t){return e instanceof Date&&t instanceof Date&&e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function ke(e,t,i){return(!t||e>=t)&&(!i||e<=i)}function Se(e,t){return t.filter((e=>void 0!==e)).reduce(((t,i)=>i?t?Math.abs(e.getTime()-i.getTime())<Math.abs(t.getTime()-e.getTime())?i:t:i:t))}function De(e){return{day:e.getDate(),month:e.getMonth(),year:e.getFullYear()}}
/**
 * @license
 * Copyright (c) 2016 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */customElements.define(we.is,we);class Ce extends(w(S(D))){static get template(){return k`
      <style>
        :host {
          display: block;
        }
 ...
 * Copyright (c) 2016 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Te extends(I(S(C(D)))){static get template(){return k`
      <style>
        :host {
          display: flex;
          flex-direction: column;
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class Re extends(S(C(D))){static get template(){return k`
      <style>
        :host {
          display: block;
        }
...
b("vaadin-combo-box-overlay",d`
  ...
  `,{moduleId:"vaadin-combo-box-overlay-styles"});class qe extends(be(_e)){static get is(){return"vaadin-combo-box-overlay"}static get template(){return Me||(Me=super.template.cloneNode(!0),Me.content.querySelector('[part~="overlay"]').removeAttribute("tabindex")),Me}connectedCallback(){super.connectedCallback();const e=this.__dataHost,t=e&&e.getRootNode().host,i=t&&t.getAttribute("dir");i&&this.setAttribute("dir",i)}ready(){super.ready();const e=document.createElement("div");e.setAttribute("part","loader");const t=this.shadowRoot.querySelector('[part~="content"]');t.parentNode.insertBefore(e,t)}_outsideClickListener(e){const t=e.composedPath();t.includes(this.positionTarget)||t.includes(this)||this.close()}}customElements.define(qe.is,qe),
/**
 * @license
 * Copyright (c) 2018 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
b("vaadin-time-picker-overlay",d`
  ...
  `,{moduleId:"vaadin-time-picker-overlay-styles"});class ze extends qe{static get is(){return"vaadin-time-picker-overlay"}}customElements.define(ze.is,ze);
/**
 * @license
 * Copyright (c) 2015 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const je=class{toString(){return""}};
/**
 * @license
 * Copyright (c) 2015 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Be extends D{static get is(){return"vaadin-combo-box-scroller"}static get template(){return k`
      <style>
        :host {
          display: block;
          min-height: 1px;
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class Le extends D{static get is(){return"vaadin-combo-box-dropdown"}static get template(){return k`
 ...
 */;class Ue extends(Ne(S(D))){static get is(){return"vaadin-time-picker-combo-box"}static get template(){return k`
      ...
      <vaadin-time-picker-dropdown
        ...
        theme="[[theme]]"
      ></vaadin-time-picker-dropdown>
    `}static get properties(){return{positionTarget:{type:Object}}}get clearElement(){return this.querySelector('[part="clear-button"]')}_getItemElements(){return Array.from(this.$.dropdown._scroller.querySelectorAll("vaadin-time-picker-item"))}ready(){super.ready(),this.allowCustomValue=!0,this._toggleElement=this.querySelector(".toggle-button"),this.setAttribute("dir","ltr")}}customElements.define(Ue.is,Ue),
/**
 * @license
 * Copyright (c) 2018 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
b("vaadin-time-picker",Y,{moduleId:"vaadin-time-picker-styles"});class Ge extends(K(H(S(x(D))))){static get is(){return"vaadin-time-picker"}static get template(){return k`
      <style>
...
`;b("vaadin-custom-field",[X,Q,We],{moduleId:"lumo-custom-field"}),b("vaadin-date-time-picker",[X,Q,We],{moduleId:"lumo-date-time-picker"}),b("vaadin-date-time-picker-date-picker",d`
    :host {
      margin-right: 2px;
    }
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class He extends Oe{static get is(){return"vaadin-date-time-picker-date-picker"}}customElements.define(He.is,He);
/**
 * @license
 * Copyright (c) 2019 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class Ye extends Ge{static get is(){return"vaadin-date-time-picker-time-picker"}}customElements.define(Ye.is,Ye);
/**
 * @license
 * Copyright (c) 2021 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const Ke=G((e=>class extends e{get slots(){return{}}ready(){super.ready(),this._connectSlotMixin()}_connectSlotMixin(){Object.keys(this.slots).forEach((e=>{if(!(void 0!==this._getDirectSlotChild(e))){const t=(0,this.slots[e])();t instanceof Element&&(""!==e&&t.setAttribute("slot",e),this.appendChild(t))}}))}_getDirectSlotChild(e){return Array.from(this.childNodes).find((t=>t.nodeType===Node.ELEMENT_NODE&&t.slot===e||t.nodeType===Node.TEXT_NODE&&t.textContent.trim()&&""===e))}}));
/**
 * @license
 * Copyright (c) 2019 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function Xe(e,t){for(;e;){if(e.properties&&e.properties[t])return e.properties[t];e=Object.getPrototypeOf(e)}}b("vaadin-date-time-picker",Y,{moduleId:"vaadin-date-time-picker"});const Qe=customElements.get("vaadin-date-time-picker-date-picker"),Je=customElements.get("vaadin-date-time-picker-time-picker"),Ze=Xe(Qe,"i18n").value(),et=Xe(Je,"i18n").value(),tt=Object.keys(Ze),it=Object.keys(et);class st extends(J(Ke(F(w(S(x(D))))))){static get template(){return k`
      <style>
    ...
    `}};e([i("#image-name")],ot.prototype,"manualImageName",void 0),e([t({type:Boolean})],ot.prototype,"is_connected",void 0),e([t({type:Boolean})],ot.prototype,"enableLaunchButton",void 0),e([t({type:Boolean})],ot.prototype,"hideLaunchButton",void 0),e([t({type:String})],ot.prototype,"location",void 0),e([t({type:String})],ot.prototype,"mode",void 0),e([t({type:String})],ot.prototype,"newSessionDialogTitle",void 0),e([t({type:String})],ot.prototype,"importScript",void 0),e([t({type:String})],ot.prototype,"importFilename",void 0),e([t({type:Object})],ot.prototype,"imageRequirements",void 0),e([t({type:Object})],ot.prototype,"resourceLimits",void 0),e([t({type:Object})],ot.prototype,"userResourceLimit",void 0),e([t({type:Object})],ot.prototype,"aliases",void 0),e([t({type:Object})],ot.prototype,"tags",void 0),e([t({type:Object})],ot.prototype,"icons",void 0),e([t({type:Object})],ot.prototype,"imageInfo",void 0),e([t({type:String})],ot.prototype,"kernel",void 0),e([t({type:Array})],ot.prototype,"versions",void 0),e([t({type:Array})],ot.prototype,"languages",void 0),e([t({type:Number})],ot.prototype,"marker_limit",void 0),e([t({type:String})],ot.prototype,"gpu_mode",void 0),e([t({type:Array})],ot.prototype,"gpu_modes",void 0),e([t({type:Number})],ot.prototype,"gpu_step",void 0),e([t({type:Object})],ot.prototype,"cpu_metric",void 0),e([t({type:Object})],ot.prototype,"mem_metric",void 0),e([t({type:Object})],ot.prototype,"shmem_metric",void 0),e([t({type:Object})],ot.prototype,"cuda_device_metric",void 0),e([t({type:Object})],ot.prototype,"cuda_shares_metric",void 0),e([t({type:Object})],ot.prototype,"rocm_device_metric",void 0),e([t({type:Object})],ot.prototype,"tpu_device_metric",void 0),e([t({type:Object})],ot.prototype,"cluster_metric",void 0),e([t({type:Array})],ot.prototype,"cluster_mode_list",void 0),e([t({type:Boolean})],ot.prototype,"cluster_support",void 0),e([t({type:Object})],ot.prototype,"images",void 0),e([t({type:Object})],ot.prototype,"total_slot",void 0),e([t({type:Object})],ot.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],ot.prototype,"total_project_slot",void 0),e([t({type:Object})],ot.prototype,"used_slot",void 0),e([t({type:Object})],ot.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],ot.prototype,"used_project_slot",void 0),e([t({type:Object})],ot.prototype,"available_slot",void 0),e([t({type:Number})],ot.prototype,"concurrency_used",void 0),e([t({type:Number})],ot.prototype,"concurrency_max",void 0),e([t({type:Number})],ot.prototype,"concurrency_limit",void 0),e([t({type:Number})],ot.prototype,"max_containers_per_session",void 0),e([t({type:Array})],ot.prototype,"vfolders",void 0),e([t({type:Array})],ot.prototype,"selectedVfolders",void 0),e([t({type:Array})],ot.prototype,"autoMountedVfolders",void 0),e([t({type:Array})],ot.prototype,"nonAutoMountedVfolders",void 0),e([t({type:Object})],ot.prototype,"folderMapping",void 0),e([t({type:Object})],ot.prototype,"used_slot_percent",void 0),e([t({type:Object})],ot.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],ot.prototype,"used_project_slot_percent",void 0),e([t({type:Array})],ot.prototype,"resource_templates",void 0),e([t({type:Array})],ot.prototype,"resource_templates_filtered",void 0),e([t({type:String})],ot.prototype,"default_language",void 0),e([t({type:Number})],ot.prototype,"cpu_request",void 0),e([t({type:Number})],ot.prototype,"mem_request",void 0),e([t({type:Number})],ot.prototype,"shmem_request",void 0),e([t({type:Number})],ot.prototype,"gpu_request",void 0),e([t({type:String})],ot.prototype,"gpu_request_type",void 0),e([t({type:Number})],ot.prototype,"session_request",void 0),e([t({type:Boolean})],ot.prototype,"_status",void 0),e([t({type:Number})],ot.prototype,"num_sessions",void 0),e([t({type:String})],ot.prototype,"scaling_group",void 0),e([t({type:Array})],ot.prototype,"scaling_groups",void 0),e([t({type:Array})],ot.prototype,"sessions_list",void 0),e([t({type:Boolean})],ot.prototype,"metric_updating",void 0),e([t({type:Boolean})],ot.prototype,"metadata_updating",void 0),e([t({type:Boolean})],ot.prototype,"aggregate_updating",void 0),e([t({type:Object})],ot.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],ot.prototype,"resourceGauge",void 0),e([t({type:String})],ot.prototype,"sessionType",void 0),e([t({type:Boolean})],ot.prototype,"ownerFeatureInitialized",void 0),e([t({type:String})],ot.prototype,"ownerDomain",void 0),e([t({type:Array})],ot.prototype,"ownerKeypairs",void 0),e([t({type:Array})],ot.prototype,"ownerGroups",void 0),e([t({type:Array})],ot.prototype,"ownerScalingGroups",void 0),e([t({type:Boolean})],ot.prototype,"project_resource_monitor",void 0),e([t({type:Object})],ot.prototype,"version_selector",void 0),e([t({type:Boolean})],ot.prototype,"_default_language_updated",void 0),e([t({type:Boolean})],ot.prototype,"_default_version_updated",void 0),e([t({type:String})],ot.prototype,"_helpDescription",void 0),e([t({type:String})],ot.prototype,"_helpDescriptionTitle",void 0),e([t({type:String})],ot.prototype,"_helpDescriptionIcon",void 0),e([t({type:Number})],ot.prototype,"max_cpu_core_per_session",void 0),e([t({type:Number})],ot.prototype,"max_mem_per_container",void 0),e([t({type:Number})],ot.prototype,"max_cuda_device_per_container",void 0),e([t({type:Number})],ot.prototype,"max_cuda_shares_per_container",void 0),e([t({type:Number})],ot.prototype,"max_shm_per_container",void 0),e([t({type:Boolean})],ot.prototype,"allow_manual_image_name_for_session",void 0),e([t({type:Object})],ot.prototype,"resourceBroker",void 0),e([t({type:Number})],ot.prototype,"cluster_size",void 0),e([t({type:String})],ot.prototype,"cluster_mode",void 0),e([t({type:Object})],ot.prototype,"deleteEnvInfo",void 0),e([t({type:Object})],ot.prototype,"deleteEnvRow",void 0),e([t({type:Array})],ot.prototype,"environ",void 0),e([t({type:Object})],ot.prototype,"environ_values",void 0),e([t({type:Object})],ot.prototype,"vfolder_select_expansion",void 0),e([t({type:Number})],ot.prototype,"currentIndex",void 0),e([t({type:Number})],ot.prototype,"progressLength",void 0),e([t({type:Object})],ot.prototype,"_grid",void 0),e([t({type:Boolean})],ot.prototype,"_debug",void 0),e([t({type:Object})],ot.prototype,"_boundFolderToMountListRenderer",void 0),e([t({type:Object})],ot.prototype,"_boundFolderMapRenderer",void 0),e([t({type:Object})],ot.prototype,"_boundPathRenderer",void 0),e([t({type:Boolean})],ot.prototype,"useScheduledTime",void 0),e([t({type:Object})],ot.prototype,"schedulerTimer",void 0),e([t({type:Object})],ot.prototype,"sessionInfoObj",void 0),ot=e([s("backend-ai-session-launcher")],ot);
