import{_ as e,p as t,c as s,L as o,d as r,I as i,a as c,n as a,e as n,b as l,h as d,B as u,g as p,f as h,t as m,q as g,k as _,o as b,r as v,F as y,R as k,l as x,m as f,u as w,v as $}from"./backend-ai-console-22d31a8d.js";import{u as S}from"./unsafe-html-06722fb8.js";import"./mwc-linear-progress-bf85309b.js";import"./mwc-slider-9da234df.js";import"./expansion-bdffdc99.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let R=class extends o{constructor(){super(...arguments),this.editable=null,this.pin=null,this.markers=null,this.marker_limit=30,this.disabled=null}static get styles(){return[r,i,c,a,n,l`
        .mdc-text-field {
          height: 25px;
        }
    ...
    `}firstUpdated(){this.slider=this.shadowRoot.querySelector("#slider"),this.editable&&(this.textfield=this.shadowRoot.querySelector("#textfield"),this.textfield.style.display="flex");const e=this.shadowRoot.querySelectorAll("wl-textfield");setTimeout((()=>{e.forEach((e=>{const t=e.getAttribute("step");e.$formElement.step=t}))}),100),this.step||(this.step=1),this.checkMarkerDisplay()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}updated(e){e.forEach(((e,t)=>{if("value"===t){setTimeout((()=>{this.editable&&this.syncToSlider(),this.slider.layout()}),500);const e=new CustomEvent("value-changed",{detail:{}});this.dispatchEvent(e)}["min","max"].includes(t)&&this.checkMarkerDisplay()}));let t=new CustomEvent("changed",{detail:""});this.dispatchEvent(t)}syncToText(){this.value=this.slider.value}syncToSlider(){let e=Math.round(this.textfield.value/this.step)*this.step;var t;this.textfield.value=e.toFixed((t=this.step,Math.floor(t)===t?0:t.toString().split(".")[1].length||0)),this.textfield.value>this.max&&(this.textfield.value=this.max),this.textfield.value<this.min&&(this.textfield.value=this.min),this.value=this.textfield.value,this.slider.value=this.textfield.value,this.slider.step=this.step}checkMarkerDisplay(){this.markers&&(this.max-this.min)/this.step>this.marker_limit&&this.slider.removeAttribute("markers"),this.slider.setAttribute("step",this.step),this.slider.step=this.step}};e([t({type:Number})],R.prototype,"step",void 0),e([t({type:Number})],R.prototype,"value",void 0),e([t({type:Number})],R.prototype,"max",void 0),e([t({type:Number})],R.prototype,"min",void 0),e([t({type:Boolean})],R.prototype,"editable",void 0),e([t({type:Boolean})],R.prototype,"pin",void 0),e([t({type:Boolean})],R.prototype,"markers",void 0),e([t({type:Number})],R.prototype,"marker_limit",void 0),e([t({type:Boolean})],R.prototype,"disabled",void 0),e([t({type:Object})],R.prototype,"slider",void 0),e([t({type:Object})],R.prototype,"textfield",void 0),R=e([s("lablup-slider")],R);let j=class extends u{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[r,i,c,a,n,l`
      ...
      <div class="layout ${this.direction}-card">
        ...
        ${"horizontal"===this.direction?d`
            ...
            <div class="layout vertical start-justified wrap">
              <div class="progress-bar">
                ...
                <wl-progress-bar id="cpu-usage-bar" class="start-bar" mode="determinate"
                    value="${this.used_resource_group_slot_percent.cpu/100}">
                </wl-progress-bar>
              </div>
              <div class="progress-bar">
                ...
                <wl-progress-bar id="cpu-usage-bar-2" class="end-bar" mode="determinate"
                    value="${this.used_slot_percent.cpu/100}">
                </wl-progress-bar>
              </div>
            </div>
            ...
            <div class="layout vertical start-justified wrap">
              <div class="progress-bar">
                ...
                <wl-progress-bar id="mem-usage-bar" class="start-bar" mode="determinate"
                    value="${this.used_resource_group_slot_percent.mem/100}"></wl-progress-bar>
              ...
              <div class="progress-bar">
                ...
                <wl-progress-bar id="mem-usage-bar-2" class="end-bar" mode="determinate"
                    value="${this.used_slot_percent.mem/100}"></wl-progress-bar>
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar" class="start-bar" mode="determinate"
                    value="${this.used_resource_group_slot_percent.cuda_device/100}"></wl-progress-bar>
              ...
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar-2" class="end-bar" mode="determinate"
                    value="${this.used_slot_percent.cuda_device/100}"></wl-progress-bar>
          ...
          ${this.total_slot.cuda_shares&&this.total_slot.cuda_shares>0?d`
          <div class="resource-line"></div>
          <div class="layout horizontal center-justified monitor">
            <div class="layout vertical center center-justified resource-name">
            ...
            <div class="layout vertical start-justified wrap short-indicator">
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar" class="start-bar" mode="determinate"
                    value="${this.used_resource_group_slot_percent.cuda_shares/100}"></wl-progress-bar>
              ...
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar-2" class="end-bar" mode="determinate"
                    value="${this.used_slot_percent.cuda_shares/100}"></wl-progress-bar>
          ...
          <div class="layout horizontal center-justified monitor">
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar" class="start-bar" mode="determinate"
                  value="${this.used_resource_group_slot_percent.rocm_device_slot/100}"></wl-progress-bar>
              ...
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar-2" class="end-bar" mode="determinate" value="${this.used_slot_percent.rocm_device_slot/100}"></wl-progress-bar>
          ...
          <div class="layout horizontal center-justified monitor">
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar" class="start-bar" mode="determinate"
                    value="${this.used_resource_group_slot_percent.tpu_device_slot/100}"></wl-progress-bar>
              ...
              <div class="progress-bar">
                ...
                <wl-progress-bar id="gpu-usage-bar-2" class="end-bar" mode="determinate"
                    value="${this.used_slot_percent.tpu_device_slot/100}"></wl-progress-bar>
          ...
          <div class="layout horizontal center-justified monitor session">
            ...
            <div class="layout vertical start-justified flex">
              <div class="progress-bar">
                <span class="gauge-label">${this.concurrency_used}/${1e6===this.concurrency_max?d`∞`:this.concurrency_max}</span>
                <span class="gauge-label">&nbsp;</span>
                <wl-progress-bar id="concurrency-usage-bar" class="short full-bar" mode="determinate" value="${this.used_slot_percent.concurrency/100}"></wl-progress-bar>
        ...
        <div class="layout horizontal center-justified monitor">
          ...
          <div class="layout vertical start-justified wrap short-indicator">
            <div class="layout horizontal">
              ...
              <div class="progress-bar">
                <wl-progress-bar id="cpu-project-usage-bar" class="start-bar" mode="determinate" value="${this.used_project_slot_percent.cpu/100}"></wl-progress-bar>
                ...
                <span class="gauge-label">${this.used_project_slot.cpu}/${this.total_project_slot.cpu===1/0?"∞":this.total_project_slot.cpu}</span>
              </div>
              <div class="layout vertical center center-justified">
            ...
            <div class="layout horizontal">
              ...
              <div class="progress-bar">
                <wl-progress-bar id="mem-project-usage-bar" class="middle-bar project-bar" mode="determinate" value="${this.used_project_slot_percent.mem/100}"></wl-progress-bar>
                ...
                <span class="gauge-label">${this.used_project_slot.mem}/${this.total_project_slot.mem===1/0?"∞":this.total_project_slot.mem}</span>
              </div>
              <div class="layout vertical center center-justified">
            ...
            <div class="layout horizontal">
              ...
              <div class="progress-bar">
                <wl-progress-bar id="gpu-project-usage-bar" class="end-bar project-bar" mode="determinate" value="${this.used_project_slot_percent.cuda_device/100}"></wl-progress-bar>
                ...
                <span class="gauge-label">${this.used_project_slot.cuda_device}/${"Infinity"===this.total_project_slot.cuda_device?"∞":this.total_project_slot.cuda_device}</span>
              </div>
              <div class="layout vertical center center-justified">
            ...
            <div class="layout horizontal">
              ...
              <div class="progress-bar">
                <wl-progress-bar id="gpu-project-usage-bar" class="end-bar project-bar" mode="determinate" value="${this.used_project_slot_percent.cuda_shares/100}"></wl-progress-bar>
                ...
                <span class="gauge-label">${this.used_project_slot.cuda_shares}/${"Infinity"===this.total_project_slot.cuda_shares?"∞":this.total_project_slot.cuda_shares}</span>
              </div>
              <div class="layout vertical center center-justified">
            ...
            <div class="layout horizontal">
              <span style="width:35px;margin-left:5px; margin-right:5px;">GPU</span>
              <div class="progress-bar">
                <wl-progress-bar id="gpu-project-usage-bar" class="end-bar project-bar" mode="determinate" value="${this.used_project_slot_percent.rocm_device/100}"></wl-progress-bar>
                ...
                <span class="gauge-label">${this.used_project_slot.rocm_device}/${"Infinity"===this.total_project_slot.rocm_device?"∞":this.total_project_slot.rocm_device}</span>
              </div>
              <div class="layout vertical center center-justified">
            ...
            <div class="layout horizontal">
              <span style="width:35px;margin-left:5px; margin-right:5px;">GPU</span>
              <div class="progress-bar">
                <wl-progress-bar id="gpu-project-usage-bar" class="end-bar project-bar" mode="determinate" value="${this.used_project_slot_percent.tpu_device/100}"></wl-progress-bar>
                ...
                <span class="gauge-label">${this.used_project_slot.tpu_device}/${"Infinity"===this.total_project_slot.tpu_device?"∞":this.total_project_slot.cuda_device}</span>
              </div>
              <div class="layout vertical center center-justified">
...
/**
 ...
 limitations under the License.
 */
class G extends w{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-list-item__graphic":this.left,"mdc-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():d``,o=this.hasMeta&&this.left?this.renderMeta():d``,r=this.renderRipple();return d`
      ${r}
      ${s}
      ${this.left?"":t}
      <span class=${x(e)}>
      ...
      ${this.left?t:""}
      ${o}`}async onChange(e){const t=e.target;this.selected===t.checked||(this._skipPropRequest=!0,this.selected=t.checked,await this.updateComplete,this._skipPropRequest=!1)}}e([g("slot")],G.prototype,"slotElement",void 0),e([g("mwc-checkbox")],G.prototype,"checkboxElement",void 0),e([t({type:Boolean})],G.prototype,"left",void 0),e([t({type:String,reflect:!0})],G.prototype,"graphic",void 0);
/**
@license
Copyright 2018 Google Inc. All Rights Reserved.
...
limitations under the License.
*/
const P=l`:host(:not([twoline])){height:56px}:host(:not([left])) .mdc-list-item__meta{height:40px;width:40px}`
/**
@license
Copyright 2020 Google Inc. All Rights Reserved.
...
*/;let C=class extends G{};C.styles=[$,P],C=e([s("mwc-check-list-item")],C);let z=class extends u{constructor(){super(),this.is_connected=!1,this.enableLaunchButton=!1,this.hideLaunchButton=!1,this.location="",this.mode="normal",this.newSessionDialogTitle="",this.importScript="",this.importFilename="",this.imageRequirements=Object(),this.resourceLimits=Object(),this.userResourceLimit=Object(),this.aliases=Object(),this.tags=Object(),this.icons=Object(),this.imageInfo=Object(),this.kernel="",this.marker_limit=25,this.gpu_modes=[],this.gpu_step=.01,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.shmem_metric={min:.0625,max:1,preferred:.0625},this.cuda_device_metric={min:0,max:0},this.rocm_device_metric={min:"0",max:"0"},this.tpu_device_metric={min:"1",max:"1"},this.aggregate_updating=!1,this.resourceGauge=Object(),this.ownerFeatureInitialized=!1,this.ownerDomain="",this.project_resource_monitor=!1,this.version_selector=Object(),this._default_language_updated=!1,this._default_version_updated=!1,this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.max_cpu_core_per_session=64,this.max_cuda_device_per_session=16,this.max_shm_per_session=2,this.active=!1,this.ownerKeypairs=[],this.ownerGroups=[],this.ownerScalingGroups=[],this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-session-launcher"}static get styles(){return[r,i,c,a,n,l`
      ...
      <backend-ai-dialog id="new-session-dialog" narrowLayout fixed backdrop>
        ...
        <form slot="content" id="launch-session-form" class="centered">
          ...
          <div class="horizontal center layout">
            <mwc-select id="scaling-groups" label="${m("session.launcher.ResourceGroup")}" required naturalMenuWidth
