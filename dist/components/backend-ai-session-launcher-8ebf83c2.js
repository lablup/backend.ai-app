import{_ as e,p as t,q as s,c as i,L as o,d as r,I as a,a as n,o as l,e as c,b as d,h as u,B as p,g as h,f as m,t as g,r as _,l as v,u as y,v as b}from"./backend-ai-webui-b56c9d72.js";import"./mwc-linear-progress-62221883.js";import"./mwc-switch-f232cf4c.js";import"./label-3b666883.js";import"./lablup-progress-bar-8c0c3f16.js";import{u as f}from"./unsafe-html-42013d5f.js";import"./vaadin-grid-69a293c4.js";import"./vaadin-grid-filter-column-8b9cef97.js";import"./vaadin-grid-selection-column-b09fda67.js";import"./expansion-a25fdbef.js";import"./mwc-slider-8ef7eea3.js";import"./textfield-50f5c976.js";
/**
 @license
 ...
 */
class k extends _{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-deprecated-list-item__graphic":this.left,"mdc-deprecated-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():u``,i=this.hasMeta&&this.left?this.renderMeta():u``,o=this.renderRipple();return u`
      ${o}
      ${s}
      ${this.left?"":t}
      <span class=${v(e)}>
 ...
 */;let S=class extends k{};S.styles=[y,$],S=e([i("mwc-check-list-item")],S);let R=class extends p{constructor(){super(),this.is_connected=!1,this.enableLaunchButton=!1,this.hideLaunchButton=!1,this.location="",this.mode="normal",this.newSessionDialogTitle="",this.importScript="",this.importFilename="",this.imageRequirements=Object(),this.resourceLimits=Object(),this.userResourceLimit=Object(),this.aliases=Object(),this.tags=Object(),this.icons=Object(),this.imageInfo=Object(),this.kernel="",this.marker_limit=25,this.gpu_modes=[],this.gpu_step=.1,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.shmem_metric={min:.0625,max:1,preferred:.0625},this.cuda_device_metric={min:0,max:0},this.rocm_device_metric={min:"0",max:"0"},this.tpu_device_metric={min:"1",max:"1"},this.cluster_metric={min:1,max:1},this.cluster_mode_list=["single-node","multi-node"],this.cluster_support=!1,this.folderMapping=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.ownerFeatureInitialized=!1,this.ownerDomain="",this.project_resource_monitor=!1,this.version_selector=Object(),this._default_language_updated=!1,this._default_version_updated=!1,this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.max_cpu_core_per_session=128,this.max_mem_per_container=1536,this.max_cuda_device_per_container=16,this.max_cuda_shares_per_container=16,this.max_shm_per_container=8,this.allow_manual_image_name_for_session=!1,this.cluster_size=1,this.deleteEnvInfo=Object(),this.deleteEnvRow=Object(),this.environ_values=Object(),this.vfolder_select_expansion=Object(),this.currentIndex=1,this._grid=Object(),this._debug=!1,this._boundFolderMapRenderer=this.folderMapRenderer.bind(this),this.active=!1,this.ownerKeypairs=[],this.ownerGroups=[],this.ownerScalingGroups=[],this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.environ=[],this.init_resource()}static get is(){return"backend-ai-session-launcher"}static get styles(){return[r,a,n,l,c,d`
      ...
      <backend-ai-dialog id="new-session-dialog" narrowLayout fixed backdrop persistent>
        ...
        <form slot="content" id="launch-session-form" class="centered" style="position:relative;">
          <div id="progress-01" class="progress center layout fade active">
            <mwc-select id="environment" icon="code" label="${g("session.launcher.Environments")}" required fixedMenuPosition
                        value="${this.default_language}">
              <mwc-list-item selected graphic="icon" style="display:none!important;">
                ${g("session.launcher.ChooseEnvironment")}
              </mwc-list-item>
            ...
            <mwc-select id="version" icon="architecture" label="${g("session.launcher.Version")}" required fixedMenuPosition>
            ...
            <mwc-textfield id="image-name" type="text" class="flex" value="" icon="assignment_turned_in"
              label="${g("session.launcher.ManualImageName")}"
            ...
            <div class="horizontal layout center justified">
              <span class="launcher-item-title" style="padding-left:16px;">${g("session.launcher.SetEnvironmentVariable")}</span>
              <mwc-button
                unelevated
                icon="rule"
                label="${g("session.launcher.Config")}"
            ...
            <div class="environment-variables-container" style="margin-top:18px;">
              ...
              `:u`
                  <div class="vertical layout center flex blank-box">
                    <span>${g("session.launcher.NoEnvConfigured")}</span>
                  </div>
                `}
            </div>
          </div>
          ...
          <wl-expansion class="vfolder" name="vfolder" open>
            <span slot="title">${g("session.launcher.FolderToMount")}</span>
            <div class="vfolder-list">
              <vaadin-grid
                ...
                <vaadin-grid-filter-column header="${g("session.launcher.FolderToMount")}"
                                          path="name" resizable></vaadin-grid-filter-column>
                <vaadin-grid-column .renderer="${this._boundFolderMapRenderer}" header="${g("session.launcher.FolderAlias")}">
                </vaadin-grid-column>
              </vaadin-grid>
              ${this.vfolders.length>0?u``:u`
              <div class="vertical layout center flex blank-box-medium">
                <span>${g("session.launcher.NoAvailableFolderToMount")}</span>
              </div>
              `}
            </div>
            </wl-expansion>
            <wl-expansion id="vfolder-mount-preview" class="vfolder" name="vfolder">
              <span slot="title">${g("session.launcher.MountedFolders")}</span>
              ...
              `:u`
                  <div class="vertical layout center flex blank-box-large">
                    <span>${g("session.launcher.NoFolderMounted")}</span>
                  </div>
              `}
              </div>
          ...
          <div id="progress-03" class="progress center layout fade">
            <div class="horizontal center layout">
              <mwc-select id="scaling-groups" label="${g("session.launcher.ResourceGroup")}"
            ...
            <div class="vertical center layout" style="position:relative;">
              <mwc-select id="resource-templates" label="${g("session.launcher.ResourceAllocation")}"
            ...
            <wl-expansion name="resource-group">
              <span slot="title">${g("session.launcher.CustomAllocation")}</span>
              <div class="vertical center layout">
                ...
                <div class="horizontal center layout">
                  <div class="resource-type">${g("webui.menu.Sessions")}</div>
            ...
            ${this.cluster_support?u`
              <mwc-select id="cluster-mode" label="${g("session.launcher.ClusterMode")}" required
              ...
              <div class="horizontal layout center" style="padding:0 24px;">
                ...
                ${"single-node"===this.cluster_mode?u`
                  <span class="caption" style="width:60px;">${g("session.launcher.Container")}</span>
                `:u`
            ...
            <wl-expansion name="hpc-option-group">
              <span slot="title">${g("session.launcher.HPCOptimization")}</span>
              <div class="vertical center layout">
                <div class="horizontal center center-justified flex layout">
                  <div style="width:313px;">${g("session.launcher.SwitchOpenMPoptimization")}</div>
                ...
                <div id="HPCOptimizationOptions" style="display:none;">
                  <div class="horizontal center layout">
                    <div style="width:200px;">${g("session.launcher.NumOpenMPthreads")}</div>
                  ...
                  <div class="horizontal center layout">
                    <div style="width:200px;">${g("session.launcher.NumOpenBLASthreads")}</div>
            ...
            <wl-expansion name="ownership" style="--expansion-content-padding:15px 0;">
              <span slot="title">${g("session.launcher.SetSessionOwner")}</span>
              <div class="vertical layout">
                ...
                <mwc-select id="owner-accesskey" label="${g("session.launcher.OwnerAccessKey")}" icon="vpn_key" fixedMenuPosition naturalMenuWidth>
                ...
                <div class="horizontal center layout">
                  <mwc-select id="owner-group" label="${g("session.launcher.OwnerGroup")}" icon="group_work" fixedMenuPosition naturalMenuWidth>
                ...
                <p style="color: rgba(0,0,0,0.6);">${g("session.launcher.LaunchSessionWithAccessKey")}</p>
                </div>
              </div>
            </wl-expansion>
          </div>
          <div id="progress-04" class="progress center layout fade">
            <p class="title">${g("session.launcher.TotalAllocation")}</p>
            <div class="vertical layout center center-justified cluster-total-allocation-container">
              ...
              <div id="total-allocation-container" class="horizontal layout center center-justified allocation-check">
                ...
                <div class="vertical layout center center-justified cluster-allocated" style="z-index:10;">
                  ...
                  <p class="small">${g("session.launcher.Container")}</p>
                </div>
                <div class="vertical layout center center-justified cluster-allocated" style="z-index:10;">
                  <div class="horizontal layout">
                    <p>${this.cluster_mode,""}</p>
                    <span>${"single-node"===this.cluster_mode?g("session.launcher.SingleNode"):g("session.launcher.MultiNode")}</span>
                  </div>
                  <p class="small">${g("session.launcher.AllocateNode")}</p>
                </div>
              </div>
            </div>
            <p class="title">${g("session.launcher.MountedFolders")}</p>
            ...
            <p class="title">${g("session.launcher.EnvironmentVariablePaneTitle")}</p>
      ...
      <backend-ai-dialog id="modify-env-dialog" fixed backdrop persistent closeWithConfirmation>
        <span slot="title">${g("session.launcher.SetEnvironmentVariable")}</span>
        <span slot="action">
        ...
        <div slot="content" id="modify-env-container">
          <div class="row header">
            <div> ${g("session.launcher.EnvironmentVariable")} </div>
            <div> ${g("session.launcher.EnvironmentVariableValue")} </div>
          </div>
      ...
      <backend-ai-dialog id="launch-confirmation-dialog" warning fixed backdrop>
        ...
        <div slot="footer" class="horizontal end-justified flex layout">
          <mwc-button
            ...
            <span>${g("session.launcher.Launch")}</span>
          </mwc-button>
        </div>
      </backend-ai-dialog>
      <backend-ai-dialog id="env-config-confirmation" warning fixed>
        ...
        <div slot="content">
          <p>${g("session.launcher.EnvConfigWillDisappear")}</p>
          <p>${g("dialog.ask.DoYouWantToProceed")}</p>
        </div>
        <div slot="footer" class="horizontal end-justified flex layout">
          <mwc-button
              id="env-config-remain-button"
              label="${g("button.Cancel")}"
          ...
          <mwc-button
              ...
              label="${g("button.DismissAndProceed")}"
