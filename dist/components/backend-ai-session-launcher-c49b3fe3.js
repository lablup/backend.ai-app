import{_ as e,p as t,q as s,c as i,L as o,d as r,I as a,a as n,n as l,e as c,b as d,h as u,B as p,g as h,f as m,t as _,o as g,u as v,v as y,l as b,w as f,x,y as w,z as k}from"./backend-ai-webui-f982c311.js";import"./mwc-linear-progress-69349e52.js";import"./mwc-switch-823c4009.js";import"./label-895b17da.js";import"./lablup-progress-bar-aeb97526.js";import{u as $}from"./unsafe-html-79f5b8ca.js";import"./vaadin-grid-97749c6c.js";import"./vaadin-grid-filter-68f7faeb.js";import"./vaadin-grid-filter-column-4c3af51f.js";import"./vaadin-grid-selection-column-9bae75c2.js";import"./expansion-fa52075e.js";import"./mwc-slider-409c33fb.js";import"./textfield-9acb13a6.js";
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */let S=class extends o{constructor(){super(...arguments),this.editable=!1,this.pin=!1,this.markers=!1,this.marker_limit=30,this.disabled=!1}static get styles(){return[r,a,n,l,c,d`
        .mdc-text-field {
          height: 25px;
        }
    ...
    `}firstUpdated(){this.editable&&(this.textfield=this.shadowRoot.querySelector("#textfield"),this.textfield.style.display="flex"),this.updateStep(),this.checkMarkerDisplay()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}update(e){this.min=this.min>this.max?this.max:this.min,super.update(e)}updated(e){e.forEach(((e,t)=>{if("value"===t){setTimeout((()=>{this.editable&&this.syncToSlider(),this.slider.layout()}),500);const e=new CustomEvent("value-changed",{detail:{}});this.dispatchEvent(e)}["min","max","step"].includes(t)&&this.checkMarkerDisplay()}));const t=new CustomEvent("changed",{detail:""});this.dispatchEvent(t)}syncToText(){this.value=this.slider.value}syncToSlider(){this.textfield.step=this.step;const e=Math.round(this.textfield.value/this.step)*this.step;var t;this.textfield.value=e.toFixed((t=this.step,Math.floor(t)===t?0:t.toString().split(".")[1].length||0)),this.textfield.value>this.max&&(this.textfield.value=this.max),this.textfield.value<this.min&&(this.textfield.value=this.min),this.value=this.textfield.value,this.slider.value=this.textfield.value,this.slider.step=this.step}checkMarkerDisplay(){this.markers&&(this.max-this.min)/this.step>this.marker_limit&&this.slider.removeAttribute("markers"),this.updateStep()}updateStep(){const e=this.shadowRoot.querySelectorAll("wl-textfield");setTimeout((()=>{e.forEach((e=>{const t=e.getAttribute("step");e.$formElement.step=t}))}),100),this.step||(this.step=1),this.slider.setAttribute("step",this.step),this.slider.step=this.step}};e([t({type:Number})],S.prototype,"step",void 0),e([t({type:Number})],S.prototype,"value",void 0),e([t({type:Number})],S.prototype,"max",void 0),e([t({type:Number})],S.prototype,"min",void 0),e([t({type:Boolean})],S.prototype,"editable",void 0),e([t({type:Boolean})],S.prototype,"pin",void 0),e([t({type:Boolean})],S.prototype,"markers",void 0),e([t({type:Number})],S.prototype,"marker_limit",void 0),e([t({type:Boolean})],S.prototype,"disabled",void 0),e([t({type:Object})],S.prototype,"textfield",void 0),e([s("#slider",!0)],S.prototype,"slider",void 0),S=e([i("lablup-slider")],S);let R=class extends p{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[r,a,n,l,c,d`
      ...
      `:u``}
`}};e([t({type:Boolean})],R.prototype,"is_connected",void 0),e([t({type:String})],R.prototype,"direction",void 0),e([t({type:String})],R.prototype,"location",void 0),e([t({type:Object})],R.prototype,"aliases",void 0),e([t({type:Object})],R.prototype,"total_slot",void 0),e([t({type:Object})],R.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],R.prototype,"total_project_slot",void 0),e([t({type:Object})],R.prototype,"used_slot",void 0),e([t({type:Object})],R.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],R.prototype,"used_project_slot",void 0),e([t({type:Object})],R.prototype,"available_slot",void 0),e([t({type:Number})],R.prototype,"concurrency_used",void 0),e([t({type:Number})],R.prototype,"concurrency_max",void 0),e([t({type:Number})],R.prototype,"concurrency_limit",void 0),e([t({type:Object})],R.prototype,"used_slot_percent",void 0),e([t({type:Object})],R.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],R.prototype,"used_project_slot_percent",void 0),e([t({type:String})],R.prototype,"default_language",void 0),e([t({type:Boolean})],R.prototype,"_status",void 0),e([t({type:Number})],R.prototype,"num_sessions",void 0),e([t({type:String})],R.prototype,"scaling_group",void 0),e([t({type:Array})],R.prototype,"scaling_groups",void 0),e([t({type:Array})],R.prototype,"sessions_list",void 0),e([t({type:Boolean})],R.prototype,"metric_updating",void 0),e([t({type:Boolean})],R.prototype,"metadata_updating",void 0),e([t({type:Boolean})],R.prototype,"aggregate_updating",void 0),e([t({type:Object})],R.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],R.prototype,"resourceGauge",void 0),e([t({type:Boolean})],R.prototype,"project_resource_monitor",void 0),e([t({type:Object})],R.prototype,"resourceBroker",void 0),R=e([i("backend-ai-resource-monitor")],R);
/**
 @license
 ...
 */
class j extends y{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-deprecated-list-item__graphic":this.left,"mdc-deprecated-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():u``,i=this.hasMeta&&this.left?this.renderMeta():u``,o=this.renderRipple();return u`
      ${o}
      ${s}
      ${this.left?"":t}
      <span class=${b(e)}>
      ...
      ${this.left?t:""}
      ${i}`}async onChange(e){const t=e.target;this.selected===t.checked||(this._skipPropRequest=!0,this.selected=t.checked,await this.updateComplete,this._skipPropRequest=!1)}}e([g("slot")],j.prototype,"slotElement",void 0),e([g("mwc-checkbox")],j.prototype,"checkboxElement",void 0),e([v({type:Boolean})],j.prototype,"left",void 0),e([v({type:String,reflect:!0})],j.prototype,"graphic",void 0);
/**
@license
...
*/;let P=class extends j{};P.styles=[x,q],P=e([w("mwc-check-list-item")],P);let C=class extends p{constructor(){super(),this.is_connected=!1,this.enableLaunchButton=!1,this.hideLaunchButton=!1,this.location="",this.mode="normal",this.newSessionDialogTitle="",this.importScript="",this.importFilename="",this.imageRequirements=Object(),this.resourceLimits=Object(),this.userResourceLimit=Object(),this.aliases=Object(),this.tags=Object(),this.icons=Object(),this.imageInfo=Object(),this.kernel="",this.marker_limit=25,this.gpu_modes=[],this.gpu_step=.1,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.shmem_metric={min:.0625,max:1,preferred:.0625},this.cuda_device_metric={min:0,max:0},this.rocm_device_metric={min:"0",max:"0"},this.tpu_device_metric={min:"1",max:"1"},this.cluster_metric={min:1,max:1},this.cluster_mode_list=["single-node","multi-node"],this.cluster_support=!1,this.folderMapping=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.ownerFeatureInitialized=!1,this.ownerDomain="",this.project_resource_monitor=!1,this.version_selector=Object(),this._default_language_updated=!1,this._default_version_updated=!1,this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.max_cpu_core_per_session=128,this.max_mem_per_container=1536,this.max_cuda_device_per_container=16,this.max_cuda_shares_per_container=16,this.max_shm_per_container=8,this.allow_manual_image_name_for_session=!1,this.cluster_size=1,this.deleteEnvInfo=Object(),this.deleteEnvRow=Object(),this.environ_values=Object(),this.vfolder_select_expansion=Object(),this.currentIndex=1,this._grid=Object(),this._debug=!1,this._boundFolderMapRenderer=this.folderMapRenderer.bind(this),this.active=!1,this.ownerKeypairs=[],this.ownerGroups=[],this.ownerScalingGroups=[],this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.environ=[],this.init_resource()}static get is(){return"backend-ai-session-launcher"}static get styles(){return[r,a,n,l,c,d`
      ...
      <backend-ai-dialog id="help-description" fixed backdrop>
        ...
        `}
          <div style="font-size:14px;">${$(this._helpDescription)}</div>
        </div>
      </backend-ai-dialog>
...
`}};e([s("#image-name")],C.prototype,"manualImageName",void 0),e([t({type:Boolean})],C.prototype,"is_connected",void 0),e([t({type:Boolean})],C.prototype,"enableLaunchButton",void 0),e([t({type:Boolean})],C.prototype,"hideLaunchButton",void 0),e([t({type:String})],C.prototype,"location",void 0),e([t({type:String})],C.prototype,"mode",void 0),e([t({type:String})],C.prototype,"newSessionDialogTitle",void 0),e([t({type:String})],C.prototype,"importScript",void 0),e([t({type:String})],C.prototype,"importFilename",void 0),e([t({type:Object})],C.prototype,"imageRequirements",void 0),e([t({type:Object})],C.prototype,"resourceLimits",void 0),e([t({type:Object})],C.prototype,"userResourceLimit",void 0),e([t({type:Object})],C.prototype,"aliases",void 0),e([t({type:Object})],C.prototype,"tags",void 0),e([t({type:Object})],C.prototype,"icons",void 0),e([t({type:Object})],C.prototype,"imageInfo",void 0),e([t({type:String})],C.prototype,"kernel",void 0),e([t({type:Array})],C.prototype,"versions",void 0),e([t({type:Array})],C.prototype,"languages",void 0),e([t({type:Number})],C.prototype,"marker_limit",void 0),e([t({type:String})],C.prototype,"gpu_mode",void 0),e([t({type:Array})],C.prototype,"gpu_modes",void 0),e([t({type:Number})],C.prototype,"gpu_step",void 0),e([t({type:Object})],C.prototype,"cpu_metric",void 0),e([t({type:Object})],C.prototype,"mem_metric",void 0),e([t({type:Object})],C.prototype,"shmem_metric",void 0),e([t({type:Object})],C.prototype,"cuda_device_metric",void 0),e([t({type:Object})],C.prototype,"cuda_shares_metric",void 0),e([t({type:Object})],C.prototype,"rocm_device_metric",void 0),e([t({type:Object})],C.prototype,"tpu_device_metric",void 0),e([t({type:Object})],C.prototype,"cluster_metric",void 0),e([t({type:Array})],C.prototype,"cluster_mode_list",void 0),e([t({type:Boolean})],C.prototype,"cluster_support",void 0),e([t({type:Object})],C.prototype,"images",void 0),e([t({type:Object})],C.prototype,"total_slot",void 0),e([t({type:Object})],C.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],C.prototype,"total_project_slot",void 0),e([t({type:Object})],C.prototype,"used_slot",void 0),e([t({type:Object})],C.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],C.prototype,"used_project_slot",void 0),e([t({type:Object})],C.prototype,"available_slot",void 0),e([t({type:Number})],C.prototype,"concurrency_used",void 0),e([t({type:Number})],C.prototype,"concurrency_max",void 0),e([t({type:Number})],C.prototype,"concurrency_limit",void 0),e([t({type:Number})],C.prototype,"max_containers_per_session",void 0),e([t({type:Array})],C.prototype,"vfolders",void 0),e([t({type:Array})],C.prototype,"selectedVfolders",void 0),e([t({type:Array})],C.prototype,"autoMountedVfolders",void 0),e([t({type:Array})],C.prototype,"nonAutoMountedVfolders",void 0),e([t({type:Object})],C.prototype,"folderMapping",void 0),e([t({type:Object})],C.prototype,"used_slot_percent",void 0),e([t({type:Object})],C.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],C.prototype,"used_project_slot_percent",void 0),e([t({type:Array})],C.prototype,"resource_templates",void 0),e([t({type:Array})],C.prototype,"resource_templates_filtered",void 0),e([t({type:String})],C.prototype,"default_language",void 0),e([t({type:Number})],C.prototype,"cpu_request",void 0),e([t({type:Number})],C.prototype,"mem_request",void 0),e([t({type:Number})],C.prototype,"shmem_request",void 0),e([t({type:Number})],C.prototype,"gpu_request",void 0),e([t({type:String})],C.prototype,"gpu_request_type",void 0),e([t({type:Number})],C.prototype,"session_request",void 0),e([t({type:Boolean})],C.prototype,"_status",void 0),e([t({type:Number})],C.prototype,"num_sessions",void 0),e([t({type:String})],C.prototype,"scaling_group",void 0),e([t({type:Array})],C.prototype,"scaling_groups",void 0),e([t({type:Array})],C.prototype,"sessions_list",void 0),e([t({type:Boolean})],C.prototype,"metric_updating",void 0),e([t({type:Boolean})],C.prototype,"metadata_updating",void 0),e([t({type:Boolean})],C.prototype,"aggregate_updating",void 0),e([t({type:Object})],C.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],C.prototype,"resourceGauge",void 0),e([t({type:Boolean})],C.prototype,"ownerFeatureInitialized",void 0),e([t({type:String})],C.prototype,"ownerDomain",void 0),e([t({type:Array})],C.prototype,"ownerKeypairs",void 0),e([t({type:Array})],C.prototype,"ownerGroups",void 0),e([t({type:Array})],C.prototype,"ownerScalingGroups",void 0),e([t({type:Boolean})],C.prototype,"project_resource_monitor",void 0),e([t({type:Object})],C.prototype,"version_selector",void 0),e([t({type:Boolean})],C.prototype,"_default_language_updated",void 0),e([t({type:Boolean})],C.prototype,"_default_version_updated",void 0),e([t({type:String})],C.prototype,"_helpDescription",void 0),e([t({type:String})],C.prototype,"_helpDescriptionTitle",void 0),e([t({type:String})],C.prototype,"_helpDescriptionIcon",void 0),e([t({type:Number})],C.prototype,"max_cpu_core_per_session",void 0),e([t({type:Number})],C.prototype,"max_mem_per_container",void 0),e([t({type:Number})],C.prototype,"max_cuda_device_per_container",void 0),e([t({type:Number})],C.prototype,"max_cuda_shares_per_container",void 0),e([t({type:Number})],C.prototype,"max_shm_per_container",void 0),e([t({type:Boolean})],C.prototype,"allow_manual_image_name_for_session",void 0),e([t({type:Object})],C.prototype,"resourceBroker",void 0),e([t({type:Number})],C.prototype,"cluster_size",void 0),e([t({type:String})],C.prototype,"cluster_mode",void 0),e([t({type:Object})],C.prototype,"deleteEnvInfo",void 0),e([t({type:Object})],C.prototype,"deleteEnvRow",void 0),e([t({type:Array})],C.prototype,"environ",void 0),e([t({type:Object})],C.prototype,"environ_values",void 0),e([t({type:Object})],C.prototype,"vfolder_select_expansion",void 0),e([t({type:Number})],C.prototype,"currentIndex",void 0),e([t({type:Number})],C.prototype,"progressLength",void 0),e([t({type:Object})],C.prototype,"_grid",void 0),e([t({type:Boolean})],C.prototype,"_debug",void 0),e([t({type:Object})],C.prototype,"_boundFolderMapRenderer",void 0),C=e([i("backend-ai-session-launcher")],C);
