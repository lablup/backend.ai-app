import{_ as e,p as t,c as s,L as o,d as i,I as r,a as c,n as a,e as n,b as l,h as d,B as u,g as h,f as p,t as m,q as _,k as g,o as b,r as v,F as y,R as x,l as k,m as f,u as w,v as $}from"./backend-ai-console-59b588b0.js";import{u as S}from"./unsafe-html-2dc22bf5.js";import"./mwc-linear-progress-ae49378a.js";import"./mwc-slider-a90d94e7.js";import"./expansion-6946b833.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let R=class extends o{constructor(){super(...arguments),this.progress=0,this.description=""}static get styles(){return[i,r,c,a,n,l`
      .progress {
          position: relative;
          display: flex;
    ...
    `}firstUpdated(){this.progressBar=this.shadowRoot.querySelector("#front"),this.frontDesc=this.shadowRoot.querySelector("#front"),this.backDesc=this.shadowRoot.querySelector("#back"),this.progressBar.style.clipPath="inset(0 0 0 0%)"}async changePct(e){await this.updateComplete,this.progressBar.style.clipPath="inset(0 0 0 "+100*e+"%)"}async changeDesc(e){await this.updateComplete,this.frontDesc.innerHTML="&nbsp;"+e,this.backDesc.innerHTML="&nbsp;"+e}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}updated(e){}attributeChangedCallback(e,t,s){"progress"!=e||null===s||isNaN(s)||this.changePct(s),"description"!=e||null===s||s.startsWith("undefined")||this.changeDesc(s),super.attributeChangedCallback(e,t,s)}};e([t({type:Object})],R.prototype,"progressBar",void 0),e([t({type:Object})],R.prototype,"frontDesc",void 0),e([t({type:Object})],R.prototype,"backDesc",void 0),e([t({type:Number})],R.prototype,"progress",void 0),e([t({type:String})],R.prototype,"description",void 0),R=e([s("lablup-progress-bar")],R);
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let j=class extends o{constructor(){super(...arguments),this.editable=null,this.pin=null,this.markers=null,this.marker_limit=30,this.disabled=null}static get styles(){return[i,r,c,a,n,l`
        .mdc-text-field {
          height: 25px;
        }
    ...
    `}firstUpdated(){this.slider=this.shadowRoot.querySelector("#slider"),this.editable&&(this.textfield=this.shadowRoot.querySelector("#textfield"),this.textfield.style.display="flex");const e=this.shadowRoot.querySelectorAll("wl-textfield");setTimeout((()=>{e.forEach((e=>{const t=e.getAttribute("step");e.$formElement.step=t}))}),100),this.step||(this.step=1),this.checkMarkerDisplay()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}updated(e){e.forEach(((e,t)=>{if("value"===t){setTimeout((()=>{this.editable&&this.syncToSlider(),this.slider.layout()}),500);const e=new CustomEvent("value-changed",{detail:{}});this.dispatchEvent(e)}["min","max"].includes(t)&&this.checkMarkerDisplay()}));let t=new CustomEvent("changed",{detail:""});this.dispatchEvent(t)}syncToText(){this.value=this.slider.value}syncToSlider(){let e=Math.round(this.textfield.value/this.step)*this.step;var t;this.textfield.value=e.toFixed((t=this.step,Math.floor(t)===t?0:t.toString().split(".")[1].length||0)),this.textfield.value>this.max&&(this.textfield.value=this.max),this.textfield.value<this.min&&(this.textfield.value=this.min),this.value=this.textfield.value,this.slider.value=this.textfield.value,this.slider.step=this.step}checkMarkerDisplay(){this.markers&&(this.max-this.min)/this.step>this.marker_limit&&this.slider.removeAttribute("markers"),this.slider.setAttribute("step",this.step),this.slider.step=this.step}};e([t({type:Number})],j.prototype,"step",void 0),e([t({type:Number})],j.prototype,"value",void 0),e([t({type:Number})],j.prototype,"max",void 0),e([t({type:Number})],j.prototype,"min",void 0),e([t({type:Boolean})],j.prototype,"editable",void 0),e([t({type:Boolean})],j.prototype,"pin",void 0),e([t({type:Boolean})],j.prototype,"markers",void 0),e([t({type:Number})],j.prototype,"marker_limit",void 0),e([t({type:Boolean})],j.prototype,"disabled",void 0),e([t({type:Object})],j.prototype,"slider",void 0),e([t({type:Object})],j.prototype,"textfield",void 0),j=e([s("lablup-slider")],j);let q=class extends u{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[i,r,c,a,n,l`
      ...
      `:d``}
`}};e([t({type:Boolean})],q.prototype,"is_connected",void 0),e([t({type:String})],q.prototype,"direction",void 0),e([t({type:String})],q.prototype,"location",void 0),e([t({type:Object})],q.prototype,"aliases",void 0),e([t({type:Object})],q.prototype,"total_slot",void 0),e([t({type:Object})],q.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],q.prototype,"total_project_slot",void 0),e([t({type:Object})],q.prototype,"used_slot",void 0),e([t({type:Object})],q.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],q.prototype,"used_project_slot",void 0),e([t({type:Object})],q.prototype,"available_slot",void 0),e([t({type:Number})],q.prototype,"concurrency_used",void 0),e([t({type:Number})],q.prototype,"concurrency_max",void 0),e([t({type:Number})],q.prototype,"concurrency_limit",void 0),e([t({type:Object})],q.prototype,"used_slot_percent",void 0),e([t({type:Object})],q.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],q.prototype,"used_project_slot_percent",void 0),e([t({type:String})],q.prototype,"default_language",void 0),e([t({type:Boolean})],q.prototype,"_status",void 0),e([t({type:Number})],q.prototype,"num_sessions",void 0),e([t({type:String})],q.prototype,"scaling_group",void 0),e([t({type:Array})],q.prototype,"scaling_groups",void 0),e([t({type:Array})],q.prototype,"sessions_list",void 0),e([t({type:Boolean})],q.prototype,"metric_updating",void 0),e([t({type:Boolean})],q.prototype,"metadata_updating",void 0),e([t({type:Boolean})],q.prototype,"aggregate_updating",void 0),e([t({type:Object})],q.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],q.prototype,"resourceGauge",void 0),e([t({type:Boolean})],q.prototype,"project_resource_monitor",void 0),e([t({type:Object})],q.prototype,"resourceBroker",void 0),q=e([s("backend-ai-resource-monitor")],q);class P extends y{constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.value="",this.reducedTouchTarget=!1,this.animationClass="",this.shouldRenderRipple=!1,this.focused=!1,this.mdcFoundationClass=void 0,this.mdcFoundation=void 0,this.rippleElement=null,this.rippleHandlers=new x((()=>(this.shouldRenderRipple=!0,this.ripple.then((e=>this.rippleElement=e)),this.ripple)))}createAdapter(){return{}}update(e){const t=e.get("indeterminate"),s=e.get("checked"),o=e.get("disabled");if(void 0!==t||void 0!==s||void 0!==o){const e=this.calculateAnimationStateName(!!s,!!t,!!o),i=this.calculateAnimationStateName(this.checked,this.indeterminate,this.disabled);this.animationClass=`${e}-${i}`}super.update(e)}calculateAnimationStateName(e,t,s){return s?"disabled":t?"indeterminate":e?"checked":"unchecked"}renderRipple(){const e=this.indeterminate||this.checked;return this.shouldRenderRipple?d`
        <mwc-ripple
          .accent="${e}"
          .disabled="${this.disabled}"
          unbounded>
...
/**
 ...
 limitations under the License.
 */
class C extends w{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-list-item__graphic":this.left,"mdc-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():d``,o=this.hasMeta&&this.left?this.renderMeta():d``,i=this.renderRipple();return d`
      ${i}
      ${s}
      ${this.left?"":t}
      <span class=${k(e)}>
...
`}};e([t({type:Boolean})],U.prototype,"is_connected",void 0),e([t({type:Boolean})],U.prototype,"enableLaunchButton",void 0),e([t({type:Boolean})],U.prototype,"hideLaunchButton",void 0),e([t({type:String})],U.prototype,"location",void 0),e([t({type:String})],U.prototype,"mode",void 0),e([t({type:String})],U.prototype,"newSessionDialogTitle",void 0),e([t({type:String})],U.prototype,"importScript",void 0),e([t({type:String})],U.prototype,"importFilename",void 0),e([t({type:Object})],U.prototype,"imageRequirements",void 0),e([t({type:Object})],U.prototype,"resourceLimits",void 0),e([t({type:Object})],U.prototype,"userResourceLimit",void 0),e([t({type:Object})],U.prototype,"aliases",void 0),e([t({type:Object})],U.prototype,"tags",void 0),e([t({type:Object})],U.prototype,"icons",void 0),e([t({type:Object})],U.prototype,"imageInfo",void 0),e([t({type:String})],U.prototype,"kernel",void 0),e([t({type:Array})],U.prototype,"versions",void 0),e([t({type:Array})],U.prototype,"languages",void 0),e([t({type:Number})],U.prototype,"marker_limit",void 0),e([t({type:String})],U.prototype,"gpu_mode",void 0),e([t({type:Array})],U.prototype,"gpu_modes",void 0),e([t({type:Number})],U.prototype,"gpu_step",void 0),e([t({type:Object})],U.prototype,"cpu_metric",void 0),e([t({type:Object})],U.prototype,"mem_metric",void 0),e([t({type:Object})],U.prototype,"shmem_metric",void 0),e([t({type:Object})],U.prototype,"cuda_device_metric",void 0),e([t({type:Object})],U.prototype,"cuda_shares_metric",void 0),e([t({type:Object})],U.prototype,"rocm_device_metric",void 0),e([t({type:Object})],U.prototype,"tpu_device_metric",void 0),e([t({type:Object})],U.prototype,"images",void 0),e([t({type:Object})],U.prototype,"total_slot",void 0),e([t({type:Object})],U.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],U.prototype,"total_project_slot",void 0),e([t({type:Object})],U.prototype,"used_slot",void 0),e([t({type:Object})],U.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],U.prototype,"used_project_slot",void 0),e([t({type:Object})],U.prototype,"available_slot",void 0),e([t({type:Number})],U.prototype,"concurrency_used",void 0),e([t({type:Number})],U.prototype,"concurrency_max",void 0),e([t({type:Number})],U.prototype,"concurrency_limit",void 0),e([t({type:Array})],U.prototype,"vfolders",void 0),e([t({type:Array})],U.prototype,"selectedVfolders",void 0),e([t({type:Object})],U.prototype,"used_slot_percent",void 0),e([t({type:Object})],U.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],U.prototype,"used_project_slot_percent",void 0),e([t({type:Array})],U.prototype,"resource_templates",void 0),e([t({type:Array})],U.prototype,"resource_templates_filtered",void 0),e([t({type:String})],U.prototype,"default_language",void 0),e([t({type:Number})],U.prototype,"cpu_request",void 0),e([t({type:Number})],U.prototype,"mem_request",void 0),e([t({type:Number})],U.prototype,"shmem_request",void 0),e([t({type:Number})],U.prototype,"gpu_request",void 0),e([t({type:String})],U.prototype,"gpu_request_type",void 0),e([t({type:Number})],U.prototype,"session_request",void 0),e([t({type:Boolean})],U.prototype,"_status",void 0),e([t({type:Number})],U.prototype,"num_sessions",void 0),e([t({type:String})],U.prototype,"scaling_group",void 0),e([t({type:Array})],U.prototype,"scaling_groups",void 0),e([t({type:Array})],U.prototype,"sessions_list",void 0),e([t({type:Boolean})],U.prototype,"metric_updating",void 0),e([t({type:Boolean})],U.prototype,"metadata_updating",void 0),e([t({type:Boolean})],U.prototype,"aggregate_updating",void 0),e([t({type:Object})],U.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],U.prototype,"resourceGauge",void 0),e([t({type:Boolean})],U.prototype,"ownerFeatureInitialized",void 0),e([t({type:String})],U.prototype,"ownerDomain",void 0),e([t({type:Array})],U.prototype,"ownerKeypairs",void 0),e([t({type:Array})],U.prototype,"ownerGroups",void 0),e([t({type:Array})],U.prototype,"ownerScalingGroups",void 0),e([t({type:Boolean})],U.prototype,"project_resource_monitor",void 0),e([t({type:Object})],U.prototype,"version_selector",void 0),e([t({type:Boolean})],U.prototype,"_default_language_updated",void 0),e([t({type:Boolean})],U.prototype,"_default_version_updated",void 0),e([t({type:String})],U.prototype,"_helpDescription",void 0),e([t({type:String})],U.prototype,"_helpDescriptionTitle",void 0),e([t({type:String})],U.prototype,"_helpDescriptionIcon",void 0),e([t({type:Number})],U.prototype,"max_cpu_core_per_session",void 0),e([t({type:Number})],U.prototype,"max_cuda_device_per_session",void 0),e([t({type:Number})],U.prototype,"max_shm_per_session",void 0),e([t({type:Object})],U.prototype,"resourceBroker",void 0),U=e([s("backend-ai-session-launcher")],U);
