import{_ as e,p as t,q as s,c as i,L as o,d as r,I as a,a as c,n,e as l,b as d,h as u,B as p,g as h,f as m,t as g,o as _,l as y,r as v}from"./backend-ai-console-8a72459f.js";import{u as b}from"./unsafe-html-b106bbcc.js";import"./lablup-progress-bar-8be20706.js";import"./mwc-switch-99c6e035.js";import"./input-behavior-69078f84.js";import"./mwc-slider-ada5f842.js";import"./textfield-1f130d2b.js";import"./expansion-31e09bfe.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let x=class extends o{constructor(){super(...arguments),this.editable=null,this.pin=null,this.markers=null,this.marker_limit=30,this.disabled=null}static get styles(){return[r,a,c,n,l,d`
        .mdc-text-field {
          height: 25px;
        }
    ...
    `}firstUpdated(){this.editable&&(this.textfield=this.shadowRoot.querySelector("#textfield"),this.textfield.style.display="flex"),this.updateStep(),this.checkMarkerDisplay()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}updated(e){e.forEach(((e,t)=>{if("value"===t){setTimeout((()=>{this.editable&&this.syncToSlider(),this.slider.layout()}),500);const e=new CustomEvent("value-changed",{detail:{}});this.dispatchEvent(e)}["min","max"].includes(t)&&this.checkMarkerDisplay()}));let t=new CustomEvent("changed",{detail:""});this.dispatchEvent(t)}syncToText(){this.value=this.slider.value}syncToSlider(){let e=Math.round(this.textfield.value/this.step)*this.step;var t;this.textfield.value=e.toFixed((t=this.step,Math.floor(t)===t?0:t.toString().split(".")[1].length||0)),this.min=this.min>this.max?this.max:this.min,this.textfield.value>this.max&&(this.textfield.value=this.max),this.textfield.value<this.min&&(this.textfield.value=this.min),this.value=this.textfield.value,this.slider.value=this.textfield.value,this.slider.step=this.step}checkMarkerDisplay(){this.markers&&(this.max-this.min)/this.step>this.marker_limit&&this.slider.removeAttribute("markers"),this.updateStep()}updateStep(){const e=this.shadowRoot.querySelectorAll("wl-textfield");setTimeout((()=>{e.forEach((e=>{const t=e.getAttribute("step");e.$formElement.step=t}))}),100),this.step||(this.step=1),this.slider.setAttribute("step",this.step),this.slider.step=this.step}};e([t({type:Number})],x.prototype,"step",void 0),e([t({type:Number})],x.prototype,"value",void 0),e([t({type:Number})],x.prototype,"max",void 0),e([t({type:Number})],x.prototype,"min",void 0),e([t({type:Boolean})],x.prototype,"editable",void 0),e([t({type:Boolean})],x.prototype,"pin",void 0),e([t({type:Boolean})],x.prototype,"markers",void 0),e([t({type:Number})],x.prototype,"marker_limit",void 0),e([t({type:Boolean})],x.prototype,"disabled",void 0),e([t({type:Object})],x.prototype,"textfield",void 0),e([s("#slider",!0)],x.prototype,"slider",void 0),x=e([i("lablup-slider")],x);let f=class extends p{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.resourceGauge=Object(),this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[r,a,c,n,l,d`
      ...
      <div class="layout ${this.direction}-card flex wrap">
        <div id="resource-gauges" class="layout ${this.direction} ${this.direction}-panel resources flex wrap">
          ...
          <div class="layout horizontal center-justified monitor">
            <div class="layout vertical center center-justified resource-name">
              <span class="gauge-name">${g("session.launcher.Sessions")}</span>
            </div>
            <div class="layout vertical center-justified wrap">
        ...
        <div class="layout horizontal center end-justified" id="resource-gauge-toggle">
          <p style="font-size:12px;color:#242424;margin-right:10px;">
            ${g("session.launcher.ResourceMonitorToggle")}
          </p>
      ...
      <div class="vertical start-justified layout ${this.direction}-card" id="resource-legend">
        <div class="layout horizontal center start-justified resource-legend-stack">
          ...
          <span class="resource-legend">${g("session.launcher.CurrentResourceGroup")} (${this.scaling_group})</span>
        </div>
        <div class="layout horizontal center start-justified">
          <div class="resource-legend-icon end"></div>
          <span class="resource-legend">${g("session.launcher.UserResourceLimit")}</span>
        </div>
      </div>
      `:u``}
      ...
      <div class="vertical start-justified layout">
        ...
        <div class="layout horizontal center-justified monitor">
          <div class="layout vertical center center-justified" style="margin-right:5px;">
            ...
            <span class="gauge-name">${g("session.launcher.Project")}</span>
          </div>
      ...
      `:u``}
`}};e([t({type:Boolean})],f.prototype,"is_connected",void 0),e([t({type:String})],f.prototype,"direction",void 0),e([t({type:String})],f.prototype,"location",void 0),e([t({type:Object})],f.prototype,"aliases",void 0),e([t({type:Object})],f.prototype,"total_slot",void 0),e([t({type:Object})],f.prototype,"total_resource_group_slot",void 0),e([t({type:Object})],f.prototype,"total_project_slot",void 0),e([t({type:Object})],f.prototype,"used_slot",void 0),e([t({type:Object})],f.prototype,"used_resource_group_slot",void 0),e([t({type:Object})],f.prototype,"used_project_slot",void 0),e([t({type:Object})],f.prototype,"available_slot",void 0),e([t({type:Number})],f.prototype,"concurrency_used",void 0),e([t({type:Number})],f.prototype,"concurrency_max",void 0),e([t({type:Number})],f.prototype,"concurrency_limit",void 0),e([t({type:Object})],f.prototype,"used_slot_percent",void 0),e([t({type:Object})],f.prototype,"used_resource_group_slot_percent",void 0),e([t({type:Object})],f.prototype,"used_project_slot_percent",void 0),e([t({type:String})],f.prototype,"default_language",void 0),e([t({type:Boolean})],f.prototype,"_status",void 0),e([t({type:Number})],f.prototype,"num_sessions",void 0),e([t({type:String})],f.prototype,"scaling_group",void 0),e([t({type:Array})],f.prototype,"scaling_groups",void 0),e([t({type:Array})],f.prototype,"sessions_list",void 0),e([t({type:Boolean})],f.prototype,"metric_updating",void 0),e([t({type:Boolean})],f.prototype,"metadata_updating",void 0),e([t({type:Boolean})],f.prototype,"aggregate_updating",void 0),e([t({type:Object})],f.prototype,"scaling_group_selection_box",void 0),e([t({type:Object})],f.prototype,"resourceGauge",void 0),e([t({type:Boolean})],f.prototype,"project_resource_monitor",void 0),e([t({type:Object})],f.prototype,"resourceBroker",void 0),f=e([i("backend-ai-resource-monitor")],f);
/**
 @license
 ...
 */
class w extends _{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const e={"mdc-list-item__graphic":this.left,"mdc-list-item__meta":!this.left},t=this.renderText(),s=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():u``,i=this.hasMeta&&this.left?this.renderMeta():u``,o=this.renderRipple();return u`
      ${o}
      ${s}
      ${this.left?"":t}
      <span class=${y(e)}>
...
*/;let $=class extends w{};$.styles=[v,k],$=e([i("mwc-check-list-item")],$);let S=class extends p{constructor(){super(),this.is_connected=!1,this.enableLaunchButton=!1,this.hideLaunchButton=!1,this.location="",this.mode="normal",this.newSessionDialogTitle="",this.importScript="",this.importFilename="",this.imageRequirements=Object(),this.resourceLimits=Object(),this.userResourceLimit=Object(),this.aliases=Object(),this.tags=Object(),this.icons=Object(),this.imageInfo=Object(),this.kernel="",this.marker_limit=25,this.gpu_modes=[],this.gpu_step=.01,this.cpu_metric={min:"1",max:"1"},this.mem_metric={min:"1",max:"1"},this.shmem_metric={min:.0625,max:1,preferred:.0625},this.cuda_device_metric={min:0,max:0},this.rocm_device_metric={min:"0",max:"0"},this.tpu_device_metric={min:"1",max:"1"},this.cluster_metric={min:1,max:1},this.cluster_mode_list=["single-node","multi-node"],this.cluster_support=!1,this.aggregate_updating=!1,this.resourceGauge=Object(),this.ownerFeatureInitialized=!1,this.ownerDomain="",this.project_resource_monitor=!1,this.version_selector=Object(),this._default_language_updated=!1,this._default_version_updated=!1,this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.max_cpu_core_per_session=64,this.max_cuda_device_per_session=16,this.max_shm_per_session=2,this.cluster_size=1,this._debug=!1,this.active=!1,this.ownerKeypairs=[],this.ownerGroups=[],this.ownerScalingGroups=[],this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-session-launcher"}static get styles(){return[r,a,c,n,l,d`
      ...
      <wl-button raised class="primary-action" id="launch-session" ?disabled="${!this.enableLaunchButton}" @click="${()=>this._launchSessionDialog()}">
        ...
        <span>${g("session.launcher.Start")}</span>
      </wl-button>
      <backend-ai-dialog id="new-session-dialog" narrowLayout fixed backdrop persistent>
        <span slot="title">${this.newSessionDialogTitle?this.newSessionDialogTitle:g("session.launcher.StartNewSession")}</span>
        <form slot="content" id="launch-session-form" class="centered">
          <div class="vertical center layout" style="padding-top:15px;">
            <mwc-select id="environment" label="${g("session.launcher.Environments")}" fullwidth required
              value="${this.default_language}">
              <mwc-list-item selected style="dispxlay:none!important;">${g("session.launcher.ChooseEnvironment")}</mwc-list-item>
            ...
            <mwc-select id="version" label="${g("session.launcher.Version")}" fullwidth required>
              <mwc-list-item selected style="display:none!important"></mwc-list-item>
                <h5 style="font-size:12px;padding: 0 10px 3px 25px;margin:0; border-bottom:1px solid #ccc;" role="separator" disabled="true" class="horizontal layout">
                  <div style="width:80px;">${g("session.launcher.Version")}</div>
                  <div style="width:120px;">${g("session.launcher.Base")}</div>
                  <div style="width:150px;">${g("session.launcher.Requirements")}</div>
                </h5>
            ...
            <mwc-textfield id="image-name" type="text" class="flex" value=""
              label="${g("session.launcher.ManualImageName")}"></mwc-textfield>
            `:u``}
          </div>
          <div style="display:none;">
            <wl-checkbox id="use-gpu-checkbox">${g("session.launcher.UseGPU")}</wl-checkbox>
          </div>
          <div class="horizontal center layout">
            <mwc-select id="scaling-groups" label="${g("session.launcher.ResourceGroup")}" required
            ...
            <mwc-textfield id="session-name" placeholder="${g("session.launcher.SessionNameOptional")}"
                           pattern="[a-zA-Z0-9_-]{4,}" fullwidth maxLength="64"
                           helper="${g("maxLength.64chars")}"
                           validationMessage="${g("session.launcher.SessionNameAllowCondition")}"
          ...
          <wl-expansion id="vfolder-select-expansion" name="vfolder-group" style="--expansion-header-padding:16px;--expansion-content-padding:0;">
            <span slot="title" style="font-size:12px;color:#404040;">${g("session.launcher.FolderToMount")}</span>
            <mwc-list fullwidth multi id="vfolder"
              @selected="${()=>this._updateSelectedFolder()}">
            ${0===this.vfolders.length?u`
              <mwc-list-item value="" disabled="true">${g("session.launcher.NoFolderExists")}</mwc-list-item>
            `:u``}
          ...
          ${this.selectedVfolders.length>0?u`
            <div class="horizontal layout end-justified">
              <mwc-button
                  outlined
                  label="${g("session.launcher.UnSelectAllVFolders")}"
                  style="width:auto;margin-right:10px;"
                  @click=${()=>this._unselectAllSelectedFolder()}></mwc-button>
            </div>
          `:u``}
          <div class="vertical center layout" style="padding-top:15px;">
            <mwc-select id="resource-templates" label="${g("session.launcher.ResourceAllocation")}" fullwidth required>
              <mwc-list-item selected style="display:none!important"></mwc-list-item>
                <h5 style="font-size:12px;padding: 0 10px 3px 25px;margin:0; border-bottom:1px solid #ccc;" role="separator" disabled="true" class="horizontal layout center">
                  ...
                  <div style="width:50px;text-align:right;">${g("session.launcher.SharedMemory")}</div>
                  <div style="width:90px;text-align:right;">${g("session.launcher.Accelerator")}</div>
                </h5>
            ...
            ${this.isEmpty(this.resource_templates_filtered)?u`
              <mwc-list-item class="resource-button vertical center start layout" role="option"
                ...
                <div>
                  <h4>${g("session.launcher.NoSuitablePreset")}</h4>
          ...
          <wl-expansion name="resource-group" open style="--expansion-header-padding:16px;">
            <span slot="title" style="font-size:12px;color:#404040;">${g("session.launcher.CustomAllocation")}</span>
            ...
            <div class="vertical center layout">
              <div class="horizontal center layout" style="margin-top:15px;">
                ...
                <span class="caption">${g("session.launcher.Core")}</span>
            ...
            <div class="horizontal center layout">
              <div class="resource-type">${g("session.launcher.SharedMemory")}</div>
            ...
            <div class="horizontal center layout">
              <div class="resource-type">${g("console.menu.Sessions")}</div>
        ...
        <mwc-select id="cluster-mode" label="${g("session.launcher.ClusterMode")}" fullwidth required
          ...
          ${this.cluster_mode_list.map((e=>u`
            <mwc-list-item
                ...
                id="${e}"
                value="${e}"
                ?disabled="${"multi-node"===e}">
              <div class="horizontal layout center" style="width:100%;">
                <p style="width:300px;margin-left:21px;">${g("session.launcher."+e)}</p>
                <mwc-icon-button
                    icon="info"
        ...
        <div class="horizontal layout center" style="padding:0 24px 24px 24px;">
          <div class="resource-type">${g("session.launcher.ClusterSize")}</div>
          ...
          <span class="caption">${g("session.launcher.Node")}</span>
        </div>`:u``}
        <wl-expansion name="ownership" style="--expansion-header-padding:16px;--expansion-content-padding:15px 0;">
          <span slot="title" style="font-size:12px;color:#404040;">${g("session.launcher.SetSessionOwner")}</span>
          <span slot="description"></span>
          <div class="vertical layout">
            <div class="horizontal center layout">
              <mwc-textfield id="owner-email" type="email" class="flex" value=""
                pattern="^.+@.+\..+$"
                label="${g("session.launcher.OwnerEmail")}" size="40"></mwc-textfield>
              <mwc-icon-button icon="refresh" class="blue"
                @click="${()=>this._fetchSessionOwnerGroups()}">
              </mwc-icon-button>
            </div>
            <mwc-select id="owner-accesskey" label="${g("session.launcher.OwnerAccessKey")}">
            ...
            <div class="horizontal center layout">
              <mwc-select id="owner-group" label="${g("session.launcher.OwnerGroup")}">
              ...
              <mwc-select id="owner-scaling-group" label="${g("session.launcher.OwnerResourceGroup")}">
            ...
            <wl-label style="padding:15px;">
              ...
              ${g("session.launcher.LaunchSessionWithAccessKey")}
            </wl-label>
          </div>
        </wl-expansion>
      </form>
      <div slot="footer" class="horizontal center-justified flex layout distancing">
        <mwc-button
          ...
          <span id="launch-button-msg">${g("session.launcher.Launch")}</span>
        </mwc-button>
      </div>
    </backend-ai-dialog>
    ...
    <backend-ai-dialog id="launch-confirmation-dialog" warning fixed backdrop>
      <span slot="title">${g("session.launcher.NoFolderMounted")}</span>
      <div slot="content" class="vertical layout">
        <p>${g("session.launcher.HomeDirectoryDeletionDialog")}</p>
        <p>${g("session.launcher.LaunchConfirmationDialog")}</p>
        <p>${g("dialog.ask.DoYouWantToProceed")}</p>
      </div>
