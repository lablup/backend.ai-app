import{r as e,ah as t,f as i,_ as s,i as n,j as o,e as a,l as r,n as l,B as c,b as d,I as h,a as p,d as u,y as m,$ as g,g as b,t as _}from"./backend-ai-webui-ac946d0d.js";import{r as f,T as v,h as y,O as w,D as A,P as x}from"./vaadin-grid-8b758932.js";import"./vaadin-grid-selection-column-87edb5f1.js";import"./vaadin-grid-sort-column-6ba9fc72.js";import"./vaadin-grid-filter-column-bb2875be.js";import"./iconset-adeb0ab0.js";import"./expansion-09b11571.js";import"./textfield-673c2471.js";import"./backend-ai-list-status-10cd8f8b.js";import"./lablup-progress-bar-dcc76d9f.js";f("vaadin-grid-tree-toggle",e`
    :host {
        ...
        <div id="controls" class="layout horizontal flex center"
          ...
          ${this._isContainerCommitEnabled?g`
            <mwc-icon-button class="fg blue controls-running"
                             ?disabled=${this._isPending(i.item.status)||this._isPreparing(i.item.status)||this._isError(i.item.status)||this._isFinished(i.item.status)||"ongoing"===i.item.commit_status}
    ...
    `}_parseSessionInfoToCommitSessionInfo(e="",t="",i=""){const s=["",""],[n,o]=e?e.split(":"):s,[a,...r]=o?o.split("-"):s;return{environment:n,version:a,tags:r,session:{name:t,id:i}}}render(){var e,t,i;return g`
      ...
      <div class="list-wrapper">
        ...
        `:g``}
          ...
          <backend-ai-list-status id="list-status" status_condition="${this.list_condition}" message="${b("session.NoSessionToDisplay")}"></backend-ai-list-status>
        </div>
      </div>
