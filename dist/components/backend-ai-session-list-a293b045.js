      ...
      `,e)}async sendRequest(e){let t,i;try{"GET"==e.method&&(e.body=void 0),t=await fetch(e.uri,e);let s=t.headers.get("Content-Type");if(i=s.startsWith("application/json")||s.startsWith("application/problem+json")?await t.json():s.startsWith("text/")?await t.text():await t.blob(),!t.ok)throw i}catch(e){}return i}_terminateApp(e){let t=window.backendaiclient._config.accessKey,i={method:"GET",uri:this._getProxyURL()+"proxy/"+t+"/"+e};return this.sendRequest(i).then(t=>{this.total_session_count-=1;let i=window.backendaiclient._config.accessKey;if(void 0!==t&&404!==t.code){let t={method:"GET",uri:this._getProxyURL()+"proxy/"+i+"/"+e+"/delete"};return this.sendRequest(t)}return Promise.resolve(!0)}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=r.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})}_getProxyURL(){let e="http://127.0.0.1:5050/";return void 0!==window.__local_proxy?e=window.__local_proxy:void 0!==window.backendaiclient._config.proxyURL&&(e=window.backendaiclient._config.proxyURL),e}_showLogs(e){const t=e.target.closest("#controls"),i=t["session-name"],s=t["access-key"];window.backendaiclient.getLogs(i,s).then(e=>{let t=(new u).ansi_to_html(e.result.logs);setTimeout(()=>{this.shadowRoot.querySelector("#work-title").innerHTML=`${i}`,this.shadowRoot.querySelector("#work-area").innerHTML=`<pre>${t}</pre>`||"No logs.",this.shadowRoot.querySelector("#work-dialog").show()},100)}).catch(e=>{e&&e.message?(this.notification.text=r.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e)):e&&e.title&&(this.notification.text=r.relieve(e.title),this.notification.show(!0,e))})}_showAppLauncher(e){const t=e.target.closest("#controls"),i=t["session-name"],s=t["access-key"],n=t["app-services"];this.appSupportList=[],n.forEach(e=>{e in this.appTemplate?("sshd"!==e||"sshd"===e&&window.isElectron)&&this.appTemplate[e].forEach(e=>{this.appSupportList.push(e)}):["ttyd","ipython"].includes(e)||this.appSupportList.push({name:e,title:e,redirect:"",src:"./resources/icons/default_app.svg"})});let o=this.shadowRoot.querySelector("#app-dialog");o.setAttribute("session-name",i),o.setAttribute("access-key",s),o.positionTarget=e.target,this.shadowRoot.querySelector("#app-dialog").show()}_hideAppLauncher(){this.shadowRoot.querySelector("#app-dialog").hide()}async _open_wsproxy(e,t="jupyter"){if(void 0===window.backendaiclient||null===window.backendaiclient||!1===window.backendaiclient.ready)return!1;let i={endpoint:window.backendaiclient._config.endpoint};if("SESSION"===window.backendaiclient._config.connectionMode?(i.mode="SESSION",i.session=window.backendaiclient._config._session_id):(i.mode="DEFAULT",i.access_key=window.backendaiclient._config.accessKey,i.secret_key=window.backendaiclient._config.secretKey),i.api_version=window.backendaiclient.APIMajorVersion,window.isElectron&&void 0===window.__local_proxy)return this.shadowRoot.querySelector("#indicator").end(),this.notification.text="Proxy is not ready yet. Check proxy settings for detail.",this.notification.show(),Promise.resolve(!1);let s={method:"PUT",body:JSON.stringify(i),headers:{Accept:"application/json","Content-Type":"application/json"},uri:this._getProxyURL()+"conf"};this.shadowRoot.querySelector("#indicator").set(20,"Setting up proxy for the app...");try{let i=await this.sendRequest(s);if(void 0===i)return this.shadowRoot.querySelector("#indicator").end(),this.notification.text="Proxy configurator is not responding.",this.notification.show(),Promise.resolve(!1);let n=i.token;this.shadowRoot.querySelector("#indicator").set(50,"Adding kernel to socket queue...");let o={method:"GET",app:t,uri:this._getProxyURL()+"proxy/"+n+"/"+e+"/add?app="+t};return await this.sendRequest(o)}catch(e){throw e}}_runApp(e){const t=e.target;let i=t.closest("#app-dialog").getAttribute("session-name"),s=t["url-postfix"],n=t["app-name"];null!=n&&(null==s&&(s=""),void 0!==window.backendaiwsproxy&&null!==window.backendaiwsproxy||(this._hideAppLauncher(),this.shadowRoot.querySelector("#indicator").start(),this._open_wsproxy(i,n).then(e=>{"sshd"===n?(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),this.sshPort=e.port,this._readSSHKey(i),this._openSSHDialog(),setTimeout(()=>{this.shadowRoot.querySelector("#indicator").end()},1e3)):"vnc"===n?(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),this.vncPort=e.port,this._openVNCDialog(),setTimeout(()=>{this.shadowRoot.querySelector("#indicator").end()},1e3)):e.url&&(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),setTimeout(()=>{window.open(e.url+s,"_blank"),this.shadowRoot.querySelector("#indicator").end(),console.log(n+" proxy loaded: "),console.log(i)},3e3))})))}async _readSSHKey(e){const t=this.shadowRoot.querySelector("#sshkey-download-link"),i=await window.backendaiclient.download_single(e,"/home/work/id_container"),s=(await i.text()).indexOf("-----"),n=await i.slice(s,i.size,i.type);t.href=window.URL.createObjectURL(n),t.download="id_container"}_runTerminal(e){const t=e.target.closest("#controls")["session-name"];null!=window.backendaiwsproxy&&null!=window.backendaiwsproxy||(this.shadowRoot.querySelector("#indicator").start(),this._open_wsproxy(t,"ttyd").then(e=>{e.url&&(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),setTimeout(()=>{window.open(e.url,"_blank"),this.shadowRoot.querySelector("#indicator").end(),console.log("Terminal proxy loaded: "),console.log(t)},3e3))}))}_openTerminateSessionDialog(e){const t=e.target.closest("#controls"),i=t["session-name"],s=t["access-key"];this.terminateSessionDialog.sessionName=i,this.terminateSessionDialog.accessKey=s,this.terminateSessionDialog.show()}_openSSHDialog(){this.shadowRoot.querySelector("#ssh-dialog").show()}_openVNCDialog(){this.shadowRoot.querySelector("#vnc-dialog").show()}_terminateSession(e){const t=e.target.closest("#controls"),i=t["session-name"],s=t["access-key"];return this.terminationQueue.includes(i)?(this.notification.text="Already terminating the session.",this.notification.show(),!1):(this.notification.text="Terminating session...",this.notification.show(),this._terminateKernel(i,s))}_terminateSessionWithCheck(e){return this.terminationQueue.includes(this.terminateSessionDialog.sessionName)?(this.notification.text="Already terminating the session.",this.notification.show(),!1):(this.notification.text="Terminating session...",this.notification.show(),this._terminateKernel(this.terminateSessionDialog.sessionName,this.terminateSessionDialog.accessKey).then(e=>{this._selected_items=[],this._clearCheckboxes(),this.terminateSessionDialog.hide(),this.notification.text="Session terminated.",this.notification.show();let t=new CustomEvent("backend-ai-resource-refreshed",{detail:"running"});document.dispatchEvent(t)}).catch(e=>{this._selected_items=[],this._clearCheckboxes(),this.terminateSessionDialog.hide(),this.notification.text=r.relieve("Problem occurred during termination."),this.notification.show(!0,e);let t=new CustomEvent("backend-ai-resource-refreshed",{detail:"running"});document.dispatchEvent(t)}))}_openTerminateSelectedSessionsDialog(e){this.terminateSelectedSessionsDialog.show()}_clearCheckboxes(){[...this.shadowRoot.querySelectorAll("wl-checkbox.list-check")].forEach(e=>{e.removeAttribute("checked")})}_terminateSelectedSessionsWithCheck(){this.notification.text="Terminating sessions...",this.notification.show();let e=this._selected_items.map(e=>this._terminateKernel(e[this.sessionNameField],e.access_key));return this._selected_items=[],Promise.all(e).then(e=>{this.terminateSelectedSessionsDialog.hide(),this._clearCheckboxes(),this.shadowRoot.querySelector("#multiple-action-buttons").style.display="none",this.notification.text="Sessions terminated.",this.notification.show()}).catch(e=>{this.terminateSelectedSessionsDialog.hide(),this._clearCheckboxes(),this.notification.text=r.relieve("Problem occurred during termination."),this.notification.show(!0,e)})}_terminateSelectedSessions(){this.notification.text="Terminating sessions...",this.notification.show();let e=this._selected_items.map(e=>this._terminateKernel(e[this.sessionNameField],e.access_key));return Promise.all(e).then(e=>{this._selected_items=[],this._clearCheckboxes(),this.shadowRoot.querySelector("#multiple-action-buttons").style.display="none",this.notification.text="Sessions terminated.",this.notification.show()}).catch(e=>{this._selected_items=[],this._clearCheckboxes(),this.notification.text=r.relieve("Problem occurred during termination."),this.notification.show(!0,e)})}async _terminateKernel(e,t){return this.terminationQueue.push(e),this._terminateApp(e).then(()=>{window.backendaiclient.destroyKernel(e,t).then(e=>{setTimeout(()=>{this.terminationQueue=[],this.refreshList(!0,!1)},1e3)}).catch(e=>{this.refreshList(!0,!1),this.notification.text=r.relieve("Problem occurred during termination."),this.notification.show(!0,e)})}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=r.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})}_hideDialog(e){let t=e.target.closest("wl-dialog");if(t.hide(),"ssh-dialog"===t.id){const e=this.shadowRoot.querySelector("#sshkey-download-link");window.URL.revokeObjectURL(e.href)}}_updateFilterAccessKey(e){this.filterAccessKey=e.target.value,this.refreshTimer&&(clearTimeout(this.refreshTimer),this._refreshJobData())}_openExportToCsvDialog(){this.exportToCsvDialog.show()}sessionInfoRenderer(e,t,i){l(c`
        <div class="layout vertical start">
          ...
          ${i.item.sessionTags?i.item.sessionTags.map(e=>c`
            ${e.map(e=>("Env"===e.category&&(e.category=e.tag),e.category&&i.item.baseversion&&(e.tag=i.item.baseversion),c`
