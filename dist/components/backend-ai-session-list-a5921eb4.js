import{b as e,p as t,e as i,B as s,I as n,f as o,c as a,U as r,h as l}from"./iron-flex-layout-classes-c9b3b8db.js";import{P as c,h as d}from"./switch-behavior-0afc6c5f.js";import"./iron-icon-6ebc5e38.js";import"./paper-input-8c401120.js";import"./lablup-shields-5d73cdab.js";import"./iron-icons-a9a73459.js";import"./hardware-icons-fa4d541e.js";import"./vaadin-icons-f8826d26.js";import{B as h}from"./backend-ai-painkiller-d4aac244.js";import"./index-e2571378.js";import"./index-ca42e7f9.js";import{B as p}from"./backend-ai-page-4ba904fc.js";import"./lablup-loading-indicator-4b4f282b.js";import"./paper-progress-261cd2b6.js";import"./radio-behavior-815c3cf2.js";import"./av-icons-84cd112f.js";import{P as u}from"./paper-dialog-040efc33.js";import"./vaadin-grid-d9d6f695.js";import"./vaadin-grid-selection-column-c829908f.js";import"./vaadin-grid-sorter-5c13235e.js";import"./vaadin-grid-sort-column-7a3db676.js";import"./backend-ai-indicator-fd375b9d.js";var g;c({_template:d`
    <style>
      ...
      `,e)}async sendRequest(e){let t,i;try{"GET"==e.method&&(e.body=void 0);let s=(t=await fetch(e.uri,e)).headers.get("Content-Type");if(i=s.startsWith("application/json")||s.startsWith("application/problem+json")?await t.json():s.startsWith("text/")?await t.text():await t.blob(),!t.ok)throw i}catch(e){}return i}_terminateApp(e){let t=window.backendaiclient._config.accessKey,i={method:"GET",uri:this._getProxyURL()+"proxy/"+t+"/"+e};return this.sendRequest(i).then(t=>{let i=window.backendaiclient._config.accessKey;if(void 0!==t&&404!==t.code){let t={method:"GET",uri:this._getProxyURL()+"proxy/"+i+"/"+e+"/delete"};return this.sendRequest(t)}return Promise.resolve(!0)}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=h.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}_getProxyURL(){let e="http://127.0.0.1:5050/";return void 0!==window.__local_proxy?e=window.__local_proxy:void 0!==window.backendaiclient._config.proxyURL&&(e=window.backendaiclient._config.proxyURL),e}_showLogs(e){const t=e.target.closest("#controls"),i=t["kernel-id"],s=t["access-key"];window.backendaiclient.getLogs(i,s).then(e=>{let t=(new f).ansi_to_html(e.result.logs);setTimeout(()=>{this.shadowRoot.querySelector("#work-title").innerHTML=`${i}`,this.shadowRoot.querySelector("#work-area").innerHTML=`<pre>${t}</pre>`||"No logs.",this.shadowRoot.querySelector("#work-dialog").show()},100)}).catch(e=>{e&&e.message?(this.notification.text=h.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0)):e&&e.title&&(this.notification.text=h.relieve(e.title),this.notification.show(!0))})}_showAppLauncher(e){const t=e.target.closest("#controls"),i=t["kernel-id"],s=t["access-key"],n=t["app-services"];this.appSupportList=[],n.forEach(e=>{e in this.appTemplate?("sshd"!==e||"sshd"===e&&window.isElectron)&&this.appTemplate[e].forEach(e=>{this.appSupportList.push(e)}):["ttyd","ipython"].includes(e)||this.appSupportList.push({name:e,title:e,redirect:"",src:"./resources/icons/default_app.svg"})});let o=this.shadowRoot.querySelector("#app-dialog");o.setAttribute("kernel-id",i),o.setAttribute("access-key",s),o.positionTarget=e.target,this.shadowRoot.querySelector("#app-dialog").show()}_hideAppLauncher(){this.shadowRoot.querySelector("#app-dialog").hide()}async _open_wsproxy(e,t="jupyter"){if(void 0===window.backendaiclient||null===window.backendaiclient||!1===window.backendaiclient.ready)return!1;let i={endpoint:window.backendaiclient._config.endpoint};if("SESSION"===window.backendaiclient._config.connectionMode?(i.mode="SESSION",i.session=window.backendaiclient._config._session_id):(i.mode="DEFAULT",i.access_key=window.backendaiclient._config.accessKey,i.secret_key=window.backendaiclient._config.secretKey),window.isElectron&&void 0===window.__local_proxy)return this.shadowRoot.querySelector("#indicator").end(),this.notification.text="Proxy is not ready yet. Check proxy settings for detail.",this.notification.show(),Promise.resolve(!1);let s={method:"PUT",body:JSON.stringify(i),headers:{Accept:"application/json","Content-Type":"application/json"},uri:this._getProxyURL()+"conf"};this.shadowRoot.querySelector("#indicator").set(20,"Setting up proxy for the app...");try{let i=await this.sendRequest(s);if(void 0===i)return this.shadowRoot.querySelector("#indicator").end(),this.notification.text="Proxy configurator is not responding.",this.notification.show(),Promise.resolve(!1);let n=i.token;this.shadowRoot.querySelector("#indicator").set(50,"Adding kernel to socket queue...");let o={method:"GET",app:t,uri:this._getProxyURL()+"proxy/"+n+"/"+e+"/add?app="+t};return await this.sendRequest(o)}catch(e){throw e}}_runApp(e){const t=e.target;let i=t.closest("#app-dialog").getAttribute("kernel-id"),s=t["url-postfix"],n=t["app-name"];null!=n&&(null==s&&(s=""),void 0!==window.backendaiwsproxy&&null!==window.backendaiwsproxy||(this._hideAppLauncher(),this.shadowRoot.querySelector("#indicator").start(),this._open_wsproxy(i,n).then(e=>{"sshd"===n?(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),this.sshPort=e.port,this._readSSHKey(i),this._openSSHDialog(),setTimeout(()=>{this.shadowRoot.querySelector("#indicator").end()},1e3)):"vnc"===n?(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),this.vncPort=e.port,this._openVNCDialog(),setTimeout(()=>{this.shadowRoot.querySelector("#indicator").end()},1e3)):e.url&&(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),setTimeout(()=>{window.open(e.url+s,"_blank"),this.shadowRoot.querySelector("#indicator").end(),console.log(n+" proxy loaded: "),console.log(i)},1e3))})))}async _readSSHKey(e){const t=this.shadowRoot.querySelector("#sshkey-download-link"),i=await window.backendaiclient.download_single(e,"/home/work/id_container"),s=(await i.text()).indexOf("-----"),n=await i.slice(s,i.size,i.type);t.href=window.URL.createObjectURL(n),t.download="id_container"}_runTerminal(e){const t=e.target.closest("#controls")["kernel-id"];null!=window.backendaiwsproxy&&null!=window.backendaiwsproxy||(this.shadowRoot.querySelector("#indicator").start(),this._open_wsproxy(t,"ttyd").then(e=>{e.url&&(this.shadowRoot.querySelector("#indicator").set(100,"Prepared."),setTimeout(()=>{window.open(e.url,"_blank"),this.shadowRoot.querySelector("#indicator").end(),console.log("Terminal proxy loaded: "),console.log(t)},1e3))}))}_openTerminateSessionDialog(e){const t=e.target.closest("#controls"),i=t["kernel-id"],s=t["access-key"];this.terminateSessionDialog.kernelId=i,this.terminateSessionDialog.accessKey=s,this.terminateSessionDialog.show()}_openSSHDialog(){this.shadowRoot.querySelector("#ssh-dialog").show()}_openVNCDialog(){this.shadowRoot.querySelector("#vnc-dialog").show()}_terminateSession(e){const t=e.target.closest("#controls"),i=t["kernel-id"],s=t["access-key"];return this.terminationQueue.includes(i)?(this.notification.text="Already terminating the session.",this.notification.show(),!1):(this.notification.text="Terminating session...",this.notification.show(),this._terminateKernel(i,s))}_terminateSessionWithCheck(e){return this.terminationQueue.includes(this.terminateSessionDialog.kernelId)?(this.notification.text="Already terminating the session.",this.notification.show(),!1):(this.notification.text="Terminating session...",this.notification.show(),this._terminateKernel(this.terminateSessionDialog.kernelId,this.terminateSessionDialog.accessKey).then(e=>{this._selected_items=[],this._clearCheckboxes(),this.terminateSessionDialog.hide(),this.notification.text="Session terminated.",this.notification.show();let t=new CustomEvent("backend-ai-resource-refreshed",{detail:"running"});document.dispatchEvent(t)}).catch(e=>{this._selected_items=[],this._clearCheckboxes(),this.terminateSessionDialog.hide(),this.notification.text=h.relieve("Problem occurred during termination."),this.notification.show(!0);let t=new CustomEvent("backend-ai-resource-refreshed",{detail:"running"});document.dispatchEvent(t)}))}_openTerminateSelectedSessionsDialog(e){this.terminateSelectedSessionsDialog.show()}_clearCheckboxes(){[...this.shadowRoot.querySelectorAll("wl-checkbox.list-check")].forEach(e=>{e.removeAttribute("checked")})}_terminateSelectedSessionsWithCheck(){this.notification.text="Terminating sessions...",this.notification.show();let e=this._selected_items.map(e=>this._terminateKernel(e.sess_id,e.access_key));return this._selected_items=[],Promise.all(e).then(e=>{this.terminateSelectedSessionsDialog.hide(),this._clearCheckboxes(),this.shadowRoot.querySelector("#multiple-action-buttons").style.display="none",this.notification.text="Sessions terminated.",this.notification.show()}).catch(e=>{this.terminateSelectedSessionsDialog.hide(),this._clearCheckboxes(),this.notification.text=h.relieve("Problem occurred during termination."),this.notification.show(!0)})}_terminateSelectedSessions(){this.notification.text="Terminating sessions...",this.notification.show();let e=this._selected_items.map(e=>this._terminateKernel(e.sess_id,e.access_key));return Promise.all(e).then(e=>{this._selected_items=[],this._clearCheckboxes(),this.shadowRoot.querySelector("#multiple-action-buttons").style.display="none",this.notification.text="Sessions terminated.",this.notification.show()}).catch(e=>{this._selected_items=[],this._clearCheckboxes(),this.notification.text=h.relieve("Problem occurred during termination."),this.notification.show(!0)})}async _terminateKernel(e,t){return this.terminationQueue.push(e),this._terminateApp(e).then(()=>{window.backendaiclient.destroyKernel(e,t).then(e=>{setTimeout(()=>{this.terminationQueue=[],this.refreshList(!0,!1)},1e3)}).catch(e=>{this.refreshList(!0,!1),this.notification.text=h.relieve("Problem occurred during termination."),this.notification.show(!0)})}).catch(e=>{console.log(e),e&&e.message&&(this.notification.text=h.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0))})}_hideDialog(e){let t=e.target.closest("wl-dialog");if(t.hide(),"ssh-dialog"===t.id){const e=this.shadowRoot.querySelector("#sshkey-download-link");window.URL.revokeObjectURL(e.href)}}_updateFilterAccessKey(e){this.filterAccessKey=e.target.value,this.refreshTimer&&(clearTimeout(this.refreshTimer),this._refreshJobData())}sessionInfoRenderer(e,t,i){r(l`
        <div class="layout vertical start">
          ...
          ${i.item.sessionTags?i.item.sessionTags.map(e=>l`
            ${e.map(e=>("Env"===e.category&&(e.category=e.tag),i.item.baseversion&&(e.tag=i.item.baseversion),l`
                <lablup-shields app="${void 0===e.category?"":e.category}" color="${e.color}" description="${e.tag}"></lablup-shields>
              `))}
          `):l``}
          ${i.item.additional_reqs?l`
            <div class="layout horizontal center wrap">
              ${i.item.additional_reqs.map(e=>l`
                  <lablup-shields app="" color="green" description="${e}"></lablup-shields>
                `)}
            </div>
          `:l``}
        </div>
      `,e)}controlRenderer(e,t,i){r(l`
