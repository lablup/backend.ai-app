 ...
 */(this.__makeTemplateObject(["\n                        (?:                         # legal sequence\n                          (\\)                    # ESC                           |                           # alternate\n                          ()                      # BEL (what xterm did)\n                        )\n                        |                           # alternate (second attempt)\n                        (                           # illegal sequence\n                          [\0-]                 # anything illegal\n                          |                           # alternate\n                          [\b-]                 # anything illegal\n                          |                           # alternate\n                          [-]                 # anything illegal\n                        )\n                    "],["\n                        (?:                         # legal sequence\n                          (\\x1b\\\\)                    # ESC \\\n                          |                           # alternate\n                          (\\x07)                      # BEL (what xterm did)\n                        )\n                        |                           # alternate (second attempt)\n                        (                           # illegal sequence\n                          [\\x00-\\x06]                 # anything illegal\n                          |                           # alternate\n                          [\\x08-\\x1a]                 # anything illegal\n                          |                           # alternate\n                          [\\x1c-\\x1f]                 # anything illegal\n                        )\n                    "]))),this._osc_st.lastIndex=0;var n=this._osc_st.exec(this._buffer);if(null===n)return e.kind=p.Incomplete,e;if(n[3])return e.kind=p.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;var a,l=this._osc_st.exec(this._buffer);if(null===l)return e.kind=p.Incomplete,e;if(l[3])return e.kind=p.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;if(this._osc_regex||(this._osc_regex=g(this.__makeTemplateObject(["\n                        ^                           # beginning of line\n                                                    #\n                        ]8;                    # OSC Hyperlink\n                        [ -:<-~]*       # params (excluding ;)\n                        ;                           # end of params\n                        ([!-~]{0,512})        # URL capture\n                        (?:                         # ST\n                          (?:\\)                  # ESC                           |                           # alternate\n                          (?:)                    # BEL (what xterm did)\n                        )\n                        ([!-~]+)              # TEXT capture\n                        ]8;;                   # OSC Hyperlink End\n                        (?:                         # ST\n                          (?:\\)                  # ESC                           |                           # alternate\n                          (?:)                    # BEL (what xterm did)\n                        )\n                    "],["\n                        ^                           # beginning of line\n                                                    #\n                        \\x1b\\]8;                    # OSC Hyperlink\n                        [\\x20-\\x3a\\x3c-\\x7e]*       # params (excluding ;)\n                        ;                           # end of params\n                        ([\\x21-\\x7e]{0,512})        # URL capture\n                        (?:                         # ST\n                          (?:\\x1b\\\\)                  # ESC \\\n                          |                           # alternate\n                          (?:\\x07)                    # BEL (what xterm did)\n                        )\n                        ([\\x21-\\x7e]+)              # TEXT capture\n                        \\x1b\\]8;;                   # OSC Hyperlink End\n                        (?:                         # ST\n                          (?:\\x1b\\\\)                  # ESC \\\n                          |                           # alternate\n                          (?:\\x07)                    # BEL (what xterm did)\n                        )\n                    "]))),null===(a=this._buffer.match(this._osc_regex)))return e.kind=p.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;e.kind=p.OSCURL,e.url=a[1],e.text=a[2];o=a[0].length;return this._buffer=this._buffer.slice(o),e}}},e.prototype.ansi_to_html=function(e){this.append_buffer(e);for(var t=[];;){var i=this.get_next_packet();if(i.kind==p.EOS||i.kind==p.Incomplete)break;i.kind!=p.ESC&&i.kind!=p.Unknown&&(i.kind==p.Text?t.push(this.transform_to_html(this.with_state(i))):i.kind==p.SGR?this.process_ansi(i):i.kind==p.OSCURL&&t.push(this.process_hyperlink(i)))}return t.join("")},e.prototype.with_state=function(e){return{bold:this.bold,fg:this.fg,bg:this.bg,text:e.text}},e.prototype.process_ansi=function(e){for(var t=e.text.split(";");t.length>0;){var i=t.shift(),s=parseInt(i,10);if(isNaN(s)||0===s)this.fg=this.bg=null,this.bold=!1;else if(1===s)this.bold=!0;else if(22===s)this.bold=!1;else if(39===s)this.fg=null;else if(49===s)this.bg=null;else if(s>=30&&s<38)this.fg=this.ansi_colors[0][s-30];else if(s>=40&&s<48)this.bg=this.ansi_colors[0][s-40];else if(s>=90&&s<98)this.fg=this.ansi_colors[1][s-90];else if(s>=100&&s<108)this.bg=this.ansi_colors[1][s-100];else if((38===s||48===s)&&t.length>0){var o=38===s,n=t.shift();if("5"===n&&t.length>0){var a=parseInt(t.shift(),10);a>=0&&a<=255&&(o?this.fg=this.palette_256[a]:this.bg=this.palette_256[a])}if("2"===n&&t.length>2){var l=parseInt(t.shift(),10),r=parseInt(t.shift(),10),c=parseInt(t.shift(),10);if(l>=0&&l<=255&&r>=0&&r<=255&&c>=0&&c<=255){var d={rgb:[l,r,c],class_name:"truecolor"};o?this.fg=d:this.bg=d}}}}},e.prototype.transform_to_html=function(e){var t=e.text;if(0===t.length)return t;if(this._escape_for_html&&(t=this.escape_txt_for_html(t)),!e.bold&&null===e.fg&&null===e.bg)return t;var i=[],s=[],o=e.fg,n=e.bg;e.bold&&i.push("font-weight:bold"),this._use_classes?(o&&("truecolor"!==o.class_name?s.push(o.class_name+"-fg"):i.push("color:rgb("+o.rgb.join(",")+")")),n&&("truecolor"!==n.class_name?s.push(n.class_name+"-bg"):i.push("background-color:rgb("+n.rgb.join(",")+")"))):(o&&i.push("color:rgb("+o.rgb.join(",")+")"),n&&i.push("background-color:rgb("+n.rgb+")"));var a="",l="";return s.length&&(a=' class="'+s.join(" ")+'"'),i.length&&(l=' style="'+i.join(";")+'"'),"<span"+l+a+">"+t+"</span>"},e.prototype.process_hyperlink=function(e){var t=e.url.split(":");return t.length<1?"":this._url_whitelist[t[0]]?'<a href="'+this.escape_txt_for_html(e.url)+'">'+this.escape_txt_for_html(e.text)+"</a>":""},e}();function g(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];var s=e.raw[0],o=/^\s+|\s+\n|\s*#[\s\S]*?\n|\n/gm,n=s.replace(o,"");return new RegExp(n)}let b=class extends s{constructor(){super(),this.active=!0,this.condition="running",this.jobs=Object(),this.compute_sessions=Array(),this.terminationQueue=Array(),this.filterAccessKey="",this.sessionNameField="session_name",this.appSupportList=Array(),this.appTemplate=Object(),this.imageInfo=Object(),this._selected_items=Array(),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundUsageRenderer=this.usageRenderer.bind(this),this._boundSessionInfoRenderer=this.sessionInfoRenderer.bind(this),this._boundCheckboxRenderer=this.checkboxRenderer.bind(this),this._boundUserInfoRenderer=this.userInfoRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this.refreshing=!1,this.is_admin=!1,this.is_superadmin=!1,this._connectionMode="API",this._grid=Object(),this.notification=Object(),this.terminateSessionDialog=Object(),this.terminateSelectedSessionsDialog=Object(),this.exportToCsvDialog=Object(),this.enableScalingGroup=!1,this.loadingIndicator=Object(),this.refreshTimer=Object(),this.kernel_labels=Object(),this._defaultFileName="",this.statusColorTable=new Proxy({"idle-timeout":"green","user-requested":"green","failed-to-start":"red","creation-failed":"red","self-terminated":"green"},{get:(e,t)=>e.hasOwnProperty(t)?e[t]:"lightgrey"}),this.sshPort=0,this.vncPort=0,this.current_page=1,this.session_page_limit=50,this.total_session_count=0}static get styles(){return[o,n,a,l`
      ...
      `}_updateSessionPage(e){let t=e.target;"button"!==t.role&&(t=e.target.closest("wl-button")),"previous-page"===t.id?this.current_page-=1:this.current_page+=1,this.refreshList()}};e([t({type:Boolean})],b.prototype,"active",void 0),e([t({type:String})],b.prototype,"condition",void 0),e([t({type:Object})],b.prototype,"jobs",void 0),e([t({type:Array})],b.prototype,"compute_sessions",void 0),e([t({type:Array})],b.prototype,"terminationQueue",void 0),e([t({type:String})],b.prototype,"filterAccessKey",void 0),e([t({type:String})],b.prototype,"sessionNameField",void 0),e([t({type:Array})],b.prototype,"appSupportList",void 0),e([t({type:Object})],b.prototype,"appTemplate",void 0),e([t({type:Object})],b.prototype,"imageInfo",void 0),e([t({type:Array})],b.prototype,"_selected_items",void 0),e([t({type:Object})],b.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],b.prototype,"_boundUsageRenderer",void 0),e([t({type:Object})],b.prototype,"_boundSessionInfoRenderer",void 0),e([t({type:Object})],b.prototype,"_boundCheckboxRenderer",void 0),e([t({type:Object})],b.prototype,"_boundUserInfoRenderer",void 0),e([t({type:Object})],b.prototype,"_boundStatusRenderer",void 0),e([t({type:Boolean})],b.prototype,"refreshing",void 0),e([t({type:Boolean})],b.prototype,"is_admin",void 0),e([t({type:Boolean})],b.prototype,"is_superadmin",void 0),e([t({type:String})],b.prototype,"_connectionMode",void 0),e([t({type:Object})],b.prototype,"_grid",void 0),e([t({type:Object})],b.prototype,"notification",void 0),e([t({type:Object})],b.prototype,"terminateSessionDialog",void 0),e([t({type:Object})],b.prototype,"terminateSelectedSessionsDialog",void 0),e([t({type:Object})],b.prototype,"exportToCsvDialog",void 0),e([t({type:Boolean})],b.prototype,"enableScalingGroup",void 0),e([t({type:Object})],b.prototype,"loadingIndicator",void 0),e([t({type:Object})],b.prototype,"refreshTimer",void 0),e([t({type:Object})],b.prototype,"kernel_labels",void 0),e([t({type:Object})],b.prototype,"_defaultFileName",void 0),e([t({type:Proxy})],b.prototype,"statusColorTable",void 0),e([t({type:Number})],b.prototype,"sshPort",void 0),e([t({type:Number})],b.prototype,"vncPort",void 0),e([t({type:Number})],b.prototype,"current_page",void 0),e([t({type:Number})],b.prototype,"session_page_limit",void 0),e([t({type:Number})],b.prototype,"total_session_count",void 0),b=e([i("backend-ai-session-list")],b);
