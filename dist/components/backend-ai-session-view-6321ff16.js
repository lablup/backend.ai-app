import{B as t,d as e,I as i,a as s,n as a,e as o,b as n,h as r,t as c,_ as l,p as d,c as b}from"./backend-ai-console-7f55dd4f.js";import"./unsafe-html-773e2c5a.js";import"./mwc-linear-progress-c82193c0.js";import"./lablup-activity-panel-064831ac.js";import"./backend-ai-session-launcher-c50f639d.js";import"./mwc-slider-635e5ab7.js";import"./radio-behavior-39d34f9e.js";import"./expansion-110edb00.js";import"./vaadin-grid-sorter-f0db9e83.js";import"./vaadin-grid-selection-column-056a9949.js";import"./vaadin-grid-sort-column-cab34161.js";import"./iconset-a5679453.js";import"./backend-ai-session-list-dc41fc73.js";import"./json_to_csv-f333d031.js";import"./mwc-tab-bar-3f36b2e3.js";
/**
 @license
      ...
      <lablup-activity-panel elevation="1" autowidth narrow noheader>
        <div slot="message">
          <h3 class="tab horizontal center layout">
            ...
            <mwc-tab-bar>
              <mwc-tab title="running" label="${c("session.Running")}" @click="${t=>this._showTab(t.target)}"></mwc-tab>
              <mwc-tab title="finished" label="${c("session.Finished")}" @click="${t=>this._showTab(t.target)}"></mwc-tab>
              <mwc-tab title="others" label="${c("session.Others")}" @click="${t=>this._showTab(t.target)}"></mwc-tab>
            </mwc-tab-bar>
            ${this.is_admin?r`
...
`}};l([d({type:String})],u.prototype,"_status",void 0),l([d({type:Boolean})],u.prototype,"active",void 0),l([d({type:Object})],u.prototype,"_lists",void 0),l([d({type:Boolean})],u.prototype,"is_admin",void 0),u=l([b("backend-ai-session-view")],u);var h=u;export default h;
