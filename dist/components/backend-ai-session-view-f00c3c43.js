import{aj as e,i as t,ak as i,j as s,_ as n,l as o,m as a,e as r,c as l,a as c,B as d,d as p,I as h,b as u,h as m,A as g,y as b,g as _,t as v,x as f,f as y}from"./backend-ai-webui-43f3504d.js";import"./backend-ai-session-launcher-60c705cb.js";import{r as w,T as x,h as k,R as A,D as S,P as T}from"./vaadin-grid-f840c455.js";import"./vaadin-grid-selection-column-1936790e.js";import"./vaadin-grid-sort-column-42023335.js";import"./vaadin-grid-filter-column-30309305.js";import"./iconset-175c6221.js";import"./expansion-84e40fc3.js";import"./vaadin-item-styles-3f497690.js";import"./backend-ai-list-status-c409a664.js";import"./lablup-progress-bar-b432c059.js";import"./mwc-tab-bar-be651071.js";import"./lablup-activity-panel-507ecea3.js";import{J as $}from"./json_to_csv-6fce0343.js";import"./mwc-switch-151936f0.js";import"./label-72dd372f.js";import"./mwc-check-list-item-2ee94c8a.js";import"./slider-91aeef1b.js";import"./dom-repeat-69730814.js";import"./lablup-codemirror-9c04e532.js";import"./radio-behavior-797743f9.js";
/**
 * @license
    ...
    `}_parseSessionInfoToCommitSessionInfo(e="",t="",i=""){const s=["",""],[n,o]=e?e.split(":"):s,[a,...r]=o?o.split("-"):s;return{environment:n,version:a,tags:r,session:{name:t,id:i}}}render(){var e,t,i;return b`
      ...
      <div class="list-wrapper">
        <vaadin-grid id="list-grid" theme="row-stripes column-borders compact" aria-label="Session list"
          ...
          `:b``}
          <vaadin-grid-filter-column frozen path="${this.sessionNameField}" auto-width header="${v("session.SessionInfo")}" resizable
                                     .renderer="${this._boundSessionInfoRenderer}">
          </vaadin-grid-filter-column>
          <vaadin-grid-filter-column width="120px" path="status" header="${v("session.Status")}" resizable
          ...
          <vaadin-grid-column width="120px" flex-grow="0" resizable header="${v("session.Usage")}"
          ...
          <vaadin-grid-filter-column width="110px" path="architecture" header="${v("session.Architecture")}" resizable
                                     .renderer="${this._boundArchitectureRenderer}">
          </vaadin-grid-filter-column>
          ${this._isIntegratedCondition?b`
            <vaadin-grid-filter-column path="type" width="120px" flex-grow="0" text-align="center" header="${v("session.launcher.SessionType")}" resizable .renderer="${this._boundSessionTypeRenderer}"></vaadin-grid-filter-column>
        `:b``}
          ${this.is_superadmin?b`
            <vaadin-grid-column auto-width flex-grow="0" resizable header="${v("session.Agent")}"
