import{B as t,g as i,d as e,I as s,a as o,o as n,e as a,b as l,h as c,t as d,f as r,_ as h,p as u,c as p}from"./backend-ai-webui-b56c9d72.js";import{t as g}from"./translate-unsafe-html-6995d0ae.js";import"./vaadin-grid-69a293c4.js";import"./vaadin-grid-sorter-d6b9e3db.js";import"./mwc-switch-f232cf4c.js";import"./lablup-activity-panel-ff25b4dd.js";import"./unsafe-html-42013d5f.js";
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */let v=class extends t{constructor(){super(),this.images=Object(),this.options=Object(),this.schedulerOptions=Object(),this.networkOptions=Object(),this.optionsAndId=Object(),this.notification=Object(),this.imagePullingBehavior=[{name:i("settings.image.digest"),behavior:"digest"},{name:i("settings.image.tag"),behavior:"tag"},{name:i("settings.image.none"),behavior:"none"}],this.jobschedulerType=["fifo","lifo","drf"],this.selectedSchedulerType="",this._helpDescriptionTitle="",this._helpDescription="",this.optionRange=Object(),this.options={image_pulling_behavior:"digest",cuda_gpu:!1,cuda_fgpu:!1,rocm_gpu:!1,tpu:!1,schedulerType:"fifo",scheduler:{num_retries_to_skip:"0"},network:{mtu:""}},this.optionRange={numRetries:{min:0,max:1e3},mtu:{min:0}},this.optionsAndId=[{option:"num_retries_to_skip",id:"num-retries"},{option:"mtu",id:"mtu"}]}static get is(){return"backend-ai-settings-view"}static get styles(){return[e,s,o,n,a,l`
        div.indicator,
        span.indicator {
          font-size: 9px;
          margin-right: 5px;
    ...
    `}firstUpdated(){this.notification=globalThis.lablupNotification,void 0===globalThis.backendaiclient||null===globalThis.backendaiclient?document.addEventListener("backend-ai-connected",(()=>{this.updateSettings()}),!0):this.updateSettings();this.shadowRoot.querySelector("#scheduler-env-dialog").addEventListener("dialog-closing-confirm",(t=>{const i=this.shadowRoot.querySelector("#scheduler-env-container").querySelectorAll("mwc-textfield");for(const t of i){if(this.options.scheduler[this._findOptionById(t.id)]!==t.value&&""!==this.selectedSchedulerType){this.openDialog("env-config-confirmation");break}this._closeDialogWithConfirmation("scheduler-env-dialog")}}));this.shadowRoot.querySelector("#overlay-network-env-dialog").addEventListener("dialog-closing-confirm",(t=>{const i=this.shadowRoot.querySelector("#overlay-network-env-container").querySelectorAll("mwc-textfield");for(const t of i){if(this.options.network[this._findOptionById(t.id)]!==t.value){this.openDialog("env-config-confirmation");break}this._closeDialogWithConfirmation("overlay-network-env-dialog")}}))}async _viewStateChanged(t){await this.updateComplete}updatePulling(){globalThis.backendaiclient.setting.get("docker/image/auto_pull").then((t=>{null===t.result||"digest"===t.result?this.options.image_pulling_behavior="digest":"tag"===t.result?this.options.image_pulling_behavior="tag":this.options.image_pulling_behavior="none",this.update(this.options)}))}updateScheduler(){for(const[t]of Object.entries(this.options.scheduler))globalThis.backendaiclient.setting.get(`plugins/scheduler/${this.selectedSchedulerType}/${t}`).then((i=>{this.options.scheduler[t]=i.result||"0"})),this.update(this.options.scheduler)}updateNetwork(){for(const[t]of Object.entries(this.options.network))globalThis.backendaiclient.setting.get(`network/overlay/${t}`).then((i=>{this.options.network[t]=i.result||""})),this.update(this.options.network)}updateResourceSlots(){globalThis.backendaiclient.get_resource_slots().then((t=>{"cuda.device"in t&&(this.options.cuda_gpu=!0),"cuda.shares"in t&&(this.options.cuda_fgpu=!0),"rocm.device"in t&&(this.options.rocm_gpu=!0),"tpu.device"in t&&(this.options.tpu=!0),this.update(this.options)}))}updateSettings(){this.updatePulling(),this.updateScheduler(),this.updateNetwork(),this.updateResourceSlots()}updateNetworkOptionElements(){this.updateNetwork();const t=[...this.shadowRoot.querySelectorAll(".network-option")];for(const i of t){const t=this._findOptionById(i.id);i.value=this.options.network[t]||""}}setImagePullingBehavior(t){if(null===t.target.selected)return!1;const e=t.target.selected.value;return e!==this.options.image_pulling_behavior&&["none","digest","tag"].includes(e)&&globalThis.backendaiclient.setting.set("docker/image/auto_pull",e).then((t=>{this.options.image_pulling_behavior=e,this.notification.text=i("notification.SuccessfullyUpdated"),this.notification.show(),this.update(this.options),console.log(t)})),!0}_findIdByOption(t){return this.optionsAndId.find((i=>i.option===t)).id}_findOptionById(t){return this.optionsAndId.find((i=>i.id===t)).option}_clearOptions(t){this.shadowRoot.querySelector("#"+t).querySelectorAll("mwc-textfield").forEach((t=>{t.value=""}))}_openDialogWithConfirmation(t){const i=this.shadowRoot.querySelector("#"+t);i.closeWithConfirmation=!0,i.show()}_closeDialogWithConfirmation(t){const i=this.shadowRoot.querySelector("#"+t);i.closeWithConfirmation=!1,i.hide()}closeAndResetEnvInput(){const t=this.shadowRoot.querySelectorAll(".env-dialog");for(const i of t)if(i.open){const t=i.querySelector(".env-container");if(this._clearOptions(t.id),this.closeDialog("env-config-confirmation"),this._closeDialogWithConfirmation(i.id),"scheduler-env-dialog"===i.id){this.shadowRoot.querySelector("#scheduler-switch").value=null}break}}_showConfigDescription(t,e){t.stopPropagation();const s={default:{title:i("settings.ConfigPerJobSchduler"),desc:i("settings.ConfigPerJobSchdulerDescription")},retries:{title:i("settings.SessionCreationRetries"),desc:i("settings.SessionCreationRetriesDescription")+"\n"+i("settings.FifoOnly")},overlayNetwork:{title:i("settings.OverlayNetworkSettings"),desc:i("settings.OverlayNetworkSettingsDescription")},mtu:{title:"MTU",desc:i("settings.MTUDescription")}};if(e in s){this._helpDescriptionTitle=s[e].title,this._helpDescription=s[e].desc;this.shadowRoot.querySelector("#help-description").show()}}openDialog(t){this.shadowRoot.querySelector("#"+t).show()}closeDialog(t){this.shadowRoot.querySelector("#"+t).hide()}saveAndCloseDialog(){const t=this.shadowRoot.querySelector("#scheduler-switch"),e=this.shadowRoot.querySelector("#num-retries"),s=e.value,o=[t,e];if(!(o.filter((t=>t.reportValidity())).length<o.length)&&["fifo","lifo","drf"].includes(this.selectedSchedulerType))if("fifo"===this.selectedSchedulerType||"fifo"!==this.selectedSchedulerType&&"0"===s){const t={num_retries_to_skip:parseInt(s).toString()};globalThis.backendaiclient.setting.set(`plugins/scheduler/${this.selectedSchedulerType}`,t).then((e=>{this.notification.text=i("notification.SuccessfullyUpdated"),this.notification.show(),this.options.schedulerType=this.selectedSchedulerType,this.options.scheduler={...this.options.scheduler,...t},this.update(this.options),this._closeDialogWithConfirmation("scheduler-env-dialog")})).catch((t=>{this.notification.text=r.relieve("Couldn't update scheduler setting."),this.notification.detail=t,this.notification.show(!0,t)}))}else"0"!==s&&(this.notification.text=i("settings.FifoOnly"),this.notification.show(),this.shadowRoot.querySelector("#num-retries").value="0")}saveAndCloseOverlayNetworkDialog(){const t=[...this.shadowRoot.querySelectorAll(".network-option")];if(t.filter((t=>t.reportValidity())).length<t.length)return;const e={};for(const i of t){const t=this._findOptionById(i.id),s=i.value;if(""===s&&null===s&&void 0===s)return;e[t]=s}globalThis.backendaiclient.setting.set("network/overlay",e).then((t=>{this.notification.text=i("notification.SuccessfullyUpdated"),this.notification.show(),this.options.network={...this.options.network,...e},this.update(this.options),this._closeDialogWithConfirmation("overlay-network-env-dialog")})).catch((t=>{this.notification.text=r.relieve("Couldn't update scheduler setting."),this.notification.detail=t,this.notification.show(!0,t)}))}changeSelectedScheduleType(t){this.selectedSchedulerType=t.target.value,this.updateScheduler();for(const[t]of Object.entries(this.options.scheduler))globalThis.backendaiclient.setting.get(`plugins/scheduler/${this.selectedSchedulerType}/${t}`).then((i=>{this.shadowRoot.querySelector("#"+this._findIdByOption(t)).value=i.result||"0"}))}_validateInput(t){const i=t.target.closest("mwc-textfield");i.value&&(i.value=Math.round(i.value),i.min&&i.max&&(i.value=globalThis.backendaiclient.utils.clamp(i.value,i.min,i.max)))}_customizeValidationMessage(t){const e=t.target.closest("mwc-textfield");e.validityTransform=(t,s)=>s.valid?{valid:s.valid,customError:!s.valid}:s.valueMissing?(e.validationMessage=i("settings.InputRequired"),{valid:s.valid,customError:!s.valid}):s.rangeOverflow||s.rangeUnderflow?(e.validationMessage=i("settings.OutOfRange"),{valid:s.valid,customError:!s.valid}):(e.validationMessage=i("settings.InvalidValue"),{valid:s.valid,customError:!s.valid})}};h([u({type:Object})],v.prototype,"images",void 0),h([u({type:Object})],v.prototype,"options",void 0),h([u({type:Object})],v.prototype,"schedulerOptions",void 0),h([u({type:Object})],v.prototype,"networkOptions",void 0),h([u({type:Object})],v.prototype,"optionsAndId",void 0),h([u({type:Object})],v.prototype,"notification",void 0),h([u({type:Array})],v.prototype,"imagePullingBehavior",void 0),h([u({type:Array})],v.prototype,"jobschedulerType",void 0),h([u({type:String})],v.prototype,"selectedSchedulerType",void 0),h([u({type:String})],v.prototype,"_helpDescriptionTitle",void 0),h([u({type:String})],v.prototype,"_helpDescription",void 0),h([u({type:Object})],v.prototype,"optionRange",void 0),v=h([p("backend-ai-settings-view")],v);var m=v;export{m as default};
