import{B as i,g as t,d as e,I as s,a,n as l,e as n,b as c,h as o,t as d,f as r,_ as u,p as g,c as p}from"./backend-ai-console-b3bc0c77.js";import"./unsafe-html-c7981cc9.js";import{t as h}from"./translate-unsafe-html-9659af02.js";import"./lablup-activity-panel-87f56c48.js";import"./mwc-switch-8f4c4df0.js";import"./vaadin-grid-sorter-3c5cee99.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let v=class extends i{constructor(){super(),this.images=Object(),this.options=Object(),this.notification=Object(),this.imagePullingBehavior=[{name:t("settings.image.digest"),behavior:"digest"},{name:t("settings.image.tag"),behavior:"tag"},{name:t("settings.image.none"),behavior:"none"}],this.jobschedulerType=["fifo","lifo","drf"],this.options={image_pulling_behavior:"digest",cuda_gpu:!1,cuda_fgpu:!1,rocm_gpu:!1,tpu:!1,scheduler:"fifo"}}static get is(){return"backend-ai-settings-view"}static get styles(){return[e,s,a,l,n,c`
        div.indicator,
        span.indicator {
          font-size: 9px;
          margin-right: 5px;
          ...
          <div slot="message" class="horizontal wrap layout">
            ...
            <div class="horizontal layout setting-item">
              ...
              <div class="vertical center-justified layout">
                ...
                ${this.imagePullingBehavior.map((i=>o`
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${h("settings.DescCUDAGPUsupport")}
                        ${this.options.cuda_fgpu?o`<br />${d("settings.CUDAGPUdisabledByFGPUsupport")}`:o``}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
