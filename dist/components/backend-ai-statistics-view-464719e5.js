import{_ as t,p as e,c as a,k as i,I as s,j as o,ad as l,l as c,a as n,h as r}from"./backend-ai-console-f442a6b8.js";import{B as d}from"./backend-ai-page-98b8ad16.js";import"./radio-behavior-0dc5181d.js";import"./backend-ai-chart-6e9380c6.js";import"./index-eb0bd4f9.js";import"./index-2ca25cb7.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let h=class extends d{constructor(){super(),this._map={num_sessions:"Sessions",cpu_allocated:"CPU",mem_allocated:"Memory",gpu_allocated:"GPU",io_read_bytes:"IO-Read",io_write_bytes:"IO-Write"},this.templates={"1D":{interval:1,length:96},"1W":{interval:1,length:672}},this.collection=Object(),this.period="1D",this.updating=!1,this.data=[]}static get styles(){return[i,s,o,l,c,n`
        wl-select {
      ...
      <wl-card elevation="0">
        ...
        ${Object.keys(this.collection).length>0?Object.keys(this._map).map((t,e)=>r`
          <wl-card>
            <h3 class="horizontal center layout">
...
/**
 ...
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let p=class extends d{constructor(){super(),this._status="inactive"}static get styles(){return[i,s,o,l,c,n`
        wl-card h3.tab {
          padding-top: 0;
          padding-bottom: 0;
          padding-left: 0;
