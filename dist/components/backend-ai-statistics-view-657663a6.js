import{_ as e,p as t,c as a,L as s,I as i,a as l,n as o,e as r,b as c,h as n,t as d,B as p,d as h}from"./backend-ai-webui-3ec8f434.js";import"./tab-group-d129e362.js";import"./mwc-tab-bar-8c51f988.js";import"./backend-ai-chart-2c0a493c.js";import"./radio-behavior-0fcc9e22.js";import"./rowing-f8414618.js";import"./chart-js-43641e3e.js";
/**
 @license
 ...
 */
let m=class extends p{constructor(){super(),this._map={num_sessions:"Sessions",cpu_allocated:"CPU",mem_allocated:"Memory",gpu_allocated:"GPU",io_read_bytes:"IO-Read",io_write_bytes:"IO-Write"},this.templates={"1D":{interval:1,length:96},"1W":{interval:1,length:672}},this.collection=Object(),this.period="1D",this.updating=!1,this.elapsedDays=0,this.data=[]}static get styles(){return[h,i,l,o,r,c`
        mwc-select {
          width: 100%;
    ...
    `}};e([t({type:Object})],m.prototype,"_map",void 0),e([t({type:Object})],m.prototype,"templates",void 0),e([t({type:Object})],m.prototype,"collection",void 0),e([t({type:String})],m.prototype,"period",void 0),e([t({type:Boolean})],m.prototype,"updating",void 0),e([t({type:Number})],m.prototype,"elapsedDays",void 0),m=e([a("backend-ai-usage-list")],m);
/**
 @license
 Copyright (c) 2015-2021 Lablup Inc. All rights reserved.
 */
let b=class extends p{constructor(){super(),this._status="inactive"}static get styles(){return[h,i,l,o,r,c`
        wl-card h3.tab {
          padding-top: 0;
          padding-bottom: 0;
          padding-left: 0;
      ...
      `}};e([t({type:String})],b.prototype,"_status",void 0),b=e([a("backend-ai-statistics-view")],b);var g=b;export default g;
