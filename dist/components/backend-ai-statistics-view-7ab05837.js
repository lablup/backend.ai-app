...
/**
 ...
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */
let p=class extends d{constructor(){super(),this._status="inactive"}static get styles(){return[i,s,o,l,n,c`
        wl-card h3.tab {
          padding-top: 0;
          padding-bottom: 0;
          padding-left: 0;
