import{_ as e,e as t,a,s as i,I as s,b as l,x as o,f as r,i as c,y as n,t as d,c as p,B as h,d as u}from"./backend-ai-webui-0215d394.js";import"./progress-spinner-484cf32f.js";import"./tab-group-6407936f.js";import"./mwc-tab-bar-e493c49d.js";import"./backend-ai-chart-7d8204e4.js";import"./radio-behavior-acd3c884.js";import"./chart-js-9a1f045e.js";
/**
 @license
 Copyright (c) 2015-2020 Lablup Inc. All rights reserved.
 */let v=class extends i{constructor(){super(),this.num_sessions=0,this.used_time="0:00:00.00",this.cpu_used_time="0:00:00.00",this.gpu_used_time="0:00:00.00",this.disk_used=0,this.traffic_used=0}static get styles(){return[s,l,o,r,c`
        wl-card {
          padding: 20px;
        }
 ...
 */
let m=class extends h{constructor(){super(),this._map={num_sessions:"Sessions",cpu_allocated:"CPU",mem_allocated:"Memory",gpu_allocated:"GPU",io_read_bytes:"IO-Read",io_write_bytes:"IO-Write"},this.templates={"1D":{interval:1,length:96},"1W":{interval:1,length:672}},this.collection=Object(),this.period="1D",this.updating=!1,this.elapsedDays=0,this.data=[]}static get styles(){return[u,s,l,o,r,c`
        mwc-select {
          width: 100%;
    ...
    `}};e([t({type:Object})],m.prototype,"_map",void 0),e([t({type:Object})],m.prototype,"templates",void 0),e([t({type:Object})],m.prototype,"collection",void 0),e([t({type:String})],m.prototype,"period",void 0),e([t({type:Boolean})],m.prototype,"updating",void 0),e([t({type:Number})],m.prototype,"elapsedDays",void 0),e([p("#period-selector")],m.prototype,"periodSelec",void 0),m=e([a("backend-ai-usage-list")],m);
/**
 @license
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */
let b=class extends h{constructor(){super(...arguments),this._status="inactive"}static get styles(){return[u,s,l,o,r,c`
        wl-card h3.tab {
          padding-top: 0;
          padding-bottom: 0;
          padding-left: 0;
      ...
      `}};e([t({type:String})],b.prototype,"_status",void 0),b=e([a("backend-ai-statistics-view")],b);var g=b;export{g as default};
