import{b as t,p as e,e as a,B as i,I as s,f as o,g as l,i as r,c,h as n}from"./iron-flex-layout-classes-c9b3b8db.js";import"./switch-behavior-30fde1cf.js";import"./iron-icon-270f343c.js";import"./input-behavior-22f7c31e.js";import"./index-0bbfdd62.js";import"./index-41b64f0a.js";import"./resize-b38d87a6.js";import{B as d}from"./backend-ai-page-4ba904fc.js";import"./radio-behavior-59efa73e.js";import"./backend-ai-chart-29e24edd.js";import"./index-6835b5eb.js";import"./index-7f5527b9.js";let h=class extends d{constructor(){super(),this._map={num_sessions:"Sessions",cpu_allocated:"CPU",mem_allocated:"Memory",gpu_allocated:"GPU",io_read_bytes:"IO-Read",io_write_bytes:"IO-Write"},this.templates={"1D":{interval:1,length:96},"1W":{interval:1,length:672}},this.collection=Object(),this.period="1D",this.updating=!1,this.data=[]}static get styles(){return[i,s,o,l,r,c`
        wl-select {
    ...
    `}};t([e({type:Object})],h.prototype,"_map",void 0),t([e({type:Object})],h.prototype,"templates",void 0),t([e({type:Object})],h.prototype,"collection",void 0),t([e({type:String})],h.prototype,"period",void 0),t([e({type:Boolean})],h.prototype,"updating",void 0),h=t([a("backend-ai-usage-list")],h);let p=class extends d{constructor(){super(),this._status="inactive"}static get styles(){return[i,s,o,l,r,c`
        wl-card h3.tab {
          padding-top: 0;
          padding-bottom: 0;
          padding-left: 0;
