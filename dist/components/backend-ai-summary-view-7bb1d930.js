import{_ as t,p as e,c as i,L as s,I as a,a as r,b as o,h as n,d as l,e as c,f as d,g as p,t as u}from"./backend-ai-console-f3f55dfb.js";import"./unsafe-html-218cb279.js";import"./lablup-loading-indicator-f881de2e.js";import"./iron-resizable-behavior-de55f964.js";import"./vaadin-progress-bar-1df69f2a.js";import"./mwc-linear-progress-6563fca2.js";import"./backend-ai-chart-493b4d27.js";import"./paper-dropdown-menu-4a6caa86.js";import"./iron-iconset-svg-9534ec82.js";import"./paper-item-74fde806.js";import"./mwc-select-1b350a7d.js";import"./backend-ai-resource-monitor-79b91f70.js";import"./radio-behavior-38c198d4.js";import"./expansion-9cb7b1da.js";import"./label-580b3f1c.js";let h=class extends s{constructor(){super(),this.title="",this.message="",this.panelId="",this.horizontalsize="",this.elevation=1,this.width=280,this.marginWidth=16,this.minwidth=0,this.maxwidth=0,this.pinned=!1,this.disabled=!1}static get styles(){return[a,r,o`
        wl-card {
          display: block;
          background: white;
...
let m=class extends l{constructor(){super(),this.condition="running",this.sessions=0,this.jobs=Object(),this.agents=0,this.is_admin=!1,this.is_superadmin=!1,this.resources=Object(),this.authenticated=!1,this.manager_version="",this.console_version="",this.cpu_total=0,this.cpu_used=0,this.cpu_percent="0",this.cpu_total_percent="0",this.cpu_total_usage_ratio=0,this.cpu_current_usage_ratio=0,this.mem_total="0",this.mem_used="0",this.mem_allocated="0",this.mem_total_usage_ratio=0,this.mem_current_usage_ratio=0,this.mem_current_usage_percent="0",this.gpu_total=0,this.gpu_used=0,this.fgpu_total=0,this.fgpu_used=0,this.indicator=Object(),this.notification=Object(),this.invitations=[]}static get styles(){return[c,a,r,d,o`
      ...
      ${this.invitations?this.invitations.map(t=>n`
            <lablup-activity-panel title="${u("summary.Invitation")}>
              <div slot="message">
                <h3>From ${t.inviter}</h3>
                <span class="invitation_folder_name">${u("summary.FolderName")}>: ${t.vfolder_name}</span>
                <div class="horizontal center layout">
                ${u("summary.Permission")}>:
                ${[...t.perm].map(t=>n`
