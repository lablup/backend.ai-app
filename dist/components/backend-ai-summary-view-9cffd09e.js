import{_ as t,p as e,c as i,L as s,I as a,j as o,a as r,h as n,k as l,l as p,m as c}from"./backend-ai-console-718d5a3e.js";import{B as d}from"./backend-ai-page-c59393e6.js";import"./lablup-loading-indicator-54b72e1f.js";import"./iron-resizable-behavior-1f5cdd15.js";import"./vaadin-progress-bar-16f22031.js";import"./paper-progress-6c363ba2.js";import"./radio-behavior-7e75b48a.js";import"./backend-ai-chart-2279faba.js";import"./backend-ai-dropdown-menu-66ab9bdb.js";import"./shadow-3fef5787.js";import"./paper-dropdown-menu-57100142.js";import"./index-3acb4c92.js";import"./index-2191793f.js";import"./backend-ai-resource-monitor-ac6a75da.js";let u=class extends s{constructor(){super(),this.title="",this.message="",this.panelId="",this.horizontalsize="",this.elevation=1,this.width=280,this.marginWidth=16,this.minwidth=0,this.maxwidth=0,this.pinned=!1}static get styles(){return[a,o,r`
        wl-card {
          display: block;
          background: white;
 ...
 */
let h=class extends d{constructor(){super(),this.condition="running",this.sessions=0,this.jobs=Object(),this.agents=0,this.is_admin=!1,this.is_superadmin=!1,this.resources=Object(),this.authenticated=!1,this.manager_version="",this.cpu_total=0,this.cpu_used=0,this.cpu_percent="0",this.cpu_total_percent="0",this.cpu_total_usage_ratio=0,this.cpu_current_usage_ratio=0,this.mem_total="0",this.mem_used="0",this.mem_allocated="0",this.mem_total_usage_ratio=0,this.mem_current_usage_ratio=0,this.mem_current_usage_percent="0",this.gpu_total=0,this.gpu_used=0,this.fgpu_total=0,this.fgpu_used=0,this.indicator=Object(),this.notification=Object(),this.invitations=[]}static get styles(){return[l,a,o,p,r`
        ul {
          padding-left: 0;
        }
