import{_ as t,e,n as i,B as a,b as s,I as o,a as r,r as l,y as n,$ as c,t as d,g as p,x as g,c as h,ar as u,d as b,as as m}from"./backend-ai-webui-ac946d0d.js";import"./switch-6ea5d115.js";import"./select-eec89b38.js";import"./tab-group-c1454b52.js";import"./mwc-tab-bar-f5180fe5.js";import"./lablup-activity-panel-bfe30f45.js";import"./lablup-codemirror-9efb36b6.js";import"./lablup-loading-spinner-7e225b78.js";import"./vaadin-grid-8b758932.js";import"./vaadin-grid-selection-column-87edb5f1.js";import"./vaadin-grid-sort-column-6ba9fc72.js";import"./iconset-adeb0ab0.js";import"./expansion-09b11571.js";import"./label-1fae8d8f.js";import"./backend-ai-list-status-10cd8f8b.js";import{t as v}from"./translate-unsafe-html-2a492c82.js";import"./mwc-switch-58b198dd.js";import"./mwc-textarea-8f6f9a88.js";import"./input-behavior-e48ce742.js";import"./radio-behavior-a8529ed3.js";import"./progress-spinner-34b29b8c.js";import"./dom-repeat-41a04999.js";let f=class extends a{constructor(){super(),this.timestamp="",this.errorType="",this.requestUrl="",this.statusCode="",this.statusText="",this.title="",this.message="",this.logs=[],this._selected_items=[],this.list_status=Object(),this.list_condition="loading",this._grid=Object(),this.logView=[],this._pageSize=25,this._currentPage=1,this._totalLogCount=0,this.boundTimeStampRenderer=this.timeStampRenderer.bind(this),this.boundStatusRenderer=this.statusRenderer.bind(this),this.boundErrTitleRenderer=this.errTitleRenderer.bind(this),this.boundErrMsgRenderer=this.errMsgRenderer.bind(this),this.boundErrTypeRenderer=this.errTypeRenderer.bind(this),this.boundMethodRenderer=this.methodRenderer.bind(this),this.boundReqUrlRenderer=this.reqUrlRender.bind(this),this.boundParamRenderer=this.paramRenderer.bind(this)}static get styles(){return[s,o,r,l`
        vaadin-grid {
          width: 100%;
          border: 0;
          font-size: 12px;
      ...
      `]}firstUpdated(){this.list_status=this.shadowRoot.querySelector("#list-status"),this._updatePageItemSize(),this._grid=this.shadowRoot.querySelector("#list-grid"),globalThis.backendaiclient&&globalThis.backendaiclient.is_admin||(this.shadowRoot.querySelector("vaadin-grid").style.height="calc(100vh - 275px)!important"),this.notification=globalThis.lablupNotification,document.addEventListener("log-message-refresh",(()=>this._refreshLogData())),document.addEventListener("log-message-clear",(()=>this._clearLogData()))}_updatePageItemSize(){const t=window.innerHeight-275-30;this._pageSize=Math.floor(t/31)}_refreshLogData(){this.list_condition="loading",this.list_status.show(),this._updatePageItemSize(),this.logs=JSON.parse(localStorage.getItem("backendaiwebui.logs")||"{}"),this._totalLogCount=this.logs.length>0?this.logs.length:1,this._updateItemsFromPage(1),this._grid.clearCache(),0==this.logs.length?this.list_condition="no-data":this.list_status.hide()}_clearLogData(){this.logs=[],this.logView=[],this._totalLogCount=1,this._currentPage=1,this._grid.clearCache()}_updateItemsFromPage(t){if("number"!=typeof t){let e=t.target;"button"!==e.role&&(e=t.target.closest("mwc-icon-button")),"previous-page"===e.id?this._currentPage-=1:this._currentPage+=1}const e=(this._currentPage-1)*this._grid.pageSize,i=this._currentPage*this._grid.pageSize;if(this.logs.length>0){const t=this.logs.slice(e,i);t.forEach((t=>{t.timestamp_hr=this._humanReadableTime(t.timestamp)})),this.logView=t}}_humanReadableTime(t){return(t=new Date(t)).toLocaleString("en-US",{hour12:!1})}_toISOTime(t){return(t=new Date(t)).toISOString()}timeStampRenderer(t,e,i){n(c`
        <div class="layout vertical">
          <span class="monospace ${i.item.isError?"error-cell":""}">${i.item.timestamp_hr}</span>
        </div>`,t)}statusRenderer(t,e,i){n(c`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">${i.item.statusCode+" "+i.item.statusText}</span>
        </div>`,t)}errTitleRenderer(t,e,i){n(c`
      <div class="layout vertical">
        <span class="${i.item.isError?"error-cell":""}">${i.item.title}</span>
      </div>`,t)}errMsgRenderer(t,e,i){n(c`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">${i.item.message}</span>
        </div>`,t)}errTypeRenderer(t,e,i){n(c`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">${i.item.type}</span>
        </div>`,t)}methodRenderer(t,e,i){n(c`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">${i.item.requestMethod}</span>
        </div>`,t)}reqUrlRender(t,e,i){n(c`
        <div class="layout vertical">
          <span class="monospace ${i.item.isError?"error-cell":""}">${i.item.requestUrl}</span>
        </div>`,t)}paramRenderer(t,e,i){n(c`
        <div class="layout vertical">
          <span class="monospace ${i.item.isError?"error-cell":""}">${i.item.requestParameters}</span>
        </div>`,t)}render(){return c`
      ...
      <div class="list-wrapper">
        ...
        <backend-ai-list-status id="list-status" status_condition="${this.list_condition}" message="${p("logs.NoLogToDisplay")}"></backend-ai-list-status>
      </div>
    ...
    `}};t([e({type:String})],f.prototype,"timestamp",void 0),t([e({type:String})],f.prototype,"errorType",void 0),t([e({type:String})],f.prototype,"requestUrl",void 0),t([e({type:String})],f.prototype,"statusCode",void 0),t([e({type:String})],f.prototype,"statusText",void 0),t([e({type:String})],f.prototype,"title",void 0),t([e({type:String})],f.prototype,"message",void 0),t([e({type:Array})],f.prototype,"logs",void 0),t([e({type:Array})],f.prototype,"_selected_items",void 0),t([e({type:Object})],f.prototype,"list_status",void 0),t([e({type:String})],f.prototype,"list_condition",void 0),t([e({type:Object})],f.prototype,"_grid",void 0),t([e({type:Array})],f.prototype,"logView",void 0),t([e({type:Number})],f.prototype,"_pageSize",void 0),t([e({type:Number})],f.prototype,"_currentPage",void 0),t([e({type:Number})],f.prototype,"_totalLogCount",void 0),t([e({type:Object})],f.prototype,"boundTimeStampRenderer",void 0),t([e({type:Object})],f.prototype,"boundStatusRenderer",void 0),t([e({type:Object})],f.prototype,"boundErrTitleRenderer",void 0),t([e({type:Object})],f.prototype,"boundErrMsgRenderer",void 0),t([e({type:Object})],f.prototype,"boundErrTypeRenderer",void 0),t([e({type:Object})],f.prototype,"boundMethodRenderer",void 0),t([e({type:Object})],f.prototype,"boundReqUrlRenderer",void 0),t([e({type:Object})],f.prototype,"boundParamRenderer",void 0),f=t([i("backend-ai-error-log-list")],f);let y=class extends a{constructor(){super(),this.lastSavedBootstrapScript="",this.bootstrapDialog=Object(),this.userconfigDialog=Object(),this.supportLanguages=[{name:d("language.OSDefault"),code:"default"},{name:d("language.English"),code:"en"},{name:d("language.Korean"),code:"ko"},{name:d("language.Russian"),code:"ru"},{name:d("language.French"),code:"fr"},{name:d("language.Mongolian"),code:"mn"},{name:d("language.Indonesian"),code:"id"}],this.beta_feature_panel=!1,this.shell_script_edit=!1,this.rcfile="",this.prevRcfile="",this.preferredSSHPort="",this.publicSSHkey="",this.rcfiles=[]}static get styles(){return[s,o,r,g,h,l`
      ...
      `]}firstUpdated(){this.notification=globalThis.lablupNotification,this.spinner=this.shadowRoot.querySelector("#loading-spinner")}async _viewStateChanged(t){await this.updateComplete,!1!==t&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?(document.addEventListener("backend-ai-connected",(()=>{this.preferredSSHPort=globalThis.backendaioptions.get("custom_ssh_port")})),globalThis.backendaiclient.isAPIVersionCompatibleWith("v4.20191231")&&(this.shell_script_edit=!0,this.bootstrapDialog=this.shadowRoot.querySelector("#bootstrap-dialog"),this.userconfigDialog=this.shadowRoot.querySelector("#userconfig-dialog"),this.rcfile=".bashrc")):(this.preferredSSHPort=globalThis.backendaioptions.get("custom_ssh_port"),globalThis.backendaiclient.isAPIVersionCompatibleWith("v4.20191231")&&(this.shell_script_edit=!0,this.bootstrapDialog=this.shadowRoot.querySelector("#bootstrap-dialog"),this.userconfigDialog=this.shadowRoot.querySelector("#userconfig-dialog"),this.rcfile=".bashrc")),this.userconfigDialog.addEventListener("dialog-closing-confirm",(()=>{const t=this.shadowRoot.querySelector("#usersetting-editor").getValue(),e=this.rcfiles.findIndex((t=>t.path===this.rcfile));this.rcfiles[e].data!==t?(this.prevRcfile=this.rcfile,this._launchChangeCurrentEditorDialog()):(this.userconfigDialog.closeWithConfirmation=!1,this.userconfigDialog.hide())})))}toggleDesktopNotification(t){!1===t.target.selected?(globalThis.backendaioptions.set("desktop_notification",!1),this.notification.supportDesktopNotification=!1):(globalThis.backendaioptions.set("desktop_notification",!0),this.notification.supportDesktopNotification=!0)}toggleCompactSidebar(t){!1===t.target.selected?globalThis.backendaioptions.set("compact_sidebar",!1):globalThis.backendaioptions.set("compact_sidebar",!0)}togglePreserveLogin(t){!1===t.target.selected?globalThis.backendaioptions.set("preserve_login",!1):globalThis.backendaioptions.set("preserve_login",!0)}toggleAutoLogout(t){if(!1===t.target.selected){globalThis.backendaioptions.set("auto_logout",!1);const t=new CustomEvent("backend-ai-auto-logout",{detail:!1});document.dispatchEvent(t)}else{globalThis.backendaioptions.set("auto_logout",!0);const t=new CustomEvent("backend-ai-auto-logout",{detail:!0});document.dispatchEvent(t)}}toggleAutomaticUploadCheck(t){!1===t.target.selected?globalThis.backendaioptions.set("automatic_update_check",!1):(globalThis.backendaioptions.set("automatic_update_check",!0),globalThis.backendaioptions.set("automatic_update_count_trial",0))}setUserLanguage(t){if(t.target.selected.value!==globalThis.backendaioptions.get("language")){let e=t.target.selected.value;"default"===e&&(e=globalThis.navigator.language.split("-")[0]),globalThis.backendaioptions.set("language",t.target.selected.value),globalThis.backendaioptions.set("current_language",e),u(e),setTimeout((()=>{const t=this.shadowRoot.querySelector("#ui-language");t.selectedText=t.selected.textContent.trim()}),100)}}changePreferredSSHPort(t){const e=Number(t.target.value);if(e!==globalThis.backendaioptions.get("custom_ssh_port",""))if(0!==e&&e){if(e<1024||e>65534)return this.notification.text=p("usersettings.InvalidPortNumber"),void this.notification.show();globalThis.backendaioptions.set("custom_ssh_port",e)}else globalThis.backendaioptions.delete("custom_ssh_port")}toggleBetaFeature(t){!1===t.target.selected?(globalThis.backendaioptions.set("beta_feature",!1),this.beta_feature_panel=!1):(globalThis.backendaioptions.set("beta_feature",!0),this.beta_feature_panel=!0)}_fetchBootstrapScript(){return globalThis.backendaiclient.userConfig.get_bootstrap_script().then((t=>{const e=t||"";return this.lastSavedBootstrapScript=e,e})).catch((t=>{console.log(t),t&&t.message&&(this.notification.text=b.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}async _saveBootstrapScript(){const t=this.shadowRoot.querySelector("#bootstrap-editor").getValue();if(this.lastSavedBootstrapScript===t)return this.notification.text=p("resourceGroup.NochangesMade"),void this.notification.show();this.spinner.show(),globalThis.backendaiclient.userConfig.update_bootstrap_script(t).then((t=>{this.notification.text=p("usersettings.BootstrapScriptUpdated"),this.notification.show(),this.spinner.hide()}))}async _saveBootstrapScriptAndCloseDialog(){await this._saveBootstrapScript(),this._hideBootstrapScriptDialog()}async _launchBootstrapScriptDialog(){const t=this.shadowRoot.querySelector("#bootstrap-editor"),e=await this._fetchBootstrapScript();t.setValue(e),t.focus(),this.bootstrapDialog.show()}_hideBootstrapScriptDialog(){this.bootstrapDialog.hide()}async _editUserConfigScript(){const t=this.shadowRoot.querySelector("#usersetting-editor");this.rcfiles=await this._fetchUserConfigScript();[".bashrc",".zshrc",".tmux.conf.local",".vimrc",".Renviron"].map((e=>{const i=this.rcfiles.findIndex((t=>t.path===e));if(-1===i)this.rcfiles.push({path:e,data:""}),t.setValue("");else{const e=this.rcfiles[i].data;t.setValue(e)}}));[".tmux.conf"].forEach((t=>{const e=this.rcfiles.findIndex((e=>e.path===t));e>-1&&this.rcfiles.splice(e,1)}));const e=this.rcfiles.findIndex((t=>t.path===this.rcfile));if(-1!=e){const i=this.rcfiles[e].data;t.setValue(i)}else t.setValue("");t.focus(),this.spinner.hide(),this._toggleDeleteButton()}_fetchUserConfigScript(){return globalThis.backendaiclient.userConfig.get().then((t=>t||"")).catch((t=>{console.log(t),t&&t.message&&(this.notification.text=b.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}async _saveUserConfigScript(t=this.rcfile){const e=this.shadowRoot.querySelector("#usersetting-editor").getValue(),i=this.rcfiles.findIndex((e=>e.path===t)),a=this.shadowRoot.querySelector("#select-rcfile-type");if(a.items.length>0){const e=a.items.find((e=>e.value===t)),i=a.items.indexOf(e);a.select(i)}if(-1!=i)if(""===this.rcfiles[i].data){if(""===e)return this.spinner.hide(),this.notification.text=p("usersettings.DescNewUserConfigFileCreated"),void this.notification.show();globalThis.backendaiclient.userConfig.create(e,this.rcfiles[i].path).then((t=>{this.spinner.hide(),this.notification.text=p("usersettings.DescScriptCreated"),this.notification.show()})).catch((t=>{this.spinner.hide(),console.log(t),t&&t.message&&(this.notification.text=b.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}else{if(this.rcfiles[i].data===e)return this.notification.text=p("resourceGroup.NochangesMade"),void this.notification.show();if(""===e)return this.notification.text=p("usersettings.DescLetUserUpdateScriptWithNonEmptyValue"),void this.notification.show();await globalThis.backendaiclient.userConfig.update(e,t).then((t=>{this.notification.text=p("usersettings.DescScriptUpdated"),this.notification.show(),this.spinner.hide()})).catch((t=>{this.spinner.hide(),console.log(t),t&&t.message&&(this.notification.text=b.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}await setTimeout((()=>{this._editUserConfigScript()}),200),this.spinner.show()}async _saveUserConfigScriptAndCloseDialog(){await this._saveUserConfigScript(),this._hideUserConfigScriptDialog()}_hideUserConfigScriptDialog(){this.userconfigDialog.hide()}_hideCurrentEditorChangeDialog(){this.shadowRoot.querySelector("#change-current-editor-dialog").hide()}_updateSelectedRcFileName(t){const e=this.shadowRoot.querySelector("#select-rcfile-type"),i=this.shadowRoot.querySelector("#userconfig-dialog #usersetting-editor");if(e.items.length>0){const a=e.items.find((e=>e.value===t)),s=e.items.indexOf(a),o=this.rcfiles[s].data;e.select(s),i.setValue(o)}}_changeCurrentEditorData(){const t=this.shadowRoot.querySelector("#userconfig-dialog #usersetting-editor"),e=this.shadowRoot.querySelector("#select-rcfile-type"),i=this.rcfiles.findIndex((t=>t.path===e.value)),a=this.rcfiles[i].data;t.setValue(a)}_toggleRcFileName(){var t;const e=this.shadowRoot.querySelector("#userconfig-dialog #usersetting-editor"),i=this.shadowRoot.querySelector("#select-rcfile-type");this.prevRcfile=this.rcfile,this.rcfile=i.value;let a=this.rcfiles.findIndex((t=>t.path===this.prevRcfile)),s=a>-1?this.rcfiles[a].data:"";const o=e.getValue();i.layout(),this._toggleDeleteButton(),s!==o?this._launchChangeCurrentEditorDialog():(a=this.rcfiles.findIndex((t=>t.path===this.rcfile)),s=(null===(t=this.rcfiles[a])||void 0===t?void 0:t.data)?this.rcfiles[a].data:"",e.setValue(s))}_toggleDeleteButton(){var t,e;const i=this.shadowRoot.querySelector("#delete-rcfile"),a=this.rcfiles.findIndex((t=>t.path===this.rcfile));a>-1&&(i.disabled=!((null===(t=this.rcfiles[a])||void 0===t?void 0:t.data)&&(null===(e=this.rcfiles[a])||void 0===e?void 0:e.permission)))}async _deleteRcFile(t){t||(t=this.rcfile),t&&globalThis.backendaiclient.userConfig.delete(t).then((e=>{const i=p("usersettings.DescScriptDeleted")+t;this.notification.text=i,this.notification.show(),this.spinner.hide(),this._hideUserConfigScriptDialog()})).catch((t=>{console.log(t),t&&t.message&&(this.notification.text=b.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))})),await setTimeout((()=>{this._editUserConfigScript()}),200)}async _deleteRcFileAll(){const t=this.rcfiles.filter((t=>""!==t.permission&&""!==t.data)).map((t=>{const e=t.path;return globalThis.backendaiclient.userConfig.delete(e)}));Promise.all(t).then((t=>{const e=p("usersettings.DescScriptAllDeleted");this.notification.text=e,this.notification.show(),this.spinner.hide()})).catch((t=>{console.log(t),t&&t.message&&(this.notification.text=b.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))})),await setTimeout((()=>{this._editUserConfigScript()}),200)}_createRcFile(t){t&&globalThis.backendaiclient.userConfig.create(t)}async _launchUserConfigDialog(){await this._editUserConfigScript(),this.userconfigDialog.closeWithConfirmation=!0,this.userconfigDialog.show()}_launchChangeCurrentEditorDialog(){this.shadowRoot.querySelector("#change-current-editor-dialog").show()}_openSSHKeypairManagementDialog(){this.shadowRoot.querySelector("#ssh-keypair-management-dialog").show()}async _openSSHKeypairRefreshDialog(){globalThis.backendaiclient.fetchSSHKeypair().then((t=>{const e=this.shadowRoot.querySelector("#ssh-keypair-management-dialog"),i=e.querySelector("#current-ssh-public-key"),a=e.querySelector("#copy-current-ssh-public-key-button");i.value=t.ssh_public_key?t.ssh_public_key:"",i.disabled=""===i.value,a.disabled=i.disabled,this.publicSSHkey=i.value?i.value:p("usersettings.NoExistingSSHKeypair"),e.show()}))}_openSSHKeypairClearDialog(){this.shadowRoot.querySelector("#clear-ssh-keypair-dialog").show()}_hideSSHKeypairGenerationDialog(){this.shadowRoot.querySelector("#generate-ssh-keypair-dialog").hide();const t=this.shadowRoot.querySelector("#ssh-public-key").value;if(""!==t){const e=this.shadowRoot.querySelector("#ssh-keypair-management-dialog");e.querySelector("#current-ssh-public-key").value=t,e.querySelector("#copy-current-ssh-public-key-button").disabled=!1}}_hideSSHKeypairDialog(){this.shadowRoot.querySelector("#ssh-keypair-management-dialog").hide()}_hideSSHKeypairClearDialog(){this.shadowRoot.querySelector("#clear-ssh-keypair-dialog").hide()}async _refreshSSHKeypair(){globalThis.backendaiclient.refreshSSHKeypair().then((t=>{const e=this.shadowRoot.querySelector("#generate-ssh-keypair-dialog");e.querySelector("#ssh-public-key").value=t.ssh_public_key,e.querySelector("#ssh-private-key").value=t.ssh_private_key,e.show()}))}_clearCurrentSSHKeypair(){this._hideSSHKeypairClearDialog(),this._hideSSHKeypairGenerationDialog()}_discardCurrentEditorChange(){this._updateSelectedRcFileName(this.rcfile),this._hideCurrentEditorChangeDialog()}_saveCurrentEditorChange(){this._saveUserConfigScript(this.prevRcfile),this._updateSelectedRcFileName(this.rcfile),this._hideCurrentEditorChangeDialog()}_cancelCurrentEditorChange(){this._updateSelectedRcFileName(this.prevRcfile),this._hideCurrentEditorChangeDialog()}_copySSHKey(t){if(""!==t){const e=this.shadowRoot.querySelector(t).value;if(0==e.length)this.notification.text=p("usersettings.NoExistingSSHKeypair"),this.notification.show();else if(void 0!==navigator.clipboard)navigator.clipboard.writeText(e).then((()=>{this.notification.text=p("usersettings.SSHKeyClipboardCopy"),this.notification.show()}),(t=>{console.error("Could not copy text: ",t)}));else{const t=document.createElement("input");t.type="text",t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}}}render(){return c`
      <lablup-loading-spinner id="loading-spinner"></lablup-loading-spinner>
    ...
    `}};t([e({type:Object})],y.prototype,"bootstrapDialog",void 0),t([e({type:Object})],y.prototype,"userconfigDialog",void 0),t([e({type:Object})],y.prototype,"notification",void 0),t([e({type:Array})],y.prototype,"supportLanguages",void 0),t([e({type:Boolean})],y.prototype,"beta_feature_panel",void 0),t([e({type:Boolean})],y.prototype,"shell_script_edit",void 0),t([e({type:Array})],y.prototype,"rcfiles",void 0),t([e({type:String})],y.prototype,"rcfile",void 0),t([e({type:String})],y.prototype,"prevRcfile",void 0),t([e({type:String})],y.prototype,"preferredSSHPort",void 0),t([e({type:String})],y.prototype,"publicSSHkey",void 0),y=t([i("backend-ai-usersettings-general-list")],y);
/**
 @license
 Copyright (c) 2015-2022 Lablup Inc. All rights reserved.
 */
let w=class extends a{constructor(){super(),this.images=Object(),this.options=Object(),this._activeTab=Object(),this.clearLogsDialog=Object(),this.logGrid=Object(),this.options={automatic_image_update:!1,cuda_gpu:!1,cuda_fgpu:!1,rocm_gpu:!1,tpu:!1,scheduler:"fifo"}}static get is(){return"backend-ai-usersettings-view"}static get styles(){return[s,o,r,g,h,l`
        div.spinner,
        span.spinner {
          font-size: 9px;
          margin-right: 5px;
    ...
    `}firstUpdated(){void 0===globalThis.backendaiclient||null===globalThis.backendaiclient?document.addEventListener("backend-ai-connected",(()=>{this.updateSettings()}),!0):this.updateSettings(),this.spinner=this.shadowRoot.querySelector("#loading-spinner"),this.notification=globalThis.lablupNotification,this.clearLogsDialog=this.shadowRoot.querySelector("#clearlogs-dialog"),document.addEventListener("backend-ai-usersettings-logs",(()=>{this._viewStateChanged(!0)})),document.addEventListener("backend-ai-usersettings",(()=>{this._viewStateChanged(!0)}))}async _viewStateChanged(t){const e=m.getState().app.params.tab;e&&"logs"===e?globalThis.setTimeout((()=>{this.shadowRoot.querySelector('mwc-tab[title="logs"]').click()}),0):globalThis.setTimeout((()=>{this.shadowRoot.querySelector('mwc-tab[title="general"]').click()}),0)}updateSettings(){}_hideClearLogsDialog(){this.clearLogsDialog.hide()}_removeLogMessage(){localStorage.getItem("backendaiwebui.logs")&&localStorage.removeItem("backendaiwebui.logs");const t=new CustomEvent("log-message-clear",{});document.dispatchEvent(t),localStorage.getItem("backendaiwebui.logs"),this.clearLogsDialog.hide(),this.notification.text=p("logs.LogMessageRemoved"),this.notification.show(),this.spinner.hide()}_showClearLogsDialog(){this.clearLogsDialog.show()}_refreshLogs(){this.logGrid=JSON.parse(localStorage.getItem("backendaiwebui.logs")||"{}");const t=new CustomEvent("log-message-refresh",this.logGrid);document.dispatchEvent(t)}_showTab(t){const e=this.shadowRoot.querySelectorAll(".tab-content");for(let t=0;t<e.length;t++)e[t].style.display="none";this._activeTab=t.title,"logs"===this._activeTab&&this._refreshLogs(),this.shadowRoot.querySelector("#"+t.title).style.display="block"}};t([e({type:Object})],w.prototype,"images",void 0),t([e({type:Object})],w.prototype,"options",void 0),t([e({type:Object})],w.prototype,"_activeTab",void 0),t([e({type:Object})],w.prototype,"clearLogsDialog",void 0),t([e({type:Object})],w.prototype,"logGrid",void 0),w=t([i("backend-ai-usersettings-view")],w);var S=w;export{S as default};
