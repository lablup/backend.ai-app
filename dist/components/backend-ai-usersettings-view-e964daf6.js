import{_ as t,e,c as i,a,B as s,d as o,I as r,b as n,i as l,A as c,y as d,t as p,g,x as h,f as u,ar as b,h as v,as as m}from"./backend-ai-webui-67004191.js";import"./switch-3d3a2d3d.js";import"./select-c9b75e15.js";import"./tab-group-57707824.js";import"./mwc-tab-bar-4c0c0798.js";import"./lablup-activity-panel-3f701007.js";import"./lablup-codemirror-39ed935b.js";import"./lablup-loading-spinner-542223c5.js";import"./vaadin-grid-b307120d.js";import"./vaadin-grid-selection-column-7bcbc3b9.js";import"./vaadin-grid-sort-column-9f8cecc6.js";import"./vaadin-icons-f0d9d23d.js";import"./expansion-a277300f.js";import"./label-15e54aa7.js";import{t as y}from"./translate-unsafe-html-e615249d.js";import"./mwc-switch-8fe28f19.js";import"./backend-ai-list-status-f6f485b3.js";import"./input-behavior-78fab2b6.js";import"./radio-behavior-85423886.js";import"./progress-spinner-8fcece3e.js";import"./dom-repeat-0177808f.js";let f=class extends s{constructor(){super(...arguments),this.timestamp="",this.errorType="",this.requestUrl="",this.statusCode="",this.statusText="",this.title="",this.message="",this.logs=[],this._selected_items=[],this.listCondition="loading",this._grid=Object(),this.logView=[],this._pageSize=25,this._currentPage=1,this._totalLogCount=0,this.boundTimeStampRenderer=this.timeStampRenderer.bind(this),this.boundStatusRenderer=this.statusRenderer.bind(this),this.boundErrTitleRenderer=this.errTitleRenderer.bind(this),this.boundErrMsgRenderer=this.errMsgRenderer.bind(this),this.boundErrTypeRenderer=this.errTypeRenderer.bind(this),this.boundMethodRenderer=this.methodRenderer.bind(this),this.boundReqUrlRenderer=this.reqUrlRender.bind(this),this.boundParamRenderer=this.paramRenderer.bind(this)}static get styles(){return[o,r,n,l`
        vaadin-grid {
          width: 100%;
          border: 0;
          font-size: 12px;
