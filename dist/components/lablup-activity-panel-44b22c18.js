import{_ as t,p as e,c as i,L as o,I as d,a,b as r,h as s}from"./backend-ai-console-b0159b49.js";let l=class extends o{constructor(){super(),this.title="",this.message="",this.panelId="",this.horizontalsize="",this.headerColor="",this.elevation=1,this.width=280,this.marginWidth=16,this.minwidth=0,this.maxwidth=0,this.pinned=!1,this.disabled=!1}static get styles(){return[d,a,r`
        wl-card {
          display: block;
          background: white;
