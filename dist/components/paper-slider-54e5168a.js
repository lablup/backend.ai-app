import{h as e,P as r,s as t}from"./polymer-legacy-4d33d7bd.js";import{a}from"./iron-resizable-behavior-33a9d7fa.js";import{c as i}from"./radio-behavior-583b4374.js";import{I as o}from"./paper-progress-31fb9b80.js";import{P as n,a as s,b as l}from"./paper-icon-button-2254421d.js";import{I as c,a as d}from"./paper-dropdown-menu-571001d5.js";
/**
@license
...
*/const p={properties:{checked:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0,observer:"_checkedChanged"},toggles:{type:Boolean,value:!0,reflectToAttribute:!0},value:{type:String,value:"on",observer:"_valueChanged"}},observers:["_requiredChanged(required)"],created:function(){this._hasIronCheckedElementBehavior=!0},_getValidity:function(e){return this.disabled||!this.required||this.checked},_requiredChanged:function(){this.required?this.setAttribute("aria-required","true"):this.removeAttribute("aria-required")},_checkedChanged:function(){this.active=this.checked,this.fire("iron-change")},_valueChanged:function(){void 0!==this.value&&null!==this.value||(this.value="on")}},h=[n,[c,d,p],{_checkedChanged:function(){p._checkedChanged.call(this),this.hasRipple()&&(this.checked?this._ripple.setAttribute("checked",""):this._ripple.removeAttribute("checked"))},_buttonStateChanged:function(){s._buttonStateChanged.call(this),this.disabled||this.isAttached&&(this.checked=this.active)}}],b=e`<style>
  :host {
...
<div id="checkboxLabel"><slot></slot></div>`;b.setAttribute("strip-whitespace",""),r({_template:b,is:"paper-checkbox",behaviors:[h],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){a(this,(function(){if("-1px"===this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim()){var e=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),r="px",t=e.match(/[A-Za-z]+$/);null!==t&&(r=t[0]);var a=parseFloat(e),i=8/3*a;"px"===r&&(i=Math.floor(i))%2!=a%2&&i++,this.updateStyles({"--paper-checkbox-ink-size":i+r})}}))},_computeCheckboxClass:function(e,r){var t="";return e&&(t+="checked "),r&&(t+="invalid"),t},_computeCheckmarkClass:function(e){return e?"":"hidden"},_createRipple:function(){return this._rippleContainer=this.$.checkboxContainer,l._createRipple.call(this)}});
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
