import{h as e,D as t,e as i,i as r,g as s,G as o,b as n,d as l,C as a,I as h,j as d,k as c,m as u,B as p,l as m,t as _,F as g,n as f,u as b}from"./iron-resizable-behavior-c7edc396.js";
/**
@license
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const Ee=document.createElement("dom-module");Ee.appendChild(e`
  <style>
...
`);const Pe=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),ke=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(Pe||ke){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",Ee.querySelector("template").content.appendChild(e)}Ee.register("vaadin-grid-styles");
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const Re=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Oe extends(G(L(ne(re(le(ie(ue(pe(me(ce(Ce(te(he(Se(se(ae(we(_e(ee))))))))))))))))))){static get template(){return e`
