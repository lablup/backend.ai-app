import{h as e,E as t,T as i,G as s,P as r,d as o,C as n,I as a,e as l,D as h,g as d,i as c,j as u,m as _,B as p,k as m,t as g,F as f,l as b,u as v}from"./iron-resizable-behavior-5743f649.js";
/**
@license
...
`);const me=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),ge=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(me||ge){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",pe.querySelector("template").content.appendChild(e)}pe.register("vaadin-grid-styles");
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const fe=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class be extends(t(i(U(V(j($(J(Z(Q(X(he(B(Y(de(G(q(le(ee(M))))))))))))))))))){static get template(){return e`
