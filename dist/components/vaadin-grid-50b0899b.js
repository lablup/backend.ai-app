...
`);const ce=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),ue=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(ce||ue){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",de.querySelector("template").content.appendChild(e)}de.register("vaadin-grid-styles");const _e=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class pe extends(v(y($(N(V(H(q(Y(X(j(oe(D(W(ne(M(G(re(K(F))))))))))))))))))){static get template(){return e`
