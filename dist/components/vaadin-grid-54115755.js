import{h as e,D as t,e as i,i as s,g as r,G as o,b as n,d as a,C as l,I as h,j as d,k as c,m as u,B as p,l as m,t as _,F as g,n as f,u as b}from"./iron-resizable-behavior-1c6a25ef.js";
/**
@license
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const Ae=document.createElement("dom-module");Ae.appendChild(e`
  <style>
...
`);const we=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),Ce=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(we||Ce){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",Ae.querySelector("template").content.appendChild(e)}Ae.register("vaadin-grid-styles");
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const Ie=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Se extends(H(F(Q(X(ee(K(oe(ne(ae(re(fe(Y(ie(be(J(te(ge(le(U))))))))))))))))))){static get template(){return e`
