import{U as e,b as t}from"./backend-ai-webui-f982c311.js";
/**
@license
 ...
 */
class k extends HTMLElement{static get version(){return"20.0.0"}}customElements.define("vaadin-lumo-styles",k);
/**
 * @license
 * Copyright (c) 2021 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`,B=document.createElement("template");B.innerHTML=`<style>${$.toString().replace(":host","html")}</style>`,document.head.appendChild(B.content);
/**
 * @license
 * Copyright (c) 2021 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function ri(e,t){return e?("string"==typeof e&&(e=Vs(e)),t&&ni(e,t),qs(e,$s)):""}function oi(e){return!e.__cssRules&&e.textContent&&(e.__cssRules=Vs(e.textContent)),e.__cssRules||null}function ni(e,t,s,i){if(!e)return;let r=!1,o=e.type;if(i&&o===Us.MEDIA_RULE){let t=e.selector.match(ei);t&&(window.matchMedia(t[1]).matches||(r=!0))}o===Us.STYLE_RULE?t(e):s&&o===Us.KEYFRAMES_RULE?s(e):o===Us.MIXIN_RULE&&(r=!0);let n=e.rules;if(n&&!r)for(let e,r=0,o=n.length;r<o&&(e=n[r]);r++)ni(e,t,s,i)}function ai(e,t){let s=e.indexOf("var(");if(-1===s)return t(e,"","","");let i=function(e,t){let s=0;for(let i=t,r=e.length;i<r;i++)if("("===e[i])s++;else if(")"===e[i]&&0==--s)return i;return-1}(e,s+3),r=e.substring(s+4,i),o=e.substring(0,s),n=ai(e.substring(i+1),t),a=r.indexOf(",");return-1===a?t(o,r.trim(),"",n):t(o,r.substring(0,a).trim(),r.substring(a+1).trim(),n)}window.ShadyDOM&&window.ShadyDOM.wrap;function li(e){if(void 0!==Ms)return Ms;if(void 0===e.__cssBuild){const t=e.getAttribute("css-build");if(t)e.__cssBuild=t;else{const t=function(e){const t="template"===e.localName?e.content.firstChild:e.firstChild;if(t instanceof Comment){const e=t.textContent.trim().split(":");if("css-build"===e[0])return e[1]}return""}(e);""!==t&&function(e){const t="template"===e.localName?e.content.firstChild:e.firstChild;t.parentNode.removeChild(t)}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */
const Di=/:host\(:dir\((ltr|rtl)\)\)/g,Li=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Mi=/:dir\((?:ltr|rtl)\)/,Fi=Boolean(window.ShadyDOM&&window.ShadyDOM.inUse),Hi=[];let $i=null,Bi="";function Vi(){Bi=document.documentElement.getAttribute("dir")}function ji(e){if(!e.__autoDirOptOut){e.setAttribute("dir",Bi)}}function qi(){Vi(),Bi=document.documentElement.getAttribute("dir");for(let e=0;e<Hi.length;e++)ji(Hi[e])}const Ui=W((e=>{Fi||$i||(Vi(),$i=new MutationObserver(qi),$i.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const t=Oe(e);class s extends t{static _processStyleText(e,s){return e=t._processStyleText.call(this,e,s),!Fi&&Mi.test(e)&&(e=this._replaceDirInCssText(e),this.__activateDir=!0),e}static _replaceDirInCssText(e){let t=e;return t=t.replace(Di,':host([dir="$1"])'),t=t.replace(Li,':host([dir="$2"]) $1'),t}constructor(){super(),this.__autoDirOptOut=!1}ready(){super.ready(),this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){t.prototype.connectedCallback&&super.connectedCallback(),this.constructor.__activateDir&&($i&&$i.takeRecords().length&&qi(),Hi.push(this),ji(this))}disconnectedCallback(){if(t.prototype.disconnectedCallback&&super.disconnectedCallback(),this.constructor.__activateDir){const e=Hi.indexOf(this);e>-1&&Hi.splice(e,1)}}}return s.__activateDir=!1,s}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let $r=!1;function Br(){if(f&&!h){if(!$r){$r=!0;const e=document.createElement("style");e.textContent="dom-bind,dom-if,dom-repeat{display:none;}",document.head.appendChild(e)}return!0}return!1}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const Mo=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Fo extends(Ts(fs(_o(ho(po(ao(Co(wo(So(yo(Ro(no(fo(ko(co(mo(No(Ao(oo))))))))))))))))))){static get template(){return Pt`
      <div
        id="scroller"
        safari$="[[_safari]]"
        ios$="[[_ios]]"
