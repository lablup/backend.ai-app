...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const _e=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class pe extends(v(y($(N(V(H(q(Y(K(j(oe(D(W(ne(M(G(re(X(F))))))))))))))))))){static get template(){return e`
