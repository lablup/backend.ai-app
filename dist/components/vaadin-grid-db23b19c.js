...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const Re=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Oe extends(G(L(ne(re(le(ie(ue(pe(me(ce(Ce(te(he(Ie(se(ae(we(_e(ee))))))))))))))))))){static get template(){return e`
