...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class S extends(f(I(b(t(i))))){static get template(){return e`
    <style>
      :host {
        display: inline-block;
      }
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const _e=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class pe extends(f(b($(N(V(H(q(Y(K(j(oe(D(W(ne(M(G(re(X(F))))))))))))))))))){static get template(){return e`
