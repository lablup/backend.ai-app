import{r as e,a as t,D as r,t as i,b as o,E as a,h as n,C as l,T as s,P as d}from"./vaadin-grid-69a293c4.js";
/**
 * @license
 ...
 */;class c extends(a(p(l(s(d))))){static get template(){return n`
    ...
    `}static get is(){return"vaadin-text-field"}static get version(){return"21.0.0"}static get properties(){return{pattern:{type:String},title:{type:String}}}}customElements.define(c.is,c);
/**
 * @license
 * Copyright (c) 2021 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class m extends class extends d{}{static get template(){return n`
      <style>
        :host {
          display: inline-flex;
          max-width: 100%;
    ...
    `}static get is(){return"vaadin-grid-filter"}static get properties(){return{path:String,value:{type:String,notify:!0},_connected:Boolean}}connectedCallback(){super.connectedCallback(),this._connected=!0}static get observers(){return["_filterChanged(path, value, _connected)"]}ready(){super.ready();const e=this.firstElementChild;e&&"filter"!==e.getAttribute("slot")&&(console.warn('Make sure you have assigned slot="filter" to the child elements of <vaadin-grid-filter>'),e.setAttribute("slot","filter"))}_filterChanged(e,t,o){void 0!==e&&void 0!==t&&o&&(void 0===this._previousValue&&""===t||(this._previousValue=t,this._debouncerFilterChanged=r.debounce(this._debouncerFilterChanged,i.after(200),(()=>{this.dispatchEvent(new CustomEvent("filter-changed",{bubbles:!0}))}))))}focus(){this.$.filter.focus()}}customElements.define(m.is,m);
