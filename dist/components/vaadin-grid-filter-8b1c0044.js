import{r as e,D as t,t as r,a as i,E as o,h as a,C as n,T as l,P as s}from"./vaadin-grid-8bd957e2.js";import{b as d}from"./backend-ai-webui-ecfefd57.js";
/**
 * @license
...
`,{moduleId:"lumo-required-field"});e("",d`
  [part$='button'] {
    flex: none;
    width: 1em;
    height: 1em;
...
`,{moduleId:"lumo-field-button"}),e("vaadin-text-field",d`
    :host {
 ...
 */;class c extends(o(p(n(l(s))))){static get template(){return a`
    ...
    `}static get is(){return"vaadin-text-field"}static get version(){return"20.0.0"}static get properties(){return{pattern:{type:String},title:{type:String}}}}customElements.define(c.is,c);
/**
 * @license
 * Copyright (c) 2021 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class m extends class extends s{}{static get template(){return a`
      <style>
        :host {
          display: inline-flex;
          max-width: 100%;
    ...
    `}static get is(){return"vaadin-grid-filter"}static get properties(){return{path:String,value:{type:String,notify:!0},_connected:Boolean}}connectedCallback(){super.connectedCallback(),this._connected=!0}static get observers(){return["_filterChanged(path, value, _connected)"]}ready(){super.ready();const e=this.firstElementChild;e&&"filter"!==e.getAttribute("slot")&&(console.warn('Make sure you have assigned slot="filter" to the child elements of <vaadin-grid-filter>'),e.setAttribute("slot","filter"))}_filterChanged(e,i,o){void 0!==e&&void 0!==i&&o&&(void 0===this._previousValue&&""===i||(this._previousValue=i,this._debouncerFilterChanged=t.debounce(this._debouncerFilterChanged,r.after(200),(()=>{this.dispatchEvent(new CustomEvent("filter-changed",{bubbles:!0}))}))))}focus(){this.$.filter.focus()}}customElements.define(m.is,m);
