import{r as e,T as t,h as r,D as i,P as a,W as o,Q as s,Z as l,_ as n,$ as d,o as h,a0 as u,c as p,a1 as c,O as m,a as v,L as f,R as g,U as _,d as b,E as x,S as y,G as C}from"./vaadin-grid-8b36a908.js";import{i as w}from"./backend-ai-webui-c75b7c5c.js";e("vaadin-input-container",w`
    :host {
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */e("vaadin-text-field",z,{moduleId:"vaadin-text-field-styles"});class H extends(O(t(x(a)))){static get is(){return"vaadin-text-field"}static get template(){return r`
      <style>
        [part='input-field'] {
          flex-grow: 0;
        }
    ...
    `}static get properties(){return{maxlength:{type:Number},minlength:{type:Number}}}ready(){super.ready(),this._tooltipController=new b(this),this._tooltipController.setPosition("top"),this.addController(this._tooltipController)}}customElements.define(H.is,H);
/**
 * @license
