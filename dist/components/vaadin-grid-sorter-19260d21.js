...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const T=!window.ShadyDOM||!window.ShadyDOM.inUse;Boolean(!window.ShadyCSS||window.ShadyCSS.nativeCss);const I=T&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const e=new CSSStyleSheet;e.replaceSync("");const t=document.createElement("div");return t.attachShadow({mode:"open"}),t.shadowRoot.adoptedStyleSheets=[e],t.shadowRoot.adoptedStyleSheets[0]===e}catch(e){return!1}})();let O=window.Polymer&&window.Polymer.rootPath||E(document.baseURI||window.location.href),z=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0,R=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1,N=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,k=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,D=window.Polymer&&window.Polymer.legacyOptimizations||!1,L=window.Polymer&&window.Polymer.legacyWarnings||!1,M=window.Polymer&&window.Polymer.syncInitialRender||!1,F=window.Polymer&&window.Polymer.legacyUndefined||!1,H=window.Polymer&&window.Polymer.orderedComputed||!1,B=window.Polymer&&window.Polymer.removeNestedTemplates||!1,$=window.Polymer&&window.Polymer.fastDomIf||!1,V=window.Polymer&&window.Polymer.suppressTemplateNotifications||!1,G=window.Polymer&&window.Polymer.legacyNoObservedAttributes||!1,j=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1,q={},U={};function W(e,t){q[e]=U[e.toLowerCase()]=t}function Y(e){return q[e]||U[e.toLowerCase()]}class J extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,t){if(e){let i=Y(e);return i&&t?i.querySelector(t):i}return null}attributeChangedCallback(e,t,i,s){t!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,t=S(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=E(t)}return this.__assetpath}register(e){if(e=e||this.id){if(N&&void 0!==Y(e))throw W(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,W(e,this),(t=this).querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}var t}}J.prototype.modules=q,customElements.define("dom-module",J);function X(e){return J.import(e)}function Z(e){const t=P((e.body?e.body:e).textContent,e.baseURI),i=document.createElement("style");return i.textContent=t,i}function K(e){const t=e.trim().split(/\s+/),i=[];for(let e=0;e<t.length;e++)i.push(...Q(t[e]));return i}function Q(e){const t=X(e);if(!t)return console.warn("Could not find style data in module named",e),[];if(void 0===t._styles){const e=[];e.push(...te(t));const i=t.querySelector("template");i&&e.push(...ee(i,t.assetpath)),t._styles=e}return t._styles}function ee(e,t){if(!e._styles){const i=[],s=e.content.querySelectorAll("style");for(let e=0;e<s.length;e++){let r=s[e],n=r.getAttribute("include");n&&i.push(...K(n).filter((function(e,t,i){return i.indexOf(e)===t}))),t&&(r.textContent=P(r.textContent,t)),i.push(r)}e._styles=i}return e._styles}function te(e){const t=[],i=e.querySelectorAll("link[rel=import][type~=css]");for(let e=0;e<i.length;e++){let s=i[e];if(s.import){const e=s.import,i=s.hasAttribute("shady-unscoped");if(i&&!e._unscopedStyle){const t=Z(e);t.setAttribute("shady-unscoped",""),e._unscopedStyle=t}else e._style||(e._style=Z(e));t.push(i?e._unscopedStyle:e._style)}}return t}function ie(e){let t=X(e);if(t&&void 0===t._cssText){let e=function(e){let t="",i=te(e);for(let e=0;e<i.length;e++)t+=i[e].textContent;return t}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ye=!1,Je=!1;function Xe(e){(function(){if(!Ye){Ye=!0;const e=document.createElement("textarea");e.placeholder="a",Je=e.placeholder===e.textContent}return Je})()&&"textarea"===e.localName&&e.placeholder&&e.placeholder===e.textContent&&(e.textContent=null)}function Ze(e){let t=e.getAttribute("is");if(t&&We[t]){let i=e;for(i.removeAttribute("is"),e=i.ownerDocument.createElement(t),i.parentNode.replaceChild(e,i),e.appendChild(i);i.attributes.length;)e.setAttribute(i.attributes[0].name,i.attributes[0].value),i.removeAttribute(i.attributes[0].name)}return e}function Ke(e,t){let i=t.parentInfo&&Ke(e,t.parentInfo);if(!i)return e;for(let e=i.firstChild,s=0;e;e=e.nextSibling)if(t.parentIndex===s++)return e}function Qe(e,t,i,s){s.id&&(t[s.id]=i)}function et(e,t,i){if(i.events&&i.events.length)for(let s,r=0,n=i.events;r<n.length&&(s=n[r]);r++)e._addMethodEventListenerToNode(t,s.name,s.value,e)}function tt(e,t,i,s){i.templateInfo&&(t._templateInfo=i.templateInfo,t._parentTemplateInfo=s)}const it=fe((e=>class extends e{static _parseTemplate(e,t){if(!e._templateInfo){let i=e._templateInfo={};i.nodeInfoList=[],i.nestedTemplate=Boolean(t),i.stripWhiteSpace=t&&t.stripWhiteSpace||e.hasAttribute("strip-whitespace"),this._parseTemplateContent(e,i,{parent:null})}return e._templateInfo}static _parseTemplateContent(e,t,i){return this._parseTemplateNode(e.content,t,i)}static _parseTemplateNode(e,t,i){let s=!1,r=e;return"template"!=r.localName||r.hasAttribute("preserve-content")?"slot"===r.localName&&(t.hasInsertionPoint=!0):s=this._parseTemplateNestedTemplate(r,t,i)||s,Xe(r),r.firstChild&&this._parseTemplateChildNodes(r,t,i),r.hasAttributes&&r.hasAttributes()&&(s=this._parseTemplateNodeAttributes(r,t,i)||s),s||i.noted}static _parseTemplateChildNodes(e,t,i){if("script"!==e.localName&&"style"!==e.localName)for(let s,r=e.firstChild,n=0;r;r=s){if("template"==r.localName&&(r=Ze(r)),s=r.nextSibling,r.nodeType===Node.TEXT_NODE){let i=s;for(;i&&i.nodeType===Node.TEXT_NODE;)r.textContent+=i.textContent,s=i.nextSibling,e.removeChild(i),i=s;if(t.stripWhiteSpace&&!r.textContent.trim()){e.removeChild(r);continue}}let o={parentIndex:n,parentInfo:i};this._parseTemplateNode(r,t,o)&&(o.infoIndex=t.nodeInfoList.push(o)-1),r.parentNode&&n++}}static _parseTemplateNestedTemplate(e,t,i){let s=e,r=this._parseTemplate(s,t);return(r.content=s.content.ownerDocument.createDocumentFragment()).appendChild(s.content),i.templateInfo=r,!0}static _parseTemplateNodeAttributes(e,t,i){let s=!1,r=Array.from(e.attributes);for(let n,o=r.length-1;n=r[o];o--)s=this._parseTemplateNodeAttribute(e,t,i,n.name,n.value)||s;return s}static _parseTemplateNodeAttribute(e,t,i,s,r){return"on-"===s.slice(0,3)?(e.removeAttribute(s),i.events=i.events||[],i.events.push({name:s.slice(3),value:r}),!0):"id"===s&&(i.id=r,!0)}static _contentForTemplate(e){let t=e._templateInfo;return t&&t.content||e.content}_stampTemplate(e,t){e&&!e.content&&window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(e);let i=(t=t||this.constructor._parseTemplate(e)).nodeInfoList,s=t.content||e.content,r=document.importNode(s,!0);r.__noInsertionPoint=!t.hasInsertionPoint;let n=r.nodeList=new Array(i.length);r.$={};for(let e,s=0,o=i.length;s<o&&(e=i[s]);s++){let i=n[s]=Ke(r,e);Qe(0,r.$,i,e),tt(0,i,e,t),et(this,i,e)}return r=r,r}_addMethodEventListenerToNode(e,t,i,s){let r=function(e,t,i){return e=e._methodHost||e,function(t){e[i]?e[i](t,t.detail):console.warn("listener method `"+i+"` not defined")}}(s=s||e,0,i);return this._addEventListenerToNode(e,t,r),r}_addEventListenerToNode(e,t,i){e.addEventListener(t,i)}_removeEventListenerFromNode(e,t,i){e.removeEventListener(t,i)}}));
/**
 * @fileoverview
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let qt="string"==typeof document.head.style.touchAction,Ut="__polymerGestures",Wt="__polymerGesturesHandled",Yt="__polymerGesturesTouchAction",Jt=["mousedown","mousemove","mouseup","click"],Xt=[0,1,4,2],Zt=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(e){return!1}}();function Kt(e){return Jt.indexOf(e)>-1}let Qt=!1;function ei(e){if(!Kt(e)&&"touchend"!==e)return qt&&Qt&&R?{passive:!0}:void 0}!function(){try{let e=Object.defineProperty({},"passive",{get(){Qt=!0}});window.addEventListener("test",null,e),window.removeEventListener("test",null,e)}catch(e){}}();let ti=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const ii=[],si={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},ri={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function ni(e){let t=Array.prototype.slice.call(e.labels||[]);if(!t.length){t=[];let i=e.getRootNode();if(e.id){let s=i.querySelectorAll(`label[for = ${e.id}]`);for(let e=0;e<s.length;e++)t.push(s[e])}}return t}let oi=function(e){let t=e.sourceCapabilities;var i;if((!t||t.firesTouchEvents)&&(e[Wt]={skip:!0},"click"===e.type)){let t=!1,s=ui(e);for(let e=0;e<s.length;e++){if(s[e].nodeType===Node.ELEMENT_NODE)if("label"===s[e].localName)ii.push(s[e]);else if(i=s[e],si[i.localName]){let i=ni(s[e]);for(let e=0;e<i.length;e++)t=t||ii.indexOf(i[e])>-1}if(s[e]===hi.mouse.target)return}if(t)return;e.preventDefault(),e.stopPropagation()}};function ai(e){let t=ti?["click"]:Jt;for(let i,s=0;s<t.length;s++)i=t[s],e?(ii.length=0,document.addEventListener(i,oi,!0)):document.removeEventListener(i,oi,!0)}function li(e){let t=e.type;if(!Kt(t))return!1;if("mousemove"===t){let t=void 0===e.buttons?1:e.buttons;return e instanceof window.MouseEvent&&!Zt&&(t=Xt[e.which]||0),Boolean(1&t)}return 0===(void 0===e.button?0:e.button)}let hi={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function di(e,t,i){e.movefn=t,e.upfn=i,document.addEventListener("mousemove",t),document.addEventListener("mouseup",i)}function ci(e){document.removeEventListener("mousemove",e.movefn),document.removeEventListener("mouseup",e.upfn),e.movefn=null,e.upfn=null}document.addEventListener("touchend",(function(e){hi.mouse.mouseIgnoreJob||ai(!0),hi.mouse.target=ui(e)[0],hi.mouse.mouseIgnoreJob=$t.debounce(hi.mouse.mouseIgnoreJob,Fe.after(2500),(function(){ai(),hi.mouse.target=null,hi.mouse.mouseIgnoreJob=null}))}),!!Qt&&{passive:!0});const ui=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:e=>e.composedPath&&e.composedPath()||[],pi={},_i=[];function mi(e){const t=ui(e);return t.length>0?t[0]:e.target}function fi(e){let t,i=e.type,s=e.currentTarget.__polymerGestures;if(!s)return;let r=s[i];if(r){if(!e[Wt]&&(e[Wt]={},"touch"===i.slice(0,5))){let t=(e=e).changedTouches[0];if("touchstart"===i&&1===e.touches.length&&(hi.touch.id=t.identifier),hi.touch.id!==t.identifier)return;qt||"touchstart"!==i&&"touchmove"!==i||function(e){let t=e.changedTouches[0],i=e.type;if("touchstart"===i)hi.touch.x=t.clientX,hi.touch.y=t.clientY,hi.touch.scrollDecided=!1;else if("touchmove"===i){if(hi.touch.scrollDecided)return;hi.touch.scrollDecided=!0;let i=function(e){let t="auto",i=ui(e);for(let e,s=0;s<i.length;s++)if(e=i[s],e[Yt]){t=e[Yt];break}return t}(e),s=!1,r=Math.abs(hi.touch.x-t.clientX),n=Math.abs(hi.touch.y-t.clientY);e.cancelable&&("none"===i?s=!0:"pan-x"===i?s=n>r:"pan-y"===i&&(s=r>n)),s?e.preventDefault():wi("track")}}(e)}if(t=e[Wt],!t.skip){for(let i,s=0;s<_i.length;s++)i=_i[s],r[i.name]&&!t[i.name]&&i.flow&&i.flow.start.indexOf(e.type)>-1&&i.reset&&i.reset();for(let s,n=0;n<_i.length;n++)s=_i[n],r[s.name]&&!t[s.name]&&(t[s.name]=!0,s[i](e))}}}function gi(e,t,i){return!!pi[t]&&(function(e,t,i){let s=pi[t],r=s.deps,n=s.name,o=e[Ut];o||(e[Ut]=o={});for(let t,i,s=0;s<r.length;s++)t=r[s],ti&&Kt(t)&&"click"!==t||(i=o[t],i||(o[t]=i={_count:0}),0===i._count&&e.addEventListener(t,fi,ei(t)),i[n]=(i[n]||0)+1,i._count=(i._count||0)+1);e.addEventListener(t,i),s.touchAction&&vi(e,s.touchAction)}(e,t,i),!0)}function yi(e,t,i){return!!pi[t]&&(function(e,t,i){let s=pi[t],r=s.deps,n=s.name,o=e[Ut];if(o)for(let t,i,s=0;s<r.length;s++)t=r[s],i=o[t],i&&i[n]&&(i[n]=(i[n]||1)-1,i._count=(i._count||1)-1,0===i._count&&e.removeEventListener(t,fi,ei(t)));e.removeEventListener(t,i)}(e,t,i),!0)}function bi(e){_i.push(e);for(let t=0;t<e.emits.length;t++)pi[e.emits[t]]=e}function vi(e,t){qt&&e instanceof HTMLElement&&$e.run((()=>{e.style.touchAction=t})),e[Yt]=t}function Ai(e,t,i){let s=new Event(t,{bubbles:!0,cancelable:!0,composed:!0});if(s.detail=i,ge(e).dispatchEvent(s),s.defaultPrevented){let e=i.preventer||i.sourceEvent;e&&e.preventDefault&&e.preventDefault()}}function wi(e){let t=function(e){for(let t,i=0;i<_i.length;i++){t=_i[i];for(let i,s=0;s<t.emits.length;s++)if(i=t.emits[s],i===e)return t}return null}(e);t.info&&(t.info.prevent=!0)}function Ci(e,t,i,s){t&&Ai(t,e,{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:s,prevent:function(e){return wi(e)}})}function xi(e,t,i){if(e.prevent)return!1;if(e.started)return!0;let s=Math.abs(e.x-t),r=Math.abs(e.y-i);return s>=5||r>=5}function Si(e,t,i){if(!t)return;let s,r=e.moves[e.moves.length-2],n=e.moves[e.moves.length-1],o=n.x-e.x,a=n.y-e.y,l=0;r&&(s=n.x-r.x,l=n.y-r.y),Ai(t,"track",{state:e.state,x:i.clientX,y:i.clientY,dx:o,dy:a,ddx:s,ddy:l,sourceEvent:i,hover:function(){return function(e,t){let i=document.elementFromPoint(e,t),s=i;for(;s&&s.shadowRoot&&!window.ShadyDOM;){let r=s;if(s=s.shadowRoot.elementFromPoint(e,t),r===s)break;s&&(i=s)}return i}(i.clientX,i.clientY)}})}function Pi(e,t,i){let s=Math.abs(t.clientX-e.x),r=Math.abs(t.clientY-e.y),n=mi(i||t);!n||ri[n.localName]&&n.hasAttribute("disabled")||(isNaN(s)||isNaN(r)||s<=25&&r<=25||function(e){if("click"===e.type){if(0===e.detail)return!0;let t=mi(e);if(!t.nodeType||t.nodeType!==Node.ELEMENT_NODE)return!0;let i=t.getBoundingClientRect(),s=e.pageX,r=e.pageY;return!(s>=i.left&&s<=i.right&&r>=i.top&&r<=i.bottom)}return!1}(t))&&(e.prevent||Ai(n,"tap",{x:t.clientX,y:t.clientY,sourceEvent:t,preventer:i}))}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/bi({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){ci(this.info)},mousedown:function(e){if(!li(e))return;let t=mi(e),i=this;di(this.info,(function(e){li(e)||(Ci("up",t,e),ci(i.info))}),(function(e){li(e)&&Ci("up",t,e),ci(i.info)})),Ci("down",t,e)},touchstart:function(e){Ci("down",mi(e),e.changedTouches[0],e)},touchend:function(e){Ci("up",mi(e),e.changedTouches[0],e)}}),bi({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(e){this.moves.length>2&&this.moves.shift(),this.moves.push(e)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,ci(this.info)},mousedown:function(e){if(!li(e))return;let t=mi(e),i=this,s=function(e){let s=e.clientX,r=e.clientY;xi(i.info,s,r)&&(i.info.state=i.info.started?"mouseup"===e.type?"end":"track":"start","start"===i.info.state&&wi("tap"),i.info.addMove({x:s,y:r}),li(e)||(i.info.state="end",ci(i.info)),t&&Si(i.info,t,e),i.info.started=!0)};di(this.info,s,(function(e){i.info.started&&s(e),ci(i.info)})),this.info.x=e.clientX,this.info.y=e.clientY},touchstart:function(e){let t=e.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchmove:function(e){let t=mi(e),i=e.changedTouches[0],s=i.clientX,r=i.clientY;xi(this.info,s,r)&&("start"===this.info.state&&wi("tap"),this.info.addMove({x:s,y:r}),Si(this.info,t,i),this.info.state="track",this.info.started=!0)},touchend:function(e){let t=mi(e),i=e.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:i.clientX,y:i.clientY}),Si(this.info,t,i))}}),bi({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(e){li(e)&&(this.info.x=e.clientX,this.info.y=e.clientY)},click:function(e){li(e)&&Pi(this.info,e)},touchstart:function(e){const t=e.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchend:function(e){Pi(this.info,e.changedTouches[0],e)}});const Ei=fe((e=>class extends e{_addEventListenerToNode(e,t,i){gi(e,t,i)||super._addEventListenerToNode(e,t,i)}_removeEventListenerFromNode(e,t,i){yi(e,t,i)||super._removeEventListenerFromNode(e,t,i)}})),Ti=e=>class extends e{static get properties(){return{theme:{type:String,readOnly:!0}}}attributeChangedCallback(e,t,i){super.attributeChangedCallback(e,t,i),"theme"===e&&this._setTheme(i)}},Ii=e=>class extends(Ti(e)){static finalize(){super.finalize();const e=this.prototype._template,t=this.template&&this.template.parentElement&&this.template.parentElement.id===this.is,i=Object.getPrototypeOf(this.prototype)._template;i&&!t&&Array.from(i.content.querySelectorAll("style[include]")).forEach((t=>{this._includeStyle(t.getAttribute("include"),e)})),this._includeMatchingThemes(e)}static _includeMatchingThemes(e){const t=J.prototype.modules;let i=!1;const s=this.is+"-default-theme";Object.keys(t).sort(((e,t)=>{const i=0===e.indexOf("vaadin-"),s=0===t.indexOf("vaadin-"),r=["lumo-","material-"],n=r.filter((t=>0===e.indexOf(t))).length>0,o=r.filter((e=>0===t.indexOf(e))).length>0;return i!==s?i?-1:1:n!==o?n?-1:1:0})).forEach((r=>{if(r!==s){const s=t[r].getAttribute("theme-for");s&&s.split(" ").forEach((t=>{new RegExp("^"+t.split("*").join(".*")+"$").test(this.is)&&(i=!0,this._includeStyle(r,e))}))}})),!i&&t[s]&&this._includeStyle(s,e)}static _includeStyle(e,t){if(t&&!t.content.querySelector(`style[include="${e}"]`)){const i=document.createElement("style");i.setAttribute("include",e),t.content.appendChild(i)}}}
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;let Oi=!1;window.addEventListener("keydown",(()=>{Oi=!0}),{capture:!0}),window.addEventListener("mousedown",(()=>{Oi=!1}),{capture:!0});const zi=e=>class extends((e=>class extends e{static get properties(){var e={tabindex:{type:Number,value:0,reflectToAttribute:!0,observer:"_tabindexChanged"}};return window.ShadyDOM&&(e.tabIndex=e.tabindex),e}})(e)){static get properties(){return{autofocus:{type:Boolean},_previousTabIndex:{type:Number},disabled:{type:Boolean,observer:"_disabledChanged",reflectToAttribute:!0},_isShiftTabbing:{type:Boolean}}}ready(){this.addEventListener("focusin",(e=>{e.composedPath()[0]===this?this.contains(e.relatedTarget)||this._focus():-1===e.composedPath().indexOf(this.focusElement)||this.disabled||this._setFocused(!0)})),this.addEventListener("focusout",(e=>this._setFocused(!1))),super.ready();const e=e=>{e.composed||e.target.dispatchEvent(new CustomEvent(e.type,{bubbles:!0,composed:!0,cancelable:!1}))};this.shadowRoot.addEventListener("focusin",e),this.shadowRoot.addEventListener("focusout",e),this.addEventListener("keydown",(e=>{if(!e.defaultPrevented&&9===e.keyCode)if(e.shiftKey)this._isShiftTabbing=!0,HTMLElement.prototype.focus.apply(this),this._setFocused(!1),setTimeout((()=>this._isShiftTabbing=!1),0);else{const e=window.navigator.userAgent.match(/Firefox\/(\d\d\.\d)/);if(e&&parseFloat(e[1])>=63&&parseFloat(e[1])<66&&this.parentNode&&this.nextSibling){const e=document.createElement("input");e.style.position="absolute",e.style.opacity="0",e.tabIndex=this.tabIndex,this.parentNode.insertBefore(e,this.nextSibling),e.focus(),e.addEventListener("focusout",(()=>this.parentNode.removeChild(e)))}}})),this.autofocus&&!this.disabled&&window.requestAnimationFrame((()=>{this._focus(),this._setFocused(!0),this.setAttribute("focus-ring","")}))}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}_setFocused(e){e?this.setAttribute("focused",""):this.removeAttribute("focused"),e&&Oi?this.setAttribute("focus-ring",""):this.removeAttribute("focus-ring")}get focusElement(){return window.console.warn(`Please implement the 'focusElement' property in <${this.localName}>`),this}_focus(){this.focusElement&&!this._isShiftTabbing&&(this.focusElement.focus(),this._setFocused(!0))}focus(){this.focusElement&&!this.disabled&&(this.focusElement.focus(),this._setFocused(!0))}blur(){this.focusElement&&(this.focusElement.blur(),this._setFocused(!1))}_disabledChanged(e){this.focusElement.disabled=e,e?(this.blur(),this._previousTabIndex=this.tabindex,this.tabindex=-1,this.setAttribute("aria-disabled","true")):(void 0!==this._previousTabIndex&&(this.tabindex=this._previousTabIndex),this.removeAttribute("aria-disabled"))}_tabindexChanged(e){void 0!==e&&(this.focusElement.tabIndex=e),this.disabled&&this.tabindex&&(-1!==this.tabindex&&(this._previousTabIndex=this.tabindex),this.tabindex=e=void 0),window.ShadyDOM&&this.setProperties({tabIndex:e,tabindex:e})}click(){this.disabled||super.click()}}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/,Ri=function(){let e,t;do{e=window.ShadyDOM&&ShadyDOM.flush(),window.ShadyCSS&&window.ShadyCSS.ScopingShim&&window.ShadyCSS.ScopingShim.flush(),t=jt()}while(e||t)};
/**
@license
Copyright (c) 2020 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
class Ni{static detectScrollType(){const e=document.createElement("div");e.textContent="ABCD",e.dir="rtl",e.style.fontSize="14px",e.style.width="4px",e.style.height="1px",e.style.position="absolute",e.style.top="-1000px",e.style.overflow="scroll",document.body.appendChild(e);let t="reverse";return e.scrollLeft>0?t="default":(e.scrollLeft=2,e.scrollLeft<2&&(t="negative")),document.body.removeChild(e),t}static getNormalizedScrollLeft(e,t,i){const{scrollLeft:s}=i;if("rtl"!==t||!e)return s;switch(e){case"negative":return i.scrollWidth-i.clientWidth+s;case"reverse":return i.scrollWidth-i.clientWidth-s}return s}static setNormalizedScrollLeft(e,t,i,s){if("rtl"===t&&e)switch(e){case"negative":i.scrollLeft=i.clientWidth-i.scrollWidth+s;break;case"reverse":i.scrollLeft=i.scrollWidth-i.clientWidth-s;break;default:i.scrollLeft=s}else i.scrollLeft=s}}const ki=[];let Di;new MutationObserver((function(){const e=Mi();ki.forEach((t=>{Li(t,e)}))})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Li=function(e,t){t?e.setAttribute("dir",t):e.removeAttribute("dir")},Mi=function(){return document.documentElement.getAttribute("dir")},Fi=e=>class extends e{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize(),Di||(Di=Ni.detectScrollType())}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")||(this.__subscribe(),Li(this,Mi()))}attributeChangedCallback(e,t,i){if(super.attributeChangedCallback(e,t,i),"dir"!==e)return;const s=i===Mi()&&-1===ki.indexOf(this),r=!i&&t&&-1===ki.indexOf(this),n=i!==Mi()&&t===Mi();s||r?(this.__subscribe(),Li(this,Mi())):n&&this.__subscribe(!1)}disconnectedCallback(){super.disconnectedCallback(),this.__subscribe(!1),this.removeAttribute("dir")}__subscribe(e=!0){e?-1===ki.indexOf(this)&&ki.push(this):ki.indexOf(this)>-1&&ki.splice(ki.indexOf(this),1)}__getNormalizedScrollLeft(e){return Ni.getNormalizedScrollLeft(Di,this.getAttribute("dir")||"ltr",e)}__setNormalizedScrollLeft(e,t){return Ni.setNormalizedScrollLeft(Di,this.getAttribute("dir")||"ltr",e,t)}};let Hi;window.Vaadin||(window.Vaadin={}),window.Vaadin.registrations=window.Vaadin.registrations||[],window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{},window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){};const Bi=new Set,$i=e=>class extends(Fi(e)){static finalize(){super.finalize();const{is:e}=this;e&&!Bi.has(e)&&(window.Vaadin.registrations.push(this),Bi.add(e),window.Vaadin.developmentModeCallback&&(Hi=$t.debounce(Hi,Be,(()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()})),Gt(Hi)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}}
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class Vi extends($i(zi(Ii(Ei(Bt))))){static get template(){return pe`
    <style>
      :host {
        display: inline-block;
      }
...
</dom-module>`;document.head.appendChild(Gi.content);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
class ji{constructor(){this.start=0,this.end=0,this.previous=null,this.parent=null,this.rules=null,this.parsedCssText="",this.cssText="",this.atRule=!1,this.type=0,this.keyframesName="",this.selector="",this.parsedSelector=""}}function qi(e){return Ui(function(e){let t=new ji;t.start=0,t.end=e.length;let i=t;for(let s=0,r=e.length;s<r;s++)if(e[s]===Ji){i.rules||(i.rules=[]);let e=i,t=e.rules[e.rules.length-1]||null;i=new ji,i.start=s+1,i.parent=e,i.previous=t,e.rules.push(i)}else e[s]===Xi&&(i.end=s+1,i=i.parent||t);return t}(e=e.replace(Zi.comments,"").replace(Zi.port,"")),e)}function Ui(e,t){let i=t.substring(e.start,e.end-1);if(e.parsedCssText=e.cssText=i.trim(),e.parent){let s=e.previous?e.previous.end:e.parent.start;i=t.substring(s,e.start-1),i=function(e){return e.replace(/\\([0-9a-f]{1,6})\s/gi,(function(){let e=arguments[1],t=6-e.length;for(;t--;)e="0"+e;return"\\"+e}))}(i),i=i.replace(Zi.multipleSpaces," "),i=i.substring(i.lastIndexOf(";")+1);let r=e.parsedSelector=e.selector=i.trim();e.atRule=0===r.indexOf(es),e.atRule?0===r.indexOf(Qi)?e.type=Yi.MEDIA_RULE:r.match(Zi.keyframesRule)&&(e.type=Yi.KEYFRAMES_RULE,e.keyframesName=e.selector.split(Zi.multipleSpaces).pop()):0===r.indexOf(Ki)?e.type=Yi.MIXIN_RULE:e.type=Yi.STYLE_RULE}let s=e.rules;if(s)for(let e,i=0,r=s.length;i<r&&(e=s[i]);i++)Ui(e,t);return e}function Wi(e,t,i=""){let s="";if(e.cssText||e.rules){let i=e.rules;if(i&&!function(e){let t=e[0];return Boolean(t)&&Boolean(t.selector)&&0===t.selector.indexOf(Ki)}(i))for(let e,r=0,n=i.length;r<n&&(e=i[r]);r++)s=Wi(e,t,s);else s=t?e.cssText:function(e){return function(e){return e.replace(Zi.mixinApply,"").replace(Zi.varApply,"")}(e=function(e){return e.replace(Zi.customProp,"").replace(Zi.mixinProp,"")}(e))}(e.cssText),s=s.trim(),s&&(s="  "+s+"\n")}return s&&(e.selector&&(i+=e.selector+" "+Ji+"\n"),i+=s,e.selector&&(i+=Xi+"\n\n")),i}const Yi={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1e3},Ji="{",Xi="}",Zi={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},Ki="--",Qi="@media",es="@",ts=new Set;function is(e){const t=e.textContent;if(!ts.has(t)){ts.add(t);const e=document.createElement("style");e.setAttribute("shady-unscoped",""),e.textContent=t,document.head.appendChild(e)}}function ss(e){return e.hasAttribute("shady-unscoped")}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function rs(e,t){return e?("string"==typeof e&&(e=qi(e)),t&&os(e,t),Wi(e,b)):""}function ns(e){return!e.__cssRules&&e.textContent&&(e.__cssRules=qi(e.textContent)),e.__cssRules||null}function os(e,t,i,s){if(!e)return;let r=!1,n=e.type;if(s&&n===Yi.MEDIA_RULE){let t=e.selector.match(c);t&&(window.matchMedia(t[1]).matches||(r=!0))}n===Yi.STYLE_RULE?t(e):i&&n===Yi.KEYFRAMES_RULE?i(e):n===Yi.MIXIN_RULE&&(r=!0);let o=e.rules;if(o&&!r)for(let e,r=0,n=o.length;r<n&&(e=o[r]);r++)os(e,t,i,s)}function as(e,t){let i=e.indexOf("var(");if(-1===i)return t(e,"","","");let s=function(e,t){let i=0;for(let s=t,r=e.length;s<r;s++)if("("===e[s])i++;else if(")"===e[s]&&0==--i)return s;return-1}(e,i+3),r=e.substring(i+4,s),n=e.substring(0,i),o=as(e.substring(s+1),t),a=r.indexOf(",");return-1===a?t(n,r.trim(),"",o):t(n,r.substring(0,a).trim(),r.substring(a+1).trim(),o)}window.ShadyDOM&&window.ShadyDOM.wrap;function ls(e){if(void 0!==f)return f;if(void 0===e.__cssBuild){const t=e.getAttribute("css-build");if(t)e.__cssBuild=t;else{const t=function(e){const t="template"===e.localName?e.content.firstChild:e.firstChild;if(t instanceof Comment){const e=t.textContent.trim().split(":");if("css-build"===e[0])return e[1]}return""}(e);""!==t&&function(e){const t="template"===e.localName?e.content.firstChild:e.firstChild;t.parentNode.removeChild(t)}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/(e),e.__cssBuild=t}}return e.__cssBuild||""}function hs(e){return""!==ls(e)}const ds=/;\s*/m,cs=/^\s*(initial)|(inherit)\s*$/,us=/\s*!important/;class ps{constructor(){this._map={}}set(e,t){e=e.trim(),this._map[e]={properties:t,dependants:{}}}get(e){return e=e.trim(),this._map[e]||null}}let _s=null;class ms{constructor(){this._currentElement=null,this._measureElement=null,this._map=new ps}detectMixin(e){return function(e){const t=d.test(e)||h.test(e);return d.lastIndex=0,h.lastIndex=0,t}(e)}gatherStyles(e){const t=function(e){const t=[],i=e.querySelectorAll("style");for(let e=0;e<i.length;e++){const s=i[e];ss(s)?_||(is(s),s.parentNode.removeChild(s)):(t.push(s.textContent),s.parentNode.removeChild(s))}return t.join("").trim()}(e.content);if(t){const i=document.createElement("style");return i.textContent=t,e.content.insertBefore(i,e.content.firstChild),i}return null}transformTemplate(e,t){void 0===e._gatheredStyle&&(e._gatheredStyle=this.gatherStyles(e));const i=e._gatheredStyle;return i?this.transformStyle(i,t):null}transformStyle(e,t=""){let i=ns(e);return this.transformRules(i,t),e.textContent=rs(i),i}transformCustomStyle(e){let t=ns(e);return os(t,(e=>{":root"===e.selector&&(e.selector="html"),this.transformRule(e)})),e.textContent=rs(t),t}transformRules(e,t){this._currentElement=t,os(e,(e=>{this.transformRule(e)})),this._currentElement=null}transformRule(e){e.cssText=this.transformCssText(e.parsedCssText,e),":root"===e.selector&&(e.selector=":host > *")}transformCssText(e,t){return e=e.replace(h,((e,i,s,r)=>this._produceCssProperties(e,i,s,r,t))),this._consumeCssProperties(e,t)}_getInitialValueForProperty(e){return this._measureElement||(this._measureElement=document.createElement("meta"),this._measureElement.setAttribute("apply-shim-measure",""),this._measureElement.style.all="initial",document.head.appendChild(this._measureElement)),window.getComputedStyle(this._measureElement).getPropertyValue(e)}_fallbacksFromPreviousRules(e){let t=e;for(;t.parent;)t=t.parent;const i={};let s=!1;return os(t,(t=>{s=s||t===e,s||t.selector===e.selector&&Object.assign(i,this._cssTextToMap(t.parsedCssText))})),i}_consumeCssProperties(e,t){let i=null;for(;i=d.exec(e);){let s=i[0],r=i[1],n=i.index,o=n+s.indexOf("@apply"),a=n+s.length,l=e.slice(0,o),h=e.slice(a),c=t?this._fallbacksFromPreviousRules(t):{};Object.assign(c,this._cssTextToMap(l));let u=this._atApplyToCssProperties(r,c);e=`${l}${u}${h}`,d.lastIndex=n+u.length}return e}_atApplyToCssProperties(e,t){e=e.replace(ds,"");let i=[],s=this._map.get(e);if(s||(this._map.set(e,{}),s=this._map.get(e)),s){let r,n,o;this._currentElement&&(s.dependants[this._currentElement]=!0);const a=s.properties;for(r in a)o=t&&t[r],n=[r,": var(",e,"_-_",r],o&&n.push(",",o.replace(us,"")),n.push(")"),us.test(a[r])&&n.push(" !important"),i.push(n.join(""))}return i.join("; ")}_replaceInitialOrInherit(e,t){let i=cs.exec(t);return i&&(t=i[1]?this._getInitialValueForProperty(e):"apply-shim-inherit"),t}_cssTextToMap(e,t=!1){let i,s,r=e.split(";"),n={};for(let e,o,a=0;a<r.length;a++)e=r[a],e&&(o=e.split(":"),o.length>1&&(i=o[0].trim(),s=o.slice(1).join(":"),t&&(s=this._replaceInitialOrInherit(i,s)),n[i]=s));return n}_invalidateMixinEntry(e){if(_s)for(let t in e.dependants)t!==this._currentElement&&_s(t)}_produceCssProperties(e,t,i,s,r){if(i&&as(i,((e,t)=>{t&&this._map.get(t)&&(s=`@apply ${t};`)})),!s)return e;let n=this._consumeCssProperties(""+s,r),o=e.slice(0,e.indexOf("--")),a=this._cssTextToMap(n,!0),l=a,h=this._map.get(t),d=h&&h.properties;d?l=Object.assign(Object.create(d),a):this._map.set(t,l);let c,u,p=[],_=!1;for(c in l)u=a[c],void 0===u&&(u="initial"),d&&!(c in d)&&(_=!0),p.push(`${t}_-_${c}: ${u}`);return _&&this._invalidateMixinEntry(h),h&&(h.properties=l),i&&(o=`${e};${o}`),`${o}${p.join("; ")};`}}ms.prototype.detectMixin=ms.prototype.detectMixin,ms.prototype.transformStyle=ms.prototype.transformStyle,ms.prototype.transformCustomStyle=ms.prototype.transformCustomStyle,ms.prototype.transformRules=ms.prototype.transformRules,ms.prototype.transformRule=ms.prototype.transformRule,ms.prototype.transformTemplate=ms.prototype.transformTemplate,ms.prototype._separator="_-_",Object.defineProperty(ms.prototype,"invalidCallback",{get:()=>_s,set(e){_s=e}});
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const fs={},gs="_applyShimCurrentVersion",ys="_applyShimNextVersion",bs="_applyShimValidatingVersion",vs=Promise.resolve();
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function As(e){let t=fs[e];t&&function(e){e[gs]=e[gs]||0,e[bs]=e[bs]||0,e[ys]=(e[ys]||0)+1}(t)}function ws(e){return e[gs]===e[ys]}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Cs=new ms;class xs{constructor(){this.customStyleInterface=null,Cs.invalidCallback=As}ensure(){this.customStyleInterface||window.ShadyCSS.CustomStyleInterface&&(this.customStyleInterface=window.ShadyCSS.CustomStyleInterface,this.customStyleInterface.transformCallback=e=>{Cs.transformCustomStyle(e)},this.customStyleInterface.validateCallback=()=>{requestAnimationFrame((()=>{this.customStyleInterface.enqueued&&this.flushCustomStyles()}))})}prepareTemplate(e,t){if(this.ensure(),hs(e))return;fs[t]=e;let i=Cs.transformTemplate(e,t);e._styleAst=i}flushCustomStyles(){if(this.ensure(),!this.customStyleInterface)return;let e=this.customStyleInterface.processStyles();if(this.customStyleInterface.enqueued){for(let t=0;t<e.length;t++){let i=e[t],s=this.customStyleInterface.getStyleForCustomStyle(i);s&&Cs.transformCustomStyle(s)}this.customStyleInterface.enqueued=!1}}styleSubtree(e,t){if(this.ensure(),t&&u(e,t),e.shadowRoot){this.styleElement(e);let t=e.shadowRoot.children||e.shadowRoot.childNodes;for(let e=0;e<t.length;e++)this.styleSubtree(t[e])}else{let t=e.children||e.childNodes;for(let e=0;e<t.length;e++)this.styleSubtree(t[e])}}styleElement(e){this.ensure();let{is:t}=function(e){let t=e.localName,i="",s="";return t?t.indexOf("-")>-1?i=t:(s=t,i=e.getAttribute&&e.getAttribute("is")||""):(i=e.is,s=e.extends),{is:i,typeExtension:s}}(e),i=fs[t];if((!i||!hs(i))&&i&&!ws(i)){(function(e){return!ws(e)&&e[bs]===e[ys]})(i)||(this.prepareTemplate(i,t),function(e){e[bs]=e[ys],e._validating||(e._validating=!0,vs.then((function(){e[gs]=e[ys],e._validating=!1})))}(i));let s=e.shadowRoot;if(s){let e=s.querySelector("style");e&&(e.__cssRules=i._styleAst,e.textContent=rs(i._styleAst))}}}styleDocument(e){this.ensure(),this.styleSubtree(document.body,e)}}if(!window.ShadyCSS||!window.ShadyCSS.ScopingShim){const e=new xs;let t=window.ShadyCSS&&window.ShadyCSS.CustomStyleInterface;window.ShadyCSS={prepareTemplate(t,i,s){e.flushCustomStyles(),e.prepareTemplate(t,i)},prepareTemplateStyles(e,t,i){window.ShadyCSS.prepareTemplate(e,t,i)},prepareTemplateDom(e,t){},styleSubtree(t,i){e.flushCustomStyles(),e.styleSubtree(t,i)},styleElement(t){e.flushCustomStyles(),e.styleElement(t)},styleDocument(t){e.flushCustomStyles(),e.styleDocument(t)},getComputedStyleValue:(e,t)=>p(e,t),flushCustomStyles(){e.flushCustomStyles()},nativeCss:b,nativeShadow:_,cssBuild:f,disableRuntime:y},t&&(window.ShadyCSS.CustomStyleInterface=t)}window.ShadyCSS.ApplyShim=Cs;
/**
 * @fileoverview
 * @suppress {checkPrototypalTypes}
 * @license Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 ...
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */
const Ss=/:host\(:dir\((ltr|rtl)\)\)/g,Ps=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Es=/:dir\((?:ltr|rtl)\)/,Ts=Boolean(window.ShadyDOM&&window.ShadyDOM.inUse),Is=[];let Os=null,zs="";function Rs(){zs=document.documentElement.getAttribute("dir")}function Ns(e){if(!e.__autoDirOptOut){e.setAttribute("dir",zs)}}function ks(){Rs(),zs=document.documentElement.getAttribute("dir");for(let e=0;e<Is.length;e++)Ns(Is[e])}const Ds=fe((e=>{Ts||Os||(Rs(),Os=new MutationObserver(ks),Os.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const t=Ue(e);class i extends t{static _processStyleText(e,i){return e=t._processStyleText.call(this,e,i),!Ts&&Es.test(e)&&(e=this._replaceDirInCssText(e),this.__activateDir=!0),e}static _replaceDirInCssText(e){let t=e;return t=t.replace(Ss,':host([dir="$1"])'),t=t.replace(Ps,':host([dir="$2"]) $1'),t}constructor(){super(),this.__autoDirOptOut=!1}ready(){super.ready(),this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){t.prototype.connectedCallback&&super.connectedCallback(),this.constructor.__activateDir&&(Os&&Os.takeRecords().length&&ks(),Is.push(this),Ns(this))}disconnectedCallback(){if(t.prototype.disconnectedCallback&&super.disconnectedCallback(),this.constructor.__activateDir){const e=Is.indexOf(this);e>-1&&Is.splice(e,1)}}}return i.__activateDir=!1,i}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ls=!1,Ms=[],Fs=[];function Hs(){Ls=!0,requestAnimationFrame((function(){Ls=!1,function(e){for(;e.length;)Bs(e.shift())}(Ms),setTimeout((function(){!function(e){for(let t=0,i=e.length;t<i;t++)Bs(e.shift())}(Fs)}))}))}function Bs(e){const t=e[0],i=e[1],s=e[2];try{i.apply(t,s)}catch(e){setTimeout((()=>{throw e}))}}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function Vs(e,t,i){return{index:e,removed:t,addedCount:i}}"interactive"===document.readyState||"complete"===document.readyState?$s():window.addEventListener("DOMContentLoaded",$s);function Gs(e,t,i,s,r,n){let o,a=0,l=0,h=Math.min(i-t,n-r);if(0==t&&0==r&&(a=function(e,t,i){for(let s=0;s<i;s++)if(!qs(e[s],t[s]))return s;return i}(e,s,h)),i==e.length&&n==s.length&&(l=function(e,t,i){let s=e.length,r=t.length,n=0;for(;n<i&&qs(e[--s],t[--r]);)n++;return n}(e,s,h-a)),r+=a,n-=l,(i-=l)-(t+=a)==0&&n-r==0)return[];if(t==i){for(o=Vs(t,[],0);r<n;)o.removed.push(s[r++]);return[o]}if(r==n)return[Vs(t,[],i-t)];let d=function(e){let t=e.length-1,i=e[0].length-1,s=e[t][i],r=[];for(;t>0||i>0;){if(0==t){r.push(2),i--;continue}if(0==i){r.push(3),t--;continue}let n,o=e[t-1][i-1],a=e[t-1][i],l=e[t][i-1];n=a<l?a<o?a:o:l<o?l:o,n==o?(o==s?r.push(0):(r.push(1),s=o),t--,i--):n==a?(r.push(3),t--,s=a):(r.push(2),i--,s=l)}return r.reverse(),r}(function(e,t,i,s,r,n){let o=n-r+1,a=i-t+1,l=new Array(o);for(let e=0;e<o;e++)l[e]=new Array(a),l[e][0]=e;for(let e=0;e<a;e++)l[0][e]=e;for(let i=1;i<o;i++)for(let n=1;n<a;n++)if(qs(e[t+n-1],s[r+i-1]))l[i][n]=l[i-1][n-1];else{let e=l[i-1][n]+1,t=l[i][n-1]+1;l[i][n]=e<t?e:t}return l}(e,t,i,s,r,n));o=void 0;let c=[],u=t,p=r;for(let e=0;e<d.length;e++)switch(d[e]){case 0:o&&(c.push(o),o=void 0),u++,p++;break;case 1:o||(o=Vs(u,[],0)),o.addedCount++,u++,o.removed.push(s[p]),p++;break;case 2:o||(o=Vs(u,[],0)),o.addedCount++,u++;break;case 3:o||(o=Vs(u,[],0)),o.removed.push(s[p]),p++}return o&&c.push(o),c}function js(e,t){return Gs(e,0,e.length,t,0,t.length)}function qs(e,t){return e===t}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ys=Element.prototype,Js=Ys.matches||Ys.matchesSelector||Ys.mozMatchesSelector||Ys.msMatchesSelector||Ys.oMatchesSelector||Ys.webkitMatchesSelector,Xs=function(e,t){return Js.call(e,t)};class Zs{constructor(e){window.ShadyDOM&&window.ShadyDOM.inUse&&window.ShadyDOM.patch(e),this.node=e}observeNodes(e){return new Ws(this.node,e)}unobserveNodes(e){e.disconnect()}notifyObserver(){}deepContains(e){if(ge(this.node).contains(e))return!0;let t=e,i=e.ownerDocument;for(;t&&t!==i&&t!==this.node;)t=ge(t).parentNode||ge(t).host;return t===this.node}getOwnerRoot(){return ge(this.node).getRootNode()}getDistributedNodes(){return"slot"===this.node.localName?ge(this.node).assignedNodes({flatten:!0}):[]}getDestinationInsertionPoints(){let e=[],t=ge(this.node).assignedSlot;for(;t;)e.push(t),t=ge(t).assignedSlot;return e}importNode(e,t){let i=this.node instanceof Document?this.node:this.node.ownerDocument;return ge(i).importNode(e,t)}getEffectiveChildNodes(){return Ws.getFlattenedNodes(this.node)}queryDistributedElements(e){let t=this.getEffectiveChildNodes(),i=[];for(let s,r=0,n=t.length;r<n&&(s=t[r]);r++)s.nodeType===Node.ELEMENT_NODE&&Xs(s,e)&&i.push(s);return i}get activeElement(){let e=this.node;return void 0!==e._activeElement?e._activeElement:e.activeElement}}function Ks(e,t){for(let i=0;i<t.length;i++){let s=t[i];Object.defineProperty(e,s,{get:function(){return this.node[s]},configurable:!0})}}class Qs{constructor(e){this.event=e}get rootTarget(){return this.path[0]}get localTarget(){return this.event.target}get path(){return this.event.composedPath()}}let er=Zs;if(window.ShadyDOM&&window.ShadyDOM.inUse&&window.ShadyDOM.noPatch&&window.ShadyDOM.Wrapper){class e extends window.ShadyDOM.Wrapper{}Object.getOwnPropertyNames(Zs.prototype).forEach((t=>{"activeElement"!=t&&(e.prototype[t]=Zs.prototype[t])})),Ks(e.prototype,["classList"]),er=e,Object.defineProperties(Qs.prototype,{localTarget:{get(){const e=this.event.currentTarget,t=e&&tr(e).getOwnerRoot(),i=this.path;for(let e=0;e<i.length;e++){const s=i[e];if(tr(s).getOwnerRoot()===t)return s}},configurable:!0},path:{get(){return window.ShadyDOM.composedPath(this.event)},configurable:!0}})}else!function(e,t){for(let i=0;i<t.length;i++){let s=t[i];e[s]=function(){return this.node[s].apply(this.node,arguments)}}}(Zs.prototype,["cloneNode","appendChild","insertBefore","removeChild","replaceChild","setAttribute","removeAttribute","querySelector","querySelectorAll"]),Ks(Zs.prototype,["parentNode","firstChild","lastChild","nextSibling","previousSibling","firstElementChild","lastElementChild","nextElementSibling","previousElementSibling","childNodes","children","classList"]),function(e,t){for(let i=0;i<t.length;i++){let s=t[i];Object.defineProperty(e,s,{get:function(){return this.node[s]},set:function(e){this.node[s]=e},configurable:!0})}}(Zs.prototype,["textContent","innerHTML","className"]);const tr=function(e){if((e=e||document)instanceof er)return e;if(e instanceof Qs)return e;let t=e.__domApi;return t||(t=e instanceof Event?new Qs(e):new er(e),e.__domApi=t),t},ir=window.ShadyDOM,sr=window.ShadyCSS;
/**
@license
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function rr(e,t){return ge(e).getRootNode()===t}
/**
 * @fileoverview
 * @suppress {checkPrototypalTypes}
 * @license Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function cr(e,t,i,s){!function(e,t,i){const s=e._noAccessors,r=Object.getOwnPropertyNames(e);for(let n=0;n<r.length;n++){let o=r[n];if(!(o in i))if(s)t[o]=e[o];else{let i=Object.getOwnPropertyDescriptor(e,o);i&&(i.configurable=!0,Object.defineProperty(t,o,i))}}}(t,e,s);for(let e in lr)t[e]&&(i[e]=i[e]||[],i[e].push(t[e]))}function ur(e,t,i){t=t||[];for(let s=e.length-1;s>=0;s--){let r=e[s];r?Array.isArray(r)?ur(r,t):t.indexOf(r)<0&&(!i||i.indexOf(r)<0)&&t.unshift(r):console.warn("behavior is null, check for missing or 404 import")}return t}function pr(e,t){for(const i in t){const s=e[i],r=t[i];e[i]=!("value"in r)&&s&&"value"in s?Object.assign({value:s.value},r):r}}const _r=ar(HTMLElement);function mr(e,t,i){let s;const r={};class n extends t{static _finalizeClass(){if(this.hasOwnProperty(JSCompiler_renameProperty("generatedFrom",this))){if(s)for(let e,t=0;t<s.length;t++)e=s[t],e.properties&&this.createProperties(e.properties),e.observers&&this.createObservers(e.observers,e.properties);e.properties&&this.createProperties(e.properties),e.observers&&this.createObservers(e.observers,e.properties),this._prepareTemplate()}else t._finalizeClass.call(this)}static get properties(){const t={};if(s)for(let e=0;e<s.length;e++)pr(t,s[e].properties);return pr(t,e.properties),t}static get observers(){let t=[];if(s)for(let e,i=0;i<s.length;i++)e=s[i],e.observers&&(t=t.concat(e.observers));return e.observers&&(t=t.concat(e.observers)),t}created(){super.created();const e=r.created;if(e)for(let t=0;t<e.length;t++)e[t].call(this)}_registered(){const e=n.prototype;if(!e.hasOwnProperty(JSCompiler_renameProperty("__hasRegisterFinished",e))){e.__hasRegisterFinished=!0,super._registered(),D&&o(e);const t=Object.getPrototypeOf(this);let i=r.beforeRegister;if(i)for(let e=0;e<i.length;e++)i[e].call(t);if(i=r.registered,i)for(let e=0;e<i.length;e++)i[e].call(t)}}_applyListeners(){super._applyListeners();const e=r.listeners;if(e)for(let t=0;t<e.length;t++){const i=e[t];if(i)for(let e in i)this._addMethodEventListenerToNode(this,e,i[e])}}_ensureAttributes(){const e=r.hostAttributes;if(e)for(let t=e.length-1;t>=0;t--){const i=e[t];for(let e in i)this._ensureAttribute(e,i[e])}super._ensureAttributes()}ready(){super.ready();let e=r.ready;if(e)for(let t=0;t<e.length;t++)e[t].call(this)}attached(){super.attached();let e=r.attached;if(e)for(let t=0;t<e.length;t++)e[t].call(this)}detached(){super.detached();let e=r.detached;if(e)for(let t=0;t<e.length;t++)e[t].call(this)}attributeChanged(e,t,i){super.attributeChanged();let s=r.attributeChanged;if(s)for(let r=0;r<s.length;r++)s[r].call(this,e,t,i)}}if(i){Array.isArray(i)||(i=[i]);let e=t.prototype.behaviors;s=ur(i,null,e),n.prototype.behaviors=e?e.concat(i):s}const o=t=>{s&&function(e,t,i){for(let s=0;s<t.length;s++)cr(e,t[s],i,dr)}(t,s,r),cr(t,e,r,hr)};return D||o(n.prototype),n.generatedFrom=e,n}const fr=function(e,t){e||console.warn("Polymer.Class requires `info` argument");let i=t?t(_r):_r;return i=mr(e,i,e.behaviors),i.is=i.prototype.is=e.is,i},gr=function(e){let t;return t="function"==typeof e?e:gr.Class(e),e._legacyForceObservedAttributes&&(t.prototype._legacyForceObservedAttributes=e._legacyForceObservedAttributes),customElements.define(t.is,t),t};
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function yr(e,t,i,s,r){let n;r&&(n="object"==typeof i&&null!==i,n&&(s=e.__dataTemp[t]));let o=s!==i&&(s==s||i==i);return n&&o&&(e.__dataTemp[t]=i),o}gr.Class=fr;const br=fe((e=>class extends e{_shouldPropertyChange(e,t,i){return yr(this,e,t,i,!0)}})),vr=fe((e=>class extends e{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(e,t,i){return yr(this,e,t,i,this.mutableData)}}));br._mutablePropertyChange=yr;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Ar=null;function wr(){return Ar}wr.prototype=Object.create(HTMLTemplateElement.prototype,{constructor:{value:wr,writable:!0}});const Cr=Dt(wr),xr=br(Cr);const Sr=Dt(class{});function Pr(e,t){for(let i=0;i<t.length;i++){let s=t[i];if(Boolean(e)!=Boolean(s.__hideTemplateChildren__))if(s.nodeType===Node.TEXT_NODE)e?(s.__polymerTextContent__=s.textContent,s.textContent=""):s.textContent=s.__polymerTextContent__;else if("slot"===s.localName)if(e)s.__polymerReplaced__=document.createComment("hidden-slot"),ge(ge(s).parentNode).replaceChild(s.__polymerReplaced__,s);else{const e=s.__polymerReplaced__;e&&ge(ge(e).parentNode).replaceChild(s,e)}else s.style&&(e?(s.__polymerDisplay__=s.style.display,s.style.display="none"):s.style.display=s.__polymerDisplay__);s.__hideTemplateChildren__=e,s._showHideChildren&&s._showHideChildren(e)}}class Er extends Sr{constructor(e){super(),this._configureProperties(e),this.root=this._stampTemplate(this.__dataHost);let t=[];this.children=t;for(let e=this.root.firstChild;e;e=e.nextSibling)t.push(e),e.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);let i=this.__templatizeOptions;(e&&i.instanceProps||!i.instanceProps)&&this._enableProperties()}_configureProperties(e){if(this.__templatizeOptions.forwardHostProp)for(let e in this.__hostProps)this._setPendingProperty(e,this.__dataHost["_host_"+e]);for(let t in e)this._setPendingProperty(t,e[t])}forwardHostProp(e,t){this._setPendingPropertyOrPath(e,t,!1,!0)&&this.__dataHost._enqueueClient(this)}_addEventListenerToNode(e,t,i){if(this._methodHost&&this.__templatizeOptions.parentModel)this._methodHost._addEventListenerToNode(e,t,(e=>{e.model=this,i(e)}));else{let s=this.__dataHost.__dataHost;s&&s._addEventListenerToNode(e,t,i)}}_showHideChildren(e){Pr(e,this.children)}_setUnmanagedPropertyToNode(e,t,i){e.__hideTemplateChildren__&&e.nodeType==Node.TEXT_NODE&&"textContent"==t?e.__polymerTextContent__=i:super._setUnmanagedPropertyToNode(e,t,i)}get parentModel(){let e=this.__parentModel;if(!e){let t;e=this;do{e=e.__dataHost.__dataHost}while((t=e.__templatizeOptions)&&!t.parentModel);this.__parentModel=e}return e}dispatchEvent(e){return!0}}const Tr=br(Er);function Ir(e){let t=e.__dataHost;return t&&t._methodHost||t}function Or(e,t,i){let s=i.mutableData?Tr:Er;kr.mixin&&(s=kr.mixin(s));let r=class extends s{};return r.prototype.__templatizeOptions=i,r.prototype._bindTemplate(e),function(e,t,i,s){let r=i.hostProps||{};for(let t in s.instanceProps){delete r[t];let i=s.notifyInstanceProp;i&&e.prototype._addPropertyEffect(t,e.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Nr(t,i)})}if(s.forwardHostProp&&t.__dataHost)for(let t in r)i.hasHostProps||(i.hasHostProps=!0),e.prototype._addPropertyEffect(t,e.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:function(e,t,i){e.__dataHost._setPendingPropertyOrPath("_host_"+t,i[t],!0,!0)}})}(r,e,t,i),r}function zr(e,t,i,s){let r=i.forwardHostProp;if(r&&t.hasHostProps){const a="template"==e.localName;let l=t.templatizeTemplateClass;if(!l){if(a){let e=i.mutableData?xr:Cr;class s extends e{}l=t.templatizeTemplateClass=s}else{const i=e.constructor;class s extends i{}l=t.templatizeTemplateClass=s}let n=t.hostProps;for(let e in n)l.prototype._addPropertyEffect("_host_"+e,l.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:Rr(e,r)}),l.prototype._createNotifyingProperty("_host_"+e);L&&s&&function(e,t,i){const s=i.constructor._properties,{propertyEffects:r}=e,{instanceProps:n}=t;for(let e in r)if(!(s[e]||n&&n[e])){const t=r[e];for(let i=0;i<t.length;i++){const{part:s}=t[i].info;if(!s.signature||!s.signature.static){console.warn(`Property '${e}' used in template but not declared in 'properties'; attribute will not be observed.`);break}}}}(t,i,s)}if(e.__dataProto&&Object.assign(e.__data,e.__dataProto),a)o=l,Ar=n=e,Object.setPrototypeOf(n,o.prototype),new o,Ar=null,e.__dataTemp={},e.__dataPending=null,e.__dataOld=null,e._enableProperties();else{Object.setPrototypeOf(e,l.prototype);const i=t.hostProps;for(let t in i)if(t="_host_"+t,t in e){const i=e[t];delete e[t],e.__data[t]=i}}}var n,o}function Rr(e,t){return function(e,i,s){t.call(e.__templatizeOwner,i.substring("_host_".length),s[i])}}function Nr(e,t){return function(e,i,s){t.call(e.__templatizeOwner,e,i,s[i])}}function kr(e,t,i){if(N&&!Ir(e))throw new Error("strictTemplatePolicy: template owner not trusted");if(i=i||{},e.__templatizeOwner)throw new Error("A <template> can only be templatized once");e.__templatizeOwner=t;let s=(t?t.constructor:Er)._parseTemplate(e),r=s.templatizeInstanceClass;r||(r=Or(e,s,i),s.templatizeInstanceClass=r);const n=Ir(e);zr(e,s,i,n);let o=class extends r{};return o.prototype._methodHost=n,o.prototype.__dataHost=e,o.prototype.__templatizeOwner=t,o.prototype.__hostProps=s.hostProps,o=o,o}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Dr=!1;function Lr(){if(D&&!T){if(!Dr){Dr=!0;const e=document.createElement("style");e.textContent="dom-bind,dom-if,dom-repeat{display:none;}",document.head.appendChild(e)}return!0}return!1}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const jr=ar(HTMLElement).prototype;
/**
@license
...
`),On.register("vaadin-grid-styles");
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const zn=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Rn extends($i(Ii(ln(nn(hn(sn(_n(mn(fn(pn(Pn(tn(cn(En(on(dn(Sn(gn(en))))))))))))))))))){static get template(){return pe`
