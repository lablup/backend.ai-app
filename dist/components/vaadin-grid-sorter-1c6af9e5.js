import{h as e,D as t,e as i,i as s,g as r,G as o,b as n,d as a,C as l,I as h,j as d,k as c,m as u,B as p,c as m,t as _,F as g,l as f,u as b}from"./iron-resizable-behavior-b556a6a9.js";
/**
@license
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const ze=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class ke extends(W(O(ne(se(ae(te(ue(pe(me(ce(Ce(ee(he(Ie(re(le(we(_e(J))))))))))))))))))){static get template(){return e`
