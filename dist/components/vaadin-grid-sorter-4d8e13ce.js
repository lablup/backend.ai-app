import{h as e,D as t,e as i,i as s,g as r,G as o,b as n,d as a,C as l,I as h,j as d,k as c,m as u,B as p,l as m,t as _,F as g,n as f,u as b}from"./iron-resizable-behavior-60d31af0.js";
/**
@license
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class L{static detectScrollType(){const e=document.createElement("div");e.textContent="ABCD",e.dir="rtl",e.style.fontSize="14px",e.style.width="4px",e.style.height="1px",e.style.position="absolute",e.style.top="-1000px",e.style.overflow="scroll",document.body.appendChild(e);let t="reverse";return e.scrollLeft>0?t="default":(e.scrollLeft=1,0===e.scrollLeft&&(t="negative")),document.body.removeChild(e),t}static getNormalizedScrollLeft(e,t,i){const{scrollLeft:s}=i;if("rtl"!==t||!e)return s;switch(e){case"negative":return i.scrollWidth-i.clientWidth+s;case"reverse":return i.scrollWidth-i.clientWidth-s}return s}static setNormalizedScrollLeft(e,t,i,s){if("rtl"===t&&e)switch(e){case"negative":i.scrollLeft=i.clientWidth-i.scrollWidth+s;break;case"reverse":i.scrollLeft=i.scrollWidth-i.clientWidth-s;break;default:i.scrollLeft=s}else i.scrollLeft=s}}const D=[];let M;new MutationObserver((function(){const e=N();D.forEach(t=>{H(t,e)})})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const H=function(e,t){t?e.setAttribute("dir",t):e.removeAttribute("dir")},N=function(){return document.documentElement.getAttribute("dir")},B=e=>class extends e{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize(),M||(M=L.detectScrollType())}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")||(this.__subscribe(),H(this,N()))}attributeChangedCallback(e,t,i){if(super.attributeChangedCallback(e,t,i),"dir"!==e)return;const s=i===N()&&-1===D.indexOf(this),r=!i&&t&&-1===D.indexOf(this),o=i!==N()&&t===N();s||r?(this.__subscribe(),H(this,N())):o&&this.__subscribe(!1)}disconnectedCallback(){super.disconnectedCallback(),this.__subscribe(!1),this.removeAttribute("dir")}__subscribe(e=!0){e?-1===D.indexOf(this)&&D.push(this):D.indexOf(this)>-1&&D.splice(D.indexOf(this),1)}__getNormalizedScrollLeft(e){return L.getNormalizedScrollLeft(M,this.getAttribute("dir")||"ltr",e)}__setNormalizedScrollLeft(e,t){return L.setNormalizedScrollLeft(M,this.getAttribute("dir")||"ltr",e,t)}};let G;window.Vaadin||(window.Vaadin={}),window.Vaadin.registrations=window.Vaadin.registrations||[],window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{},window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){};const V=new Set,W=e=>class extends(B(e)){static finalize(){super.finalize();const{is:e}=this;e&&!V.has(e)&&(window.Vaadin.registrations.push(this),V.add(e),window.Vaadin.developmentModeCallback&&(G=i.debounce(G,s,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),r(G)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}}
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class $ extends(W(F(O(o(n))))){static get template(){return e`
    <style>
      :host {
        display: inline-block;
      }
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/,le=e=>class extends e{getEventContext(e){const t={},i=e.composedPath(),s=i[i.indexOf(this.$.table)-3];return s?(t.section=["body","header","footer","details"].filter(e=>s.getAttribute("part").indexOf(e)>-1)[0],s._column&&(t.column=s._column),"body"!==t.section&&"details"!==t.section||Object.assign(t,this.__getRowModel(s.parentElement)),t):t}}
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`),Ee.register("vaadin-grid-styles");
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const ze=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class ke extends(W(O(ne(se(ae(te(ue(pe(me(ce(Ce(ee(he(Se(re(le(we(_e(J))))))))))))))))))){static get template(){return e`
