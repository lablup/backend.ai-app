import{aa as e,b as t}from"./backend-ai-webui-db9b3c72.js";class s extends HTMLElement{static get version(){return"1.6.1"}}customElements.define("vaadin-lumo-styles",s);
/**
@license
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let C,S,x=/(url\()([^)]*)(\))/g,P=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/;function T(e,t){if(e&&P.test(e))return e;if("//"===e)return e;if(void 0===C){C=!1;try{const e=new URL("b","http://a");e.pathname="c%20d",C="http://a/c%20d"===e.href}catch(e){}}if(t||(t=document.baseURI||window.location.href),C)try{return new URL(e,t).href}catch(t){return e}return S||(S=document.implementation.createHTMLDocument("temp"),S.base=S.createElement("base"),S.head.appendChild(S.base),S.anchor=S.createElement("a"),S.body.appendChild(S.anchor)),S.base.href=t,S.anchor.href=e,S.anchor.href||e}function E(e,t){return e.replace(x,(function(e,s,i,r){return s+"'"+T(i.replace(/["']/g,""),t)+"'"+r}))}function I(e){return e.substring(0,e.lastIndexOf("/")+1)}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function be(e){return e.indexOf(".")>=0}function ve(e){let t=e.indexOf(".");return-1===t?e:e.slice(0,t)}function Ae(e,t){return 0===e.indexOf(t+".")}function we(e,t){return 0===t.indexOf(e+".")}function Ce(e,t,s){return t+s.slice(e.length)}function Se(e){if(Array.isArray(e)){let t=[];for(let s=0;s<e.length;s++){let i=e[s].toString().split(".");for(let e=0;e<i.length;e++)t.push(i[e])}return t.join(".")}return e}function xe(e){return Array.isArray(e)?Se(e).split("."):e.toString().split(".")}function Pe(e,t,s){let i=e,r=xe(t);for(let e=0;e<r.length;e++){if(!i)return;i=i[r[e]]}return s&&(s.path=r.join(".")),i}function Te(e,t,s){let i=e,r=xe(t),n=r[r.length-1];if(r.length>1){for(let e=0;e<r.length-1;e++){if(i=i[r[e]],!i)return}i[n]=s}else i[t]=s;return r.join(".")}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Si={},xi="_applyShimCurrentVersion",Pi="_applyShimNextVersion",Ti="_applyShimValidatingVersion",Ei=Promise.resolve();
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function Ii(e){let t=Si[e];t&&function(e){e[xi]=e[xi]||0,e[Ti]=e[Ti]||0,e[Pi]=(e[Pi]||0)+1}(t)}function Oi(e){return e[xi]===e[Pi]}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
