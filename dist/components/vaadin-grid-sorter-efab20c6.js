...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const ze=document.createElement("dom-module");ze.appendChild(e`
  <style>
...
`);const ke=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),Pe=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(ke||Pe){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",ze.querySelector("template").content.appendChild(e)}ze.register("vaadin-grid-styles");
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
const Re=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Oe extends($(L(ne(re(le(ie(ue(pe(me(ce(Ce(te(he(Se(se(ae(we(_e(ee))))))))))))))))))){static get template(){return e`
