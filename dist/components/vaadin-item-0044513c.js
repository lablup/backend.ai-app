import{a as e,r as t,h as i,T as s,c as o,P as a}from"./vaadin-grid-69a293c4.js";e("vaadin-item",t`
    :host {
      display: flex;
      align-items: center;
 ...
 * Copyright (c) 2021 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;class r extends(n(s(o(a)))){static get template(){return i`
      <style>
        :host {
    ...
    `}static get is(){return"vaadin-item"}static get version(){return"21.0.0"}constructor(){super(),this.value}}customElements.define(r.is,r);
