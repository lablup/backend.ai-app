import{h as e,b as t}from"./iron-resizable-behavior-60d31af0.js";import{T as i,D as s}from"./vaadin-grid-1307b1dd.js";const o=e`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
`}static get is(){return"vaadin-item"}static get version(){return"2.2.0"}constructor(){super(),this.value}}customElements.define(n.is,n);
