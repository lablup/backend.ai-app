import{f as e,P as t}from"./backend-ai-console-718d5a3e.js";import{T as i}from"./iron-resizable-behavior-1f5cdd15.js";import"./vaadin-grid-3fb53cd4.js";const s=e`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class a extends(o(i(t))){static get template(){return e`
    <style>
      :host {
