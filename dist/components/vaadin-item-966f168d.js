import{h as e,T as t,P as i}from"./iron-resizable-behavior-de55f964.js";import"./vaadin-grid-4911f4dc.js";const s=e`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class a extends(o(t(i))){static get template(){return e`
    <style>
      :host {
