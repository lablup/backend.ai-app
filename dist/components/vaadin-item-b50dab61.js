import{h as e,b as t}from"./switch-behavior-4e1a81fd.js";import{T as i}from"./iron-resizable-behavior-a95821af.js";import"./vaadin-grid-2601235c.js";const s=e`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
`}static get is(){return"vaadin-item"}static get version(){return"2.1.1"}constructor(){super(),this.value}}customElements.define(a.is,a);
