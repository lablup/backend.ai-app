 ...
 */;class f extends(r(v(a(s(l))))){static get template(){return n`
    ...
    `}static get is(){return"vaadin-text-field"}static get version(){return"3.0.1"}static get properties(){return{pattern:{type:String},title:{type:String}}}}customElements.define(f.is,f);
/**
 * @license
 * Copyright (c) 2020 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
