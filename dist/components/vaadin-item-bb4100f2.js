import{r as e,h as t,T as i,b as s,P as o}from"./vaadin-grid-bce1097a.js";import{b as a}from"./backend-ai-webui-cb5ec9bc.js";e("vaadin-item",a`
    :host {
      display: flex;
      align-items: center;
 ...
 */;class r extends(n(i(s(o)))){static get template(){return t`
    ...
    `}static get is(){return"vaadin-item"}static get version(){return"20.0.2"}constructor(){super(),this.value}}customElements.define(r.is,r);
