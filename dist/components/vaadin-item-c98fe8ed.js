 ...
 */;class d extends(r(a(i(n)))){static get template(){return s`
    ...
    `}static get is(){return"vaadin-item"}constructor(){super(),this.value}}customElements.define(d.is,d);
