import{h as r,b as e}from"./switch-behavior-30fde1cf.js";import{E as a,T as o}from"./iron-resizable-behavior-885c0670.js";const t=r`<dom-module id="lumo-progress-bar" theme-for="vaadin-progress-bar">
  <template>
    <style>
      :host {
...
</custom-style>`;document.head.appendChild(t.content);const s=r=>(class extends r{static get properties(){return{value:{type:Number,observer:"_valueChanged"},min:{type:Number,value:0,observer:"_minChanged"},max:{type:Number,value:1,observer:"_maxChanged"},indeterminate:{type:Boolean,value:!1,reflectToAttribute:!0}}}static get observers(){return["_normalizedValueChanged(value, min, max)"]}ready(){super.ready(),this.setAttribute("role","progressbar")}_normalizedValueChanged(r,e,a){const o=this._normalizeValue(r,e,a);this.style.setProperty("--vaadin-progress-value",o),this.updateStyles({"--vaadin-progress-value":String(o)})}_valueChanged(r,e){this.setAttribute("aria-valuenow",r)}_minChanged(r,e){this.setAttribute("aria-valuemin",r)}_maxChanged(r,e){this.setAttribute("aria-valuemax",r)}_normalizeValue(r,e,a){let o;return r||0==r?e>=a?o=1:(o=(r-e)/(a-e),o=Math.min(Math.max(o,0),1)):o=0,o}});class i extends(a(o(s(e)))){static get template(){return r`
    <style>
      :host {
        display: block;
